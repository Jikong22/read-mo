...
export const generatedPosts: Post[] = [
  {
    ...
    "translation": [
      "을 가져야 하는 한편, 독자에게 무엇을 생각할지 말하는 것을 피해야 한다고 상기시키는 것은 가치 가 있다. 그것(논점) 전체에 물음표를 달기 위해 노력해라. 이런 방식으로 당신은 독자들이 당신의 요점과 당신이 하는 주장들에 대해 스스로 생각할 수 있게 만든다. 결과적으로 독자들은 당신만큼이 나 당신이 한 주장과 당신이 드러내는 통찰력에 몰입되는 자신을 발견하면서, 좀 더 열중하게 되 는 느낌을 받게 될 것이다. 당신은 독자들의 수동 성을 피하면서도 흥미롭고 사람들을 생각하게 만 드는 글을 쓰게 될 것이다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "인류학자 Mary Douglas는 더러운 것은 “제자리에 놓여있지 않은 물체”라는 흔히 하는 말을 소환하 여 해석했다. 더러운 것은 상대적인 것이라고 그 녀는 강조한다. “신발은 그 자체로는 더럽지 않지 만, 식탁 위에 놓여 있을 때 더러운 것이며, 음식 은 그 자체로는 더럽지 않지만, 침실에 냄비와 팬 을 놓아둔다면, 혹은 음식이 옷에 다 묻어 있을 때, 유사하게, 거실에 있는 욕실 용품, 의자 위에 놓여 있는 옷, 실내에 있는 실외 물품들, 아래층 에 있는 위층 물건들, 등등이 더러운 것이다.” 깨 끗한 것과 더러운 것을 분류하는 것 ― 식탁에서 신발을 치우는 것, 세탁기에 더러운 옷을 넣는 것 ― 은 체계적인 정리와 분류를 포함하는 것이다. 더러운 것을 제거하는 것은 그러므로 긍정적인 과 정이다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "해 싸우는 것도 중요하지만, 자신의 생각을 위해 싸우는 것을 중단하고 신뢰할 수 있는 집단이 가 장 좋다고 생각하는 것을 받아들이는 쪽으로 나아 가는 것이 현명한 때가 온다. 이것은 매우 어려울 수 있다. 하지만 여러분이 마음을 열고 신뢰할 수 있는 집단의 결론이 여러분이 생각하는 어떤 것보 다 낫다는 믿음을 갖는 것이 더 영리하고 궁극적 으로 더 좋다. 만약 여러분이 그들의 생각을 이해 할 수 없다면, 여러분은 아마도 단지 그들이 생각 하는 방식을 보지 못하는 것이다. 모든 증거와 신 뢰할 수 있는 사람들이 당신에게 반대할 때 당신 이 최선이라고 생각하는 것을 계속한다면, 당신은 위험할 정도로 자신감에 차 있는 것이다. 사실 대 부분의 사람들은 믿을 수 없을 정도로 마음을 열 게 되는 반면에, 어떤 사람들은 자신이 옳지 않았 을 때 옳았다고 확신하는 것으로부터 많은 고통을 겪고 난 후에도 그럴 수 없다는 것이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "금류, 생선에 반대함에 따라 주류가 되어가고 있 다. American Dietetic Association에 따르면, 대 략적으로 계획된 채식 식단이 건강에 좋고, 영양 학적으로도 적당하고, 특정한 질병을 예방하고 치 료하는 데 건강상의 이점을 제공한다. 그러나 건 강에 대한 염려들이 젊은이들이 그들의 식단을 바 꾸려고 하는 유일한 이유는 아니다. 몇몇은 동물 의 권리에 대한 관심 때문에 선택한다. 음식으로 길러지는 대다수의 동물들이 갇혀서 산다는 것을 보여주는 통계자료를 볼 때, 많은 십대들은 그러 한 상황에 저항하기 위해 고기를 포기한다. 다른 사람들은 환경을 지지하기 위해 채식주의자가 된 다. 고기를 생산하는 것은 거대한 양의 물, 땅, 곡 식과 에너지를 사용하고 가축에서 나오는 쓰레기 와 그에 따른 오염과 같은 문제들을 만들어낸다."
    ],
    "tags": [
      "#과학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "상력을 유지하게 도와준다. 대부분의 사람들은 갈 등은 나쁜 것이고 “편안한 구역”에 머무는 것이 좋은 것이라고 단정한다. 그것은 정확히는 사실이 아니다. 물론, 우리는 직장 또는 의료보험이 없거 나, 배우자, 가족, 직장 상사, 직장 동료들과의 다 툼에 빠진 자신의 모습을 보고 싶어 하지 않는다. 하나의 나쁜 경험이 우리에게 평생 지속되는 데 충분할 수 있다. 하지만 가족과 친구들과의 작은 의견 충돌, 기술적 또는 재정적 문제, 직장과 가 정에서의 어려움이 우리의 능력에 대해 진지하게 고민하게 도와준다. 해결책이 필요한 문제들은 창 의적인 해답들을 개발하기 위해 우리의 뇌를 사용 하도록 강요한다. 시련과 갈등을 주는, 변화무쌍 한 지형을 운전하는 것은 우리 감각과 마음에 아 무런 어려움을 주지 않는 지형을 다니는 것보다 훨씬 더 창의성에 도움을 준다. 우리의 2백만년 역사는 어려움과 갈등으로 가득 차 있다."
    ],
    "tags": [
      "#심리학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "물품이 팔리기 마련이라고 주장한다. 모든 생산된 물품으로부터 나오는 돈은 다른 물품을 사는 데 사용된다. 한 회사가 물품을 팔 수 없게 되어서 직원들을 해고하고 공장의 문을 닫아야 하는 상황 은 절대 있을 수 없다. 따라서, 경기 후퇴와 실업 은 불가능하다. 지출의 정도를 욕조 안의 물 높이 로 상상해 보아라. Say의 법칙은 사람들이 그들의 모든 수입을 물품을 사는 데 사용하기 때문에 적 용된다. 하지만 만약 사람들이 그들의 돈을 전부 사용하는 대신, 돈의 일부를 모은다면 무슨 일이 일어날까? 경제에서 저축은 지출의 ‘누수’이다. 당 신은 아마 물의 높이가 지금 낮아지고 있는 것, 즉 경제에서 지출이 적어지는 것을 상상하고 있을 것이다. 그것은 회사들이 더 적게 생산하고 일부 직원들을 해고하는 것을 의미할 것이다."
    ],
    "tags": [
      "#경제",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "회적 교류를 발전시켰는지를 설명할 수 있다. 인 간은 영장류 중에서 몇 년, 수십 년, 혹은 평생 지속될 수 있는 광범위한 상호 관계를 보여준다는 점에서 특별한 것 같다. 큰 사냥감의 고기는 사냥 꾼 한 명과 그의 직계가족이 소비할 수 있을 만한 양을 초과한다. 게다가, 사냥의 성공은 매우 가변 적이다. 한 주에는 성공한 사냥꾼이 다음 주에는 실패할 수도 있다. 이러한 조건들은 사냥으로 인 한 음식 공유를 장려한다. 사냥꾼이 당장 먹을 수 없는 고기를 나눠 주는 데 드는 비용은 혼자서 고 기를 다 먹을 수 없고 남은 고기는 곧 상하기 때 문에 많이(→ 적게) 든다. 그러나 그 사람이 나중 에 스스로 음식을 얻지 못했을 때, 그 사람의 음 식을 받은 다른 사람들이 관대한 호의에 보답할 때 그 혜택은 클 수 있다. 본질적으로 사냥꾼들은 그들의 친구와 이웃의 몸에 여분의 고기를 저장할 수 있다."
    ],
    "tags": [
      "#과학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "단순한 제품이다. 최근까지, 자전거는 최고급이라 고 여겨지기 위해서는 보통 15개 혹은 20개의 많 은 기어를 가져야 했다. 그러나 최소한의 특징을 가지고 있는, 고정식 기어 자전거들은 그것들을 사는 사람들이 훨씬 적은 것에 대해 기꺼이 더 지 불함에 따라 점점 더 인기를 얻게 되었다. 이런 자전거들의 전반적인 수익성은 더 복잡한 것들 보 다 훨씬 더 큰데 그것들이 추가되는 복잡성에 대 한 비용 없이 한 가지를 정말 잘하기 때문이다. 기업들은 경쟁 업체와 더 많은 특징들을 추가하는 전쟁을 하는 것을 조심해야 하는데, 이것이 가격 에 대한 경쟁적인 압박 때문에 비용을 증가시키고 수익성을 거의 확실히 감소시킬 것이기 때문이다."
    ],
    "tags": [
      "#경제",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "이유로 언어를 발달시켰다고 주장한다. 우리는 거 래해야했고, 거래하기 위해서는 신뢰를 확립해야 했다. 언어는 당신이 누군가와 거래할 때 매우 편 리하다. 초창기의 두 인간은 3개의 나무로 만든 그릇을 6다발의 바나나와 거래하기로 동의할 수 있었을 뿐만 아니라 규칙을 정할 수도 있었다. 그 그릇들을 만드는데 무슨 나무를 사용했나? 어디서 그 바나나를 얻게 되었나? 단지 제스처와 혼란스 런 소음만을 사용해서는 그 상업 거래는 거의 불 가능 했을 것이고, 합의된 조항에 따라서 그것을 실행하는 것이 신뢰라는 결속을 만든다. 언어는 우리가 구체적이도록 해주고 이것이 대화가 중요 한 역할을 하는 지점이다."
    ],
    "tags": [
      "#과학",
      "#경제"
  ...
  },
  {
    ...
    "translation": [
      "점은 마술사들이 그들의 실수를 관중에게 숨기는 반면, 과학에서는 공공연히 실수를 한다는 것이다. 당신은 모두가 실수로부터 배울 수 있도록 실수를 드러내 보여준다. 이런 식으로, 당신은 단지 실수 라는 영역을 거쳐 온 당신 자신만의 특유한 길(에 서 얻은 이익)뿐만 아니라, 다른 모든 사람들의 Wolf Howls in Algonquin Park Wolf Howls in Algonquin Park는 오늘밤 당신에게 평생 한 번 밖에 없을만한 경험을 선사합니다! 늑대들이 우리 직원과 나누는 대화를 들을 기회를 놓치지 마세요. 언제 & 어디에서 ∙ 2021년 8월 25일 수요일 오후 8시 (날씨가 허락하고 늑대 무리가 근처에 있을 때만 가능) ∙ 야외극장에서 직원을 만나서 늑대울음 장소까지 그들과 함께 오세요. 이용 요금 ∙ 1인당 18달러(65세 이상 Ontario 거주자는 무료) 공지 ∙ 3시간 이상 진행되는 프로그램을 위해 옷을 따뜻하게 입으세요. ∙ 행사 내내 반려견을 동반할 수 없습니다. ∙ 행사에 5인 미만 신청 시, 취소됩니다. ※ 더 많은 정보를 원하시면, 우리 웹 사이트 www.algonguinpark.on에 방문하세요. Premier Reading Challenge 이 행사는 경쟁하는 대회가 아니고, 학생들이 독서에 대한 사랑을 가지도록 영감을 주기 위 한 도전과제입니다. ∙ 참가자들 ‐ 6학년부터 9학년까지의 학생들 ∙ 날짜 ‐ 6월 1일부터 12월 31일까지 ∙ 도전 과제 ‐ 6학년과 7학년 개별 학생은 15권의 책을 읽어야 합니다. ‐ 8학년과 9학년 개별 학생은 20권의 책을 읽어야 합니다. ∙ 상품 ‐ 모든 참가자들에게 책갈피 ‐ 도전과제를 완수한 학생들에게 수료증 ∙ 등록 ‐ 오직 온라인으로만 ― www.edu.prc.com ※ 더 많은 정보를 위해, 학교 도서관 사서를 만나거나 위에 있는 웹 사이트를 방문하세요.고 1 정답 및 해설 2021학년도 9월 전국연합학력평가 12 15 경험이라는 이익을 얻는다. 한편, 이는 왜 우리 인간이 다른 모든 종보다 훨씬 더 영리한지에 대 한 또 다른 이유이다. 그것은 우리의 뇌가 더 크 거나 더 강력해서, 혹은 심지어 우리가 우리 자신 의 과거 실수들을 반추하는 능력을 가져서가 아니 라, 우리 개개인들의 뇌가 그들 개개인들의 시행 착오의 역사로부터 얻어낸 이익들을 나눠서이다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "끝날 때까지 끝나지 않은 과업을 상기시켜주는 잠 재적인 마음의 경향을 의미한다. Bluma Zeigarnik 는 1920년대에 과업을 완성하지 못한 채로 남겨두 는 것이 주는 효과에 대해 쓴 리투아니아 심리학자 이다. 그녀는 그 효과를 알아차렸는데 한 식당에서 웨이터들이 서빙하는 것을 보고 있을 때였다. 그 웨 이터들은 아무리 복잡하더라도 그 주문이 끝날 때 까지 주문을 기억했는데, 그들은 나중에는 그 주문 을 기억하는 것이 어렵다는 것을 알았다. Zeigarnik 는 어른들과 아이들 둘 다에게 완성할 퍼즐을 주고 그 과업들 중에 몇몇을 하는 도중에 그들을 방해를 하는 더 깊은 연구를 했다. (그들은 퍼즐을 같이 맞 춤으로써 과업들을 마친 후에 협동 기술을 발달시 켰다.) 그 결과들은 어른들과 아이들 둘 다 방해로 인해 완성되지 못한 과업들을 완성된 것들보다 더 잘 기억했다는 것을 보여주었다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "content": [
      "Understanding how to develop respect for and a\nknowledge of other cultures begins with reexamining the\ngolden rule: “I treat others in the way I want to be treated.” It can also create a frustrating situation where we\nbelieve we are doing what is right, but what we are\ndoing is not being interpreted in the way in which it was\nmeant. This miscommunication can lead to problems. In a multicultural setting, however, where words, gestures,\nbeliefs, and views may have different meanings, this rule\nhas an unintended result; it can send a message that my\nculture is better than yours. This rule makes sense on some level; if we treat\nothers as well as we want to be treated, we will be\ntreated well in return. This rule works well in a\nmonocultural setting, where everyone is working within\nthe same cultural framework. - - - - - - - - - -"
    ],
    "translation": [
      "는 방법을 이해하는 것은 다음과 같은 황금률을 재점검해보는 일에서 시작된다. “나는 당신을 내 가 대접받고 싶은 방식대로 대접합니다.” 이 법칙은 어느 수준에서는 말이 된다. 만약 우리가 다른 사람들을 대접받고 싶은 만큼 대접한다면 우 리는 보답으로 잘 대접받게 될 것이다. 이 법칙은 모든 사람이 같은 문화적 틀 안에서 일하는 단일 문화 환경에서는 잘 통한다. 그러나 단어, 제 스처, 신념과 관점이 다른 의미를 지닐지도 모르 는 다문화 환경에서는 이 법칙이 의도치 않은 결 과를 낳는다. 그것은 나의 문화가 너의 것보다 낫 다는 메시지를 줄 수 있다. 그것은 또한 우리 가 하는 것이 옳다고 믿지만, 그것이 의도된 방식 으로 해석되지 않는 답답한 상황을 낳을 수도 있 다. 이러한 의사소통 오류는 문제를 야기할 수 있 다."
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "content": [
      "In a study, a researcher pretending to be a volunteer\nsurveyed a California neighborhood, asking residents if\nthey would allow a large sign reading ‘‘Drive Carefully’’ to\nbe displayed on their front lawns. The reason that they agreed was this: two weeks\nearlier, these residents had been asked by another\nvolunteer to make a small commitment to display a tiny\nsign that read ‘‘Be a Safe Driver’’ in their windows. Since it was such a small and simple request, nearly all of\nthem agreed. The astonishing result was that the initial\nsmall commitment deeply influenced their willingness to\naccept the much larger request two weeks later. To help them understand what it would look like, the\nvolunteer showed his participants a picture of the large\nsign blocking the view of a beautiful house. Naturally,\nmost people refused, but in one particular group, an\nincredible 76 percent actually approved. - - - - - - - - - -"
    ],
    "translation": [
      "이 한 캘리포니아 동네에서 주민들에게 그들의 앞 마당에 “운전 조심”이라고 쓰인 큰 표지판을 세워 두는 것을 허락할지를 설문조사했다. 그것이 어떻게 보일지에 대한 그들의 이해를 돕기 위해, 그 자원봉사자는 참여자들에게 아름다운 집의 전 망을 막는 큰 표지판 사진을 보여주었다. 당연하 게도, 대부분의 사람들은 거절했지만, 한 특정 그 룹에서, 놀랍게도 76퍼센트가 실제로 승낙했다. 그들이 동의한 이유는 이것이다. 2주 전에, 이 주민들은 다른 자원봉사자로부터 “안전운전자 가 되세요”라고 쓰인 아주 작은 표지판을 그들의 창문에 붙인다는 작은 약속을 하도록 요청받은 적 이 있었다. 그것이 아주 작고 간단한 요청이 었기 때문에, 그들 거의 모두가 동의했다. 놀라운 결과는, 처음의 작은 약속이 그들이 2주 후의 훨 씬 더 큰 요청을 기꺼이 받아들이는 데 깊은 영향 을 끼쳤다는 것이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "However, using caffeine to improve alertness and mental\nperformance doesn’t replace getting a good night’s sleep.\nStudies have consistently shown caffeine to be effective\nwhen used together with a pain reliever to treat headaches. The positive correlation between caffeine intake and\nstaying alert throughout the day has also been well\nestablished. As little as 60 mg (the amount typically in\none cup of tea) can lead to a faster reaction time. One\nstudy from 2018 showed that coffee improved reaction times\nin those with or without poor sleep, but caffeine seemed to\nincrease errors in the group with little sleep. Additionally, this study showed that even with caffeine, the\ngroup with little sleep did not score as well as those with\nadequate sleep. It suggests that caffeine does not fully\nmake up for inadequate sleep."
    ],
    "translation": [
      "통제와 함께 사용할 때 효과적이라는 것을 일관적 으로 보여주었다. 또한 카페인 섭취와 하루 종일 각성된 상태로 있는 것 사이에는 양의 상관관계가 잘 확립되어 있다. 60 mg (일반적으로 차 한 잔에 들어 있는 양) 만큼의 적은 양으로도 반응 시간이 빨라질 수 있다. 하지만, 각성과 정신적 수행능력 을 향상시키기 위해 카페인을 사용하는 것은 숙면 을 취하는 것을 대체하지 못한다. 2018년 한 연구 는 커피는 수면이 부족한 사람이나 부족하지 않은 사람에게나 반응 시간은 개선시켰지만, 카페인은 수면이 부족한 집단 내에서는 오류를 증가시키는 것 같다는 것을 보여주었다. 게다가, 이 연구는 카 페인을 섭취하더라도, 수면이 부족한 그룹은 적절 한 수면을 취한 집단만큼 점수를 잘 받지 못했다는 것을 보여주었다. 그것은 카페인이 불충분한 수면 을 충분히 보충하지 못한다는 것을 보여준다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "제품을 팔 수 있도록 여러분의 블로그를 시작하려는 참이다. 유감스럽게도, 여기가 ‘비즈니스 정신’이 나쁜 것이 될 수 있는 지점이다. 대부분의 사람들은 제품 을 홍보하는 성공적인 상업용 블로그를 가지기 위해 서 그들이 엄격하게 ‘그 주제에’ 머물러야 한다고 믿 는다. 만일 여러분이 하는 일의 전부가 뻔뻔스럽게 여러분의 제품을 홍보하는 것이라면, 그렇다면 누가 여러분이 쓰고 있는 최신의 것을 읽고 싶어할까? 대 신에, 사람들이 계속해서 다시 방문할 이유를 가지도 록 여러분은 어떤 유용하거나 재미있는 정보를 무료 로 줄 필요가 있다. 이렇게 해야만 여러분은 여러분 이 그 다음에 판매를 할 수 있게 될 관심 있는 독자 를 만들 수 있다. 따라서, 상업용 블로그로 성공하기 위한 가장 좋은 방법은 여러분의 독자들이 관심을 가질 만한 것들에 대해 쓰는 것이다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "내는 것을 돕는다. 이것을 잘 드러내는 다음과 같은 문구들을 생각해 보라. 우리가 중요한 무언가를 성취 할 때, 우리는 그것이 ‘피, 땀, 그리고 눈물’을 필요로 했다고 말한다. 우리는 중요한 성과는 ‘힘들게 얻은’ 것이라고 말한다. 우리는 ‘하루 동안의 일’이라는 말 로도 충분할 때 ‘힘든 하루 동안의 일’이라는 말을 권한다. 우리가 ‘쉬운 돈’이라는 말을 할 때, 우리는 그것이 불법적이거나 의심스러운 수단을 통해 얻어 졌다는 것을 넌지시 드러내고 있다. 우리는 보통 누 군가의 의견이 틀렸음을 입증하려고 할 때, 우리는 ‘말은 쉽지’라는 문구를 비판으로 사용한다. 이는 마 치 우리 모두가 ‘올바른’ 방법은 반드시 더 어려운 방법이라는 것을 자동적으로 받아들이는 것과 같다. 나의 경험상 이것은 거의 한 번도 의문이 제기되지 않는다. 만약 여러분이 정말로 이 신성한 소에 맞선 다면 무슨 일이 일어날까? 우리는 중요하고 가치 있 는 무언가를 쉬운 것으로 만들 수 있다고 잠시 멈춰 생각해 보지도 않는다. 만약 우리가 중요한 일을 하 지 못하게 하는 가장 큰 것이 중요한 일은 엄청난 노력을 필요로 한다는 잘못된 전제라면 어떨까? * sacred cow: 지나치게 신성시되어 비판이나 의심이 허용 되지 않는 관습이나 제도"
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "translation": [
      "고 하지만, 무섭고 위협적인 뉴스에 관한 한, 연구는 정반대를 시사한다. 두려움을 주는 뉴스는 실제로 사 람들로부터 내면의 통제력을 빼앗을 수 있어서, 그들 이 스스로와 다른 사람들을 돌볼 가능성을 더 낮게 만든다. 공중 보건 연구는 뉴스가 건강과 관련된 정 보를 비관적인 방식으로 제시할 때, 결과적으로 사람 들이 질병으로부터 자신을 보호하기 위한 조치를 취 할 가능성이 실제로 더 낮다는 것을 보여준다. 예를 들어, 증가하는 암 발생률에 대해 사람들에게 경고하 려 하는 뉴스 기사는 그들이 발견할지도 모를 것에 대해 너무 두려워하기 때문에 더 적은 사람들이 그 병에 대해 검사받는 것을 선택하는 결과를 가져올 수 있다. 이것은 기후 변화와 같은 문제에도 해당된 다. 뉴스가 온통 파멸과 암울한 상황일 때, 사람들은 우울하게 느끼고 생태학적 붕괴와 싸우기 위한 작고 개인적인 조치를 취하는 것에 흥미를 덜 느끼게 된 다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "믿을 수 없는 결과는 그것들이 합쳐서 일종의 타임 머신이라는 것이고, 이것은 너무나 현실적이어서 그 것들이 우리 하루의 기간을 바꾸고 있다. 그것은 이 와 같이 작동한다. 즉, 빙하가 녹고 바다가 높아지면 서 중력이 적도를 향해 더 많은 물을 밀어 넣는다.3 이것은 지구의 모양을 아주 약간 변화시켜 가운데 주변으로 그것을 더 불룩하게 만들고, 이것은 결과적 으로 발레 무용수가 양팔을 뻗어서 그녀의 회전을 늦추는 방식과 유사한 방식으로 행성의 회전을 늦춘 다. 이 감속이 매년 단지 몇천 분의 1초로 크지는 않 지만, 해마다 상승하는 바다의 알아차리기 힘든 증가 처럼, 그것은 쌓인다. 공룡들이 지구에 살았을 때, 하 루는 약 23시간만 지속되었다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "이 즉시 “아니, 그건 안 될 거야.”라고 말한 것을 들 은 적이 있는가? 여러분은 아마도 “그 사람은 기회조 차 주지 않았어. 어떻게 그들은 그것이 안 될 것이라 는 것을 알지?”라고 생각했을 것이다. 여러분이 어떤 일에 대해 옳다면, 여러분은 다른 관점이나 기회의 가능성을 닫아 버린다. 어떤 일에 대해 옳다는 것은 “그것은 원래 그런 거야, 끝.”이라고 하는 것을 의미 한다. 여러분이 맞을 수도 있다. 여러분이 그것을 보 는 특정한 방법이 사실에 부합할 수도 있다. 하지만 다른 선택지나 다른 사람의 관점을 고려하는 것은 이로울 수 있다. 만약 여러분이 그들의 관점을 안다 면, 여러분이 새로운 것을 보거나 그것보다는 나쁘더 라도 다른 사람이 삶을 바라보는 방식에 대한 무언 가를 배울 것이다. 왜 모두가 여러분이 하는 방식대 로 삶을 보거나 경험할 것이라고 생각하는가? 그것 이 얼마나 지루할지는 제외하고라도, 그것은 모든 새 로운 기회, 아이디어, 발명, 그리고 창의성을 없앨 것 이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "수 있는 몇 가지 일에 대한 헤드라인들을 뉴스에서 본 적이 있을 것이다. 하지만, AI로 구동되는 기계가 실제로 수행할 수 있는 모든 작업을 고려한다면, 그 것은 꽤 놀라울 것이다! 인공 지능의 핵심 특징들 중 하나는 그것이 새로운 작업에 특화된 프로그래밍을 필요로 하기보다는 기계들이 새로운 것을 학습할 수 있게 한다는 것이다. 그러므로, 미래의 컴퓨터들과 과거의 그것들 사이의 핵심적인 차이점은 미래의 컴 퓨터가 학습하고 스스로 개선할 수 있을 것이라는 점이다. 가까운 미래에, 스마트 가상 비서는 여러분 에 대해 여러분의 가장 가까운 친구나 가족이 아는 것보다 더 많이 알게 될 것이다. 그것이 우리의 삶을 어떻게 변화시킬지 상상할 수 있는가? 왜 이러한 종 류의 변화는 정확히 새로운 기술들이 우리 세계에 미칠 영향을 인식하는 것이 아주 중요한가에 대한 이유이다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "발견되는 옥신이라고 불리는 호르몬 그룹에 의해 조 절된다. 줄기의 끝에서 생산된 옥신은 그늘진 곳에 있는 줄기의 옆면에 축적되는 경향이 있다. 따라서, 옥신은 식물의 그늘진 면에서의 성장을 자극한다. 그 러므로 그늘진 면은 햇빛을 마주하는 면보다 더 빨 리 자란다. 이 현상은 줄기가 휘어지게 하고 빛을 향 하여 성장하는 것처럼 보이게 한다. 옥신은 식물의 뿌리에서는 반대의 효과를 가진다. 뿌리 끝에 있는 옥신은 성장을 억제하는 경향이 있다. 만약 하나의 뿌리가 토양 속에서 수평이라면, 옥신은 아래쪽에 축 적되어 그것의 발달을 방해할 것이다. 그러므로 뿌리 의 아래쪽은 위쪽보다 더 빠르게(→ 더 느리게) 자 라게 된다. 이것은 결과적으로 뿌리가 아래로 휘어지 게 하고 뿌리의 끝부분은 그 방향으로 자란다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "설명하기 위해, 심리학 및 행동경제학 교수인 Dan Ariely는 MIT의 자신의 수업 중 세 개에서 학생들을 대상으로 실험을 수행했다. 그는 학기 과정 동안 모 든 수업에 세 개의 보고서를 과제로 부여했다. 첫 번 째 수업의 학생들은 종강일까지 포함해서 세 개의 마감일을 스스로 선택해야 했다. 두 번째는 마감일이 없었고, 세 개의 보고서 모두 종강일까지 제출되기만 하면 되었다. 그의 세 번째 수업에서, 그는 학기 과 정 동안 학생들에게 세 개의 정해진 마감일을 주었 다. 학기 말에, 그는 마감일이 정해진 학생들이 최고 의 성적을 받았고, 마감일이 없는 학생들은 최하의 성적을 받았으며, 자신의 마감일을 선택할 수 있었던 학생들은 그 중간 어디쯤의 위치에 있었다는 것을 알아냈다. Ariely는, 교수에 의해서든 혹은 일을 미루 는 자신의 성향을 인식한 학생들에 의해서든, 자유를 제한하는 것은 자기 통제와 성과를 향상시킨다고 결 론짓는다."
    ],
    "tags": [
      "#심리학",
      "#경제"
  ...
  },
  {
    ...
    "translation": [
      "람들이 서로를 위해 일할 수 있도록 함으로써이다. 인류 역사의 주요한 주제는 우리가 생산하는 데 꾸 준히 더 전문화되고 소비하는 데 꾸준히 더 다양화 되는 것이다. 즉, 우리는 불안정한 자급자족에서 더 안전한 서로 간의 상호의존으로 옮겨간다는 것이다. 일주일에 40시간 동안 사람들의 필요를 충족시키는 것, 즉 우리가 직업이라고 부르는 것에 집중함으로 써, 여러분은 다른 사람들에 의해 여러분에게 제공되 는 서비스에 의지하여 나머지 72시간(잠자는 56시간 은 계산에 넣지 않고)을 보낼 수 있다. 혁신은 전등 을 한 시간 동안 켜는 여유를 가질 수 있게 하기 위 해 아주 짧은 시간 동안 일하는 것을 가능하게 했고, 그것은 만약 여러분이 그리 멀지 않은 과거에 많은 인류가 했던 것처럼 단순한 등을 켜기 위해 참기름 이나 양의 지방을 모으고 정제함으로써 그것을 스스 로 만들어야 했다면 하루 종일의 노동을 필요로 했 었을 빛의 양을 제공했다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "적이 있다면, 여러분은 그 습관을 깨는 방법을 배우 는 데 관심이 있을지도 모른다. 그렇게 하도록 여러 분의 뇌를 속이는 한 가지 좋은 방법은 ‘Ulysses 계 약’에 서명하는 것이다. 이러한 인생 조언의 이름은 저항할 수 없는 노래로 희생자들을 죽음으로 유혹한 위험한 여성 부족인 사이렌의 섬을 자신의 배로 항4 해해 지나갔던 선장 Ulysses에 관한 그리스 신화에 서 유래되었다. 그는 그렇게 하지 않으면 저항할 수 없다는 것을 알고 Ulysses는 자신이 배를 사이렌으 로 돌리는 것을 막기 위해 자신의 선원들이 그들의 귀를 솜으로 막고 그를 배의 돛대에 묶으라고 지시 했다. 그것은 그에게 효과가 있었고 여러분은 여러분 의 유혹으로부터 스스로를 차단함으로써 같은 일을 할 수 있다. 예를 들어, 만약 여러분이 휴대폰을 멀 리하고 여러분의 일에 집중하고 싶다면, 여러분의 주 의를 산만하게 하는 앱들을 삭제하거나 친구에게 여 러분의 비밀번호를 바꿔달라고 요청하라!"
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "곳이며, 실내 환경에 적응된 종들을 수용하고 새로운 방향으로 진화를 밀어붙인다. 실내 미생물, 곤충, 그 리고 쥐들은 모두 항균제, 살충제, 독에 대한 내성을 키우면서 우리의 화학적 공격에서 살아남을 수 있는 능력을 진화시켜왔다. 독일 바퀴벌레는 바퀴벌레 덫 에서 미끼로 흔히 사용되는 포도당에 대한 혐오감을 발달시켜 온 것으로 알려져 있다. 야외(에 사는) 상 대방에 비해 먹이를 잡아먹을 더 적은 기회를 가지 는 일부 실내 곤충은 먹이가 제한적일 때 생존할 수 있는 능력을 발달시켜 온 것으로 보인다. Dunn과 다 른 생태학자들은 지구가 점점 더 발전되고 도시화되 면서, 더 많은 종들이 실내에서 번성하기 위해 그들 이 필요로 하는 특성들을 진화시킬 것이라고 말해 왔다. 충분히 긴 시간에 걸쳐, 실내 생활은 또한 우 리의 진화를 이끌 수 있었다. 아마도 실내 생활을 좋 아하는 내 모습은 인류의 미래를 대변할 것이다."
    ],
    "tags": [
      "#과학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "적인 능력과 전문적인 능력 모두에서 한 개인으로서 의 여러분에게 많은 이점을 가져다 준다. 표현적 글 쓰기가 면역 체계와 폐 기능을 향상시키고, 심리적 고통을 줄이고, 관계를 증진시키는 것으로 밝혀지면 서, 시를 쓰는 것은 신체적, 정신적 이점을 지닌 것 으로 보여져 왔다. 시는 여러 정신 건강에 필요한 것 들을 지원하고, 공감 능력을 개발하고, 자연적 환경 과 만들어진 환경 둘 다와의 관계를 재고하기 위해 오랫동안 사용되어 왔다. 시는 또한 인지 발달 시기 를 적극적으로 겨냥하는 믿을 수 없을 정도로 효과 적인 방법이며, 그 과정에서 여러분의 생산성과 과학 적 창의력을 향상시킨다. (시는 감정을 표현하는 쉽 고 유용한 수단으로 여겨지지만, 여러분이 그것의 복 잡성을 깨달았을 때 여러분은 좌절감에 빠진다.) 간 단히 말해서, 만약 여러분이 시에게 그렇게 할 기회 를 준다면, 시는 제공할 많은 것을 가지고 있다."
    ],
    "tags": [
      "#심리학",
      "#철학"
  ...
  },
  {
    ...
    "content": [
      "Things are changing. It has been reported that 42 percent\nof jobs in Canada are at risk, and 62 percent of jobs in\nAmerica will be in danger due to advances in automation. However, what’s difficult to automate is the ability to\ncreatively solve problems. Whereas workers in “doing”\nroles can be replaced by robots, the role of creatively\nsolving problems is more dependent on an irreplaceable\nindividual. You might say that the numbers seem a bit unrealistic, but\nthe threat is real. One fast food franchise has a robot that\ncan flip a burger in ten seconds. It is just a simple task but\nthe robot could replace an entire crew. Highly skilled jobs are also at risk. A supercomputer, for\ninstance, can suggest available treatments for specific\nillnesses in an automated way, drawing on the body of\nmedical research and data on diseases. - - - - - - - - - -"
    ],
    "translation": [
      "42퍼센트가 위기에 처해 있고, 미국의 일자리 중 62 퍼센트가 자동화의 발전으로 인해 위기에 처할 것이 라고 보도되어 왔다. 여러분은 그 숫자들이 약간 비현실적으로 보인다고 말할지 모르지만, 그 위협은 현실이다. 한 패스트푸드 체인점은 10초 안에 버거 하나를 뒤집을 수 있다. 그것은 단지 단순한 일일 뿐 이지만 그 로봇은 전체 직원을 대체할 수도 있다. 고도로 숙련된 직업들 또한 위기에 처해 있다. 예를 들면, 슈퍼컴퓨터는 질병에 대한 방대한 양의 의학 연구와 데이터를 이용하여 특정한 질병들에 대 해 이용 가능한 치료법을 자동화된 방식으로 제안할 수 있다. 하지만, 자동화하기 어려운 것은 창의 적으로 문제들을 해결하는 능력이다. ‘(기계적인 일 을) 하는’ 역할의 노동자들은 로봇들에 의해 대체될 수 있는 반면에, 창의적으로 문제를 해결하는 역할은 대체 불가능한 개인에 더 의존한다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "content": [
      "Each beech tree grows in a particular location and soil\nconditions can vary greatly in just a few yards. The soil can\nhave a great deal of water or almost no water. It can be full\nof nutrients or not. This is taking place underground through the roots.\nWhoever has an abundance of sugar hands some over;\nwhoever is running short gets help. Their network acts as\na system to make sure that no trees fall too far behind. However, the rate is the same. Whether they are thick or\nthin, all the trees of the same species are using light to\nproduce the same amount of sugar per leaf. Some trees\nhave plenty of sugar and some have less, but the trees\nequalize this difference between them by transferring sugar. Accordingly, each tree grows more quickly or more slowly\nand produces more or less sugar, and thus you would\nexpect every tree to be photosynthesizing at a different\nrate."
    ],
    "translation": [
      "고 토양의 조건들은 단 몇 야드 안에서도 크게 달라 질 수 있다. 토양은 다량의 물을 가지거나 거의 물이 없을 수도 있다. 그것은 영양분이 가득할 수도 아닐 수도 있다. 이에 따라, 각 나무는 더 빨리 혹은 더 느리게 자라고 더 많은 혹은 더 적은 당분을 생 산하는데, 그래서 여러분은 모든 나무가 다른 정도로 광합성을 할 것이라고 기대할 것이다. 그러나 그 정도는 동일하다. 그들이 굵든 가늘든 간에, 같은 종 의 모든 나무들은 빛을 사용하여 이파리당 같은 양 의 당을 생산한다. 어떤 나무들은 충분한 당을 지니 고 어떤 것들은 더 적게 지니지만, 나무들은 당을 전 달함으로써 그들 사이의 이 차이를 균등하게 한다. 이것은 뿌리들을 통해 지하에서 일어나고 있다. 풍부한 당을 가진 나무가 누구든 간에 일부를 건네 주고, 부족해지는 나무는 누구든 간에 도움을 받는 다. 그들의 연결망은 그 어떤 나무도 너무 뒤처지지 않는 것을 확실히 하기 위한 시스템으로서 역할을 한다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "오렌지주스를 넣고 다른 잔에는 약간의 레몬주스를 넣어라. 여러분이 가지고 있는 것은 본질적으로 물 두 잔이지만 완전히 다른 화학적 성질을 지닌 것들 이다. 만약 우리가 오렌지주스가 든 잔을 가져와 그 것을 가열한다면, 우리는 여전히 다른 화학적 성질을 지닌 두 개의 다른 물잔을 가지고 있을 것이지만, 이 제 그것들은 또한 다른 온도를 가질 것이다. 만약 우 리가 마법처럼 그 유리잔들을 없앨 수 있다면, 우리 는 두 액체가 잘 섞이지 않는다는 것을 알게 될 것 이다. 어쩌면 그것들은 그것들이 만났던 곳에서 조금 섞일 것이다. 하지만, 그것들의 다른 화학적 성질과 온도 때문에 그것들은 분리된 상태로 남아 있을 것 이다. 더 따뜻한 물은 그것의 더 가벼운 무게 때문에 찬물의 표면에 떠 있을 것이다. 바다에서 우리는 온 도와 염분에서 다른 액체들을 가지고 있다. 이러한 이유로, 그것들은 섞이지 않는다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "다. 그는 자신의 인생의 대부분을 보이지 않는 것에 적응하는 데, 그리고 심지어 이 상태에서 스키 경력 을 쌓는 데도 보냈기 때문에, 자신의 다른 감각들은 더 강해지는 것을 통해 보충되었다. 그러나 그의 시 력이 40대에 수술을 통해 회복되었을 때, 그의 현실 에 대한 전반적 인식은 방해받았다. 그가 예상했던 것처럼 이제 볼 수 있다는 것에 감격하는 대신, 자신 의 뇌가 새로운 시각적 자극으로 너무 과부하가 걸 려 세상은 두렵고 압도적인 장소가 되었다. 그가 만 지는 것과 냄새를 통해 자신의 가족을 아는 것을 배 운 후, 그는 자신의 눈으로 자신의 아이들을 알아볼 수 없다는 것을 알게 되었고 이것은 그를 혼란스러 운 상태로 남겨 두었다. 스키 또한 그가 시각적인 자 극에 적응하려고 힘쓰면서 훨씬 더 어려워졌다. 이 혼란은 그의 뇌가 아직 보는 것을 배우지 못했기 때문에 일어났다. 비록 우리는 종종 우리의 눈이 우리의 뇌에 정보를 전달하는 비디오 카메라로서 기능한다고 가정하는 경향이 있지만, 신경 과학 연구의 발전은 이 것이 실제로 그렇지 않다는 것을 증명했다. 대신, 시 각은 우리의 눈과 뇌 사이의 협력적인 노력이며, 우리 가 시각적 현실을 처리하는 방법은 이 두 가지가 소통 하는 방식에 달려 있다. 만약 우리의 눈과 뇌 사이의 의사소통이 방해된다면, 현실에 대한 우리의 인식은 그에 따라 바뀐다. 그리고 May의 뇌의 다른 부분들은 주로 그의 다른 감각을 통해 정보를 처리하는 것에 적 응했었기 때문에, 보는 방법을 배우는 과정은 그가 예 상했던 것보다 더 쉬웠다(→ 더 어려웠다)."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "무언가를 가르치고 있다. 그들은 보는 것으로부터 배운다. 그들은 듣거나 ‘우연히 듣는 것’으로부터 배운다. 아이들은 인생에서 가장 중요한 것에 대 해 그들 부모의 가치를 공유한다. 우리의 우선순 위와 원칙 그리고 훌륭한 행동에 대한 본보기는 우리 자녀에게 다른 길이 유혹적으로 보일 때 올 바른 길로 가도록 가르칠 수 있다. 아이들은 확고 한 인격을 구성하는 가치를 단순히 그것에 대해 ‘들음’으로써 배우지 않는다는 것을 기억하라. 그 들은 그들 주변 사람들이 그들의 일상생활에서 그 러한 가치를 좇아 ‘행동’하고 ‘유지’하는 것을 봄 으로써 배운다. 그러므로 여러분의 자녀에게 여러 분의 행동으로 삶의 모범을 보여라. 우리 일상생 활에서, 우리는 우리 자녀에게 우리가 타인을 존 중하는 것을 보여줄 수 있다. 우리는 그들에게 타 인이 괴로워할 때 우리의 연민과 걱정을, 그리고 우리가 어려운 결정을 할 때 우리 자신의 자제력, 용기 그리고 정직을 보여줄 수 있다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "어 봤을 것이다. 만약 숲에서 나무가 쓰러지고 그 것이 쓰러지는 것을 들을 사람이 거기에 없다면, 소리가 나는 것일까? 정답은 ‘아니요’이다. 소리는 압력파 이상이며, 정말로 듣는 사람 없이는 소리 가 있을 수 없다. 마찬가지로, 과학적 커뮤니케이 션은 양방향 프로세스이다. 어떠한 종류의 신호든 그것이 감지되지 않으면 쓸모가 없는 것처럼, 출판 된 과학 논문(신호)은 그것이 의도된 독자에 의해 수신 ‘그리고’ 이해가 둘 다 되지 않으면 쓸모가 없다. 따라서 우리는 과학의 자명한 이치를 다음과 같이 재진술할 수 있다. 과학 실험은 결과가 출판되 고 ‘그리고 이해될’ 때까지 완성되지 않는다. 출판 된 논문이 이해되지 않으면 출판은 압력파에 지나 지 않는다. 너무 많은 과학 논문이 소리 없이 숲속 에서 쓰러진다."
    ],
    "tags": [
      "#과학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "모두는 매일 협상한다. 하지만 이제까지 ‘어떻게’ 협상하는지를 배운 사람은 거의 없다. (협상 방식 을) 배우는 사람들은 대개 양측에 유리한 합의를 도출할 가능성이 있는 접근법보다는 전통적인, 한 쪽에만 유리한 협상 방식을 배운다. 이 구식의 적 대적인 접근법은 아마도 여러분이 그 사람을 다시 상대하지 않을 일회성 협상에서 유용할지도 모른 다. 그러나, 우리 대부분은 배우자와 자녀, 친구와 동료, 고객과 의뢰인같이 동일한 사람들을 반복적 으로 상대하기 때문에, 이러한 거래는 점점 더 드 물어지고 있다. 이러한 관점에서, 우리 자신을 위 해 성공적인 결과를 얻어내는 동시에 협상 파트너 들과 건전한 관계를 유지하는 것이 중요하다. 오 늘날 비즈니스 파트너십과 장기적 관계의 상호 의 존적인 세계에서, 양측에 유리한 성과는 ‘유일하 게’ 받아들일 수 있는 결과가 빠르게 되어가고 있 다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "현지 주민의 상호 작용은 지식 파급과 같은 긍정 적인 외부 효과로 인해 생산성을 증가시킬 수 있 다. 이것은 어느 정도까지만 장점이다. 배경의 다 양성이 너무 클 경우, 분열은 의사소통에 대한 과 도한 거래 비용을 초래하는데, 이는 생산성을 저 하시킬 수 있다. 다양성은 노동 시장에 영향을 줄 뿐만 아니라 한 지역의 삶의 질에도 영향을 미칠 수 있다. 관용적인 원주민은 이용 가능한 재화와 용역 범위의 증가로 인해 다문화 도시나 지역을 가치 있게 여길 수 있다. 반면에, 원주민들이 다 양성을 그들의 국가 정체성이라고 생각하는 것에 대한 왜곡으로 인식한다면 다양성은 매력적이지 않은 특징으로 인식될 수 있다. 그들은 심지어 다 른 민족 집단을 차별할 수도 있고 그들은 다른 외 국 국적들 간의 사회적 갈등이 그들 인근으로 유 입되는 것을 두려워할 수도 있다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "각한다. 그러나 실제로 우리의 건물과 개발도 또 한 우리를 형성하고 있다. 이것의 가장 좋은 예 중 하나는 가장 오래된 것으로 알려진 건축물인 튀르키예의 Göbekli Tepe에 있는 화려하게 조각 된 입석의 고리이다. 이 조상들이 약 12,000년 전 에 입석을 세우는 아이디어를 얻기 전에 그들은 수렵 채집인이었다. 거석으로 된 여러 개의 고리 를 세우는 데 오랜 시간이 걸렸고 많은 잇따른 세 대를 거쳤어야 해서 이 혁신가들은 건설 작업을 완료하기 위해 정착해야만 했던 것으로 보인다. 그 과정에서, 그들은 지구상 최초의 농업 사회가 되었다. 이것은 결국 사회 자체를 근본적으로 재 구성하는 무언가를 건설하는 사회의 초기 예이다. 우리 시대에도 상황이 그렇게 다르지 않다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "름이 존재하는 이유가 있다. 주말 경기에 대해 토 론하는 팬들의 소셜 미디어의 댓글만 읽어봐도 여 러분은 자신이 경기장에 있는 사람들보다 더 성공 적으로 경기를 뛰고, 감독하고, 스포츠팀을 관리 할 수 있다고 얼마나 많은 사람들이 믿는지 금방 알 수 있다. 이것은 이사회실에서도 마찬가지이다. 스포츠 사업에서 수년간의 훈련을 받고 전문적인 학위를 가진 학생들과 전문가들 또한 친구들, 가 족, 혹은 전문 지식이 전혀 없는 심지어 완전히 낯선 사람들로부터 어떻게 자신의 일을 해야 하는 지에 대한 충고를 듣고 있는 자신을 발견할지도 모른다. 스포츠 경영 임원진들은 자신의 각 분야 에서 수십 년의 지식과 경험을 가지고 있다. 하지 만, 그들 중 많은 사람들이 그들에게 그들의 사업 운영 방식을 알려주는 팬들과 지역 사회 구성원들 로부터의 비난에 직면한다. 자신의 의사에게 수술 하는 방법을 알려주거나 자신의 회계사에게 자신 의 세금을 준비하는 방법을 알려주는 사람은 거의 없지만, 많은 사람들이 스포츠 조직이 어떻게 관 리되어야 하는지에 대한 피드백은 제공한다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "히 스트레스가 많은 일이다. 그들은 안심감을 잃 고 그들의 일상이 무너지고 익숙한 모든 것이 사 라질 때 혼란스러움을 느낄 수도 있다. 3세에서 6 세 사이의 어린아이들은 이사에 특히 영향을 받는 다. 이 시기에 그들의 이해력은 꽤 융통성이 없어 서, 그들이 새로운 집과 자신의 새로운 방을 미리 상상하는 것은 쉽다(→ 어렵다). 어린아이들은 “내 가 새로운 곳에서 여전히 나일까?”와 “내 장난감 과 침대가 우리와 함께 갈까?”와 같은 걱정들을 가질지도 모른다. 아이들의 과거 경험을 인정하는 것과 그들이 새로운 곳에 적응하도록 돕는 데 집 중하는 것 사이에 균형을 잡는 것이 중요하다. 아 이들은 자신이 누구인지에 대한 중요한 부분으로 서 자신의 과거를 존중하는 방식으로 자신의 배경 을 공유할 기회를 가질 필요가 있다. 이것은 공동 체 의식을 형성하는 데 기여하고, 이는 모든 아이 들, 특히 변화를 겪는 아이들에게 가장 중요하다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "한다. 종종, 이 두려움은 통제력의 부족에서 비롯 된다. 조종사는 통제를 하지만 승객은 그렇지 않으 며, 이러한 통제력의 부족은 두려움을 스며들게 한 다. 많은 잠재적인 승객들은 너무 두려워서 그들은 비행기를 타는 대신 목적지에 도착하기 위해 먼 거 리를 운전하는 것을 선택한다. 그러나 운전을 하기 로 한 그들의 결정은 논리가 아닌 오직 감정에 근 거한다. 논리에 따르면 통계적으로 자동차 사고로 사망할 확률은 약 5,000분의 1이고, 반면 비행기 사고로 사망할 확률은 1,100만분의 1에 가깝다고 한다. 만약 여러분이 위험을 감수할 것이라면, 특 히 여러분의 안녕을 혹시 포함할 수 있는 위험을 감수할 것이라면, 여러분에게 유리한 확률을 원하 지 않겠는가? 그러나 대부분의 사람들은 그들에게 최소한의 불안감을 야기할 수 있는 선택을 한다. 위험을 감수하는 것에 대해 여러분이 가지고 있는 생각에 주의를 기울이고 여러분의 결정을 단지 감 정이 아닌 사실에 근거하고 있는지 확인하라."
    ],
    "tags": [
      "#심리학",
      "#철학"
  ...
  },
  {
    ...
    "translation": [
      "관심 있어 할 적절한 글을 제공하는 것이다. 나의 학문적인 연구와 나의 수업은 Rosalie Fink의 연 구에 깊이 영향을 받아왔다. 그녀는 물리학자, 생 화학자 그리고 회사의 최고 경영자를 포함해 그들 의 직업에서 매우 성공한 열두 명의 성인들과 면 담했다. 그들 모두가 난독증이 있었고 그들의 학 령기 내내 읽기에 상당한 문제를 겪어 왔다. 그녀 는 그들이 학습에 있어 읽기를 피했고 그것을 우 회하거나 다른 전략들로 보완할 방법을 발견했을 것이라고 알아낼 것을 예상했으나, 정반대를 알아 냈다. “놀랍게도, 나는 난독증이 있는 이런 사람들 이 열성적인 독자인 것을… 그들이 좀처럼 읽기를 피하지 않는 것을 알아냈다. 이에 반하여, 그들은 책을 찾았다.” Fink가 발견한 패턴은 그녀의 실험 대상자 모두가 어떤 개인적인 관심사에 열정적이 었다는 것이었다. 관심 분야는 종교, 수학, 상업, 과학, 역사 그리고 전기문을 포함했다. 중요한 것 은 그들이 더 많이 알아내기 위해 탐욕스럽게 읽 었다는 것이다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "말단을 조직에 가지고 있다. 예를 들어, 만약 여 러분이 핀과 같이 날카로운 물체를 밟는다면, 피 부의 신경 말단이 통증 감각을 여러분의 다리 위 로, 그리고 척수를 따라 위로 뇌까지 전달할 것이 다. 통증 자체는 불쾌하지만, 사실은 발을 보호하 는 메커니즘으로 작용하고 있다. (즉, 여러분은 그 통증에 익숙해져 통증을 피할 수 있는 능력이 감소한다.) 뇌 안에서, 신경은 언어를 통제하는 부분에 연결될 것이고, 그래서 여러분은 ‘아야’ 또 는 다소 덜 공손한 무언가를 외칠 것이다. 그것들 은 또한 척수를 타고 다시 내려오는 운동 신경에 연결될 것이고, 그리고 이제 재빨리 수축하여 고 통을 주는 물체로부터 발을 떼어 들어 올리게 하 는 여러분의 다리 근육에 연결될 것이다. 감각 신 경과 운동 신경은 심장의 박동에서부터 장 운동, 발한과 그 밖에 모든 것에 이르기까지 신체의 거 의 모든 기능을 통제한다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "Maybe you’ve heard this joke: “How do you eat an\nelephant?” The answer is “one bite at a time.” Common crystal habits include squares, triangles, and\nsixsided hexagons. Usually crystals form when liquids\ncool, such as when you create ice cubes. Many times,\ncrystals form in ways that do not allow for perfect shapes.\nIf conditions are too cold, too hot, or there isn’t enough\nsource material, they can form strange, twisted shapes. So, how do you “build” the Earth? That’s simple, too: one\natom at a time. Atoms are the basic building blocks of\ncrystals, and since all rocks are made up of crystals, the\nmore you know about atoms, the better. Crystals come in\na variety of shapes that scientists call\nhabits. But when conditions are right, we see beautiful displays.\nUsually, this involves a slow, steady environment where\nthe individual atoms have plenty of time to join and fit\nperfectly into what’s known as the\ncrystal lattice. This is\nthe basic structure of atoms that is seen time after time. - - - - - - - - - -"
    ],
    "translation": [
      "을 것이다. “코끼리를 어떻게 먹는가?” 정답은 ‘한 번에 한 입’이다. 그렇다면, 여러분은 어떻게 지구를 ‘건설’하는가? 그것은 또한 간단하다. 한 번에 하나의 원자이다. 원자는 결정의 기본 구성 요소이고, 모든 암석은 결정으로 이루어져 있기 때문에, 여러분은 원자에 대해 더 많이 알수록 더 좋다. 결정은 과학자들이 ‘습성’이라고 부르는 다 양한 모양으로 나온다. 일반적인 결정 습성은 사각형, 삼각형, 육면의 육각형을 포함한다. 보통 여러분이 얼음을 만들 때와 같이 액체가 차가워질 때 결정이 형성된다. 많은 경우, 결정은 완벽한 모 Silversmithing Class Kingston Club은 정교한 보석 만들기 수업을 제공합니다. 여러분만의 보석을 만들 이 좋은 기회를 놓치지 마세요! 시간 & 장소 · 2023년 10월 21일 토요일(오후 2시부터 오후 4시까지) · Kingston Club 스튜디오 등록 · 온라인으로만 가능 · 일자: 2023년 10월 1~14일 · 비용: 40달러(이것은 모든 도구와 재료를 포함합니다.) · 등록은 6명으로 제한됩니다. 유의 사항 · 참가자는 16세 이상이어야 합니다. · 수업 당일 취소 시 환불 불가 2023 Ocean Awareness Film Contest 우리의 일곱 번째 연례 영상 대회에 참여하여 해양 보존에 관한 여러분의 지식을 보여 주세요. □ 주제 해양 야생 생물 / 해양 오염 (위에서 하나를 선택하세요.) □ 지침 참가자: 고등학생 제출 기한: 2023년 9월 22일 영상은 10분에서 15분 사이여야 합니다. 모든 출품작은 우리 웹사이트에 업로드되 어야 합니다. 1인당 오직 하나의 출품작 □ 상금 · 1등: 100달러 · 2등: 70달러 · 3등: 50달러 (수상자는 우리 웹사이트에 공지될 것입니다.) 더 많은 정보를 위해 www.oceanawareFC.com을 방문하세요. 양을 허용하지 않는 방식으로 형성된다. 조건이 너무 차갑거나, 너무 뜨겁거나, 혹은 원천 물질이 충분하지 않으면 이상하고 뒤틀린 모양을 형성할 수 있다. 하지만 조건이 맞을 때, 우리는 아름 다운 배열을 본다. 보통, 이것은 개별적인 원자들 이 결합하고 ‘결정격자’라고 알려진 것에 완벽하게 들어맞는 충분한 시간을 가지는 느리고 안정적인 환경을 수반한다. 이것은 반복하여 보이는 원자의 기본적인 구조이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "When you pluck a guitar string it moves back and forth\nhundreds of times every second. The vibration of the wood creates more powerful waves\nin the air pressure, which travel away from the guitar.\nWhen the waves reach your eardrums they flex in and out\nthe same number of times a second as the original string. Naturally, this movement is so fast that you cannot see\nit — you just see the blurred outline of the moving string.\nStrings vibrating in this way on their own make hardly\nany noise because strings are very thin and don’t push\nmuch air about. But if you attach a string to a big hollow box (like a guitar\nbody), then the vibration is amplified and the note is\nheard loud and clear. The vibration of the string is passed\non to the wooden panels of the guitar body, which vibrate\nback and forth at the same rate as the string."
    ],
    "translation": [
      "수백 번 이리저리 움직인다. 당연히, 이 움직 임은 너무 빨라서 여러분이 그것을 볼 수 없다. 여러분은 그저 움직이는 줄의 흐릿한 윤곽만 본 다. 이렇게 스스로 진동하는 줄들은 거의 소리가 나지 않는데, 이는 줄이 매우 가늘어 많은 공기를 밀어내지 못하기 때문이다. 하지만 여러분이 (기타 몸통 같은) 커다란 속이 빈 상자에 줄을 달 면, 그 진동은 증폭되어 그 음이 크고 선명하게 들린다. 그 줄의 진동은 기타 몸통의 나무판으로 전달되어 줄과 같은 속도로 이리저리 떨린다. 그 나무의 진동은 공기의 압력에 더 강력한 파동 을 만들어 내어 기타로부터 멀리 퍼진다. 그 파동 이 여러분의 고막에 도달할 때 그것들(고막)은 원 래의 줄과 초당 동일한 횟수로 안팎으로 구부러진 다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "content": [
      "Other individuals prefer integrating work and family roles all\nday long.\nBoundaries between work and home are blurring as portable\ndigital technology makes it increasingly possible to work\nanywhere, anytime. Individuals differ in how they like to\nmanage their time to meet work and outside responsibilities. Some people prefer to separate or segment roles so\nthat boundary crossings are minimized. For example,\nthese people might keep separate email accounts for work\nand family and try to conduct work at the workplace and take\ncare of family matters only during breaks and nonwork time. We’ve even noticed more of these “segmenters”\ncarrying two phones ― one for work and one for personal use. Flexible schedules work well for these individuals because\nthey enable greater distinction between time at work and time in\nother roles. This might entail constantly trading text\nmessages with children from the office, or monitoring emails at\nhome and on vacation, rather than returning to work to find\nhundreds of messages in their inbox."
    ],
    "translation": [
      "업하는 것을 점차 가능하게 함에 따라 직장과 가 정의 경계가 흐릿해지고 있다. 사람들은 직장과 외부의 책임을 수행하기 위해 자신의 시간을 관리 하기를 바라는 방식에 차이가 있다. 어떤 사람들 은 경계 교차 지점이 최소화되도록 역할을 분리하 거나 분할하는 것을 선호한다. 예를 들어, 이러한 사람들은 직장과 가정을 위한 별개의 이메일 계정 을 유지하고 직장에서 일을 수행하고 휴식 시간과 일을 하지 않는 시간 동안에만 가정사를 처리하려 고 할지도 모른다. 우리는 더 많은 이러한 ‘분할자 들’이 하나는 업무용이고 하나는 개인용인 두 개 의 전화기를 가지고 다니고 있음을 심지어 알게 되었다. 유연근로시간제는 이런 사람들에게 잘 적 용되는데, 직장에서의 시간과 다른 역할에서의 시 간 간에 더 큰 구별을 가능하게 하기 때문이다. 다른 사람들은 하루 종일 직장과 가정의 역할을 통합하는 것을 선호한다. 이것은 직장으로 돌아가 서 받은 편지함에서 수백 개의 메시지를 발견하는 것 대신 사무실에서 아이들과 문자 메시지를 지속 적으로 주고받거나 집에서 그리고 휴가 중에 이메 일을 확인하는 것을 수반할지도 모른다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "는 제품이다. 예를 들어, 팝콘은 영화에 대한 보 완재인 한편, 여행 베개는 긴 비행기 여행에 대한 보완재이다. 한 제품의 인기가 높아지면 그것의 보완재 판매량도 늘어난다. 여러분은 이미 인기가 있는 (또는 곧 있을) 다른 제품을 보완하는 제품 을 생산함으로써 여러분의 제품에 대한 꾸준한 수 요 흐름을 보장할 수 있다. 일부 제품들은 완벽한 보완적 상태를 누리고 있고, 그것들은 램프와 전 구와 같이 함께 소비‘되어야’ 한다. 그러나 고객들 이 그 제품에 완전히 고정되어 있지 않을 수 있으 므로, 어떤 제품이 완벽하게 보완적이라고 가정하 지 마라. 예를 들어, 비록 운전자들이 자신의 차 를 운전하기 위해 휘발유를 구매할 필요가 있는 것처럼 보일지라도, 그들은 전기 자동차로 바꿀 수 있다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "의 덫을 주의할 필요가 있다. 물론, 당신은 자랑 스러워하는 부모이고, 그리고 그래야 한다. 당신 의 작은 천재와 그 또는 그녀의 놀라운 행동에 대 해서 쉬지 않고 말하는 것은 매우 쉬우나, 이것은 당신의 아이에게 매우 스트레스가 될 수 있다. 당 신의 자랑하는 행동을 당신의 아주 가까운 친구 나, 당신의 부모에게로 제한하는 것이 매우 중요 하다. 영재는 그들의 부모가 지나치게 그들을 자 랑할 때 부담을 느낀다. 이러한 행동은 그들이 부 응할 수 없을지도 모르는 기대를 만들고, 또한 당 신의 자녀에게 있어 잘못된 자의식을 만든다. 당 신은 당신의 자녀가 그들의 엄청난 업적에 의해서 규정지어진 대로 보이는 누군가가 아니라 있는 그 대로의 그들이기를 바란다. 그렇지 않으면, 당신 은 결국 지나친 완벽주의자 아이 또는 아마도 학 업 중단자이거나 그보다 더 안 좋은 것을 마주하 게 될 것이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "는 생각에 의해 현저히 지배당하는 상황에서 벗어 나기 위한 한 가지 유용한 기술은 우리가 분투하 고 있는 문제를 해결해 본 타인과 함께 있기로 선 택하는 것이다. 이것은 자조 집단의 큰 힘 중 하 나이다. 우리가 부정적인 상태에 있을 때, 우리는 부정적인 사고 형태에 많은 에너지를 투입해 왔고 긍정적인 사고 형태는 약하다. 더 높은 진동에 있 는 사람들은 그들의 부정적인 사고에서 나오는 에 너지가 없고, 긍정적인 사고 형태를 활기 띠게 했 다. 단지 그들이 있는 자리에 있기만 하는 것도 유익하다. 일부 자조 집단에서 이것은 ‘승자들과 어울리기’라고 불린다. 여기에서의 이점은 의식의 정신적 수준에 있으며, 긍정적인 에너지의 전달과 자신의 잠재적인 긍정적인 사고 형태의 재점화가 있다."
    ],
    "tags": [
      "#철학",
      "#과학"
  ...
  },
  {
    ...
    "translation": [
      "생존에 기여해 왔기 때문에 존재한다고 여겨진다. 두려움은 우리가 위험을 피하는 데 도움을 주어 왔 고, 분노를 표현하는 것은 우리가 위협을 쫓아내도 록 돕고, 긍정적인 감정을 표현하는 것은 우리가 다른 사람과 유대하도록 돕는다. 진화적 관점에서, 감정은 유발될 때 (주의, 지각, 기억, 움직임, 표현 등을 포함하는) 우리의 많은 활동을 지시하는 일종 의 ‘프로그램’이다. 예를 들어, 두려움은 우리를 매 우 주의 깊게 만들고, 우리의 지각의 초점을 위협 적인 자극으로 좁히고, 우리로 하여금 상황을 정면 으로 대하거나 (싸우거나) 그것을 피하도록 (도피 하도록) 하며, 우리로 하여금 경험을 더 강렬하게 기억하도록 (그래서 우리가 미래에 위협을 피하도 록) 할 수도 있다. 그것들이 우리의 시스템을 활성 화하는 구체적인 방식과는 관계없이, 우리가 소유 한 특정한 감정은 그것들이 오래전에 우리의 환경 내에서 우리가 (종으로서) 힘든 상황에서 생존하도 록 도움을 주어 왔기 때문에 존재한다고 여겨진다. 만약 그것들이 우리가 적응하고 생존하도록 도움을 주지 않았었더라면 그것들은 우리와 함께 진화해 오지 않았을 것이다."
    ],
    "tags": [
      "#심리학",
      "#과학"
  ...
  },
  {
    ...
    "translation": [
      "있는 노동자를 위한 일터로의 접근성을 향상시킴 으로써, AI는 일터에서 포괄성을 향상시킬 수 있 다. 시각, 발화 또는 청각 장애가 있는 노동자들 을 돕기 위한 AI 동력의 보조 장치들이 더 널리 보급되어, 장애를 지닌 사람들의 업무 접근성과 업무의 질을 향상시키고 있다. 예를 들어, 구음 장애가 있는 사람들을 위한 발화 인식 솔루션이나 청각 장애인과 난청인을 위한 실시간 자막 시스템 은 동료와의 의사소통과 대인 의사소통이 필요한 일에 대한 접근을 용이하게 할 수 있다. AI는 또 한 그들의 임금과 경력 전망에 잠재적으로 긍정적 인 영향과 함께 저숙련 노동자들의 능력을 향상시 킬 수 있다. 예를 들어, 문자 언어와 음성 언어를 실시간으로 번역하는 AI의 능력은 일터에서 비원 어민의 수행을 향상시킬 수 있다. 게다가, 최근의 AI 동력의 텍스트 생성기의 발전은 글쓰기, 코딩, 고객 서비스와 같은 영역에서 저숙련된 개인의 수 행을 즉시 향상시킬 수 있다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "들이 죽을 때, 각각의 고래는 평균 30톤의 이산화 탄소를 격리하며, 수 세기 동안 대기로부터 그 탄고 1 정답 및 해설 2024학년도 9월 전국연합학력평가 12 16 소를 빼내어 둔다. 비교하자면, 평균적인 나무는 연간 48파운드의 이산화 탄소만을 흡수한다. 기후 의 관점에서 각각의 고래는 수천 그루의 나무에 상응하는 바다에 사는 것이다. 고래는 또한 영양 이 풍부한 배설물을 내보내면서 바다를 비옥하게 함으로써 탄소를 격리하는 데 도움을 주는데, 결 과적으로 식물성 플랑크톤 개체를 증가시키고 이 는 또한 탄소를 격리한다. 그리하여 몇몇 과학자 들은 그들을 ‘해양 생태계의 기술자’라고 부르게 되었다. 2019년 국제 통화 기금(IMF)의 경제학자 들은 각각의 고래에 의해서 제공되는 생태계 서비 스의 가치를 미화 200만 달러가 넘게 추정했다. 그들은 기후 변화에 대한 ‘자연 기반 해결책’의 한 예로서 고래 개체수를 산업화 이전의 고래잡이 수 준으로 되돌리기 위한 새로운 글로벌 경제적 인센 티브 프로그램을 요구했다. 기후 변화를 늦추기 위해 세계적인 고래 복원 프로그램에 대한 요구가 현재 제기되고 있다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "은 다른 문화 유형들을 포함할 수 있는지에 대한 가장 매력적인 예시 중 하나는 조직 내 다른 부서 들의 기능적 운영을 인식하는 것이다. 조직 내 다 양한 부서와 과는 필연적으로 어떤 주어진 상황이 라도 그들 자신만의 편향적이고 편파적인 관점에 서 볼 것이다. 한 부서와 그 구성원들은 그들을 다른 이들이 그것들을 보는 대로 볼 수 없게 하는 ‘터널 시야 현상’을 갖게 될 것이다. 조직의 구조 자체가 갈등을 만들어낼 수 있다. 구조가 ‘기계적’ 인지 또는 ‘유기적’인지의 선택은 갈등 관리에 깊 은 영향을 미칠 수 있다. 기계적 구조는 많은 규 칙, 많은 절차 그리고 의사결정에 포함된 많은 수 준의 관리를 가진 수직적 위계를 갖는다. 유기적 구조는 본래 더 수평적이고, 여기서는 의사결정이 덜 중앙 집중화되고, 조직 전반에 걸쳐 펼쳐진다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "제거하는 것이다. 몇몇 도시는 자전거, 보행자, 그 리고 수시 서비스 차량을 위한 광범위한 망의 도 로와 거리를 마련해 둔다. 이것은 사람들이 자동 차보다 자전거로 이동을 하도록 동기를 부여하여 거리를 모두에게 더 안전하게 만든다. 자전거가 도시에서 더 대중적이 되면, 계획자들은 더 많은 자동차 도로와 전체 거리를 더 많은 자전거를 수 용할 수 있도록 전환할 수 있다. 그럼에도 불구하 고, 가장 자전거를 타기 좋은 도시들조차도 여전 히 택시, 긴급 차량, 그리고 배달 트럭을 위한 자 동차 도로를 필요로 한다. 배달 차량은 자주 반감 의 대상이지만, 그것들은 실제로 도시를 더 친환 경적으로 만드는 필수 구성요소이다. 짐이 빽빽하 게 들어찬 배달 트럭은 각각 몇 개의 쇼핑백을 실 은 여러 하이브리드 차량보다 훨씬 더 비효율적인 (→ 효율적인) 상품 운송 수단이다. 음식과 다른 상품을 동네 상인에게 배포하는 것은 그들이 집에 가까운 더 작은 상점을 운영할 수 있게 하고 그 결과 주민들은 식료품을 사기 위해 운전하기보다는 걸어갈 수 있다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "들의 시대에 진가를 인정받지 못했다고 몇 번이고 듣는다. 그들의 시대에 베토벤, 브람스, 스트라빈스 키의 곡들을 모든 사람이 이해할 수 있었던 것은 아니었다. 이러한 초기의 수용 부족의 이유는 낯섦 이다. 음악적 형식, 또는 그 안에 표현된 생각은 완전히 새로운 것이었다. 그럼에도 불구하고 이것 이 바로 그들을 그토록 위대하게 만드는 것들 중 하나이다. 유능한 작곡가는 그들 자신만의 생각을 갖는다. 당신은 고전 영화 Amadeus를 본 적이 있 는가? 작곡가 Antonio Salieri가 이 영화의 ‘주인공’ 이다. 그는 가장 유명한 위대하지 않은 작곡가 중 한 명으로 묘사된다. 그는 모차르트 시대에 살았고 그에 의해 완전히 가려졌다. 인제 보니 Salieri는 형편없는 작곡가가 아니었다. 사실, 그는 매우 훌 륭한 작곡가였다. 하지만 그의 작품이 독창적이지 않았기 때문에 그는 세계의 위대한 작곡가들 중 한 명은 아니었다. 그가 쓴 곡은 마치 그 당시 모든 다른 사람들이 작곡했던 것처럼 들렸다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "성과 같은 목적을 달성하기 위한 도구인 반면, 일 부 콘텐츠 제작자들은 사회적 목적 그 자체로서 평범한 명성을 원한다. 리얼리티 텔레비전 스타들 과 다르지 않게, 소셜 미디어 유명인들은 연기나 가창력과 같은 전통적인 엘리트 명성과 관련된 기 술과 재능을 가지고 있지 않다는 이유로 종종 비 판을 받는다. 이러한 비판은 디지털 콘텐츠 제작 자들이 엘리트 명성의 영역으로 넘어가는 데 있어 실질적인 장벽에 직면하고 있다는 사실을 강조한 다. 그러나 이 비판은 또한 평범한 명성 현상이 명성의 의미를 재구성한다는 점을 놓친다. 엘리트 유명인은 스타라는 은유로 상징되고, 신비로움과 계층적 거리로 특징지어지며, 타고난 자질의 재능 과 계층에 연관되어 있다. 평범한 유명인은 다른 평범한 사람들과의 정기적이고 빈번한 상호작용을 통해 관심을 끈다. 소셜 미디어 유명인으로서 평 범한 명성을 얻는 것은 게임에서 잘하는 것과 같 은데, 왜냐하면 이 영역에서 명성은 관심 척도, 즉, 소셜 미디어 애플리케이션에 내장된 구독자, 팔로 워, 좋아요 또는 클릭의 측정 기준에서 상대적으로 높은 점수 그 이상도 그 이하도 아니기 때문이다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "것이 최고의 학습 전략이라는 착각을 하는 것일 까? 우리가 우리의 기억의 다양한 구획을 구별할 수 없기 때문이다. 우리의 교과서나 수업 노트를 2024 Young Inventors Robot Competition Young Inventors Robot Competition의 신 나는 날에 우리와 함께하세요! □ 분야 참가자들은 다음 분야 중 하나에 참가할 수 있습니다. · 로봇 디자인 · 로봇 코딩 · 로봇 원격 조종 □ 날짜와 시간 2024년 9월 28일, 오전 10시부터 오후 3시까지 □ 장소 Oakwood University 컴퓨터실 □ 등록 2024년 8월 1일부터 8월 10일까지 고등학생이 등록 가능 온라인 등록만 가능 (www.younginventors.edu) □ 시상 각 경쟁 분야에서 세 명의 참가자가 수상할 것입니다. · 1등: 300달러 · 2등: 200달러 · 3등: 100달러 ※ 더 많은 정보를 원하시면, 저희 웹사이트를 방문하세요. Saintville Art Week Stamp Tour 해마다 열리는 8번째 Saintville Art Week Stamp Tour가 올해도 돌아왔습니다! 누구나 우리의 행사에 참가할 수 있습니다. 우리와 함 께하여 전시와 새로운 컬렉션을 즐겨 보세요. □ 언제: 2024년 10월 첫째 주 □ 어디서: Saintville Arts District □ 어떻게: 1단계: Saintville Arts Center에서 스탬프 투어 지도를 받으세요. 2단계: 다섯 곳 중 적어도 세 곳에서 도장을 받고 선물을 받으세요. 예술 작품이 인쇄된 우산이나 머그잔 중 하나를 선물로 선택할 수 있습니다. ※ 더 많은 정보를 원하시면, 저희 웹사이트 www.SaintvilleArtsCenter.com을 방문해 주세요. 읽은 직후에는 정보가 우리 머릿속에 완전히 존재 한다. 그것은 우리의 의식적인 작업 기억에 활동 적인 형태로 자리한다. 그것은 우리의 단기 저장 공간에 존재하기 때문에 우리는 마치 우리가 그것 을 알고 있는 것처럼 느끼지만, 이 단기 구획은 며칠 후 같은 정보를 기억하기 위해 우리가 필요 로 할 장기 기억과는 아무런 관련이 없다. 몇 초 또는 몇 분 후, 작업 기억은 이미 사라지기 시작 하고, 며칠 후 그 영향은 엄청나게 되어, 여러분 이 자신의 지식을 다시 테스트하지 않으면 기억은 사라진다. (같은 자료를 반복해서 다시 복습하는 것보다 새로운 주제를 탐구하는 데 집중하는 것이 여러분의 학업 성취를 향상시킬 수 있다.) 정보를 장기 기억에 넣으려면, 여러분의 모든 시간을 공 부하는 데에 쓰기보다는 자료를 공부하고 나서 스 스로를 테스트하는 것이 필수적이다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "The discovery of mirror neurons has profoundly changed\nthe way we think of a fundamental human capacity, learning\nby observation. You may not see the tongue stick out each time you stick\nyours out at your newborn, but if you do it many times,\nthe tongue will come out more often than if you do\nsomething different. Babies babble and later start to\nimitate the sounds their parents produce. As children we learn a lot by observing what our parents\nand friends do. Newborns, in the first week of life, have an\ninborn tendency to stick out their tongue if their parents\nstick out theirs. Such imitation is not perfect. Later still, they play with vacuum cleaners and hammers in\nimitation of their parents. Our modern cultures, in which\nwe write, speak, read, build spaceships and go to school,\ncan work only because we are not restricted to the\nbehavior we are born with or learn by trial and error. We\ncan learn a lot by simply watching others."
    ],
    "translation": [
      "는 근본적인 인간의 능력에 대해 우리가 생각하는 방식을 완전히 바꾸어 놓았다. 어린이일 때 우 리는 우리의 부모와 친구들이 하는 것을 관찰하면 서 많이 배운다. 갓난아기들은 생의 첫 주에 그들 의 부모가 그들의 것(혀)을 내밀면 자신의 혀를 내미는 선천적인 성향을 갖고 있다. 그러한 모방 은 완벽하지 않다. 당신은 당신의 갓난아기에 게 당신의 것(혀)을 내밀 때마다 (아기의) 혀가 내밀어 나오는 것을 보지 못할 수도 있지만, 만약 당신이 그것을 여러 번 한다면 당신이 다른 것을 할 때보다 (아기의) 혀가 더 자주 나올 것이다. 아기들은 옹알이하고 이후에 그들의 부모가 내는 소리를 모방하기 시작한다. 이후에도 여전히, 그들은 부모들을 흉내 내어 진공청소기와 망치를 갖고 논다. 쓰고 말하고 읽고 우주선을 만들고 학 교에 가는 우리의 현대 문화는 단지 우리가 가지 고 태어나는 또는 시행착오를 통해 배우는 행동에 국한되지 않기 때문에 작동할 수 있다. 우리는 그 저 다른 사람들을 관찰하는 것을 통해 많이 배울 수 있다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "content": [
      "Have you ever been surprised to hear a recording of your\nown voice? You might have thought, “Is that really what my\nvoice sounds like?” There are two pathways through which we perceive our\nown voice when we speak. One is the route through\nwhich we perceive most external sounds, like waves that\ntravel from the air through the outer, middle and inner ear. But because our vocal cords vibrate when we speak,\nthere is a second internal path. Vibrations are conducted\nthrough our bones and stimulate our inner ears directly.\nLower frequencies are emphasized along this pathway.\nThat makes your voice sound deeper and richer to\nyourself than it may sound to other people. Maybe your accent is more pronounced in the recording\nthan you realized, or your voice is higher than it seems to\nyour own ears. This is of course quite a common\nexperience. The explanation is actually fairly simple."
    ],
    "translation": [
      "적이 있는가? 당신은 ‘내 목소리가 정말 이렇게 들리는가?’라고 생각했을지도 모른다. 어쩌면 녹음에서는 당신이 인식한 것보다 당신의 억양이 더 강조되거나, 당신의 목소리가 당신의 귀에 들 리는 것 같은 것보다 더 높다. 이것은 당연히 꽤 흔한 경험이다. 이 설명은 사실 꽤 간단하다. 우리가 말할 때 우리 자신의 목소리를 인지하는 데는 두 가지 경로가 있다. 하나는 외이, 중이, 내 이를 통하는 공기로부터 이동하는 파동처럼 우리 가 대부분의 외부의 소리를 인지하는 경로이다. 그러나 우리가 말할 때 우리의 성대가 진동하 기 때문에 두 번째 내부의 경로가 있다. 진동은 뼈를 통해 전해지고, 우리의 내이를 직접 자극한 다. 낮은 주파수는 이 경로를 따라 두드러진다. 그것은 당신의 목소리가 다른 사람에게 들릴 수 있는 것보다 당신 자신에게 더 깊고 풍부하게 들 리게 한다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "content": [
      "Capuchins ― New World Monkeys that live in large social\ngroups ― will, in captivity, trade with people all day long,\nespecially if food is involved.\nI give you this rock and you\ngive me a treat to eat. If you put two monkeys in cages\nnext to each other, and offer them both slices of cucumber\nfor the rocks they already have, they will happily eat the\ncucumbers. If, however, you give one monkey grapes\ninstead ― grapes being universally preferred to cucumbers\n― the monkey that is still receiving cucumbers will begin to\nthrow them back at the experimenter. Even though she is\nstill getting “paid” the same amount for her effort of\nsourcing rocks, and so her particular situation has not\nchanged, the comparison to another makes the situation\nunfair. Furthermore, she is now willing to abandon all gains\n― the cucumbers themselves ― to communicate her\ndispleasure to the experimenter.\n\nAccording to the passage, if the Capuchin monkey realizes the in rewards compared to another monkey, she\nwill her rewards to express her feelings about the\ntreatment, despite getting exactly the same rewards as before.\nbenefit …… protect\ninequality …… share\nabundance …… yield\ninequality …… reject\nbenefit …… display"
    ],
    "translation": [
      "명한 시인 Sheikh Saadi가 살았다. 대부분의 다른 시인들과 철학자들처럼 그는 매우 검소한 생활을 했다. Shiraz의 부유한 상인은 그의 딸의 결혼식 을 준비하고 있었고 그를 그 마을의 많은 큰 사업 가들과 함께 초대했다. 그 시인은 초대를 수락했 고 참석하기로 결정했다. 결혼식 날, 결혼식 의 혼주인 부유한 상인은 입구에서 손님을 맞이하 고 있었다. 마을의 많은 부유한 사람들이 결혼식 에 참석했다. 그들은 자신의 가장 좋은 옷차림으 로 나왔다. 시인은 거창하지도 비싸지도 않은 소 박한 옷을 입었다. 그는 누군가가 자신에게 다가 오기를 기다렸지만 아무도 그에게 단 일 초의 눈 길도 주지 않았다. 혼주조차도 그에게 인사하지 않고 눈길을 돌렸다. 이 모든 것을 보고 시인 은 조용히 파티를 떠나 그가 옷을 빌릴 수 있는 가게로 갔다. 그곳에서 그는 화려하게 장식된 외 투를 골랐고, 그것은 그를 새로운 사람처럼 보이 게 만들었다. 이 외투를 입고, 그는 파티에 들어 갔고 이번에는 두 팔 벌려 환영을 받았다. 혼주는 그가 오랜 친구에게 하듯이 그를 껴안았고, 그가 입고 있는 옷에 대해 그에게 칭찬했다. 시인은 한 마디도 하지 않고 혼주가 그를 식당으로 안내하도 록 허락했다. 혼주는 직접 시인을 그의 자리 로 안내했고 그에게 닭고기 수프를 내주었다. 잠 시 후에 시인은 마치 음식을 먹이듯 그의 외투 자 락을 수프에 갑자기 담갔다. 모든 손님이 바로 그 를 놀라서 바라보고 있었다. 혼주가 말했다. “선생 님, 뭐 하는 겁니까?” 시인은 매우 침착하게 대답 했다. “내가 비싼 옷을 입으니, 이곳에서 엄청난 차이를 봅니다. 내가 지금 할 수 있는 모든 말은 이 진수성찬이 내 옷을 위한 것이지, 나를 위한 것이 아니라는 것뿐입니다.”"
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "잠재적인 힘을 간과한다. 종종, 학생들이 충분히 조용하고 그 순간 교사의 시간에 대한 긴급한 요 구가 많으면, 수업이 시작되기 전에 10분 이상이 사라질 수 있다. 학생들이 수업에 늦는 것은 놀라 운 일이 아니다. 그들이 제시간에 올 이유가 거의 없다. 당신은 훌륭한 시작으로 당신의 수업을 출 발시키도록 첫 10분을 사용하거나 당신은 이 시간 을 낭비하도록 선택할 수 있다. 첫 몇 분이 나머 지 수업의 분위기를 설정한다. 당신이 수업 준비 가 되어 있고 시작 루틴을 학생들에게 가르쳤다면, 그들은 지난 수업 또는 과목으로부터 정신적, 감 정적 변화를 만들고 새로운 자료를 배우는 것에 집중하려고 준비하기 위해 이 짧은 시간을 사용할 수 있다. 요약하자면, 효과적인 출발로 수업을 전 개하기 위한 시작 루틴을 마련해야 한다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "자체만큼이나 오래되었다. 당신이 숨을 쉴 때, 예 를 들어, 당신이 들이마신 원자 중 일부만이 당신 의 다음 숨에서 내뱉어진다. 남아있는 원자는 당 신의 몸으로 들어가 당신의 일부가 되고, 이후 그 것들은 다양한 방법으로 당신의 몸을 떠난다. 당 신은 당신의 몸을 구성하는 원자를 ‘소유’하지 않 는다. 당신은 그것들을 빌린다. 원자는 영원히 우 리 주변과 내부, 그리고 우리 사이를 이동하기 때 문에 우리 모두는 같은 원자풀로부터 공유한다. 원자는 우리가 숨을 쉬고 땀이 증발하면서 사람에 서 사람으로 순환한다. 우리는 거대한 규모로 원 자를 재순환시킨다. 가장 가벼운 원자의 기원은 우주의 기원으로 거슬러 올라가며, 대부분의 더 무거운 원자는 태양과 지구보다 오래되었다. 태초 부터 존재해 온 원자가 당신의 몸에 있으며 제한 없는 형태, 즉 비생물체와 생물체 가운데 우주 전 체에 걸쳐 재순환한다. 당신은 몸속 원자의 현재 관리인이다. 당신의 뒤를 이을 많은 것[사람]들이 있을 것이다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "인 형태이다. 그것은 파기와 심기에서 물 주기와 수확하기까지 이르는 다양한 움직임을 포함한다. 이런 활동들은 강인함, 유연성과 내구력을 향상시 키는 것을 돕는다. 당신은 그것을 인식하지 못할 수도 있으나 잡초 뽑기나 퇴비 뒤섞기와 같은 작 은 과업들은 많은 칼로리를 태울 수 있다. 원예는 특히 전통적 운동이 힘들다고 생각하는 사람들에 게 이롭다. 그것은 활동적이고 건강하게 유지하기 에 부담을 주지 않는 방법이어서 모든 연령대 및 신체 능력을 지닌 사람들이 접근할 수 있게 만든 다. 신체적 건강 외에도, 원예는 충분한 정신적 건강 이점이 있다. 식물을 돌보는 것은 믿을 수 없을 정도로 고요하고 명상적일 수 있다. 그것은 당신이 현재 순간에 집중하게 하면서 스트레스와 불안감을 줄인다. 원예와 관련한 반복적인 과업은 명상과 유사한 마음 돌봄의 상태를 유도한다. 연 구는 심지어 작은 정원이더라도 자연에서 시간을 보내는 것이 기분을 돋우고, 인지를 개선하며, 우 울 증상을 줄일 수 있음을 보여왔다. 당신의 식물 들이 성장하고 잘 자라는 것을 지켜본 것에서 온 성취감은 또한 자아존중감과 전반적 행복을 높일 수 있다."
    ],
    "tags": [
      "#심리학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "지각할 수 없는 자연 현상을 바꾸고 우리의 지각 으로 가져오는 도구들을 이용해 왔다. 어떤 경우 에는, 이것은 우리의 일반적인 감각 입력으로 들 어오는 신호를 단순히 확장하는 것(예: 망원경은 너무 멀어서 우리 눈이 그 자체로 지각할 수 없는 것을 명확한 시야로 가져올 수 있다)으로 구성된 다. 다른 도구들은 우리가 인지할 수 없는 신호를 우리가 관찰할 수 있는 것으로 바꾼다. 이러한 도 구 중 일부는 우리의 현재 감각 범위를 확장하는 빛의 자외선 스펙트럼을 기반으로 가시 이미지를 생성하거나 보통은 인간의 귀가 들을 수 있는 것 의 범위 밖에 있는 소리를 들을 수 있는 신호로 바꾸는 것과 같이 형태를 취한다. 아니면, 일부 도구들은 우리가 전혀 감각 수용 능력이 없는 속 성을 측정하고 이를 우리가 관찰할 수 있는 것으 로 그것들을 바꾼다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "사망률 감소의 유일한 원인이 아닐 뿐만 아니라, 인간 건강에 기여했던 많은 의학적 발전이 동물 실험의 결과가 아니었다고 주장한다. 연구 옹호자 들은 동물 실험 실행과 의학적 발전 사이에 강한 상관관계가 있기 때문에 전자가 후자를 초래했다 고 주장해왔다. 연구 반대자들은 이 추론을 거부 한다. 결국, 우리는 이러한 현상들이 상관관계가 있을 것이라고 예상하게 하는 독립적인 이유를 가고 1 정답 및 해설 2025학년도 9월 전국연합학력평가 12 16 진다. 법이 모든 신약들, 보철 장치들 그리고 외 과 기술들이 인간에게 사용되기 전에 동물에게 시 험 되어야 한다고 규정하기 때문에, 우리는 그 결 과로서 모든 의학적 발전들이 이전의 동물 실험과 상관관계가 있다는 것을 알게 될 것이다. 따라서, 동물 실험과 의학적 발견 간의 상관관계는 법적 필요성의 결과이지, 동물 실험이 의학적 발전을 이끌었다는 증거가 아니다. 게다가, 몇몇 영향력 있는 의사들은 동물 실험이 옹호자들이 주장하는 것만큼 생의학적 발견의 원인이 아니었다는 역사 적 증거를 제시해 왔다. 그들은 임상적 발견들이 동물 연구자들이 우리가 믿게 해 온 것보다 더 중 요한 역할을 했다고 주장한다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "으로부터의 위험에 대해 다른 방식으로 반응한다. 어떤 종들은 그들이 위협을 감지할 때 긴장하고, 빠르고, 즉각적인 비행을 하도록 프로그램화되어 있다. 다른 종들은 더 느리고, 덜 긴장하고, 무리 속에서 보호를 찾고, 위협을 받았을 때 그들의 자 리를 지키고 필요할 때까지 도망가지 않는다. 자 연스럽게, 긴장하는 동물 종들은 갇힌 상태를 유 지하기 어렵다. 만약 우리 안에 넣어지면, 그들은 패닉에 빠지게 될 가능성이 있고 충격으로 죽거나 탈출하려는 시도로 그들 자신을 반복적으로 울타 리에 부딪혀 죽을 가능성이 있다. 예를 들어, 이것 은 가젤에 해당하는데 이들은 수천 년 동안 비옥 한 초승달 지대의 일부 지역에서 가장 빈번하게 사냥된 사냥감 종이었다. 그 지역에 처음으로 정 착한 인간들이 가젤보다 길들일 기회가 더 많았던 포유류는 없다. 그러나 어떤 가젤 종도 지금까지 길들여진 적이 없다. 도망가고, 자신을 맹목적으로 벽에 부딪히고, 거의 30피트까지 뛰어오를 수 있 고, 시속 50마일 속도로 달릴 수 있는 동물을 무 리 지으려고 노력하는 것을 상상해봐라!"
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "어난 종에게 있어, 자원이 풍부하고 외부의 위험 이 거의 없을 때 나누고 협력하려는 우리의 타고 난 성향은 복잡하다. 우리가 더 적게 가질 때, 우 리가 가진 것을 나누는 데 더 개방적이 되는 경향 이 있다. 특정 유목 부족은 많은 것을 가지고 있 지 않지만, 그렇게 하는 것이 그들의 이익에 부합 하기 때문에 그들은 기꺼이 나누려고 한다. 만약 당신이 여행 중 그들을 우연히 만나면, 그들은 자 신의 집을 열고 당신에게 음식과 환대를 제공할 것이다. 이는 그들이 좋은 사람이어서만이 아니다. 이는 그들의 생존이 나누는 것에 달려 있기 때문 인데, 왜냐하면 그들은 또 다른 날 그들이 음식과 거처가 필요한 여행자가 될 수 있음을 알기 때문 이다. 아이러니하게도, 우리가 더 많이 가질수록, 우리의 울타리는 더 커지고, 사람들을 멀리 두기 위한 우리의 보안은 더 정교해지며, 우리는 더 적 게 나누기를 원하게 된다. 우리의 더 많은 것에 대한 욕망은 ‘일반 대중’과의 증가된(→ 줄어든) 실제적인 상호작용과 결합되어서, 현실에 대한 단 절이나 눈멀음을 만들어내기 시작한다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "나 불만족스러운 것은 좋은 일이 일어나면 행복하 고, 나쁜 일이 일어나면 슬픈 것처럼 단지 삶의 경험의 각각의 개별적인 연속적인 순간에 의해 결 정되지 않는다. 우리의 경험은 우리의 기분에 영 향을 미치지만, 우리는 각 돌풍에 의해 완전히 새 로운 방향으로 날아가지 않는다. 인간으로서 우리 는 좋을 뿐 아니라 나쁘기도 한 새로운 정보와 사 건들에 적응하고 우리의 개인적인 기본 행복 수준 으로 돌아간다. 기복은 있을 것이지만, 시간이 지 나면서 고유한 수위를 찾는 물처럼 우리는 우리의 기준선으로 끌려가는데 즉, 나쁜 소식 후에는 다 시 ‘올라’오고 좋은 소식 후에는 다시 ‘내려’온다. 첫사랑의 행복감은 사라지고, 결별의 절망도 그렇 다. 이 경향은 어린 아이들과 그들의 장난감 기쁨 에서 가장 잘 보여진다. 그들은 간절히 원하던 것 을 얻을 때, 그들의 남은 인생동안 행복할 것이라 고 믿는다. 그리고 그들의 남은 인생의 처음 몇 분 동안, 그들은 그렇다. 하지만 그리고 나서 어 른들처럼 아이들은 적응한다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "넣기 위해 잠자는 것을 미룰 수 있지만, 결국 당 신의 수면에 대한 필요는 압도적이게 되고 잠을 잘 수 밖에 없게 된다. 이러한 매일의 수면 욕구 는 부분적으로 아데노신이라고 알려진 화합물 때 문으로 보인다. 이 자연 화학물질은 깨어 있는 시 간이 증가할수록 당신의 혈액 속에 쌓인다. 당신 이 자는 동안, 당신의 몸은 아데노신을 분해한다. 따라서, 이 분자는 당신의 몸이 놓쳐버린 수면을 추적하고 필요할 때 수면을 유도하는 데 사용하는 것일지도 모른다. 아데노신의 축적과 다른 요인들 은 왜 당신이 최적의 수면량에 미치지 못한 며칠 밤 후에 평소보다 더 오래 잠으로써 당신이 보충 해야 하는 수면 빚을 쌓는지를 설명할 수도 있다. 이러한 내재된 분자적 피드백 때문에, 당신은 당 신의 몸이 필요한 것보다 더 적은 잠을 자는 것에 익숙해질 수 없다. 결국 수면 부족은 당신을 따라 잡는다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "는 것들 중 하나는 불확실성의 중요성이 상대적이 라는 것이다. 지구와 태양 사이의 거리, 즉 연중 한 지점에서 측정된 1.49597 × 10⁸km의 예를 들어보자. 이것은 상대적으로 정확해 보이지만, 결국, 여섯 자리의 유효 숫자를 사용하는 것은 백 만 분의 일 정도의 정확도로 그 거리를 알고 있다 는 것을 의미한다. 하지만, 만약 다음 숫자가 불 확실하다면, 그것은 지구와 태양의 정확한 거리를 아는 것에 있어서의 불확실성이 뉴욕과 시카고의 거리보다 더 크다는 것을 의미한다! 따라서, 인용 된 숫자가 ‘정확한지’ 아닌지는 내가 그것으로 무 엇을 하려고 하느냐에 따라 다르다. 만약 내가 내 일 태양이 몇 분에 뜰지에만 관심이 있다면, 여기 인용된 숫자로 괜찮다. 하지만 만약 내가 태양 바 로 위에 궤도를 돌 위성을 보내고 싶다면, 나는 더 정확하게 거리를 알 필요가 있을 것이다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "지구 온난화를 막기 위해 재생 가능 에너지 기반 시설을 구축할 때, 우리는 실제로 인류 역사상 가 장 큰 변화 프로젝트 중 하나에 관여하는 것이라 고 주장한다. 태양광 패널과 풍력 터빈에 더하여 우리는 대체 교통 기반 시설, 농업 절차 그리고 산업 프로세스를 구축해야 한다. 이 변화는 화석 연료 없이는 일어날 수 없다. 예를 들어, 콘크리트 구조물과 강철 요소의 생산은 화석 에너지로만 생 산가능한 에너지의 양을 필요로 한다. 태양광 패 널의 생산은 발굴되어져야 하는 희귀하고 값비싼 광물들을 필요로 하며, 이는 또한 화석 연료 사용 을 필요로 한다. 따라서, 우리가 재생 가능 에너지 시스템을 향하여 더 세게 밀고 나아갈수록, 더 빠 FatherDaughter Sock Hop 우리는 당신을 아빠와 딸이 춤을 추는 매우 특별한 저녁인 제5회 연례 Father Daughter Sock Hop에 모시게 되어 기쁩니다! 언제 & 어디서 • 9월 12일(금요일), 저녁 6시에서 9시까지 • Maple Creek 커뮤니티 센터 참가비 • 한 쌍당 25달러 • 추가되는 딸 1명당 5달러 • 행사 당일 취소 시 환불 불가 공지사항 • 양말 한 켤레가 모든 참가자에게 선물로 제공될 것입니다. • 포토존에서 사진을 찍으세요. 등록 • www.maplecreekcity.org에서 온라인으로 등록하세요. 2025 Library Bookmark Design Contest 제6회 연례 Library Bookmark Design Contest가 지금 열립니다! 여러분의 창의성과 디자인 기술을 보여주세요. 참가 • 참가자는 5세에서 12세 사이여야 합니다. 지침 • 마커 또는 크레용을 사용하여 손으로 책갈피를 만드세요. • 디자인은 “Find Your Voice” 슬로건에 적합해야 합니다. • 디자인에 상업용 캐릭터 이미지들을 사용하지 마세요. 제출 • 참가자당 한 개의 출품작으로 제한합니다. • 출품작은 10월 4일까지 이메일을 통해 contest@srpls.org로 제출되어야 합니다. 시상 • 1등: 50달러 선물 카드, 2등: 30달러 선물 카드 • 수상자의 책갈피는 인쇄되어 방문객에게 제공될 것입니다. ※ 더 많은 정보를 위해, 우리 웹사이트 www.sherrillpubliclibrary.org를 방문하세요. 르게 우리는 건설 과정에서 화석 에너지를 사용해 야 한다. 이는 단지 비용이 많이 들 뿐만 아니라, 전세계적 배기가스를 줄이려는 우리의 노력을 훼 손하는 요인이 된다. Heinberg는 이러한 새로운 에너지 기반 시설을 구축하는 비용이 전환 제안에 서 거의 계산되지 않는다고 언급하는데, 이는 에 너지 공급 요구 사항에만 집중하는 경향이 있다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "고 인간과 같은 결정을 내릴 수 있는 기계를 꿈꿔 왔다. 고대 그리스 이래로 로봇, 자동 장치, 인공 생명체에 대한 신화가 존재해 왔다. (예를 들면, 세상에 불행을 퍼뜨린 Pandora의 신화). 마찬가지 로, 역사를 통틀어 문학은 인간과 같은 생명체와 사고하는 기계를 창조하는 꿈을 꿔왔다. (예를 들 면, Mary Shelley의 ‘프랑켄슈타인’). 1950년, 영 국의 수학자 Alan Turing은 기계가 인간처럼 사 고하고 추론할 수 있는지 물었고, 그 다음에 기계 의 지능과 기계가 자율적으로 사고할 수 있는지를 측정하기 위해 튜링 테스트를 개발했다. 몇 년 후, MIT 교수 John McCarthy는 이전에 사용된 ‘자동 장치 연구’라는 표현을 대체해 ‘인공지능’이라는 표현을 만들어냈다. (하지만 인공지능은 거기서 멈추지 않았다. 그것의 첫 주요 출현은 감정을 느 끼는 인공지능이 인간 배역을 로봇으로 대체했던 영화에서였다.) 그 이후로, 인공지능은 인간처럼 사고하도록 프로그램화된 즉, 그들의 창조자들에 의해 추론과 학습 능력을 부여받은 ‘지능적인 기 계 만들기’에 대한 연구와 실행이 되었다."
    ],
    "tags": [
      "#철학",
      "#예술",
  ...
  },
  {
    ...
    "content": [
      "The desert tortoise has a simple solution for coping with\nDeath Valley’s extreme heat: It avoids it. But to stay supplied with water through its extended\nhibernation, the reptile relies on something else ― its highly\nsophisticated bladder. Unlike most animals, the tortoise’s\nbladder acts as a holding tank, allowing it to reabsorb water\nback into its body. Incredibly, a desert tortoise can go a full\nyear without taking in any freshwater at all. The slow moving creature hibernates during the winter\nand stays in its tunnel for much of the summer, meaning\nthat it spends more than 90 percent of its life immobile. In\nfact, the tortoise usually only surfaces after a good rain.\nThen, it gets to work. The tortoise stocks up on water by\neating plants and digging holes to collect rain. And because its bladder is so important to a tortoise’s\nsurvival, park rangers often remind visitors not to stop and\nhelp the slow movers across the road. Tortoises become\nso terrified when people pick them up that they empty\ntheir bladders, losing their precious water reserves."
    ],
    "translation": [
      "극복하기 위해 간단한 해결책을 가지고 있는데 그 것은 더위를 피하는 것이다. 그 느리게 움직이 는 생명체는 겨울에는 동면하고 대부분의 여름에 는 그것의 굴 속에서 보내는데 이는 그 생의 90퍼 센트 이상을 움직이지 않은 채로 보낸다는 것을 의미한다. 사실, 거북은 보통 충분한 비가 온 후에 만 밖으로 나온다. 그 다음에 그것은 활동을 시작 한다. 거북은 식물을 먹고, 빗물을 모으기 위한 구 멍을 팜으로써 물을 비축한다. 하지만 그것의 장기간에 걸친 동면 동안 수분이 공급된 채로 지 내기 위해, 이 파충류는 다른 것에 의존한다. 즉, 그것의 매우 정교한 방광이다. 대부분의 동물과 달리, 거북의 방광은 보관 탱크로서의 역할을 하 며, 그것이 그것의 몸으로 물을 다시 흡수할 수 있게 한다. 놀랍게도, 사막거북은 1년 내내 담수를 전혀 섭취하지 않고도 살아갈 수 있다. 그리고 그것의 방광이 거북의 생존에 매우 중요하기 때문 에, 공원 순찰대원들은 종종 방문객들에게 멈추어 그 느리게 움직이는 것을 도로를 건너도록 도와주 지 않을 것을 상기시킨다. 거북은 사람들이 그들 을 들어 올릴 때 너무 겁을 먹어 그들의 방광을 비워버리고, 소중한 저장된 물을 잃게 된다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "content": [
      "Imagine you are pedalling your bicycle on a level road.\nYou stop pedalling: no force is now acting to move you\nforward. What happens? One of these is friction in the wheels rubbing on the\naxles. Another is air resistance, which you can feel,\npushing you backwards as you and the bicycle move\nforwards. When you apply these ideas to something\naround you, like a cart, you can see what could be\ngenerating friction: mainly the axles rubbing on the body\nas they rotate. You gradually slow down. How could you slow down\nmore suddenly, in a shorter distance? By putting the\nbrakes on. Because the brakes change your movement,\nmaking you slow down more suddenly, they must be\nexerting a force on the bicycle and you, as they grip and\nrub on the wheelrims. This is the force called friction, which tends to slow\ndown moving things by acting in the direction opposite to\nmovement, that is backwards. Even without the brakes\non, there are other friction forces acting on you and your\nbicycle, which also slow you down."
    ],
    "translation": [
      "고 상상해 보아라. 당신은 페달을 밟는 것을 멈추 고 당신을 앞으로 나아가게 하는 어떠한 힘도 이 제 작용하지 않는다. 그러면 어떻게 될까? 당 신은 서서히 느려진다. 당신은 더 짧은 거리 안에 서 더 갑자기 속도를 줄이려면 어떻게 해야 할까? 브레이크를 작동시키면 된다. 브레이크는 당신의 움직임을 변화시켜 당신을 더 갑자기 느려지게 하 기 때문에, 그것들이 바퀴 테두리를 잡고 닿으면 서 자전거와 당신에게 힘을 가하고 있어야 한다. 이것이 마찰력이라고 불리는 힘이며, 그리고 그 힘은 움직임의 반대 방향, 즉 뒤쪽으로 작용함 으로써 움직이는 물체를 느리게 하는 경향이 있 다. 심지어 브레이크를 작동시키지 않아도 당신과 당신의 자전거에 작용하는 다른 마찰력이 존재하 며, 이것은 또한 당신을 느리게 한다. 이들 중 하나는 축에 닿는 바퀴의 마찰이다. 또 다른 하나 는 당신과 자전거가 앞쪽으로 움직일 때 당신을 뒤쪽으로 미는 공기 저항으로 이는 당신이 느낄 수 있다. 카트와 같은 당신 주변에 있는 어떤 것 에 이러한 개념을 적용하면, 주로 회전하면서 본 체에 닿는 축들과 같이, 당신은 무엇이 마찰력을 발생시킬 수 있을지 알 수 있다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "면이나 장면을 찾기 위해 빨리 감기나 빨리 되감기 를 할 필요 없이 어떤 비디오 숏이나 장면으로의 임의적 접근을 가능하게 하는 비선형 컴퓨터 기반 시스템이다. 비선형 시스템은 슬로 모션, 와이프 그리고 디졸브 같은 다양한 특수 효과를 만들 수 있다. 디지털 비선형 시스템의 또 다른 주요 특징 은 편집자가 비디오테이프를 빨리 감거나 되감는 데 시간을 들일 필요 없이 원하는 숏이나 장면을 찾는 것을 쉽게 해주는 그것의 임의적 접근 과정이 다. 비선형 편집으로는 숏이나 장면을 프로그램의 어디에나 쉽게 추가하거나 삭제할 수 있으며, 컴퓨 터는 프로그램의 길이를 자동으로 조정한다. 선형 편집은 타자기로 글을 작성하는 것과 같았다. 만약 실수가 생겼거나 새로운 정보가 추가되어야 할 필 요가 있다면, 전체를 다시 작성해야 했다. 비선형 편집은, 반면, 워드 프로세싱 프로그램을 사용하는 것과 같다. 만약 실수가 생기면 그것은 몇 번의 키 입력으로 쉽게 삭제되고 수정될 수 있으며, 새로운 정보가 쉽게 추가될 수 있다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "치를 인정하는 개인적 발달의 여정에 나서지 않을 것이다. 하고 싶은 대로 내버려 두면, 그들은 본능 적으로 서로 점점 더 경쟁적이 될 것이다. 그들은 스포츠 경기장에서와 마찬가지로 교실 환경 내의 점수, 성적표, 피드백을 비교할 것이다. 우리는 학 생들에게 승자와 패자에 대해 가르칠 필요가 없다. 운동장과 미디어가 그들을 위해 그렇게 하는 것이 다. 하지만, 우리는 그들에게 승리하는 것보다 삶 에 더 많은 것이 있다는 것과 성공적인 협력을 위 해 그들이 필요로 하는 기술에 대해 가르쳐 줄 필 요가 있다. 성공적으로 함께 일하는 그룹은 고도의 대인 의식뿐만 아니라 다양한 사회적 기술을 가진 개인들을 필요로 한다. 일부 학생들은 본래 이러한 기술에 대한 자연스러운 이해를 가지고 있지만, 그 들은 항상 소수이다. 당신의 교실에 또래들 사이의 협력을 이루도록 하기 위해서, 당신은 의식적이고 주의 깊게 이러한 기술들을 가르쳐야 하고, 학창시 절 내내 계속해서 그것들을 육성해야 한다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "것은 우리가 상호 배타적이거나 모순된다고 가정하 는 생각과 행동의 경향을 보여준다. 예를 들어, 최 고의 작업을 수행하기 위해서는 팀이 해결하려는 문제와 관련된 주제에 대한 깊은 지식과 수반되는 과정의 숙달이 필요하다. 그러나 동시에, 널리 퍼져 있는 지혜나 일을 하는 입증된 방법에 구애받지 않 는 신선한 관점이 필요하다. 종종 ‘초심자의 마음’ 이라고 불리는 이것은 신참의 관점이다. 즉, 이런 사람들은 호기심 많고, 심지어 장난기 넘치고, 질문 이 아무리 순진해 보이더라도 무엇이든 기꺼이 물 어보는데, 이것은 자신이 모르는 것이 무엇인지도 모르기 때문이다. 따라서 모순되는 특징들을 한데 모으는 것이 새로운 아이디어의 과정을 가속화할 수 있다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "새로운 경기장 또는 경전철 시스템, 컨벤션 센터, 주택 프로젝트와 같은 대규모 건설 프로젝트를 통 해 그들의 도시를 이전의 영광으로 되돌릴 수 있다 고 잘못 상상하고 있다. 거의 예외 없이 공공 정책 이 도시 변화의 흐름(조석력)을 늦출 수는 없다. 우리는 Rust Belt에 사는 가난한 사람들의 요구를 무시하지 말고 공공 정책이 가난한 지역을 돕는 것 이 아닌 가난한 ‘사람들’을 돕도록 해야 한다. 반짝 이는 새로운 부동산은 쇠퇴하는 도시를 꾸밀 수는 있지만 그러나 이것은 기저에 있는 문제를 해결하 지는 못한다. 쇠퇴하는 도시의 특징은 그들은 그들 의 경제력에 비해서 ‘너무 많은’ 주택과 기반시설을 가지고 있다는 것이다. 건축물의 모든 공급과 너무 적은 수요로 인해 더 많은 공급을 만들어 내기 위 해 공공 자금을 사용하는 것은 의미가 없다. 건물 중심의 도시 재생의 어리석음은 우리에게 도시는 구조물이 아니라 사람이라는 것을 상기시킨다."
    ],
    "tags": [
      "#경제",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "해양 종들은 그들이 미칠 수 있는 영향에 대한 정 보가 거의 없는 상태에서 의도적으로 식량이나 침 식 방제를 위해 도입되었다. 어패류는 양식을 위해 전 세계에 의도적으로 도입되어 음식과 일자리를 제공하지만, 탈출해서 토착종, 생태계 기능, 또는 생계에 위협이 될 수 있다. 대서양 연어는 Washington State와 British Columbia의 해양 그물 어장에서 길러진다. 매년 많은 연어가 탈출해, 그 들은 Washington State, British Columbia, Alaska 의 해수와 담수에서 발견되어진다. 여가용 낚시 또 한 침입종을 전파시킬 수 있다. Maine의 미끼용 벌레들은 전국적으로 인기가 있다. 그것들은 보통 많은 다른 유기체들을 포함하는 해초에 싸여 있다. 만약 해초가 버려지면, 해초나 해초 위에 있는 유 기체들은 새로운 영역에서 군락을 이룰 수 있다. 낚시용 장화, 여가용 보트와 트레일러는 유기체를 한 장소에서 집어 올려 다른 곳으로 옮길 수 있다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "기념품 행상인들이 Battery Park City로 나아가기 전에, 세계 무역 센터 뒤편의 지역은 거대하고 혐 오스러운 쓰레기 매립지였다. 1982년, 예술가 Agnes Denes는 비록 일시적이긴 하지만 그 매립 지를 다시 원래의 뿌리로 되돌리기로 결정했다. Denes는 Public Art Fund로부터 Manhattan에서 지금까지 본 가장 의미심장하며 환상적인 공공 사 업 작품 중 하나를 만들어 달라는 의뢰를 받았다. 그녀의 콘셉트는 전통적인 조형물이 아니라 대중이 미술을 보는 방식을 바꾼 살아있는 설치 조형물이 었다. 예술의 이름으로, Denes는 반짝이는 쌍둥이 빌딩의 그림자에 아름다운 황금 밀밭을 만들었다. 작품인 Wheatfield ― A Confrontation을 위해, Denes와 자원 봉사자들은 4에이커의 땅에서 쓰레 기를 치운 다음 그 지역 위에 황색 빛깔의 너울거 리는 곡물을 심었다. 수개월의 농사와 관개 후에 밀밭은 무성하게 되고 준비가 되었다. 그 예술가와 그녀의 자원 봉사자들은 수천 파운드의 밀을 수확 하여 뉴욕의 푸드 뱅크에 기부하였고, 뉴욕 사람들 의 마음과 몸에 모두 영양분을 공급해 주었다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "여 고압에 적응해 왔고, 일부는 거의 물만으로 구 성되어 있다. 대부분의 심해 유기체들은 부레가 없다. 그들은 냉혈 유기체들로 주변 환경에 체온 을 맞추어, 낮은 신진대사를 유지하고 있는 동안 차가운 물에 생존하게 한다. 많은 종들은 먹을 수 있는 드문 음식을 찾는 것이 많은 에너지를 소비 하기 때문에 오랜 기간동안 음식 없이 생존이 가 능하도록 그들의 신진대사를 매우 많이 낮춘다. 심해의 많은 포식성 물고기는 거대한 입과 날카로 운 이빨을 가지고 있는데 그것들이 먹이를 붙잡고 제압하게 한다. 해양의 잔광 구역에서 먹이를 잡 는 일부 포식자들은 뛰어난 시력을 가지고 있고, 반면 나머지 포식자들은 먹이감이나 짝을 끌어들 이기 위해 자신의 빛을 만들어 낼 수 있다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "식 주기를 통해서는 결코 실현할 수 없었을 사과, 튤립, 감자에 있어 개량을 가능케 했다. 이러한 경 작 과정은 소비자들이 식료품 가게에서 찾는, 몇몇 의 알아볼 수 있는 채소나 과일을 만들어냈다. 그 러나 만약 추수가 망쳐지면 소수의 재배된 작물에 만 의존하는 것은 인류를 기아나 농업의 손실에 취 약한 상태에 둘 수도 있다. 예를 들어, 아일랜드 사람들이 영양학적으로 균형 있는 식사를 마련하기 위해 주로 감자와 우유에 의존했기 때문에, 아일랜 드 감자 기근 (사태) 동안 백만 명의 사람들이 3 년의 추이에 걸쳐 사망했다. 재배 식물과 공생 관 계를 유지하려면, 인류는 생물의 다양성을 고려해 야만 하고 식물의 단일 경작이 가져올 수 있는 잠 재적 이점(→ 결점)에 대해서도 인식해야만 한다. 설령 그것들이 당장은 유용하고 이득이 된다고 보 이지는 않아도 모든 종류의 씨앗을 심는 것은 다가 올 세대들을 위해 그러한 식물들이 오래 지속되는 것을 보장해 줄 수 있다. 야생에 대한 자연의 능력 과 통제에 대한 인간의 욕망 사이에서 균형은 유지 되어야 한다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "다른 영역에 걸쳐 정신을 위한 일반적인 메커니즘 으로 작용한다. 예를 들어, Mindless Eating의 저 자 Brian Wansink는 그것이 우리의 허리 둘레에 도 영향을 미칠 수 있다는 것을 보여주었다. 우리 는 어느 정도로 먹을지를, 단순히 우리가 실제로 얼마나 많은 음식을 소비할지의 함수로서가 아니 라 그것의 선택(대안)과의 비교를 통해서 결정한 다. 우리가 메뉴에 있는 8온스, 10온스, 12온스의 버거 세 개 중 하나를 선택해야 한다고 하자. 우 리는 10온스 버거를 고르고 식사가 끝날 때쯤이 면 완벽하게 만족할 수 있을 것이다. 하지만 만약 대신에 우리의 선택권이 10온스, 12온스, 14온스 라면, 우리는 다시 중간의 것을 선택할 것이고, 비록 우리가 더 많이 먹었더라도, 식사가 끝날 때 매일 영양분을 섭취하거나 포만감을 느끼기 위해 필요하지 않았던 12온스의 햄버거에 똑같이 행복 감과 만족감을 다시 느낄 수 있을 것이다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "지식에 대한 철학자의 갈망은 그 답이 결코 발견 되지 않는다 하더라도 질문에 대한 더 나은 답을 찾으려는 시도를 통해 보이게 된다. 동시에, 철학 자는 또한 지나치게 확신하는 것이 다른 가능성들 과 더 나은 가능성들의 발견을 방해할 수 있다는 것을 알고 있다. 철학적 대화에서 참여자들은 그 들이 알지 못하거나 이해하지 못하는 것이 있다는 것을 인식한다. 그 대화의 목표는 누구라도 미리 알지 못했거나 이해하지 못했다는 생각에 도달하 는 것이다. 철학이 존재하지 않는 전통적 학교에 서, 학생들은 흔히 사실적 질문에 대해 공부하고, 교육과정에 실린 특정한 내용을 배우며, 철학적인 문제를 해결하도록 요구받지 않는다. 하지만 우리 는 누구라도 알지 못하는 것에 대한 인식이 지식 을 습득하는 좋은 방법이 될 수 있다는 것을 안다. 지식과 이해는 사색과 토론을 통해 발달한다. 생 각을 말로 표현하는 것은 생각을 더 분명하게 만 든다. 따라서 학생들은 잘못된 무언가를 말하거나 처음에 그들이 옳다는 것을 확신하지 않고 이야기 하는 것을 두려워해서는 안 된다."
    ],
    "tags": [
      "#철학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "통을 견딜 수 있게 만드는 일종의 사랑을 가져다 주는 경험이다. 이러한 감정적 경험은 우리가 행복 하다고 느끼는 것으로 귀착하는(끝나는) 선택과 행 동의 결과이다. 우리가 정신적 필터를 통해 행복을 바라볼 때, 우리는 그것이 고통이나 마음의 아픔이 없다는 것을 의미하는 것이 아니라는 것을 깨닫는 다. 아프거나 다친 아이와 함께 앉아 있으면, 모든 부모는 아들 혹은 딸이 치유되기 시작할 때 벅차오 르는 깊은 기쁨을 알게 된다. 이것은 이전의 고통 과 대조함에 따라 어떻게 우리가 더욱 강렬해진 행 복으로 넘쳐날 수 있는지의 간단한 예이다. 이와 같은 경험은 변연계의 화학적 기록 보관소에 들어 간다. 진정한 행복을 경험할 때마다, 기억했던 것 보다 더 깊은 기쁨이 벅차오르면서 저장된 감정이 활성화된다. 당신의 정신적 유전자는 어떤 의미에 서 기쁨으로 가는 당신의 생물학적 보물지도이다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "적인 역할을 맡고 있으며 의사소통망의 중심에 위 치되어 있는데, 부분적으로는 그들의 환자들과의 높은 접촉 정도 뿐만 아니라 다른 전문직 종사자들 과 잘 발달된 관계를 유지하기 때문이다. 이런 이 유로 간호사들은 학제간의(여러 학문 분야가 관련 된) 의사소통에서 중요한 역할을 한다. 그들은 다 양한 전문직 종사자들 집단과 환자와 보호자 집단 사이에서 중개 역할을 한다. (정신건강 관리 전문 직 종사자들은 법적으로 자신의 환자의 사생활을 보호하기로 되어 있어, 그들은 치료에 필요한 모든 것에 관해 비자발적이라기보다, 말할 수 없을지도 모른다.) 이것은 정신 건강 상의 문제를 이해하는 다양한 방식을 가진 사람들에게 납득 가능하고 이 해 가능한 언어로 집단 간 의사소통을 번역하는 것 을 포함한다. 이것은 고도로 민감하고 숙련된 작업 이며 대안적 시각에 대한 높은 수준의 관심과 높은 수준의 의사소통 이해를 요구한다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "When trying to sustain an independent ethos, cultures\nface a problem of critical mass. No single individual,\nacting on his or her own, can produce an ethos. They manage this feat through a combination of trade,\nto support their way of life, and geographic isolation.\nThe Inuit occupy remote territory, removed from major\npopulation centers of Canada. If cross cultural contact\nwere to become sufficiently close, the Inuit ethos would\ndisappear. Rather, an ethos results from the interdependent acts of\nmany individuals. This cluster of produced meaning may\nrequire some degree of insulation from larger and\nwealthier outside forces. The Canadian Inuit maintain\ntheir own ethos, even though they number no more than\ntwenty four thousand. Distinct cultural groups of similar size do not, in the\nlong run, persist in downtown Toronto, Canada, where\nthey come in contact with many outside influences and\npursue essentially Western paths for their lives."
    ],
    "translation": [
      "할 때, 문화는 결정적 질량(임계 질량)의 문제에 직면한다. 자신 혼자서 행동하는 어떤 한 개인도 민족(사회) 정신을 만들어 낼 수 없다. 오히 려 민족(사회) 정신은 많은 개인의 상호의존적인 행위에서 비롯된다. 생성된 의미의 이러한 군집은 더 크고 더 부유한 외부 힘으로부터 어느 정도의 단절을 필요로 할 수 있다. 캐나다 이누이트족은 비록 2만 4천 명에도 불과하지만 그들만의 민족 (사회) 정신을 유지하고 있다. 그들은 삶을 유지하기 위해 무역과 지리적 고립의 조합을 통해 이러한 업적을 해낸다. 이누이트족은 캐나다의 주 요 인구 중심지에서 따로 멀리 떨어진 영토를 차 지하고 있다. 만약 문화 간 접촉이 충분히 긴밀해 진다면, 이누이트인들의 민족(사회) 정신이 사라 지게 될 것이다. 비슷한 규모의 다른 문화 집 단은 캐나다 토론토 도심에서는 결국 지속되지 않 는데, 거기에서 그들은 많은 외부 영향과 접촉하 고 그들의 삶을 위해 본질적으로 서구적 방식을 추구한다."
    ],
    "tags": [
      "#경제",
      "#사회"
  ...
  },
  {
    ...
    "content": [
      "Heat is lost at the surface, so the more surface area\nyou have relative to volume, the harder you must work\nto stay warm. That means that little creatures have to\nproduce heat more rapidly than large creatures. Despite the vast differences in heart rates, nearly all\nmammals have about 800 million heartbeats in them if\nthey live an average life. The exception is humans. We\npass 800 million heartbeats after twentyfive years, and\njust keep on going for another fifty years and 1.6\nbillion heartbeats or so. They must therefore lead completely different lifestyles.\nAn elephant’s heart beats just thirty times a minute, a\nhuman’s sixty, a cow’s between fifty and eighty, but a\nmouse’s beats six hundred times a minute — ten times a\nsecond. Every day, just to survive, the mouse must eat\nabout 50 percent of its own body weight. We humans, by contrast, need to consume only about 2\npercent of our body weight to supply our energy\nrequirements. One area where animals are curiously\nuniform is with the number of heartbeats they have in a\nlifetime. - - - - - - - - - -"
    ],
    "translation": [
      "대비하여 더 많은 표면적을 가질수록 당신은 따뜻 함을 유지하기 위해 더 열심히 움직여야 한다. 그 것은 작은 생물이 큰 생물보다 더 빠르게 열을 생 산해야 함을 의미한다. 그러므로 그들은 완전 히 다른 생활방식으로 살아가야만 한다. 코끼리의 심장은 1분에 단 30회를 뛰고 인간은 60회, 소는 50회에서 80회를 뛰지만, 생쥐는 1분에 600회, 즉 1초에 10회를 뛴다. 매일 단지 살아남기 위해 생쥐 는 자신의 몸무게의 약 50퍼센트를 먹어야 한다. 대조적으로 우리 인간은 에너지 요구량을 공 급하기 위해 우리 신체 무게의 단지 약 2퍼센트만 먹으면 된다. 동물이 기묘하게도 동일한 하나의 영 역은 동물이 평생 동안 뛰는 심장박동 수라는 부분 이다. 심장 박동 수의 엄청난 차이에도 불구 하고 거의 모든 포유동물은 만약 그들이 평균수명 을 산다면 약 8억 회의 심장 박동 수를 갖는다. 예 외는 인간이다. 우리는 25년 이후 8억 회를 넘어서 고 또 다른 50년 동안 계속해서 심장이 뛰어 약 16억 회 정도의 심장 박동 수를 갖는다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "일하게 하고 신뢰와 투명성 같은 핵심적인 리더십 요 소에 활력을 준다. 여러분의 조직에서 누가 또는 무 엇이 평가되고 있는지 간에 그들이 무엇에 대해 평가 되고 있는지는 분명해야 하고 사람들은 그것을 알고 있어야 한다. 만약 여러분의 조직에 있는 개개인들이 그들이 무엇에 대해 평가되고 있는지를 알지 못한 채 로 평가된다면 그것은 불신을 초래하고 여러분의 조 직을 명확성으로부터 멀어지게 할 수 있다. 여러분의 조직이 생산적이고 응집력이 있고 성공적이기 위해서 는 신뢰가 필수적이다. 여러분의 조직에 대한 신뢰를 갖지 못하는 것은 어떤 평가의 결과에도 부정적인 영 향을 끼칠 것이다. 그것은 또한 여러분의 조직의 성 장을 상당히 방해할 것이다. 정확한 평가를 수행하기 위해 신뢰는 필수적인 것이고, 그것은 명확성으로부 터 온다. 결국 평가는 여러분이 더 분명하게 볼 수 있도록 도와주는데, 그것은 그러고 나서 여러분의 조 직이 최적의 성공에 도달하도록 해 준다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "는 각각의 일이 우리의 에너지 수준에 이상적으로 맞춰져야 한다는 사실을 지적한다. 예를 들어 분석적 인 일은 우리의 에너지가 높고 방해물이 없으며 집 중할 수 있을 때 가장 잘 수행된다. 나는 보통 활기 찬 상태로 일어난다. 몇 년 동안 나는 ‘아침 식사로 나의 문제를 먹는’ 습관을 꾸준히 고수해 왔다. 나는 아직 일어나지 않은 다양한 시나리오와 대화를 너무 많이 생각하는 경향이 있는 사람이다. 불만족스러워 하는 고객과 이야기하거나 불쾌한 이메일을 처리하 는 것을 미룰 때 나는 낮 동안에 너무 많은 감정적3 인 에너지를 낭비한다고 생각한다. 마치 그 일이 뇌 리에서 떠나지 않는 것 같고, 나는 그것을 단지 처리 하는 데 실제로 걸리는 것보다 더 많은 시간을 그것 에 대해 걱정하고, 그것에 대해 이야기하고 그리고 그것을 피하는 데 보낼 것이다. 그래서 나에게는 그 것이 항상 내가 끝내는 첫 번째 일이 될 것이다. 만 약 여러분이 자신이 아침형 인간이 아니라는 것을 안다면, 여러분의 어려운 일을 오후 늦은 시간에 하 도록 일정을 짜는 것에 대한 전략을 세우라."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "의 첫 번째 날’처럼)과 관련이 있다고 제시했을 때, 연구자들이 그것을 평범한 날 (‘3월의 세 번째 목요 일’처럼)로 제시했을 때보다 학생들은 그것을 목표 추 구를 시작하기에 더 매력적인 때로 보았다. 그것이 새 로운 운동 습관을 시작하는 것이든 혹은 소셜 미디어 에 시간을 덜 쓰는 것이든 연구자들이 제시하는 날짜 가 새로운 시작과 관련될 때 더 많은 학생들이 바로 그때 변화를 시작하기를 원했다. 그리고 다른 팀에 의 한 더 최근의 연구는 목표를 추구하는 사람들에게 수 정된 주간 일정표를 보여 줌으로써 비슷한 이점들이 얻어졌다는 것을 알아냈다. 달력이 오늘을 (월요일이 든 일요일이든) 한 주의 첫날로 표현했을 때, 사람들 은 그들의 목표에 대한 즉각적인 진전을 이루는 데 더 욱 동기 부여가 되는 것을 느낀다고 보고했다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "종종 노래를 불렀고 춤을 췄다. 이러한 준비의 노래에 서 야기된 감정적이고 신경 화학적인 흥분 상태가 그 들의 공격을 수행하기 위한 힘을 그들에게 제공했다. 무의식적이고 억제되지 않는 행동으로서 시작했을지도 모르는 것, 즉 격분하여 노래를 부르고 드럼을 치는 것으로 그들의 희생자를 공격하는 것은 승리자들이 그 들이 공격하고 있는 사람들에게 자신들의 행동이 미치 는 영향을 직접 목격하면서 전략이 되었을 수도 있다. 비록 전쟁의 춤이 적에게 곧 있을 공격을 경고해 주는 위험을 감수하는 것임에도 불구하고, 공격자들에게 주 는 정서적 자극과 동시에 움직이게 하는 이점이 기습 의 상실을 보상해 줄 수 있다. 노래하고, 춤추고, 행진 했던 사람들은 그러한 장관을 목격한 적들을 겁먹게 했을 뿐만 아니라 전쟁터에서 강한 우세를 누렸을지도 모른다. 19세기와 20세기의 독일인들은 스코틀랜드인 들을 가장 무서워했는데, 백파이프와 드럼이 순전한 시끄러움과 시각적인 장관으로 교란시켰다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "은 유럽, 미국, 호주 그리고 아시아의 몇몇 도시 지역 에서 적극적으로 자전거를 타는 사람들 수의 증가와 자전거 타기 클럽 회원의 성장으로 나타났다. 그것은 또한 자전거의 상징적인 재해석과 동반되어 왔다. 자 전거가 수년 동안 가난과 연관되었던 이후로, 비싼 여가용 자전거 또는 여가용으로부터 영감을 얻은 통 근용 자전거가 도시 환경에서 갑자기 열망의 상품이 되었다. 현재 자전거 타기가 그것의 드러내 놓고 표 현하는 가치, 정체성 형성에 있어서의 그것의 역할, 그리고 타인에게 깊은 인상을 주고 사회적 지위를 암 시하는 것에 있어서의 그것의 효과를 위해 수행되기 도 하는 활동이 되었다. 어느 정도는 자전거 타기가 부유한 사람들의 상징적 표시로 바뀌었다. 분명히 가 치를 지닌 소비 행위는 자전거 타기에 결코 한정되지 않는다. 그러나 정체성 형성과 과시적 소비와의 관련 성은 자전거 타기의 경우에 특히 분명해졌다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "떤 특정한 활동을 시작하는 것을 방지하기 위해 만들 어진다는 것을 의미한다. 어떤 경우에는 선제적 조치 는 단순히 경쟁자들이 같은 행동을 하는 것을 단념시 킬 수 있는 어떤 의도의 공표일 수도 있다. 선매 행 위 개념은 때로 타이밍이 매우 중요하다는 것을 암시 하는데, 즉 어떤 시점의 결정이나 조치는 다른 시점 에 그것을 하는 것보다 훨씬 더 득이 될 수 있다. 선 매 행위는 새로운 진입자가 시장에 진출하기 이전과 진출해 있는 동안에 광고의 가중치를 높이는 것을 포 함할 수 있다. 그 취지는 신규 진입자의 광고가 잠재 적 구매자들에게 인상을 남기는 것을 더 어렵게 만드 는 것이다. 제품 확산은 또 다른 잠재적인 선매 행위 전략이다. 일반적인 아이디어는 수용되지 않는 시장 수요의 방식이 거의 없도록 다양한 제품 변형을 출시 하는 것이다. 거의 틀림없이, 만약 시장이 제품 변형 으로 이미 채워져 있다면 경쟁자들은 아직 점유되지 않은 시장 수요 주머니를 찾기가 더 어렵다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "위장을 제공하는 시각적으로 평평하게 하는 과정이 다. 햇빛이 물체를 위에서 비출 때, 그 물체는 맨 위 에서 가장 밝을 것이다. 물체의 색깔은 맨 아래로 향 할수록 점차 더 어두운색으로 음영이 생기게 될 것 이다. 이러한 음영은 물체에 농도를 주고 보는 사람 이 그것의 모양을 식별하게 해 준다. 따라서 비록 동 물이 밑바탕과 정확하지만 균일하게 같은 색일지라 도 빛이 비춰질 때 쉽게 눈에 띌 것이다. 그러나 대 부분의 동물은 아랫부분보다 윗부분이 더 어둡다. 그 들이 위에서 빛을 받을 때, 더 어두운 등은 밝아지고 더 밝은 복부는 음영이 생긴다. 따라서 동물은 하나 의 색처럼 보이고 밑바탕과 쉽게 섞인다. 이러한 형 태의 배색 즉, 카운터셰이딩은 생물체의 모양의 시각 적 인상을 강화한다(→ 파괴한다). 그것은 동물이 그 것의 배경과 섞이게 해 준다."
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "translation": [
      "다. 유기체는 사건이 그들의 기대에 어긋날 때에만 학습한다. 다시 말해 놀람은 학습의 근본적인 동력 중 하나이다. 일련의 똑같은 음인 AAAAA를 듣는 것 을 상상해 보아라. 각각의 음은 여러분의 뇌의 청각 영역에서 반응을 끌어내지만 음이 반복되면서 그 반 응은 점진적으로 감소한다. 이것은 ‘적응’이라 불리며 당신의 뇌가 다음 사건을 예상하는 것을 배울 것임을 보여 주는 현혹될 정도로 단순해 보이는 현상이다. 갑자기 그 음이 AAAAA#으로 바뀐다. 당신의 일차 청각 피질은 즉시 강한 놀람의 반응을 보이는데, 즉 적응이 점차 사라질 뿐만 아니라 예상치 못한 소리에 대한 반응으로 추가적인 뉴런이 힘차게 활성화되기 시작한다. 그리고 적응을 유발하는 것은 단순한 반복4 이 아니라, 중요한 것은 그 음이 예측 가능한지이다. 예를 들어 만약 당신이 ABABA와 같이 한 세트의 교차하는 음을 듣는다면, 당신의 뇌는 이 교차에 익 숙해지고, 당신의 청각 영역 내 활동은 다시 감소한 다. 그러나 이번에는 놀람의 반응을 일으키는 것은 바로 ABABB와 같은 예상치 못한 반복이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "‘감염’에 취약하게 만든다. 금융상의 실패는 독감처럼 퍼지면서 채무자에서부터 은행, 보증인까지 나아갈 수 있다. 그러나 시장에서의 그러한 감염에 관한 예 상치 못한 특징들이 있다. 감염이 심지어 어떤 접촉 없이도 일어날 수 있다. 은행은 어떠한 투자에 실패 하지 않고도 지급 불능이 될 수 있다. 어떤 나쁜 투 자들 때문에 일어나는 연속된 실패처럼 금융 시장에 두려움과 불확실성은 손해를 끼칠 수 있다. 만약 우 리 모두가 내일 깨어나서 X은행이 지급 불능이 될 것 이라고 믿는다면, 그것은 지급 불능이 될 것이다. 사 실 우리가 다른 사람들이 X은행이 실패할 것이라고 믿고 있다는 것을 무서워하거나 단지 우리의 집단적 인 두려움을 무서워하는 것으로 충분할 것이다. 우리 모두가 심지어 X은행이 건전한 투자로 잘 운영된다는 것을 알지라도 만약 우리가 다른 사람들이 그들의 돈 을 인출해 갈 것이라고 예상한다면, 그러면 우리는 자신의 돈을 인출하는 마지막 사람이 되는 것을 무서 워 할 것이다. 재정적인 고통은 자기충족적일 수 있 고 금융 시장에서의 특별히 골치 아픈 측면이다."
    ],
    "tags": [
      "#경제",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "림없이 그것들을 먹을 수 없다는 점에서 음수는 양수보 다 훨씬 더 추상적이지만 여러분은 그것들을 생각할 수 있으며, 채무에서부터 몹시 차가운 기온, 주차장과 씨 름하는 것에 이르기까지 일상생활의 모든 측면에서 생 각‘해야만 한다’. 여전히 우리들 중 많은 사람들은 음수 와 잘 지내지 못해 왔다. 사람들은 그 두려운 음수의 기호를 피하기 위해 모든 종류의 우스꽝스럽고 사소한 정신적 전략들을 만들어 냈다. 뮤추얼 펀드(계약형 투 자 신탁) 진술에서 손실(음수)은 빨간색으로 인쇄되거 나 음수의 기호가 발견되지 않은 채 괄호 안에 갇혀 있다. 역사책은 우리에게 Julius Caesar가 –100이 아 닌 기원전 100년에 태어났다고 말한다. 주차장의 지 하층은 종종 B1과 B2와 같은 명칭을 가지고 있다. 기 온은 몇 안 되는 예외 중 하나인데 특히 여기 New York의 Ithaca에서 사람들은 바깥의 기온이 –5도라고 말하지만 심지어 그때에도 많은 사람들은 영하 5도라 고 말하길 선호한다. 그 음수의 기호에 관해서는 정말 불쾌하게만 보이는 무언가가 있다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "없다. 인간은 다양한 생활 방식으로 그리고 다양한 환경에서 살고 있다. 따라서 그들은 적절한 실험 대 상이 되기에 충분히 동질적이지 않다. 이러한 ‘교란 변수’는 인간 역학 조사로부터 타당한 인과적 결론을 도출하는 우리의 능력을 손상시킨다. 교란 변수는 역 학자가 연구되고 있는 특정한 변수의 영향을 분리하기 어렵게 만드는 (알려지거나 알려지지 않은) 변수이다. 예를 들어, Taubes는 술을 마시는 많은 사람들이 흡 연도 하기 때문에 연구자들이 알코올 섭취와 암 사이 의 연관성을 결정짓는 데 어려움을 겪는다고 주장했 다. 마찬가지로 유명한 Framingham 연구의 연구자들 은 커피를 마시는 것과 관상 동맥성 심장 질환 사이 에 상당한 상관관계를 확인했다. 그러나 연구자들이 커피를 마시는 많은 사람들이 흡연도 한다는 사실에 대해 수정을 하자 이러한 상관관계의 대부분은 사라 졌다. 교란 변수들이 알려져 있다면 그것들을 수정하 는 것이 종종 가능하다. 그러나 그것들이 알려져 있 지 않다면, 그것들은 우리가 역학 조사로부터 도출하 는 인과적 결론의 신뢰성을 손상시킬 것이다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "롭거나 더 이해하기 어려운 것은 없다. 사람들의 행 동을 자극하는 질투를 실제로 알아차리는 것은 매우 어렵다. 이러한 모호함의 이유는 간단한데, 우리는 우리가 느끼고 있는 질투를 대부분 절대 직접적으로 표현하지 않는다. 질투는 우리가 가치 있게 여기는 무언가에서 우리가 또 다른 사람보다 열등하다는 스 스로에 대한 인정을 수반한다. 이 열등감을 인정하는 것은 고통스러울 뿐만 아니라 우리가 이것을 느끼고 있다는 것을 다른 사람들이 알게 되는 것은 훨씬 더 나쁘다. (질투는 질병을 유발할 수도 있는데 왜냐하 면 질투하는 사람이 무의식적으로라도 그들이 시기 하는 사람에게 ‘증오에 찬 눈초리’를 보낼 수 있거나 질투심이 강한 사람이 그 감정 때문에 건강이 나빠 질 수 있기 때문이다.) 그래서 우리가 최초의 질투심 을 경험하는 거의 즉시, 우리는 그것을 우리 자신에 게 감추고자 하게 되는데, 즉 그것은 우리가 느끼는 질투가 아니라 재산의 분배나 관심에 대한 불공평함, 이 불공평함에 대한 분개, 심지어 분노이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "게 하기에 충분한 항영양소가 있는 식물을 섭취하면 그 동물은 그 식물을 다시는 먹지 않을 것이다. 직관적으 로 동물은 또한 이러한 식물을 멀리할 줄 안다. 오랜 시간의 진화와 전해 내려오는 정보는 이 타고난 지능을 만들어 냈다. 그러나 이 ‘직관’은 동물에게서만 보이는 것은 아니다. 여러분은 대부분의 아이들이 왜 야채를 싫어하는지 궁금해 한 적이 있는가? Dr. Steven Gundry는 이것을 우리의 유전적 프로그래밍, 즉 우리 의 내적 지능의 일부로 정당화한다. 많은 야채들이 항 영양소로 가득 차 있기 때문에 여러분이 아직 연약하 고 성장 중에 있을 때 여러분의 몸은 여러분을 그것들 로부터 멀리하게 하려고 노력한다. 그것은 여러분의 미뢰(味蕾)로 하여금 이러한 맛을 나쁘고 심지어 역겨 운 것으로 인식하게 만듦으로써 이를 수행한다. 여러 분이 성장하고 여러분의 신체가 이러한 항영양소를 견딜 만큼 충분히 더 강해지면 갑자기 그것들은 더 이상 이전만큼 맛이 나쁘게 느껴지지 않는다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "뇌가 우리를 속이는 일관성 있는 (그러나 반드시 사실 은 아닌) 이야기를 만들어 내는 데 있어 탁월하다는 것을 보여 주는 연구를 수행했다. 그 연구에서 분리5 뇌 환자들에게 그들의 왼쪽 눈에만 보이도록 이미지 를 보여 주고 그들의 왼손으로 관련 있는 카드를 선 택하도록 요청했다. 왼쪽 눈의 시력과 왼쪽 몸의 움 직임은 우뇌에 의해 제어된다. 분리 뇌 환자에게 있 어 우뇌와 좌뇌 사이의 연결은 끊어졌으며 이는 한 쪽 뇌에서 다른 쪽 뇌로 정보가 건너갈 수 없다는 것을 의미한다. 따라서 이 실험에서 우뇌가 모든 작 업을 수행하고 있었고, 좌뇌는 무슨 일이 일어나고 있는지 알고 있었다(→ 알지 못하고 있었다). Gazzaniga는 그 후 참가자들에게 그들이 선택했던 그 카드를 왜 선택했는지 질문했다. 언어는 좌뇌에서 처리되고 생성되기 때문에 좌뇌가 응답하도록 요구 된다. 그러나 그 실험의 설계 때문에 오직 우뇌만이 왜 그 참가자가 그 카드를 선택했는지 알고 있었다. 결과적으로 Gazzaniga는 참가자들이 질문에 답할 것 을 요청받았을 때 침묵할 것이라고 예상했다. 하지만 그 대신에 모든 피실험자는 응답을 꾸며 냈다. 좌뇌 는 우뇌에 의해 행해진 행동에 대한 설명을 제공하 라는 요청을 받고 있었다. 좌뇌는 답을 알지 못했다. 그러나 그것이 좌뇌가 답을 꾸며 내는 것을 막지는 못했다. 하지만 그 대답은 사실 근거를 가지고 있지 않았다. 자, 만약 이 연구가 분리 뇌 환자에만 제한 됐었다면, 그것은 흥미롭지만 우리와 매우 관련 있는 일은 아닐 것이다. 분리 뇌 환자들이 이유를 꾸며 내 는 유일한 사람이 아닌 것으로 드러난다. 우리 모두 그렇게 한다. 우리 모두는 자신에 대한 일관성 있는 이야기를 필요로 하고 그 이야기에서 정보가 빠져 있을 때, 우리의 뇌는 단순히 세부 사항을 채운다."
    ],
    "tags": [
      "#경제",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "단지 연습 경기이기는 했지만 농구공은 마치 Chanel의 손에 속한 것처럼 느껴졌다. 그녀는 그녀의 쌍둥이 자매인 Vasha에게 공을 패스하지 않기로 결심 했다. 그 대신에 그녀(Chanel)는 멈추고, 점프하 여 공을 골대 쪽으로 던졌지만 그것은 백보드를 맞고 튕겨 나갔다. Chanel은 팀원들이 실망하는 것을 볼 수 있었다. 상대 팀이 공을 가져가서 이내 득점했고 경기가 끝났다. 연습 경기가 끝났을 때, Chanel은 그녀의 눈이 눈물 로 따끔거리는 것을 느꼈다. “괜찮아,” Vasha가 위로 하는 목소리로 말했다. Chanel은 그녀에게 고마움을 느꼈지만 Vasha가 그녀의 기분을 더 나아지게 해 주 지는 않았다. Vasha는 그녀의 쌍둥이가 향상하는 것 을 돕고 싶었다. 그녀는 그녀의 쌍둥이에게 자신 (Vasha)과 함께 연습하자고 권유했다. 방과 후에 그 들은 그들의 농구공을 가지고 그들의 농구 슛을 연습 하기 시작했다. 처음에 Chanel은 Vasha가 슛을 할 때마다 그것이 들어갔기 때문에 Vasha와 연습하는 것을 좋아하지 않 았다. 하지만 Chanel의 차례마다 그녀는 슛을 넣지 못했다. 그녀(Chanel)는 슛을 넣지 못한 것에 좌 절했다. “포기하지 마!” 각각의 슛이 실패한 후에 Vasha가 외쳤다. 12번의 연이은 실패 후에 그녀의 13번째 슛이 들어갔고, 그녀가 “마침내 내가 해냈어!” 라고 외쳤다. 그녀의 쌍둥이가 “나는 네(Chanel) 가 해낼 줄 알았어! 자, 계속 연습하자!”라고 말했다. 다음날 Chanel은 라이벌 학교와의 챔피언십 경기 에 출전했다. 그것은 팽팽한 경기였고 Chanel이 경기 에서 10초가 남은 상황에서 Vasha에게 공을 패스받 았을 때 점수는 동점이었다. 그녀(Chanel)는 공 중으로 뛰어올라 공을 던졌다. 그것은 곧바로 골대 안으로 들어갔다! Chanel의 마지막 슛은 그녀의 팀 을 우승팀으로 만들었다. Vasha와 모든 다른 팀원들 은 그녀에게 환호를 보냈다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "동했는지를 ‘파악하기’ 위해 심리학자 역할을 하려 고 자주 노력한다. 그들의 관점을 이해하기 위해 직원들과 공감하는 것은 매우 도움이 될 수 있다. 하지만, 특히 문제 영역을 다룰 때, 그것은 잘하지 못하는 사람이 아니라 근무 중에 보여지는 행동이 라는 것을 기억하라. 직원들에게 그들이 바꿔야 할 인격적 특성에 대해 제안하는 것을 피하라. 대신에 더 용인되는 수행 방법을 제안하라. 예를 들어, 관 리자는 어떤 사람의 ‘신뢰할 수 없음’에 초점을 맞 추는 대신, 그 직원이 ‘이번 달에 회사에 일곱 번 지각했다’는 사실에 초점을 맞출 수도 있을 것이다. 직원들은 자신이 어떤 사람인지를 바꾸기는 어렵 다. 일반적으로 자신이 행동하는 방식을 바꾸기가 훨씬 쉽다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "더 앞서 ‘생각한다’고 짐작한다. 나무들 사이에서 각 종은 다른 종들과 싸운다. 중부 유럽 태생의 너 도밤나무가 그곳의 숲 대부분에서 우세하게 나타날 수 있다고 가정해 보자. 이게 정말 이점일까? 만약 대부분의 너도밤나무를 감염시켜 죽게 만드는 새로 운 병원균이 나타나면 어떻게 될까? 그런 경우, 주 변에 참나무, 단풍나무 또는 전나무와 같은 일정한 수의 다른 종이 계속 자라서 새로운 세대의 어린 너도밤나무가 싹을 틔우고 자라는 데 필요한 그늘 을 제공한다면 더 유리하지 않을까? 다양성은 오래 된 숲에 안전을 제공한다. 균류도 또한 안정적인 조건에 매우 의존하기 때문에, 그들은 한 종의 나 무가 우세해지지 않도록 확실히 하기 위해 땅 속에 서 다른 종을 지원하고 그것들을 완전한 붕괴로부 터 보호한다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "날 정도로 우리가 긴장을 푸는 데 도움이 된다는 것은 주목할 만하다. 만약 여러분이 긴장을 풀고 싶다면, 심호흡하거나, 마사지를 받거나, 산책을 할 수도 있지만, 단순히 눈을 감고 여러분이 누릴 지도 모를 미래의 결과에 대해 상상해 볼 수도 있 다. 하지만 여러분의 목표가 소망을 실현하는 것 인 경우라면 어떨까? 여러분이 ‘가장 피해야 할’ 상태는 긴장이 풀려 있는 것이다. 여러분은 소파 에서 일어나 체중을 감량하거나 직업을 찾거나 시 험공부를 할 수 있을 만큼 충분히 활력을 얻어야 하고, 피할 수 없는 장애물이나 문제가 발생할 때 도 계속 전념할 수 있도록 충분히 동기 부여 되어 야 한다. ‘그것을 꿈꿔라. 그것을 소망하라. 그것 을 실행하라.’라는 원칙은 사실이 아니며, 우리는 이제 그 이유를 안다. 그것을 꿈꾸는 중에, 여러 분은 그것을 하는 데 필요한 에너지를 약화시킨 다. 여러분은 스스로를 완전한 행복, 고요, 그리고 비활동의 일시적인 상태에 빠지게 한다."
    ],
    "tags": [
      "#철학",
      "#과학"
  ...
  },
  {
    ...
    "translation": [
      "하는 것만큼 요리가 인간의 정체성, 생물학 및 문 화에 중요하다면, 우리 시대의 요리 감소가 현대 생활에 심각한 결과들을 초래한다고 추론하는 것 은 당연하고, 실제로 그래왔다. 그것들이 모두 나 쁜가? 전혀 그렇지 않다. 요리하는 일의 많은 부 분을 기업에 아웃소싱하는 것은 전통적으로 여성 들에게 한정된, 가족들을 먹여야 하는 책임이었던 것에서 여성들을 벗어나게 했고, 그들이 집 밖에 서 일하고 직업을 갖는 것을 더 쉽게 했다. 그것 은 성 역할과 가족 역학의 그렇게 큰 변화가 촉발 할 많은 가정 내 갈등을 막아냈다. 그것은 더 긴 근무일과 분주한 자녀를 포함하여 가정의 다른 곤 란을 덜어주었고, 이제 우리가 다른 일에 투자할 수 있도록 시간을 절약해 주었다. 그것은 또한 우 리의 식단을 상당히 다양하게 해주었고, 요리 기 술이 없고 돈이 거의 없는 사람들까지도 완전히 색다른 요리를 즐길 수 있게 해 주었다. 필요한 것이라곤 전자레인지뿐이다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "떻게 구매하는지는 정치적일 수 있다. 여러분은 여러분의 돈을 누구에게 주고 싶은가? 여러분은 어떤 회사와 기업을 가치 있게 여기고 존중하는 가? 우리의 지원을 받을 자격이 있는지를 결정하 기 위해 우리의 돈을 가져가는 기업들을 면밀히 조사함으로써 모든 구매에 주의를 기울여라. 그들 은 환경을 오염시킨 기록이 있는가, 아니면 그들 이 만든 제품에 대한 공정 거래 관행과 제품 수명 종료 계획이 있는가? 그들은 세상에 득이 되는 것 에 헌신하고 있는가? 예를 들어, 우리 가족은 사 회적 양심을 가지고 재활용되고 플라스틱 포장이 없는 화장지를 생산하는 회사를 발견했다. 그들은 수익의 50%를 전 세계 화장실 건설에 기부하고 우리는 이 특별한 화장지에 매달 돈을 쓸 수 있어 서 정말 기쁘다. 기업의 세계는 소비자를 기반으 로 구축되므로, 소비자로서 여러분은 지갑으로 투 표하고 여러분이 선택한 모든 구매를 통해 회사들 이 더 건강하고 더 지속 가능한 관행을 받아들이 도록 장려할 힘이 있다는 것을 기억하라."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "것은 의심할 여지가 거의 없다. 일단 어떤 품목이 그 기한을 지나면 폐기물 흐름으로 들어가고, 이 는 그것의 탄소 발자국을 더욱더 증가시킨다. 그 러한 품목들이 선반에 도달하기 위해 이미 수백 마일을 이동했고 일단 그것들이 버려지게 되면 그 것들은 새로운 탄소 마일 여정을 시작한다는 것을 기억하라. 그러나 우리 모두는 판매 유효 기한에 대해 자신만의 판단을 내린다. 가령, 제2차 세계 대전 중에 자란 사람들은 그들이 생각하기에 그러 한 경고가 조장하는 끔찍한 낭비를 자주 경멸한다. 식품 제조업자는 무엇인가를 만들거나 재배할 때 제품이 선반에 도달할 때에는 그것은 이미 매우 오랫동안 그리고 아마도 상당한 거리를 이동해 왔 다는 관점을 가지고 있다. 그래서 제조업자는 제 품이 이를테면 90일 이내에는 무리 없이 소비될 수 있고 90일에서 이동에 필요한 많은 날들을 뺀 것이 판매 유효 기한이 된다고 결정한다. 그러나 그것이 유독해지는지는 각 개인이 결정할 수 있는 것이다. 큰 묶음의 상하기 쉬운 제품을 사지 않는 것이 이치에 맞는 것으로 보이겠지만, 상하지 않 는 품목들의 경우에는 비용 효율이 높아질 수도 있다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "카페인은 여러분의 간 안에 있는 효소에 의해 여 러분의 신체로부터 제거되는데, 이 효소는 시간이 지남에 따라 그것을 점진적으로 분해한다. 대체로 유전적 특징 때문에, 어떤 사람들은 카페인을 분 해하는 더 효율적인 형태의 효소를 갖고 있는데, 이는 간이 그것을 혈류로부터 더 빠르게 제거할 수 있도록 한다. 이 몇 안 되는 사람들은 저녁과 함께 에스프레소를 마시고도 아무 문제 없이 한밤 중에 깊이 잠들 수 있다. 그러나 다른 사람들은 더 느리게 작용하는 형태의 효소를 가지고 있다. 그들의 신체가 같은 양의 카페인을 제거하는 데 훨씬 더 오랜 시간이 걸린다. 결과적으로, 그들은 카페인의 효과에 매우 둔감하다(→ 민감하다). 아 침에 마시는 한 잔의 차나 커피는 그날 대부분 동 안 지속될 것이고, 심지어 이른 오후라도, 두 번 째 잔을 마신다면, 그들은 저녁에 잠드는 것이 어 렵다는 것을 알 것이다. 노화는 또한 카페인 제거 속도를 변화시킨다. 즉, 우리가 나이가 들수록 우 리의 뇌와 신체가 카페인을 제거하는 것이 더 오 래 걸리고, 따라서 우리는 노후에 카페인의 수면 을 방해하는 효과에 더 민감해진다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "도 모르지만, 영리한 마케터들은 나머지 우리에게 그러듯이 그들에게 영향을 준다. “모두가 그것을 하고 있다.”라고 말하는 것은 일부 사람들로 하여 금 어떠한 생각에 대해 흥미를 잃게 할지도 모른 다. 이 사람들은 대안을 찾을 것이고, 그것은 (만 약 영리하게 계획된다면) 정확히 마케터나 설득자 가 여러분이 믿기를 원하는 것일 수 있다. 만약 내가 여러분이 한 아이디어를 고려하길 바라고, 여러분의 독립성과 유일성을 유지하기 위해 대중 적인 의견을 강하게 거부한다는 것을 안다면, 나 는 대다수가 선택하는 것을 먼저 제시할 것이고, 여러분은 내가 실제로 선호하는 것에 맞게 그것을 거부할 것이다. 우리는 반항의 입장을 유지하려고 할 때 종종 속는다. 사람들은 우리가 그들의 목적 에 맞는 선택지를 ‘독자적으로’ 택하도록 만들기 위해 이러한 반전을 사용한다. 일부 브랜드들은 주류에 대한 우리의 반항을 완전히 활용하여 스스 로를 반항자로 자리매김해 왔고, 이는 훨씬 더 강 력한 브랜드 충성도를 만들어 왔다."
    ],
    "tags": [
      "#경제"
    ],
  ...
  },
  {
    ...
    "translation": [
      "어내며, 그 세계에서는 프로그램 제작자들의 마음 속에만 먼저 존재하고 그러고 나서 시청자의 마음 속에 재현되는 허구의 캐릭터들을 매우 복잡한 관 계망이 연결한다. 만약 줄거리를 따라가고 그것에 대해 추측하기 위해 시청자가 얼마나 많은 인간 심리학, 법, 그리고 심지어 일상에서의 물리학을 알아야 하는지에 대해 생각한다면, 여러분은 그것 이 상당하다는 것을, 즉 적어도 현대 수학의 한 부분을 따라가고 그것에 대해 추측하는 데 필요한 지식만큼이라는 것, 그리고 대부분의 경우 훨씬 더 많다는 것을 발견할 것이다. 하지만 시청자들 은 드라마를 쉽게 따라간다. 그들은 어떻게 그런 추상에 대처할 수 있을까? 왜냐하면, 당연하게도, 그 추상은 매우 친숙한 틀 위에서 만들어졌기 때 문이다. 드라마 속 인물들과 그들 사이의 관계는 우리가 매일 경험하는 실제 사람들 및 관계와 매 우 흡사하다. 드라마의 추상은 현실 세계에서 불 과 한 걸음 떨어져 있다. 드라마를 따라가기 위해 필요한 정신적 ‘훈련’은 우리의 일상에 의해 제공 된다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "먹잇감은 수백만 년 동안 생사를 가르는 감각 군 비 경쟁에 참여해 왔다. 나방의 청력은 특히 박쥐 에게 잡아먹히는 위협에 대한 반응으로 생겨난 것 으로 여겨진다. (모든 곤충이 들을 수 있는 것은 아니다.) 수백만 년 동안, 나방은 계속 더 높아진 주파수의 소리를 감지하는 능력을 진화시켰고, 그 것들이 그렇게 함에 따라 박쥐의 발성 주파수도 높아졌다. 일부 나방 종은 또한 날개의 비늘과 몸 에 모피와 같은 외피를 진화시켰다. 둘 다 ‘음향 위장’의 역할을 하는데, 박쥐에 의해 방출되는 주 파수의 음파를 흡수함으로써, 그것으로 음파가 되 돌아가는 것을 방지한다. B2 폭격기와 그 밖의 ‘스텔스’ 항공기는 레이더 전파에 대해 유사한 것 을 하는 재료로 만들어진 기체를 가지고 있다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "나머지는 처리하기 쉬운 상태로 분류하도록 설계 된다. 특히 문화와 사회에서 이용할 수 있는 엄청 난 양의 정보를 고려할 때, 우리의 감각에서 오는 데이터의 유입은 압도적인 혼란을 야기할 수 있 다. 모든 감각적 인상과 가능한 정보 중에서, 우 리의 개인적인 필요와 가장 관련이 있는 소량을 찾고 그것을 사용 가능한 지식체로 구성하는 것이 중요하다. 예상들은 이 작업의 일부를 수행하여 예상되는 것과 무관한 정보를 걸러내는 데 도움이 되고, 명확한 모순에 우리의 주의를 집중시킨다. 학습과 기억의 과정은 정보의 지속적인 제거로 특 징지어진다. 사람들은 그들 주변 세계의 일부분만 을 인지한다. 그런 다음, 그들이 알아차린 것의 일부만 처리되어 기억에 저장된다. 그리고 기억에 넘겨진 것의 일부만 생각해 낼 수 있다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "럽의 통치자들이 매우 오랫동안 현저하게 약했기 때문에 그것이 번성하고 번영했다는 것이다. 로마 의 멸망 후 천 년 넘게, 유럽의 통치자들은 백성 들이 생산하고 있었던 것을 평가하고 이를 바탕으 로 상당한 세금을 부과할 능력이 부족했다. 유럽 의 약함을 설명하는 가장 눈에 띄는 방법은 그들 이 거둔 세입이 얼마나 적은지를 보여주는 것이다. (이러한 이유로, 유럽의 세금 징수원은 막대한 액 수의 세입을 거둘 수 있었고 따라서 사회가 어떻 게 기능해야 하는지에 큰 영향을 미쳤다.) 유럽인 들은 결국 강력한 세입 징수 시스템을 개발했지만, 그렇게 하는 데는 엄청나게 오랜 시간이 걸렸다. 중세와 초기 근대의 일부 동안, 중국의 황제들과 이슬람 문명의 칼리프들은 작은 도시 국가들을 제 외한 어떤 유럽 통치자들보다 경제적 생산물에서 훨씬 더 많은 것을 얻어낼 수 있었다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "content": [
      "If you drive down a busy street, you will find many\ncompeting businesses, often right next to one another.\nFor example, in most places a consumer in search of a\nquick meal has many choices, and more fast food\nrestaurants appear all the time. Yes, costs rise, but consumers also gain information to\nhelp make purchasing decisions. Consumers also benefit\nfrom added variety, and we all get a product that’s\npretty close to our vision of a perfect good — and no\nother market structure delivers that outcome. However, this misconception doesn’t account for why\nfirms advertise. In markets where competitors sell\nslightly differentiated products, advertising enables firms\nto inform their customers about new products and\nservices. These competing firms advertise heavily. The temptation\nis to see advertising as driving up the price of a\nproduct without any benefit to the consumer. - - - - - - - - - -"
    ],
    "translation": [
      "여러분은 자주 서로의 바로 옆에서 경쟁하는 많은 업체들을 발견할 것이다. 예를 들어, 대부분의 장 소에서 빠른 식사를 찾는 소비자는 많은 선택권을 가지고 있고, 더 많은 패스트푸드 식당들이 항상 나타난다. 이 경쟁하는 회사들은 광고를 많이 한다. 광고를 소비자에게 어떤 혜택도 없이 제품 의 가격을 올리는 것으로 보기 쉽다. 그러나 이러한 오해는 회사들이 광고하는 이유를 설명하 지 않는다. 경쟁사들이 약간 차별화된 제품들을 판매하는 시장에서, 광고는 회사들이 그들의 소비 자들에게 새로운 제품과 서비스를 알릴 수 있게 해 준다. 물론 가격이 상승하기는 하지만, 소 비자들은 구매 결정을 내리는 데 도움이 되는 정 보도 얻는다. 소비자들은 또한 추가된 다양성으로고 2 정답 및 해설 2023학년도 9월 전국연합학력평가 14 28 부터 혜택을 얻고, 우리 모두는 완벽한 제품에 대 한 우리의 상상에 매우 근접한 제품을 얻는데, 다 른 어떤 시장 구조도 그러한 결과를 제공하지 않 는다."
    ],
    "tags": [
      "#경제",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "2006년에 연구자들은 미국을 향한 9.11 테 러 공격 이후에 도움을 주려는 동기에 대한 연 구를 수행했다. 그 연구에서, 그들은 타인에게 초점을 맞춘 동기(다른 사람의 곤란을 줄이기 위해 베푸는 것) 때문에 돈, 혈액, 물품, 또는 다른 형태의 도움을 주었던 사람들이 자신의 고통을 줄이는 것이 원래 동기였던 사람들보다 일 년 후에도 여전히 지원을 제공할 가능성이 거의 네 배 더 높다는 것을 발견했다. 이 결과 는 감정적 자극의 차이에서 비롯된 것 같다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "면 더 만족할 것이라고 여러분의 아이들을 설득하 는 것만으로는 그들이 걱정하는 것을 멈추게 하지 않을 것이다. 어떤 이유로, 아이들은 걱정이 자신고 2 정답 및 해설 2024학년도 9월 전국연합학력평가 12 28 이 거의 통제할 수 없거나 아예 통제할 수 없는 삶의 사실이라고 믿는 것 같다. 결과적으로, 그들 은 멈추려고 노력하지도 않는다. 따라서, 여러분 은 걱정이 죄책감과 두려움처럼 감정에 지나지 않 고, 모든 감정과 같이 의지의 힘에 영향을 받기 쉽다고 그들을 설득할 필요가 있다. 아이들에게 단순히 걱정에 주의를 기울이려 하지 않음으로써 그들이 자신의 삶으로부터 걱정을 없앨 수 있다는 것을 알려주어라. 아이들에게 그들이 어떻게 느끼 는지와 상관없이 걱정하며 행동하는 것을 거부한다 면, 그들은 결국 걱정하는 것을 멈추고 걱정 없는 삶을 수반하는 만족감을 경험하기 시작할 것이라고 설명하라."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "에서 목표는 더 이상 오류 방지와 반복 가능성이 아니다. 반대로, 그것은 창의성, 속도 그리고 명민 함이다. 산업화 시대에서, 목표는 변화를 최소화 하는 것이었다. 그런데 오늘날의 창의적 기업에서 는 변화를 극대화하는 것이 더 필수적이다. 이러 한 상황에서, 가장 큰 위험은 실수를 하거나 일관 성을 잃는 것이 아니라, 가장 재능 있는 사람을 끌어들이는 것, 새로운 제품을 만드는 것, 혹은 상황이 변할 때 방향을 빠르게 바꾸는 것에 실패 하는 것이다. 일관성과 반복 가능성은 여러분의 회사에 이익을 가져오기보다 새로운 생각을 짓누 를 가능성이 더 높다. 많은 작은 실수는 때때로 고통스럽지만, 조직이 빠르게 배우는 것을 돕고 혁신 주기의 중요한 부분이다. 이러한 상황에서, 규칙과 과정은 더 이상 최선의 답이 아니다. 교향 악단은 여러분이 추구하는 것이 아니다. 지휘자와 악보는 내버려 두어라. 대신 재즈 밴드를 구성하라."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "을 내리도록 하고 이것은 정보를 요한다. 재난 상 황 중에는 소통이 매우 중요해서 보통의 사회적 장벽이 자주 낮아진다. 우리는 평상시에는 전혀 고려하지 않을 방식으로 낯선 사람에게 말을 걸 것이다. 소방 훈련이나 매우 연착된 기차와 같은 우리 삶에서의 비교적 낮은 수준의 혼란조차도 보 통의 에티켓을 어기고 낯선 사람에게 말을 거는 것을 허용해 주는 것처럼 보인다. 어떠한 사건이 특정 사람들에게 중요할수록, 소식에 대한 요구가 더 상세하고 긴박해진다. 그것이 신문이든 신뢰할 만한 방송국이든, 사실에 대한 공신력 있는 출처 없이, 소문은 자주 제멋대로 뻗어 나간다. 소문은 사람들이 자신이 속한 집단이 위험에 처해 있다고 믿어서, 입증되지 않은 소문임에도 불구하고, 이 를 전달해야 한다고 생각하기 때문에 시작된다. 예를 들어, 한 근로자가 그의 고용주의 사업이 잘 안되어서 사람들이 해고될 것이라고 들으면, 그들 은 그 정보를 동료들에게 전달할 것이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "장소에 특유한 특정 문화적 전통, 특정 공유 지식, 그리고 특정 가치와 아이디어에 기반한(또는 이에 반하는) 문화적 활동이라고 인식하는 것 같다. 하 지만 과학의 경우에는 의견이 갈린다. 위대한 생 물학자 J. B. S. Haldane과 같은 일부 과학자들은 유사한 관점에서 과학을 보는데, 특정한 시기와 장소에서 발생하고 그 맥락 안에서 이해될 필요가 있는 역사적 활동으로 보는 것이다. 하지만 다른 사람들은 과학을 그것을 만들어 내는 사람들의 문 화적 관점과 가치에 의해 영향을 받지 않는 순전 히 ‘객관적인’ 일로 본다. 과학에 대한 이러한 관 점을 묘사할 때, 철학자 Hugh Lacey는 단순히 거 기에 있어서 발견되는 세계의 근원적인 질서가 있 다는 믿음에 대해 말하는데, 이것은 가치와 어떠 한 연관도 없는 순전한 ‘사실’의 세계이다. 이러한 관점에 따라 과학의 목적은 이러한 순전한 ‘사실’ 의 세계를 나타내는 것인데, 그것이 인간의 관습 및 경험과 혹여라도 맺을 수 있는 어떠한 관계와 도 무관하게 말이다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "범과 신호를 스스로 습득하는 것으로 이루어지는 데, 그들은 더 유능한 개인들, 일반적으로 성인들 의 도움을 받는 사회적 상황에서만 이를 습득할 수 있다. 이러한 의미에서 정신적 발달은 사회적 양식 을 내면화하고 다른 책임 있는 행위자들 사이에서 점차 책임 있는 행위자가 되는 것으로 이루어진다. 덴마크에서 형사 책임 연령은 15세인데, 이는 그러 면 우리가 사람들이 이 시점에서 자신의 행위에 책 임을 지기에 충분한 정신적 성숙을 발현했다고 말 할 수 있음을 의미한다. 그리고 18세에 사람들은 투표권을 받고, 그것에 의해 기본적인 민주적 과정 에 공식적으로 포함된다. 나는 이러한 연령 경계가 최적인지는 모르겠지만, 정신적 발달이 다른 개인 에게 다른 속도로 일어나고, 특히 그들에게 주어져 있는 사회적 환경과 가정 환경에 따라 달라진다는 것은 분명하다. 따라서 특정 연령부터 모든 사람에 게 적용되는 책임에 대한 공식적인 제한을 두는 것 은 다소 의심스러운 관행이다. 그러나 물론 문제는 그것이 조금이나마 다르게 행해질 수 있는지이다."
    ],
    "tags": [
      "#심리학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "우리가 태양을 공전하는 하나의 행성에 사는 거주 자일 뿐이라고 이해하는 관점으로 바뀌었을 때 잘 알려진 한 가지 변화가 일어났다. 태양계의 관점 을 이해하는 각각의 사람이 있어서, 그 다음 사람 이 그렇게 하는 것이 더 쉬워졌다. 세계가 인간의 경제를 중심으로 돌아간다는 개념도 마찬가지이 다. 이것은 경제가 모든 생명체를 연결하는 물질 흐름의 더 거대한 시스템의 일부라는 관점으로 서 서히 대체되고 있다. 이러한 관점이 바뀌어 자리 를 잡으면, 우리의 경제적 안녕이 우리가 생태학 적 건강의 요인에 책임지고, 대응하는 것을 필요 로 한다는 것이 분명해질 것이다. 불행하게도 우 리는 변화를 만들어 낼 한두 세기의 시간이 없다. 오래된 관점과 새로운 관점의 본질을 명확히 하 고, 그 과정을 진전시키기 위해 협력할지도 모를 행동을 밝힘으로써 우리는 그 변화를 가속화하는 데 도움을 줄 수 있다."
    ],
    "tags": [
      "#철학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "가능한 열대 지역에서 진화했다. 밝은 피부는 강 렬한 태양 광선에 대한 보호를 거의 제공하지 못 했을 것이기 때문에 그들은 매우 어두운 피부를 가졌을 가능성이 있다. 이 사람들이 세계의 다른 지역으로 퍼져나갔는지, 아니면 대신에 사람들이 세계의 다른 지역에서 독립적으로 발생했는지에 대해서는 논쟁이 있다. 어느 경우이든, 언젠가 그 들은 아프리카에서부터, 결국 세계 대부분의 지역 으로 퍼져 나갈 수 있게 되었다고 믿어진다. 이것 은 아마도 그들의 신체적 특성이 바뀌었기 때문일 것이다. 예를 들어, 초기 인류는 아마도 직립 보 행을 하지 않았을 것이지만, 그들이 그 능력을 발 달시켰을 때, 그들은 더 효율적으로 이동할 수 있 었다. 더 중요한 것은 아마도 그들의 도구 제작의 발달이었다. 도구를 이용하여, 그들은 다른 동물 을 사냥할 수 있어서, 그들의 저에너지 채식 식단 이 제공했을 것보다 더 많은 단백질과 지방을 섭 취할 수 있었다. 그들의 신체뿐만 아니라 뇌도 더 많은 에너지와 함께 변화되었을 것이다. 뇌는 성 장하기 위해 많은 에너지가 필요하다. 초기 인류 의 식단이 축소되면서(→ 확장되면서) 그들은 신 체적으로 그리고 지적으로 그들의 영역을 확장할 수 있었다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "서 우리가 ‘가장 듣고 싶지 않은’ 말은 그 과정이 공정했다는 말이다. 불리한 결과와 불공정한 과정 의 결합이 분노를 불러일으키지만, 이 결합은 또 한 위로의 상, 즉 나쁜 결과를 우리 자신 이외의 다른 무언가의 탓으로 돌릴 가능성을 더불어 가져 다준다. 우리는 우리의 나쁜 결과가 우리와는 거 의 관련이 없었고 불공정한 과정과 전적으로 관련 이 있었다고 믿음으로써 우리 자신을 안심시킬지 도 모른다. 하지만 그 과정이 공정하다면, 우리는 결과를 거의 마찬가지로 쉽게 외부화할 수 없으 며, 우리는 우리가 얻은 것을 ‘정정당당하게’ 얻은 것이다. 그 과정이 공정할 때 우리는 우리의 결과 가 마땅하다고 믿게 되는데, 이는 그 결과를 초래 한 우리 자신(우리가 무엇을 했는지 또는 우리가 누구인지)에 관한 무언가가 틀림없이 있었을 것이 라고 말하는 또 다른 방식이다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "Louis Kroeber는 약 3세기 전으로 거슬러 올라가 판화 복제품을 사용하여 서양의 여성 이브닝 드레 스에 대한 풍부하고 심도 있는 연구를 수행했다. 다양한 기원 때문에 이 판들의 크기를 조정하여, 그는 패션 특징에서의 일정한 요소를 분석해서 직 관적이지도 대략적이지도 않은, 정확하고 수학적 이며 통계적인 연구를 구상할 수 있었다. 그는 여 성 의류를 스커트의 길이와 크기, 목선의 크기와 깊이, 허리선의 높이와 같은 몇 가지 특징들로 정 리했다. 그는 패션이 매년 일어나는 변화의 수준 이 아니라 역사의 척도에 위치하는 매우 규칙적인 현상이라는 것을 분명하게 보여주었다. 거의 300 년 동안 여성 드레스는 매우 정확한 주기적인 순 환의 영향을 받았는데, 형식은 50년마다 변화의 정점에 도달했다. 어느 한 시기에 스커트가 가장 길었다면 50년 후에 가장 짧아질 것이고, 따라서 스커트는 짧아진 데서 50년 후에 다시 길어지고, 길어진 데서 100년 후에 길어진다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "이 있다. 할 수 있는 사람은 기본을 가르칠 수 없 다고 말하는 것이 더 정확할 것이다. 많은 전문 지식은 명시적이지 않고 암시적이다. 숙달을 향해 더 나아갈수록 여러분은 흔히 기본에 대해 덜 의 식적인 인식을 지닌다. 실험들에 따르면 숙련된 골퍼와 와인 애호가들은 자신의 퍼팅과 시음 기술 을 설명하는 데 어려움을 겪으며, 심지어 그들의 접근 방식을 설명해 달라고 요청하는 것은 그들의 수행에 방해가 되기에 충분하기 때문에 그들은 자 주 자동 조종 상태에 있다. 내가 한 엘리트 다이 버가 공중제비를 4회 반 도는 것을 처음 봤을 때, 나는 어떻게 그렇게 빨리 회전할 수 있었는지 물 었다. 그의 대답은 “그냥 공 모양으로 올라가기만 하면 돼요.”였다. 전문가들은 자주 방법에 대해 직 관적인 지식을 가지고 있지만, 취해야 할 모든 단 계를 분명하게 표현하는 데 고전한다. 그들이 이 것저것 표현하는 것은 부분적으로는 쓰레기로 차 있다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "는 과도한 소금을 넣을 필요 없이 본연의 풍미와 맛을 유지하는 가장 좋은 방법 중 하나일 수 있 다. 이것은 또한 대부분의 영양소, 특히 많은 비 타민과 항산화물질과 같은 가장 민감한 영양소를 유지하는 효율적인 방법일 수 있다. 곡물을 제분 하는 것은 영양소 함량에 크게 영향을 미치는 가 장 가혹한 과정 중 하나이다. 곡물에는 (즉 통밀 가루 또는 플레이크에는) 미량 영양소, 항산화물 질, 그리고 섬유질이 자연적으로 매우 풍부하지만, 제분이 일반적으로 흰 밀가루를 만들기 위해 대부 분의 미네랄, 비타민 그리고 섬유질을 제거한다. (곡물 생산을 늘리려면 화학비료 사용이 최소화되 어야 하고 해충에 강한 곡물 품종이 개발되어야 한다.) 주요 영양소와 섬유질의 그러한 손상은 최 적의 영양소 밀도와 건강 보호를 목표로 하는 지 속 가능한 식단의 맥락에서 더 이상 받아들여질 수 없다. 대조적으로, 다양한 식품의 발효나 곡물 의 발아는 알려진 관심을 받는 전통적이고, 현지 에서 접근 가능하며, 에너지가 적게 들고, 매우 영양가 있는 과정이다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "content": [
      "It would seem obvious that the more competent\nsomeone is, the more we will like that person. By\n“competence,” I mean a cluster of qualities: smartness, the\nability to get things done, wise decisions, etc. If this were true, we might like people more if they\nreveal some evidence of fallibility. For example, if your\nfriend is a brilliant mathematician, superb athlete, and\ngourmet cook, you might like him or her better if, every\nonce in a while, they screwed up. One possibility is that, although we like to be around\ncompetent people, those who are\ntoo competent make us\nuncomfortable. They may seem unapproachable, distant,\nsuperhuman ― and make us look bad (and feel worse) by\ncomparison. We stand a better chance of doing well at our life tasks\nif we surround ourselves with people who know what\nthey’re doing and have a lot to teach us. But the\nresearch evidence is paradoxical: In problemsolving\ngroups, the participants who are considered the most\ncompetent and have the best ideas tend not to be the\nones who are best liked. Why?"
    ],
    "translation": [
      "사람을 더 많이 좋아할 것이라는 점은 명확해 보 일 것이다. 나는, ‘능력’이라는 것을, 똑똑함, 일을 수행하는 능력, 지혜로운 결정 등과 같은 총체적 인 특징을 뜻하는 것으로 말한다. 우리는 자 신이 무엇을 하고 있는지를 알고 우리를 가르칠 많은 것들을 갖고 있는 사람 주변에 있을 때, 우 리의 인생 과업에서 잘할 더 나은 가능성이 있다. 그러나 연구 증거는 역설적이다. 문제 해결 집단 에서, 가장 능력이 있다고 여겨지고 가장 좋은 생 각을 갖고 있는 참여자들은 가장 선호되는 사람들 이 아닌 경향이 있다. 왜 그럴까? 하나의 가 능성은, 비록 우리는 능력 있는 사람들 주위에 있 고 싶어하지만, ‘너무’ 능력 있는 사람들은 우리를 불편하게 만든다는 것이다. 그들은 접근할 수 없 고, 멀고, 초인간적으로 보일 수가 있어서, 비교해 보면 우리가 형편없어 보이게(그리고 기분이 더 나쁘게) 만든다. 만약에 이것이 사실이라면, 사람들이 실수를 저지를 수 있다는 어떤 증거를 드러낼 때 그들을 더 좋아할지도 모른다. 예를 들 면, 여러분의 친구가 훌륭한 수학자, 뛰어난 운동 선수, 그리고 미식 요리사라면, 여러분은 가끔 그 들이 일을 망친다면 그들을 더 좋아할지도 모른 다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "깊은 유사성이 있다. 예를 들어, 바이러스에 감염 된 다른 사람들과 아주 근접해 있거나 어느 정도 근접해 있는 사람들은 그들도 감염될 가능성이 더 높은데, 이는 사람들이 술을 많이 마시는 사람들 과 함께 시간을 많이 보낼 때 술을 과도하게 마실 가능성이 더 높은 것과 마찬가지이다. 하지만 두 종류의 전염 사이에 중요한 차이점들도 있다. 한 가지는 가시성이 행동의 전염을 촉진하지만, 감염 성 질병의 확산은 억제한다는 것이다. 예를 들어,고 2 정답 및 해설 2024학년도 9월 전국연합학력평가 14 28 거리에서 볼 수 있는 태양 전지판은 이웃의 설치 를 북돋을 가능성이 더 높다. 대조적으로, 우리는 눈에 띄게 몸이 아픈 다른 사람들을 피하려고 노 력한다. 또 다른 중요한 차이는 바이러스성의 전 염은 거의 항상 나쁜 것인 반면, 행동의 전염은 흡연의 경우와 같이, 때로는 부정적이지만, 태양 전지판 설치의 경우와 같이, 때때로 긍정적이라는 것이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "가지 호기심을 끄는 사실은 동면하고 있는 동물들 또한 잠자는 기간을 가진다는 점이다. 그것은 우 리 대부분에게 놀라움으로 다가오지만, 동면과 수 면은 적어도 신경학적이고 신진대사적인 관점에서 볼 때 전혀 같은 것이 아니다. 동면은 마취되는 것과 더욱 비슷한데, 그 대상은 의식이 없지만 실 제로 잠들어 있지는 않다. 그래서 동면하고 있는 동물은 더 큰 무의식 속에서 매일 몇 시간의 전형 적인 잠을 잘 필요가 있다. 우리 대부분에게 더욱 놀라운 점은 겨울에 잠을 자는 동물 중 가장 유명 한 곰도 실제로는 동면하지 않는다는 것이다. 실 제 동면은 깊은 무의식과 체온의 급격한 하락을 포함하는데, 자주 대략 화씨 32도로 떨어진다. 이 러한 정의에 따르면, 곰의 체온은 정상 근처를 유 지하고 쉽게 잠에서 깨어나기 때문에 그것들은 동 면하지 않는다. 그것들의 겨울잠은 더 정확하게는 휴면 상태라고 불린다."
    ],
    "tags": [
      "#철학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "략은 다른 군대를 공격할 때 군대를 지휘하는 행 동 계획이며, 전술은 전장의 상황에 대한 대응책 이다. 이러한 맥락에서, 우리의 문화에 의해, 시간 을 나노초 단위로 조직화한 기술에 의해, 그리고 그것의 유한한 본질과 우리가 오직 그 정도만 살 것이라는 사실에 의해 시간이 우리에게 부과된다. 이에 대응하여 우리는 시간과 기다림을 다루는 전 술을 개발해야 한다. 이는 기다림을 없애기 위한 전술이 아니다. 대신에, 이는 우리에게 이음매로 부터 배우는 방법을 가르치기 위한 전술이다. 이 러한 전술은 우리의 기다림의 시간에 대한 우리의 관점을 변화시키면서 심오한 방식으로 우리의 방 향을 바꿀 수 있는 잠재력을 가지고 있다. 이러한 새로운 관점은 기다림을 부담에서 창의성, 사회적 비판, 우리 내면의 상태와 우리 관계의 상태에 대 한 성찰과 같은 것을 향한 도약의 발판으로 바꿔 준다."
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "translation": [
      "어떤 동물이 이 세포를 가지고 있는지 살펴보는 것보다 어떤 것이 더 타당하겠는가? 그리고 이것 이 바로 현대 연구가 서 있는 곳으로, 현재까지 연구자들이 아는 것은 유인원이 거울 뉴런을 갖고 있다는 것뿐이다. 우리는 여전히 어떤 다른 종이 이 점에서 우리와 비슷한지 알아보기 위해 검증할 필요가 있다. 과학자들은 종종 우리가 아마도 여 기서 놀라움을 기대할 수도 있을 것이라고 공공연 하게 추측한다. 그들은 무리나 큰 집단으로 사는 모든 동물은 비슷한 두뇌 작동 기제를 가지고 있 다고 가정하는데, 왜냐하면 사회적 (구성)단위는 개인이 집단 내 다른 이들의 관점에서 사물을 보 고 그들이 느끼고 있는 것을 느낄 수 있어야만 기 능하기 때문이다. 나는 우리를 향해 지느러미를 흔들고 있는 금붕어를 볼 수 있다. 긴밀하게 결속 된 무리를 지어 다니는 동물로서, 그것은 이러한 생각에 부합하는 배에 올라타 있거나 적어도 그 배와 나란히 헤엄치고 있다."
    ],
    "tags": [
      "#심리학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "되는 보완하는 힘이라는 두 가지 힘에 달려 있다. 많은 이야기에는 지배권을 놓고 서로 싸우는 영웅 과 악당이 있지만, 우리의 이야기에서는 기술이 둘 다의 역할을 동시에 수행하는데, 노동자를 대 체하는 동시에 경제의 다른 곳에서 그들의 노력에 대한 수요를 증가시킨다. 이러한 상호작용은 자동 화에 대한 과거의 우려가 왜 잘못된 것인지 설명 하는 데 도움이 된다. 우리 조상들은 그 싸움의 승자를 잘못 예측하며, 보완하는 힘이 얼마만큼 강력하다고 드러날지를 꽤 과소 평가하거나 혹은 단순히 그 요소를 완전히 무시했었다. 이는 또한 왜 경제학자들이 전통적으로 기술 실업이라는 개 념을 무시해 왔는지를 설명하는 데 도움이 된다. 대체하는 힘에는 확고한 한계가 있어 보이고, 기 계에 의해서 수행될 수 없는 많은 과업들과, 그것 들을 대신 수행할 수 있는 인간에 대한 증가하는 수요를 남겼다."
    ],
    "tags": [
      "#철학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "체를 발사하는 비용에 극단적인 폭락이 있는 세상 에서, 여러분이 패널을 대기권 위에 설치하여 패 널당 에너지를 극대화하고 싶어 할 수도 있다고 생각할 수 있다. 그러나 패널은 저렴하고, 우리가 우주 발사 비용의 상당히 가파른 하락을 가정하더 라도, 계산이 맞지 않는다. 여러분이 유지보수에 대해 생각하기 시작하면 이것은 특히 분명해진다. 우주에 수 에이커에 달하는 유리 패널들이 끊임없 는 햇빛의 극심한 열을 견뎌 내며 강렬한 방사선 과 우주 파편에 정기적으로 충격을 받는 상상을 해 보라. 그것들은 우주 비행사나 첨단 로봇 군단 에 의해 수리되고 관리되어야 할 것이다. 호주에 있는 태양광 패널은 분무기와 헝겊으로 십 대 청 소년에 의해 청소될 수 있다."
    ],
    "tags": [
      "#과학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "이 생각할 수 있는 어떤 다른 가능한 기술어(記述 語)에서든, 연속선상에 존재한다. 그럼에도, 우리는 뚜렷한 구분을 만들고 생각 없이 받아들이며, 그러 한 구분은 근소한 차이가 그렇게 하는(삶을 변화시 키는) 것보다 훨씬 더 극적으로 삶을 변화시킨다. 사실, 모든 차이는 자의적이지만, 범주들 사이에 확고한 선을 긋는 것은 이러한 자의성을 숨기고 심 각하게 피해를 줄 수 있다. 나는 이러한 결과적인 피해를 ‘경계선 효과’라고 부른다. 그 예는 끝이 없 다. 어떤 사람의 IQ가 69이고 다른 사람의 IQ가 70인데, 70이라는 점수만 정상 범위 내에 있는 것 으로 간주된다. 우리는 69와 70 사이에 의미 있는 차이가 없다는 것을 알기 위해 통계학자가 되어야 할 필요는 없다. 하지만 일단 점수가 더 낮은 사람 이 ‘인지적으로 어려움이 있는’이라고 꼬리표가 붙 게 되면, 그 사람의 삶은 1점의 우위가 있는 사람 과는 다르게 전개될 것이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "계에서 그것들이 관찰하는 차이에 따라 시간의 흐 름을 표시한다. 어떤 차이를 표시할지에 대한 우 리의 선택은 첫째로 우리가 무엇을 관찰할 수 있 는지와 둘째로 우리 삶에서 무엇이 중요한지에 따 라 달라진다. 우리의 달력과 의식의 형태처럼 우 리가 그 차이들을 표시하는 방법은 그 두 가지 사 이에 우리가 만드는 연결에 따라 달라진다. 위도 가 높아 계절을 쉽게 관찰할 수 있었던 전근대 유고 2 정답 및 해설 2025학년도 9월 전국연합학력평가 12 27 럽의 농경 사회에서는 태양의 주기를 관찰하는 것 은 자연스러운 일이었다. 반대로, 계절 변화가 덜 중요한 아라비아의 대체로 유목 생활을 하는 민족 들에게는 음력이 더 합리적인 선택이었다. 그렇다 고 해서 이슬람교가 음력을, 로마 기독교가 양력 을 사용하는 것이 필연적인 것은 아니었지만, 지 리와 생활 방식에 의해 제한된 선택지 중에서 전 통을 통해 걸러져 정치적, 종교적 결정이 이루어 졌다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "칭송받지만, 모든 사람이 공감을 지지하는 사람인 것은 아니다. 공감에 대해 비판하는 사람들은 공 감이 사람 간 그리고 집단 간 갈등으로부터 우리 를 구해주지 않을 것이라고 주장한다. 사실, 그들 은 공감이 그러한 갈등을 더 악화시킨다고 주장한 다. 이런 비평가들은 공감은 소모적일 수 있으며, 번아웃 또는 고통에 대한 무감각으로 이어질 수 있다고 주장한다. 그들은 우리가 내집단에는 강하 게 공감하고 외집단에 대한 공감에는 저항하며, 심지어 경쟁적이거나 위협적인 상황에서는 외집단 의 고통을 즐기는 경향이 있다고 주장한다. 따라 서, 더 많은 공감을 처방하는 것은 갈등 상황에서 종종 효율적이다(→ 역효과를 낸다). 그들이 주장 하기로는, 공감은 더 나아가 갈등을 조장하고 우 리를 우리 대 그들이라는 사고방식으로 몰아넣을 수 있다. 마지막으로, 우리와 다르거나 낯선 상황 에 있는 타인에게 공감하려고 할 때조차도, 때때 로 우리는 그들의 경험을 정확하게 공감하지 못하 고, 그 이상의 오해와 좌절을 유발한다. 공감을 비판하는 사람들은 우리가 공감을 포기하고 사회 적 조화를 얻기 위해 다른 도구를 이용해야 한다 고 주장하는데, 예를 들면 이성적 연민 또는 두려 움, 분노, 수치심과 같은 도덕적 감정들이다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "게 만드는 것은 바로 불확실성이다. 여러분을 일 상적인 삶에서 벗어나게 만드는 사건들을 생각해 보아라. 아마도 가족 결혼식에 참석하거나, 중대 한 발표를 하거나, 한 번도 가보지 못한 곳에 가 는 것 같은 일들 말이다. 시간이 약간 느려지는 것 같고, 여러분이 더 온전히 몰입한다고 느끼는 때는 바로 그러한 순간들이다. 등산이나 패러세일 링처럼 그 경험이 위험한 경우에도 마찬가지이다. 여러분의 감각들이 더 예민해진다. 여러분은 더 많은 것을 알아차린다. ‘도파민’이라고 불리는 기 분 좋게 하는 화학 물질이 뇌 안에서 분비되는 덕 분에, 여러분은 계획된 만남보다 사람들과의 우연 한 만남에서 더 크게 몰려오는 즐거움을 얻게 된 다. 좋은 소식, 금전적 보상, 그리고 선물은 뜻밖 의 일일 때 더 즐겁다. 그것이 가장 인기 있는 텔 레비전 쇼와 영화가 예기치 않은 줄거리의 반전과 놀라운 결말을 가진 것들인 이유다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "식에 뒤처지지 않기 위해 끊임없이 수정된다. 로 마 시대에 ‘addicts’는 빚을 갚을 수 없어서 스스 로 채권자의 노예가 된 사람들이었다. 그 단어는 결국 약물 의존과 연관되었는데, 사람은 자신이 중독된 것에 노예가 된다는 것이다. ‘husband’라는 단어는 원래 주택 소유자가 되는 것을 가리켰고, 기혼 상태와는 아무런 관련이 없었다. 그러나 재 산을 소유하는 것은 여러분이 배우자를 찾을 가능 성을 더 높게 만들었기 때문에 결국 그 단어는 결 혼한 남성을 의미하게 되었다. 1605년 11월 5일, Guy Fawkes는 영국 의사당을 폭파하려 했다. 그 는 체포되어 처형당했다. 로열리스트들은 그를 닮 은 인형을 불태웠는데 그들은 그것에 ‘guy’라는 별명을 붙였다. 수 세기 후, 그 단어는 부정적인 함축을 잃었고 Guys and Dolls라는 제목의 뮤지 컬이 브로드웨이에서 상연되었다. 미국 속어에서 ‘bad’는 ‘좋은’을, ‘cool’은 ‘멋진’을, ‘wicked’는 ‘탁 월한’을 의미한다. 언어 자체가 인간이 만들어 내 는 것의 계속 변화하는 반영물이기 때문에 여러분 이 100년 후 미래로 이동할 수 있다면 여러분의 증손자의 말에 당황하게 될 것이다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "위해 텍스트가 자주 이미지 옆에 사용되는 점을 관찰한 Roland Barthes(그는 사진에 중점을 두었 다)에 의해 도입되었다. 이미지가 이끌어 낼 수 있는 모든 가능한 있는 그대로의 또는 함축된 해 석 중에서, 텍스트는 보는 사람을 원하는, 특정한 방향으로 향하게 할 것이다. 광고할 때, Barthes 가 주장하는 것처럼, 상징적 메시지는 식별이 아 니라 해석을 유도한다. 보는 사람은 그들이 보는 것을 인식하도록 요구되는 것이 아니라 왜 그들이 그것을 보는지 그리고 그것이 그들에게 무엇을 의 미하는지를 이해하도록 요구된다. 이미지와 텍스 트를 결합함으로써, 광고는 한편으로는 정확하고 구체적이며, 다른 한편으로는 더욱 풍부한 상징적 의미를 만들어 내어, 그 결과 이성적이고 감성적 해석의 깊이를 더하고 폭은 제거한다. 광고의 헤 드라인이나 끝맺음말이 이미지의 의도된 의미를 통해 독자를 안내하여, 독자는 어떤 것은 피하고 다른 것은 받아들인다. 그것은 독자를 미리 선택 된 의미 쪽으로 ‘원격 제어한다’."
    ],
    "tags": [
      "#심리학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "큰 질량은 시공간을 ‘휘어지게 한다’. 뉴턴의 이론 은 그런 예측을 하지 않는다. 이런 시공간의 휘어 짐은 멀리 있는 별의 빛이 태양과 같은 거대한 질 량 옆을 지날 때 다른 위치에 있는 것처럼 보이는 ‘중력 렌즈 효과’와 같은 현상으로 이어진다. 우리 는 낮에 태양이 떠 있을 때 별들이 보이지 않기 때문에 이러한 렌즈 효과를 보통 보지 못하지만, 1919년의 일식은 태양의 중력이 멀리 있는 별로 부터 오는 빛에 어떤 영향을 주는지 과학자들이 관찰할 수 있게 해 주었다. 태양 주변의 별들은 밤하늘의 그것들의 정상적인 위치에서부터 이동한 것처럼 보였다. (우리 태양계 안에서의 행성들의 정확한 궤도를 확인하려는 지속적인 노력에도 불 구하고, 관찰 스케줄은 지역의 날씨 현상에 의해 자주 방해받는다.) 그 이동은 뉴턴의 이론이 예측 한 것보다 훨씬 컸지만, 아인슈타인의 이론에 의 해 예측된 위치에 정확히 있었다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "content": [
      "We’re naturally wired to organize the world into a\nhierarchy. We do this to help make sense of the world,\nmaintain our beliefs, and generally feel better. Or consider when you get frustrated with your kids and\nend an argument with “Because I said so.” (Or the\noffice equivalent: “Because I’m the boss.”) In these\nmoments you’ve stopped thinking and regressed to your\nbiological tendencies of reaffirming the hierarchy. You’re reacting to a threat to your inherent sense of\nhierarchy. On the road we are all equals. We’re all\nsupposed to play by the same rules. Cutting someone\noff violates those rules and implies higher status. But when someone infringes on our place in the world\nand our understanding of how it works, we react\nwithout thinking. When someone cuts you off on the\nhighway and road rage kicks in, that’s your unconscious\nmind saying, “Who are you to cut me off?”"
    ],
    "translation": [
      "되어 있다. 우리는 세상을 이해하고, 우리의 신념 을 유지하며, 일반적으로 기분이 나아지도록 하 기 위해 이것을 한다. 그러나 누군가가 세상 에서의 우리의 위치와 그것이 어떻게 작동하는지 에 대한 우리의 이해를 침해할 때 우리는 생각하 지 않고 반응한다. 누군가가 고속 도로에서 여러 분에게 끼어들어 운전자의 분노가 발생했을 때, 그것은 “네가 뭔데 나에게 끼어들었어?”라고 말하 는 여러분의 무의식적인 마음이다. 여러분은 여러분의 내재한 위계 의식에 대한 위협에 반응하 고 있다. 도로 위에서 우리는 모두 평등하다. 우 리는 모두 같은 규칙에 따라 행동해야 한다. 누군 가에게 끼어드는 것은 그러한 규칙을 위반하는 것 이며 더 높은 지위를 의미한다. 또는 여러분 이 여러분의 자녀에게 실망하게 되어 말다툼을 “내가 그렇게 말했으니까.”라고 말하며 끝낼 때(또 는 동일한 사무실 상황, “내가 상사니까.”)를 생각 해 봐라. 이런 순간에 여러분은 생각하는 것을 멈 추었고 위계를 재확인하는 여러분의 생물학적 성 향으로 되돌아갔다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "content": [
      "Once a nail is hammered in, it is friction that holds it\nin place. Friction is the force that arises when two\nsurfaces are sliding, or trying to slide, against each other. The force it would take to stretch the nail is much\nlarger than the friction forces on the surface, so we\ndon’t have to worry too much about the former. It’s the\nfriction with which we need to concern ourselves. If you try to pull apart two blocks of wood that have\nbeen nailed together, the wood fibers grip the shaft of\nthe nail. The nail feels a force trying to rip it apart\nalong its length, and we call that force tension. Your experiment can now fail in one of two ways ―\neither the nail stretches and splits in half because the\ntension force is too large for the nail, or the nail comes\nloose because the friction force is overcome."
    ],
    "translation": [
      "자리에 붙들고 있는 것은 바로 마찰이다. 마찰은 두 표면이 서로에 저항해 미끄러지거나 미끄러지려 고 할 때 발생하는 힘이다. 만약 여러분이 함께 못 박혀 있는 두 개의 나무 블록을 떼어 내려고 하 면, 나무 섬유가 못의 축을 잡고 있다. 못은 그것의 길이대로 그것을 쪼개려고 하는 힘을 받고, 우리는 그 힘을 장력이라고 부른다. 여러분의 시도는 이제 두 가지 방법 중 하나로 실패할 수 있는데, 장력이 못이 견디기에는 너무 커서 못이 늘어나 반 으로 갈라지거나, 또는 마찰력이 극복되어 못이 헐 거워지는 둘 중 하나이다. 못을 늘리는 데 들 힘은 표면의 마찰력보다 훨씬 더 커서 전자에 대해 우리는 너무 많이 걱정할 필요가 없다. 우리가 신 경 쓸 필요가 있는 것은 바로 마찰이다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "합하다. 그것을 만드는 셀룰로오스 섬유는 최대로 구부러지는 부분에서 부분적으로 꺾일 수 있어 영 구적인 주름이 형성되도록 하는 동시에, 충분한 섬 유가 완전하게 남아 재료가 갈라지고 떨어지지 않 는다. 실제로, 이러한 상태에서 그것은 잡아당겨짐 에 저항하는 능력을 상당히 유지하지만, 그것은 또 한 작은 초기의 찢김 같은 약한 지점이 열리면 주 름을 따라 쉽고 정확하게 찢어질 수 있다. 이러한 물리적 특성의 우수한 조합은 그것이 주름짐과 접 힘을 통해 어떤 물체의 모양도 취할 수 있도록 하 며, 이러한 점에서 종이접기 예술이 생겼다. 이만큼 좋은 재료들은 매우 드문데, 금속 호일은 주름을 유지할 수 있지만, 주름의 통제가 다소 더 어렵다. 플라스틱 시트는 매우 부드럽지 않은 한 주름을 전 혀 유지하지 않는 경향이 있고, 매우 부드러운 경 우에는 좋은 포장재에 요구되는 단단함이 부족하다. 따라서 종이를 이 용도에 특별히 적합하도록 만드 는 것은 바로 뻣뻣한 상태를 유지하면서 주름을 유 지하는 그것의 능력이다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "Collin의 아버지는 15년 된 차를 가지고 있 었는데, 그것은 Collin과 같은 나이였다. 그는 그것을 마침내 더 새로운 모델로 교체할 때라 고 결심했다. 어느 날 밤 저녁 식사에서 그 는 새 차를 사려는 그의 계획을 그의 가족들과 공유했다. 그 소식에 기뻐서, Collin은 그의 아 버지의 큰 구매에 기여하겠다고 결심하게 되었 다. 지난 수년 동안, Collin은 그의 용돈을 모아 왔다. 그는 이번이 아버지를 위해 특별한 무언 가를 할 완벽한 기회라고 느꼈다. 다음 날 아침, 학교로 향하기 전, Collin은 봉투를 주방 탁자 위에 두었다. 그의 아버지가 주방으로 들어왔을 때, 그는 그 봉투를 알 아차리고 그의 아내에게 그것에 관해 물었다. 그녀는 Collin이 학교로 떠나기 전에 그것을 거 기에 두었다고 설명했다. Collin의 아버지는 그 봉투를 열었고 두꺼운 돈다발을 보았다. “여기 1,000달러가 있어!” 그가 그것을 세어 본 후 외쳤다. 그의 아내는 미소를 지었고, “Collin이 당신이 새 차를 위한 비용을 내는 것을 돕고 싶어 했어요.”라고 말했다. 그날 오후, Collin의 아버지는 자동차 판매 대 리점에 가서 1년밖에 안 된 차를 구입했다. 그 는 빨간색이 Collin이 가장 좋아하는 색깔이기 때문에 빨간 차를 골랐다. 그의 아들이 그를 위해 놓아두었던 돈은 나머지 금액을 충당하기 에 충분했고, 그는 심지어 약간의 돈을 남겼다! Collin의 아버지는 그 여분의 돈으로 그의 아들에 게 작은 선물을 사 주기로 결심했다. 그날 저녁, Collin이 집에 왔을 때, 그는 진입로에 새로운 차가 주차된 것을 보게 되어 놀랐다. 그의 아버지는 그에게 진심으로 고마워했고, 그가 Collin의 사려 깊은 행동을 얼마나 자 랑스러워하는지 Collin에게 말했다. 그러고 나 서 Collin에게 리본이 위에 달린 작은 상자를 건넸고, 새 야구공이 그 안에 있었다. Collin은 그것을 좋아했다! 그는 기쁨으로 얼굴이 환 히 빛났고 “우리가 새 차를 가지게 됐을 뿐만 아니라, 저도 아주 멋진 새 야구공을 받았어 요!”라고 말했다. 그의 아버지는 따뜻하게 미소 짓고 그를 안아 주었다. Collin의 친절하고 너 그러운 마음이 그의 가족에게 아름다운 순간을 만들었다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "과학 발전에 영감을 받은 아이디어와 같은 새로운 아이디어는 건전한 공개 토론 과정 의 일부로 우리의 대중문화에서 자주 방송되고 비판되는데, 과학자들은 때로 자신들 이 받는 비판을 받는 것이 마땅하다. 그러나 널리 퍼진 과학자의 이미지를 개선한다 면 과학의 대중화는 크게 증진될 것이다. 그 문제의 일부는 아마도 소설, 희곡, 그리 고 영화 대본을 쓸 가능성이 높은 사람 대다수가 과학이 아니라 인문학 분야에서 교 육받았다는 것일 수도 있다. 더욱이 작가로 전업한 몇 안 되는 과학자가 자신들이 받 은 과학 교육을 과학과 과학자의 이미지를 더욱 해치는 스릴러물의 원자료로 사용해 왔다. 우리는 긍정적인 관점에서 과학자를 보여주는 더 많은 영화 대본과 소설이 필 요하다. 우리의 현대 세계에서 텔레비전과 영화는 특히 영향력 있는 매체여서, 더 많 은 과학자 영웅들을 주인공으로 도입한다면 과학을 더 매력 있게 하는 데 도움이 될 것이다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "여러분이 일하는 습관에서 이뤄낼 수 있는 가장 중요한 단 한 가지 변화는 창조적인 일을 먼저 하고 대응적인 일은 그다음에 하는 쪽으로 전환하는 것이다. 이것은 전화 기와 이메일을 끈 채, 여러분 자신의 우선순위에 따라 창조적인 작업을 위해 매일 많 은 시간을 차단한다는 것을 의미한다. 나는 좌절감을 느끼는 작가였다. 이렇게 전환하 자 나는 생산적인 작가로 변신했다. 하지만 내가 기사나 블로그 게시글 혹은 책의 한 챕터를 쓰려고 앉을 때마다 일련의 사람들이 내가 그들에게 답장을 주기를 기다리지 않은 날이 단 하루도 없었다. 그것은 쉽지 않았고, 특히 “‘2시간 전에’ 이메일을 보냈14 어요...!”라고 시작하는 전화 메시지를 받을 때는 아직도 쉽지 않다. 당연히, 이러한 접근 방식은 다른 사람들의 기대와 그들이 여러분에게 가하는 압박에 맞지 않는다. 단 한 시간 동안이라도 세상에 대한 스위치를 끄는 데는 의지가 필요하다. 그것은 불 편한 느낌이 들고, 때로 사람들이 기분 상하기도 한다. 그러나 빈 수신함을 위해(수신 함을 늘 비어 있게 하려고) 자신의 꿈을 포기하는 것보다, 사소한 것에 대해 몇 사람 을 실망하게 하는 것이 낫다. 그렇게 하지 않으면, 여러분은 전문성이라는 환상을 위 해 자신의 잠재력을 희생하고 있다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "주택 단지를 건설하려는 도급업자들은 계획 과정에 비중을 더 많이 둘 수도 있다. 적 절한 계획은 그 건설 사업에 대해 면밀한 사고를 하게 한다. 그것은 건설 사업 책임 자(또는 팀)가 ‘그 주택 단지를 자기 머릿속에 지어 보게’ 해준다. 그 건설 사업 책임 자(또는 팀)는 여러 다른 방법론을 고려함으로써 어떤 것이 가장 잘 작동되는지 또는 어떤 것이 전혀 작동되지 않는지를 결정할 수 있다. 이런 면밀한 사고는 추정 과정에 서 다루지 못했던 제약이나 위험을 발견할 수 있는 유일한 방법일 수 있다. 실행 과 정보다는 계획 단계에서 특정 기술이나 재료가 작동되지 않으리라는 것을 발견하는 편이 훨씬 더 나을 것이다. 도급업자에게 계획 과정의 목표는 허용되는 시간과 주어 진 예산 내에서 자원을 효율적으로 사용하는 실행 가능한 계획을 만들어 내는 것이 다. 잘 만들어진 계획이, 실행 과정이 흠 없이 진행될 것이라거나 심지어 그 건설 사 업이 그 목표를 달성하는 데 성공할 것이라고 보장하는 것은 아니다. 하지만 그것은 정말로 그 가능성을 크게 높인다.15"
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "아이들은 (역할) 놀이와 이야기로의 몰입이 같은 활동의 형태인 것처럼 쉽게 그 둘 사이를 이동한다. 이야기식 구조의 해적 게임에서 역할을 맡는 것은 영화를 감상하면 서 등장인물과 동일시하며 역할을 맡는 것과 크게 다르지 않다. 사람들이 청소년기로 성장하면서 아동기의 놀이를 그만둔다고 여겨질 수도 있겠지만, 이는 그렇지 않다. 대 신에, 이런 활동의 기반과 흥미가 바뀌어 스포츠 활동과 관람으로, 연극, 소설, 영화 의 허구로, 그리고 최근에는 비디오 게임으로 발전한다. 허구에서 사람들은 있을법한 세계로 들어갈 수 있다. 그런 세계에서 감정들을 경험하면, 이는 우리가 일관되지 않 다거나 퇴행하고 있다는 신호가 아니다. 그것은 새로운 방식으로, 새로운 세계에서, 우리에게 감동적이고 중요할 수 있는 방식으로 우리 자신의 은유적 변신을 시도하는 것에서 기인하는 것이다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "인식적 접근법과 신경심리학적 접근법이 사회 지각을 손상시킬지도 모르는 노화에 따 른 상실을 강조하긴 하지만, 동기 이론은 어떤 이득이나 질적 변화가 있을 수 있다는 것을 보여 준다. Charles와 Carstensen은 사람들은 나이가 들면서 친밀한 사회적 관계를 우선시하고, 정서적 행복을 성취하는 데 더 주력하고, 긍정적인 정서적 정보를 더 주목하는 반면에 부정적인 정보는 무시하는 경향이 있다는 것을 보여 주는 상당한 양의 증거를 재검토한다. 노년의 이런 변화하는 동기 부여상의 목표는 주변 환경으로 부터의 사회적 신호를 주목하고 처리하는 것에 영향을 미친다. 노년의 정서적 변화를 고려할 때 특히 중요한 것은 긍정 편향, 즉 부정적 정보와 비교해 더 많은 긍정적 정 보를 인지하고, 주목하고, 기억하는 경향의 존재이다. 사회적 기술에 관한 인생 경험 의 역할 또한 노년의 성인이 사회 지각의 일부 측면에서 이득을 얻을 수 있다는 것을 보여 준다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "대부분의 과학 역사가들은 별과 행성에 대한 연구, 즉 우리가 현재 천문학이라 부르 는 것에 대해 배우고자 하는 동기로 농업 활동을 규제하기 위한 신뢰할 만한 달력의 필요성을 지적한다. 초기 천문학은 언제 작물을 심어야 하는지에 대한 정보를 제공했 고 인간에게 시간의 흐름을 기록하는 그들 최초의 공식적인 방법을 제공했다. 영국 남부에 있는 4,000년 된 고리 모양을 하고 있는 돌들인 스톤헨지는 아마도 우리가 살 고 있는 세계에서 규칙성과 예측 가능성을 발견한 가장 잘 알려진 기념비일 것이다. 스톤헨지의 커다란 표식은 우리가 계절의 시작을 표시하기 위해 여전히 사용하는 날 짜인 지점(至點)과 분점(分點)에서 태양이 뜨는 지평선의 장소를 가리킨다. 그 돌들은 심지어 (해·달의) 식(蝕)을 예측하는 데 사용되었을지도 모른다. 글이 없던 시절 사람 들이 세운 스톤헨지의 존재는 자연의 규칙성뿐만 아니라 눈앞에 보이는 모습의 이면 을 보고 사건에서 더 깊은 의미를 발견할 수 있는 인간의 정신적 능력을 말없이 증언 해 준다."
    ],
    "tags": [
      "#철학",
      "#과학"
  ...
  },
  {
    ...
    "translation": [
      "스포츠는 그것의 소비자에게 다른 제품이 좀처럼 일으키지 못하는 종류의 정서적 반 응을 촉발시킬 수 있다. 은행 고객이 그들 은행에 대한 충성심을 보여주기 위해 기념 품을 구입하거나, 고객이 그들 자동차 보험 회사에 대해 매우 강한 동질감을 가져서 회사 로고로 문신을 한다고 상상해 보라. 우리는 일부 스포츠 추종자들이 선수, 팀, 그리고 그 스포츠 자체에 매우 열정적이어서 그들의 관심이 집착에 아주 가깝다는 것 을 알고 있다. 이런 중독은 팬을 팀과 묶어주는 정서적 접착제를 제공하고, 구장에서 일어나는 실패에도 충성심을 유지하게 한다. 대부분의 관리자는 스포츠팬만큼 그들 제품에 열정적인 고객을 가지기를 오직 꿈꾸지만, 스포츠로 인해 촉발되는 감정은 또 한 부정적인 영향을 미칠 수 있다. 스포츠의 정서적 격렬함은 조직이 향수와 클럽 전 통을 통해 과거에 대한 강한 애착을 가지고 있다는 것을 의미할 수 있다. 그 결과, 그것[조직]은 효율성, 생산성 및 변화하는 시장 상황에 신속하게 대응해야 할 필요성 을 늘릴(→ 무시할) 수도 있다. 예를 들어, 더 매력적인 이미지를 투사하기 위해 클럽 색깔을 바꾸자는 제안은 그것이 전통과의 관계를 끊기 때문에 무산될 수도 있다."
    ],
    "tags": [
      "#심리학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "학과의 성장과 미술사학이나 고생물학과 같은 하위 학과의 성장, 그리고 미술평론가 와 같은 특정 인물의 성장은 비록 힘든 일로 남게 되었지만, 지킬 가치가 있는 것을 선택하고 정리하기 위한 원칙과 관행의 도출에 도움이 되었다. 게다가, 19세기 말엽 에 박물관과 대학이 서로 더욱 멀어지면서, 그리고 세상을 알게 되는 매우 가치 있는 경로로서 대상이라는 개념이 쇠퇴하면서, 수집은 특히 과학에서 가치 있는 지적 활동21 으로서 지위를 잃기 시작했다. 과학의 참으로 흥미롭고 중요한 측면은 점점 더 육안 에 보이지 않는 것들이었고, 수집된 것들에 대한 분류는 더 이상 최첨단의 지식을 생 산할 가망이 없었다. ‘나비 채집’이라는 용어는 ‘한낱(mere)’이라는 형용사와 사용되 어, 부차적인 학문적 지위의 추구를 나타낼 수 있었다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "정보 탐색에 관한 가장 통찰력 있는 연구 중 일부는 ‘전략적 자기 무지’를 강조하는 데, 이는 ‘무지를 핑계로 자신의 미래 자아에 해로울 수도 있는 즐거운 활동을 과도 하게 하는 것’으로 이해된다. 여기서의 생각은, 만약 사람들이 현재에 편향되어 있다 면, 현재의 활동을 덜 매력적으로 만들 정보를 피할 수도 있다는 것인데, 아마도 그 것이 죄책감이나 수치심을 유발할 것이고, 그러한 활동을 하지 말라고 충고할 총체적 절충을 제안할 것이기 때문일 것이다. 성 아우구스티누스는 “하나님 제게 정결을 내 일 주시옵소서.”라는 유명한 말을 했다. 현재에 편향되어 있는 행위자들은 “제가 위험 을 내일 알게 해주세요.”라고 생각한다. 사람들이 단기적인 혜택은 있지만 장기적인 대가가 있는 활동을 하려고 생각하고 있을 때마다, 그들은 중요한 정보의 수신을 미 루는 것을 선호할 수도 있다. 사람들을 슬프게 하거나 화나게 할 수 있는 정보에 관 해서도 똑같은 점이 있을 수 있다. “제가 알아야 할 것을 내일 말해 주세요.”"
    ],
    "tags": [
      "#경제"
    ],
  ...
  },
  {
    ...
    "translation": [
      "Emma Brindley는 이웃 새와 낯선 새의 노래에 유럽 울새가 보이는 반응을 조사해 왔다. 유럽 울새의 크고 복잡한 노래 목록에도 불구하고, 그것은 이웃 새와 낯선 새 의 노래를 구별할 수 있었다. 낯선 새의 테이프 녹음 소리를 들었을 때, 그것은 이웃 새의 노래를 들었을 때 그랬던 것보다, 더 빨리 노래를 부르기 시작했고, 더 많은 노 래를 불렀으며, 더 자주 자기 노래를 재생된 노래와 겹치게 불렀다. Brindley가 말하 는 것처럼, 노래를 겹치게 부르는 것은 공격적인 반응일 수도 있다. 그러나 이웃 새 와 낯선 새에 대한 반응의 이러한 차이는, 이웃 새의 영역과 실험 대상이 되고 있는 그 새의 영역 사이의 경계에 놓인 확성기로 이웃 새의 노래를 틀었을 때만 발생했다. 같은 이웃 새의 노래를 다른 경계, 즉 실험 대상의 영역을 또 다른 이웃 새의 영역과 분리해 주는 경계에서 틀었을 경우, 그것은 낯선 새의 울음으로 취급되었다. 이 결과 는 울새가 장소를 친숙한 노래와 연관시킨다는 것을 입증할 뿐만 아니라, 또한 (녹음 소리) 재생 실험에 사용되는 노래의 선택이 매우 중요하다는 것을 보여 준다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "친족 유대 관계는 오늘날에도 계속 중요하다. 사람들이 자주 가족 모임을 갖는 미국 과 같은 현대 사회에서, 그들은 자신의 친척에게 자주 전화하고, 아주 다양한 도움을 제공한다. Eugene Litwak은 이 행동 패턴을 ‘수정확대가족’이라고 언급했다. 그것은24 다세대의 유대 관계가 유지되기 때문에 확대가족 구조이지만, 일반적으로 세대 간 공 동 거주에 기초를 두지 않고 대부분의 확대가족이 공동 집단으로서 기능하지는 않기 때문에 수정확대가족 구조이다. 비록 수정확대가족의 구성원들이 흔히 가까이 살기는 하지만, 수정확대가족은 지리적 근접이 필요치 않으며, 유대 관계는 친척이 상당히 멀 리 떨어져 있더라도 유지된다. (가족 구성원들이 서로 아무리 멀리 떨어져 살지라도, 중요한 문제에 관해서는 그 가족의 최고 연장자가 결정을 내린다.) 친척이 항상 아주 가까이서 사는 전통적인 확대가족과는 대조적으로, 수정확대가족의 구성원들은 친척 에게서 자유로이 멀리 이주해가서 직업상의 발전을 위한 기회를 추구할 수도 있다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "content": [
      "A firm is deciding whether to invest in shipbuilding. If it\ncan produce at sufficiently large scale, it knows the venture\nwill be profitable. There is a “good” outcome, in which both types of\ninvestments are made, and both the shipyard and the\nsteelmakers end up profitable and happy. Equilibrium is\nreached. Then there is a “bad” outcome, in which neither\ntype of investment is made. This second outcome also is\nan equilibrium because the decisions not to invest\nreinforce each other. Assume that shipyards are the only potential customers of\nsteel. Steel producers figure they’ll make money if there’s\na shipyard to buy their steel, but not otherwise. Now we\nhave two possible outcomes ― what economists call\n“multiple equilibria.” But one key input is low-cost steel, and it must be produced\nnearby. The company’s decision boils down to this: if there\nis a steel factory close by, invest in shipbuilding; otherwise,\ndon’t invest. Now consider the thinking of potential steel\ninvestors in the region."
    ],
    "translation": [
      "한 회사가 조선업에 투자할지를 결정하고 있다. 만약 충분히 대규모로 생산할 수 있 다면, 그것은 그 (사업상의) 모험이 수익성이 있을 거라는 것을 알고 있다. 하지 만 한 가지 핵심 투입 요소는 저가의 강철이고, 그것은 근처에서 생산되어야 한다. 그 회사의 결정은 결국 다음과 같이 된다. 만약 근처에 강철 공장이 있다면, 조선업 에 투자하고, 그렇지 않으면 투자하지 마라. 이제 그 지역에 있는 잠재적 강철 투자 자들의 생각을 고려해 보라. 조선소가 유일한 잠재적 강철 소비자라고 가정하라. 강철 생산자들은 자신의 강철을 구매할 조선소가 있으면 자신이 돈을 벌 것이고, 그 렇지 않으면 돈을 벌지 못하리라고 생각한다. 이제 우리는 경제학자들이 ‘복수균형’이 라고 부르는 가능한 두 가지 결과를 갖게 된다. ‘좋은’ 결과가 있는데, 그 결과 내에서는 두 가지 투자 형태가 모두 이루어지고, 조선소와 제강업자 모두 결국 이득 을 얻고 만족하게 된다. 균형이 이루어지는 것이다. 그다음에 ‘나쁜’ 결과가 있는데, 그 결과 내에서는 (둘 중) 어떤 투자 형태도 이루어지지 않는다. 이 두 번째 결과 또 한 균형이 이루어진 것인데, 왜냐하면 투자하지 않겠다는 결정이 서로를 강화하기 때 문이다."
    ],
    "tags": [
      "#경제"
    ],
  ...
  },
  {
    ...
    "translation": [
      "사생활에 대한 권리는 다른 사람의 표현의 자유에 대한 권리나 정보에 대한 권리를 제한하지 않는 정도까지만 확대될 수 있다. 사생활에 대한 권리의 범위는 범죄 예방 이나 공중 보건 증진에서의 공공이익에 의해 비슷하게 제한된다. 하지만 우리가 속성 에 기반을 둔 권리 개념(예를 들어, 사생활에 대한 권리가 이미지와 인격을 보호할 개념)에서 사생활과 가족의 생활이라는 현대적 개념으로 옮겨갈 때, 우리는 그 권리의 한계를 설정하기가 더 쉽다는(→ 더 어렵다는) 것을 알게 된다. 이것은 물론 변화하는 기대와 기술 진보에 대처하기 위해 적응할 수 있다는 점에서, 사생활 개념의 강점이 다. 요컨대, 오늘날 사생활이란 ‘무엇’인가? 그 개념은 우리가 주시당하지 않아야 한다는 주장과, 우리에 관한 특정 정보와 이미지가 우리의 허락 없이 유포되어서는 안 된다 는 주장을 포함한다. ‘왜’ 이러한 사생활 주장들이 생겼는가? 그것은 영향력 있는 사 람들이 그렇게 주시당하는 것에 불쾌감을 느꼈기 때문에 생겼다. 게다가 사생활은 가 족, 가정, 그리고 서신을 임의의 간섭으로부터 보호할 필요성을 포함했고, 또한 명예 와 평판을 보호하려는 확고한 의지가 있었다. 사생활은 ‘어떻게’ 보호되는가? 역사적 으로 사생활은 피해를 주는 자료의 유포를 제한함으로써 보호되었다. 그러나 사생활 개념이 사진과 신문을 통한 이미지 재생산에 대한 대응으로 처음 법적으로 관심을 끌 게 되었다면, 자료 저장, 디지털 이미지, 그리고 인터넷과 같은 더 근래의 기술 발전 은 사생활에 새로운 위협을 제기한다. 사생활에 대한 권리는 이제 그러한 문제들에 대처하기 위해 재해석되고 있다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "content": [
      "Fighting against the force of the water was a thrilling\nchallenge. Sophia tried to keep herself planted firmly in the\nboat, paying attention to the waves crashing against the rocks.\nAs the water got rougher, she was forced to paddle harder to\nkeep the waves from tossing her into the water. Her friends Mia\nand Rebecca were paddling eagerly behind her to balance the\nboat. They were soaked from all of the spray. Mia shouted to\nSophia, “Are you OK? Aren’t you scared?”"
    ],
    "translation": [
      "물의 힘에 맞서 싸우는 것은 짜릿한 도전이었다. Sophia는 바위에 세게 부딪히는 물결에 주목하면서 배에 단단히 버티어 자리 잡고 있으려고 애썼다. 물이 더 거칠어 지자, 그녀는 물결이 자기를 물속으로 내동댕이치지 못하게 더 열심히 노를 저을 수 밖에 없었다. 그녀의 친구들인 Mia와 Rebecca는 보트의 균형을 유지하려고 그녀의 뒤에서 열심히 노를 젓고 있었다. 그들은 모든 물보라로 흠뻑 젖었다. Mia는 Sophia 에게 “너 괜찮니? 너 무섭지 않니?”라고 소리쳤다. “나는 아주 좋아!”라고 Sophia는 신이 나서 되받아 소리쳤다. 보트가 이리저리 내던져지고 있었지만 그 여자들은 어느 바위에도 부딪치는 것을 피했다. 갑자기, 물이 더 거칠어졌던 것처럼 거의 그만큼 빠르게 강이 잔잔해지는 것처럼 보였고, 그들은 모두 긴장을 풀었다. 안도의 한숨을 쉬면서, Sophia는 주변을 둘러보았다. “우와! 정 말 멋진 풍경이다!”라고 그녀는 소리쳤다. 그들 주변의 경치는 숨이 멎을 정도로 멋졌 다. 모두가 말문이 막혔다. 그들이 에메랄드빛 녹색의 Rocky 산맥을 즐길 때, Mia가 말했다. “래프팅이 Colorado에서 할 수 있는 최고의 일이라는 것은 당연해!”30 자기 친구에게 동의하면서 Rebecca는 엄지를 들어 올렸다. “Sophia, 네 선택은 탁월했어!”라고 그녀는 기쁜 미소를 띠면서 말했다. “근데, Sophia, 나는 네가 물을 무서워한다고 생각했어.”라고 Mia가 말했다. Sophia가 설명하기를, “음, 래프팅을 시 작하기 전에는 무서워했었지. 하지만 나는 몇 달 후에 대학을 졸업해. 그래서, 그러기 전에, 나는 내 용기를 시험해 볼 수 있는 진짜 모험적인 것을 해보고 싶었어. 나는 완전히 미친 짓을 하면 그것이 나에게 취업 면접할 때 더 많은 자신감을 줄 거라고 생각했어.” 이제 그들은 왜 그녀가 래프팅을 하러 가자고 제안했는지 알 수 있었다. “네 말은 정말 일리가 있어. 위험을 마다하지 않는 모험가의 마음가짐으로 대학을 졸업하는 것은 정말 유리한 점이야.”라고 Mia가 말했다. Rebecca가 재빨리 덧붙여 말하기를, “그게 내가 대학을 나와서 첫 직장 생활을 시작하기 전에 몽골에 간 이유 야. 그곳에서 두 달 동안 영어를 가르친 것은 내게 큰 도전이었어. 그런데 나는 그 경험에서 많이 배웠어. 그것은 정말 인생에서 무슨 일이든 시도해 볼 용기를 내게 주 었어.” 자기 친구들의 말을 들으면서, Sophia는 물에 비친 자기 자신의 모습을 보았 고 자신에게 미소를 되돌려주는 자신만만한 젊은 여자를 보았다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "우리는 모든 이가 빠르고 확실한 해결책을 찾고 있는 듯한 시대에 살고 있다. 컴퓨터 회사들은 심지어 컴퓨터가 부모를 대신할 수 있는 방법을 광고하기 시작했다. 그들은 너무 늦었는데, 텔레비전이 이미 그것을 해버렸다. 하지만 진지하게, 도덕 교육을 포 함한 교육의 모든 분야에서, 우리는 우리가 특정한 내용 묶음이나 특정 교육 방법 또 는 학생과 공간의 특정 배치가 우리의 목적을 성취할 것이라고 가정할 때 실수를 범 하는 것이다. 정답은 더 어렵고 또한 더 단순하다. 우리, 부모와 교사는, 우리의 아이 들과 생활하고, 그들과 이야기를 나누고, 그들의 말에 귀 기울이며, 그들과 함께하는 것을 즐기고, 우리가 하는 것과 말하는 방식을 통해 그들에게 감사하며 살거나 최소 한 대부분의 다른 사람들과 비폭력적으로 사는 것이 가능하다는 것을 보여주어야 한 다."
    ],
    "tags": [
      "#철학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "협업의 전등 스위치를 휙 누르는 것은 고유하게 지도자들이 해야 하는 위치에 있는 것인데, 왜냐하면 자발적으로 혼자 일하는 사람들에게 여러 장애물이 방해되기 때문 이다. 우선, 상황을 잘 모르고 혼자 남겨진다는 두려움은 그들이 계속 자신들의 기업 소셜미디어에 매달리도록 할 수 있다. 개인들은 고립되거나 고립된 듯 보이는 것을 원치 않는다. 또 다른 이유로는, 자신들의 팀 동료들이 무엇을 하고 있는지 아는 것 이 편안하고 안전하다는 느낌을 제공하는데, 사람들은 그들 자신의 행동을 집단과 조 화를 이루도록 조정할 수 있기 때문이다. 아마도 바로 처음부터 성공적이지 않을 뭔 가 새로운 것을 시도하기 위해 홀로 벗어나는 것은 위험천만하다. 하지만 사람들이 과잉연결되는 것이 안도감이 든다고 느낄지라도, 그들이 주기적으로 (조직을) 벗어나 스스로 생각하여 그다지 성숙하지는 않더라도 다양한 아이디어를 창안하는 것이 조직 을 위해 더 좋다. 따라서, 사람들이 그것을 스스로 선택하지 않는 때에도, 처벌처럼 보이게 하지 않으면서 간간이 일어나는 상호작용을 시행함으로써, 전체에게 유익한 여건을 조성하는 것이 지도자의 임무가 된다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "역사적으로 전문직과 사회는 그들의 관계의 조건을 규정하고자 의도된 협상 과정에 참여해 왔다. 이 과정의 핵심에는 전문직의 자율성 추구와 책임성에 대한 공공의 요 구 사이의 긴장이 있다. 사회가 전문직에 권한과 특권을 부여한 것은 사회 복지에 기15 여하고 더 넓은 사회적 가치와 일치하는 방식으로 자신의 일을 수행하는 그들의 자발 성과 능력을 전제로 한다. 전문직의 전문지식과 특권적 지위는 그들이 봉사하는 사람 들을 희생시키고서 그들 자신의 이익을 향상시키기 위해 쉽게 이용될 수 있는 권위와 권한을 준다는 것이 오랫동안 인식되어 왔다. Edmund Burke가 두 세기 전에 말했 듯이, “인간은 자신의 욕구를 도덕적으로 구속하는 그들의 성향에 정확히 비례해서 시민적 자유를 누릴 자격이 부여된다.” 자율성은 일방통행로였던 적이 없었으며 결코 절대적이고 뒤집을 수 없게 주어지는 것은 아니다."
    ],
    "tags": [
      "#철학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "칸트가 보기에, 기하학적 모양은 너무 완벽해서 심미적 경험을 유발할 수 없다. 그것 들이 근본적인 개념이나 생각에 일치해서 고대 그리스인들이 추구하고 찬양했던 ‘정 확성’을 갖고 있는 한, 기하학적 모양은 이해될 수는 있지만 감정을 불러일으키지 않 으며 가장 중요하게 그것들은 상상력을 자유롭고 새로운 (정신적인) 범위로 움직이게 하지 않는다. 그와는 반대로, 어느 정도의 헤아릴 수 없음을 가지거나 제약되어 보이 지 않는 형태나 현상은 인간의 상상력을 자극하기 때문에 숭고한 심미적인 경험을 유 발할 수 있다. 헤아릴 수 없는 대상, 즉 규정할 수 없거나 형태가 없는 대상을 경험 하는 것과 연관된 즐거움은 사람 자신의 감정적이고 정신적인 활동을 즐기는 것으로 정의될 수 있다. 다시 말해, 그 즐거움은 볼 수 있게 존재하는 현상을 이해하고 해독 하려고 도전 받고 애쓰는 것으로 구성된다. 게다가, 그 즐거움의 일부는 사람의 안락 구역을 (일시적으로) 벗어나는 데서 온다."
    ],
    "tags": [
      "#심리학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "세상은 질서를 유지하기 위해 공공 행정과 관리의 시스템을 도입한 법과 통치의 나라 가 되었다. 이런 행정적인 관리 시스템으로, 도시의 정부 기관들은 자신의 시민에게, 과세 과정 그리고/또는 (예를 들면, 치안과 소방, 도로 유지‧보수, 공익사업, 쓰레기 관리 등) 서비스 수수료를 통해 제공되는, 증대되는 수준의 서비스를 제공하도록 진화 했다. 빈번하게 이것은 시민 참여를 대체했다. 서비스를 위해 내는 돈은 시민의 책임 과 공적인 참여를 대체하는 게 아니다. 대체 제공자가 되는 정부가 서서히 시민의 책 임을 대신하고 있다. 결과적으로, 도시를 기반으로 하는 우리 사회가 참여해야 하는 책임의 태도와 의식에서 철학적이고 사회적인 변화가 있다. 공동체 의식과 적극적인 참가자가 되어야 한다는 모든 시민의 관련된 책임감은 그래서 줄어들고 있다. 시민의 의무와 참여를 정부가 대신하는 것은 심각한 영향을 미칠 수 있다. 이것은 전반적인 준비 태세의 일부로 자연재해와 인재에 반응하는 전 세계의 국가들을 방해한다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "다른 사람들이 전달하고 있는 것이 무엇이든 그것을 받아들이는 것은 그들의 관심사 가 우리의 관심사와 일치할 때에만 성공하는데, 체내의 세포, 벌집 속의 벌을 생각해 보라. 인간 사이의 의사소통에 관한 한, 관심사의 그런 공통성은 좀처럼 이루어지지 않는데, 심지어 임산부도 태아가 보내는 화학적 신호를 믿지 못할 이유가 있다. 다행 히도, 가장 적대적인 관계에서도 의사소통이 이루어지게 할 수 있는 방법이 있다. 먹 잇감은 포식자에게 자신을 쫓지 말도록 설득할 수 있다. 그러나 그러한 의사소통이 일어나기 위해서는, 신호를 받는 자가 그것을 믿는 것이 더 좋을 것이라는 강력한 보 장이 있어야 한다. 메시지는 전체적으로 정직한 상태로 유지되어야 한다. 인간의 경 우, 정직성은 전달된 정보를 평가하는 일련의 인지 기제에 의해 유지된다. 이러한 기 제는 우리가 가장 유익한 메시지를 받아들이며(개방적이면서), 반면에 가장 해로운 메 시지를 거부할(경계할) 수 있게 해 준다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "경제 시스템에서는 한 부문에서 일어나는 일이 다른 부문에 영향을 미치며, 한 부문 에서의 재화나 서비스에 대한 수요는 다른 부문에서 파생된다. 예를 들어, 상점에서 상품을 구매하는 소비자는 아마 이 상품의 보충을 촉발할 것이고, 이것은 제조, 자원 추출, 그리고 물론 운송과 같은 활동에 대한 수요를 창출할 것이다. 운송이 (상품과) 다른 점은 그것이 혼자서는 존재할 수 없고 이동은 저장될 수 없다는 것이다. 팔리지 않은 상품은 (흔히 할인 인센티브로) 구매될 때까지 매장 진열대에 남아 있을 수 있 지만, 항공편의 팔리지 않은 좌석이나 동일 항공편의 미사용 화물 적재 용량은 팔리 지 않은 상태로 남게 되며 이후에 추가 용량으로 되돌릴 수 없다. 이 경우, 제공되는 운송량이 그것에 대한 수요를 초과하였기 때문에 기회가 포착되었다(→ 상실되었다). 파생된 운송 수요는 흔히 (그에) 상응하는 공급과 조화를 이루기가 매우 어려워서, 실 제로 운송 회사들은 (흔히 훨씬 더 높은 가격으로) 예측하지 못한 수요를 수용할 수 있는 얼마간의 추가 용량을 갖는 것을 선호할 것이다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "인류 문화의 고고학 기록을 살펴볼 때, 우리는 그것이 엄청나게 불완전하다는 것을 고려해야 한다. 인류 문화의 많은 측면은 고고학자들이 낮은 고고학적 가시성이라고 말하는 것을 지니고 있는데, 이것은 그것들이 고고학적으로 식별하기 어렵다는 것을 의미한다. 고고학자들은 문화의 유형적인 (혹은 물질적인) 측면, 즉 도구, 음식, 구조 물처럼 다루고 사진을 찍을 수 있는 것들에 초점을 맞추는 경향이 있다. 문화의 무형 적 측면을 재구성하는 것은 더 어려워서, 우리는 유형적인 것에서 더 많은 추론을 끌 어내야 한다. 예를 들어, 고고학자들이 석기와 음식 유물로부터 기술과 식습관을 식별21 하고 그것에 관한 추론을 도출하기는 비교적 쉽다. 같은 종류의 물질적인 유물을 사 용하여 사회 체계와 사람들이 무엇을 생각하고 있었는지에 관한 추론을 도출하는 것 은 더 어렵다. 고고학자들은 그렇게 하지만, 쓸모없는 것으로 인식되는 물리적 유물로 부터 신념 체계에 관한 해석에 도달하는 것과 관련된 더 많은 추론이 어쩔 수 없이 있어야 한다."
    ],
    "tags": [
      "#철학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "TV를 보는 것처럼 평범한 행동일지라도 그 행동은 어떤 사람들이 주의를 딴 데로 돌 리는 것을 통해 고통스러운 자각에서 벗어나는 방법이 될 수 있다. 이 생각을 검증하 기 위해, Sophia Moskalenko와 Steven Heine은 참가자들에게 그들의 시험 성적에 관한 거짓 피드백을 주었고, 그런 다음 연구의 다음 부분으로 각각 TV 앞에 앉아 비 디오를 시청하게 했다. 음악 사운드트랙과 함께 자연의 장면을 보여 주는 비디오가 나오자, 실험자는 이것이 잘못된 비디오라고 소리쳤고, 아마도 제대로 된 것을 가지러 가면서, 참가자를 비디오가 재생될 때 홀로 남겨두었다. (시험 성적에 관하여) 실패라 는 피드백을 받았던 참가자들은 자신이 성공했다고 생각하는 참가자들보다 훨씬 더 오래 비디오를 시청했다. 연구자들은 텔레비전 시청을 통해 주의를 딴 데로 돌리는 것이 고통스러운 실패나 자신과 자기 안내 지침 사이의 불일치와 관련된 불편함을 효 과적으로 완화할 수 있다고 결론지었다. 이와 대조적으로, 성공한 참가자들은 자기 자 신과 관련된 생각에서 주의가 딴 데로 돌려지기를 거의 바라지 않았다!"
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "개별적이고 문화적으로 형성된 행동과 문화적 통합의 상태 사이의 상호의존성을 인식 하는 것은 중요하다. 사람들은 아무리 모순되더라도 자신이 내면화한 문화적 패턴에 의해 제공되는 형태 내에서 일한다. 사상은 다른 수용된 사상의 논리적 영향이나 결 과로 도출되고, 이러한 방식으로 문화적 혁신과 발견이 가능하다. 새로운 사상은 논리 적 추론을 통해 발견되지만, 그러한 발견은 개념 체계에 내재 및 (일부로서) 내장되어 있고, 오직 그 전제를 수용하기 때문에 가능해진다. 예를 들어, 새로운 소수의 발견은 사용되고 있는 특정 숫자 체계의 ‘실제’ 결과이다. 따라서, 문화적 사상은 이전 사상 의 결과물이기 때문에 ‘진보’와 ‘발전’을 보여 준다. 많은 개인의 축적된 작업은 특정 ‘발견’이 가능해지거나 가능성이 높아지는 집적된 지식을 생산한다. 그러한 발견은 (이루어지기에) ‘알맞게 익었고’, 더 일찍 발생할 수 없었을 것이며, 또한 다수의 개인 에 의해 동시에 이루어질 가능성이 있다."
    ],
    "tags": [
      "#철학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "동물이 무해한 자극 앞에서 움직일 수 있게 하는 것은 학습의 거의 보편적인 기능이 다. 대부분의 동물은 선천적으로 이전에 마주치지 않은 대상을 피한다. 익숙하지 않은 대상은 위험할 수 있으므로, 그것을 조심해서 다루는 것은 생존가(生存價)를 갖는다. 그러나 그러한 신중한 행동이 지속된다면, 그 행동은 조심해서 얻는 이익이 소실될 정도로 먹이 섭취와 다른 필요한 활동을 방해할 수도 있다. 바람이 조금 불 때마다, 또는 구름이 그림자를 드리울 때마다 등껍질 속으로 움츠리는 거북은 게으른 토끼와 의 경주라도 결코 이기지 못할 것이다. 이 문제를 극복하기 위해, 거의 모든 동물은 자주 발생하는 안전한 자극에 익숙해져 있다. 낯선 대상에 직면하면, 경험이 없는 동 물은 얼어붙거나 숨으려고 할 수도 있지만, 불쾌한 일이 일어나지 않으면 그것은 머 잖아 활동을 계속할 것이다. 익숙하지 않은 대상이 유용할 가능성도 있으므로, 그것이 즉각적인 위협을 주지 않는다면, 더 자세히 살펴보는 것이 가치가 있을 수도 있다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "다양한 이론적 관점은 이주에 대한 통찰을 제공한다. 행위자들이 효용 극대화에 참여 한다고 상정하는 경제학은 하나의 틀을 제시한다. 이런 관점에서는 개인은 합리적인 행위자라고, 즉 그들은 특정한 지역을 떠나는 것의 비용 및 편익과 대비하여 남는 것24 의 비용과 편익 모두에 대한 자신의 평가에 근거하여 이주 결정을 내린다고 추정된 다. 편익은 단기적 및 장기적인 금전적 이득, 안전, 문화적 표현의 더 큰 자유를 포함 할 수도 있지만 이에 국한되지는 않는다. (더 큰 금전적 혜택이 있는 사람들은 사치 품을 구입함으로써 자신의 사회적 지위를 과시하기 위해 돈을 쓰는 경향이 있다.) 개 인적 비용은 이동 비용, 타지에서 사는 것의 불확실성, 다른 언어에 적응하는 것의 어려움, 다른 문화에 대한 불확실성, 새로운 지역에서 사는 것에 대한 큰 염려를 포 함하지만 이에 국한되지는 않는다. 가족, 친구와의 이별과 미지의 것에 대한 두려움과 관련된 심리적 비용 또한 비용-편익 평가에서 고려되어야 한다."
    ],
    "tags": [
      "#경제",
      "#사회"
  ...
  },
  {
    ...
    "content": [
      "Green products involve, in many cases, higher ingredient\ncosts than those of mainstream products. They’d rather put money and time into known, profitable,\nhigh-volume products that serve populous customer\nsegments than into risky, less-profitable, low-volume\nproducts that may serve current noncustomers. Given that\nchoice, these companies may choose to leave the green\nsegment of the market to small niche competitors. Even if the green product succeeds, it may cannibalize the\ncompany’s higher-profit mainstream offerings. Given such\ndownsides, companies serving mainstream consumers with\nsuccessful mainstream products face what seems like an\nobvious investment decision. Furthermore, the restrictive ingredient lists and design\ncriteria that are typical of such products may make\ngreen products inferior to mainstream products on core\nperformance dimensions (e.g., less effective cleansers). In\nturn, the higher costs and lower performance of some\nproducts attract only a small portion of the customer base,\nleading to lower economies of scale in procurement,\nmanufacturing, and distribution."
    ],
    "translation": [
      "많은 경우, 친환경 제품은 주류 제품보다 더 높은 원료비를 수반한다. 게다가 그 런 제품에서 일반적인 제한 성분 목록과 디자인 기준이 친환경 제품을 주류 제품보다 핵심 성능 측면(예를 들어, 덜 효과적인 세척제)에서 더 열등하게 만들 수 있다. 결과 적으로, 일부 제품의 더 높은 비용과 더 낮은 성능은 고객층의 오직 적은 부분만 유 인해서, 조달, 제조, 유통에서 더 낮은 규모의 경제를 초래한다. 친환경 제품이 성 공하더라도 기업의 고수익 주류 제품을 잡아먹을 수 있다. 이런 부정적인 면을 고려 하면, 성공적인 주류 제품으로 주류 소비자의 요구를 충족하는 기업들은 마치 뻔한 투자 결정처럼 보이는 것에 직면한다. 그들은 현재 고객이 아닌 사람들의 요구를 충족할 수 있는 위험하고 수익성이 더 낮은 소량의 제품보다는, 다수의 고객 계층의 요구를 충족하는, 이미 알고 있고 수익성이 있는 다량의 제품에 돈과 시간을 투자하 고 싶어 한다. 그런 선택을 고려하면, 이들 기업은 소규모 틈새 경쟁업체들에게 시장 의 친환경 부문을 남겨두는 선택을 할 수 있다."
    ],
    "tags": [
      "#경제"
    ],
  ...
  },
  {
    ...
    "translation": [
      "초기 인류는 매우 제한된 수의 물질, 즉 돌, 나무, 찰흙, 가죽 등 자연적으로 존재하 는 물질에만 접근할 수 있었다. 시간이 흐르면서 그들은 자연적인 특성의 물질보다 더 우수한 특성을 가진 물질을 만들어 내는 기술을 발견했는데, 이 새로운 물질에는 도자기와 다양한 금속이 포함되었다. 게다가, 물질의 특성이 열처리와 여타 다른 물질 의 첨가로 바뀔 수 있다는 것이 발견되었다. 이 시기에, 물질 이용은 주어진 상당히 제한된 물질 집합 중에서 물질의 특성에 근거하여 용도에 가장 적합한 물질을 결정하 는 것을 수반하는 전적으로 선택의 과정이었다. 비로소 과학자들이 물질의 구조적 요 소와 물질 특성의 관계를 이해하게 된 것은 비교적 최근에 이르러서였다. 대략 지난 100년 동안 획득된 이 지식으로 그들은 상당한 정도로 물질의 특성을 형성할 수 있 게 되었다. 따라서 금속, 플라스틱, 유리, 섬유를 포함하여, 현대적이고 복잡한 우리 사회의 요구를 충족하는 상당히 특화된 특성을 가진 수만 가지의 다양한 물질이 생성 되었다."
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "translation": [
      "을 두 집단으로 나눈다. 한 집단(실험 집단)은 비타민 C 보충제를 받고 다른 집단(통 제 집단)은 비타민 C 보충제를 받지 않는다. 연구원들은 한 집단이 다른 집단보다 감 기에 더 적게 또는 더 짧게 걸리는지를 알아내기 위해 두 집단 모두를 관찰한다. 이 어지는 논의는 이러한 종류의 실험에 내재한 함정 중 일부와 이를 피하는 방법을 설 명한다. 실험 대상자를 두 집단으로 분류할 때, 연구원들은 반드시 각 개인이 실험 집단 또는 통제 집단 둘 중 한 곳에 배정될 확률이 동일하도록 해야 한다. 이는 임의 추출에 의해 달성되는데 즉 실험 대상자는 동전 던지기나 우연이 포함된 어떤 다른 방법에 의해 동일 모집단에서 임의로 선정된다. 임의 추출은 반드시 결과에 처리가 반영되도록, 실험 대상자의 분류에 영향을 줄지도 모르는 요인은 반영되지 않도록 하 는 데 도움이 된다. 중요한 것은, 감기의 비율, 심각성, 또는 지속 기간에서 관찰된 차이가 어떤 식으로든 일어났을지도 모른다는 가능성을 배제하기 위해 감기와 관련하 여 두 집단의 사람들이 비슷하고 동일한 기록을 가지고 있어야 한다는 것이다. 예를 들어, 통제 집단이 보통 실험 집단보다 감기에 무려 두 배나 많이 걸리는 경우, 연구 결과는 아무것도 입증하지 못한다. 영양분을 포함하는 실험에서, 두 집단의 식단 또한 달라야(→ 비슷해야) 하며, 연구 중인 영양분에 관련해서 특히 그래야 한다. 실험 집 단에 속한 사람들이 평소 식단에서 비타민 C를 적게 섭취하고 있었다면, 보충제의 어 떤 효과도 분명하지 않을 수 있다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "조직이 소셜 미디어로 실험하는 것을 처음 고려할 때 범하는 가장 일반적인 실수 중 하나는 너무 지나치게 소셜 미디어 도구와 플랫폼에 중점을 두고 조직 자체의 사업 목표에는 충분히 중점을 두지 않는 것이다. 기업을 위한 소셜 웹에서의 성공의 실제 는 소셜 미디어 프로그램을 고안하는 것이 최신 소셜 미디어 도구와 채널에 대한 통 찰력이 아니라 조직 자체의 목적과 목표에 대한 철저한 이해와 더불어 시작된다는 것 이다. 소셜 미디어 프로그램은 그저 ‘다른 모든 이가 하고 있기’ 때문에 인기 소셜 네 트워크상에서 ‘존재’를 관리해야 할 막연한 필요를 이행하는 것이 아니다. ‘소셜 미디 어에 있다는 것’은 그 자체로는 아무 쓸모도 없다. 조금이라도 어떤 쓸모가 있으려면, 소셜 미디어상의 존재는 조직과 조직의 고객을 위해 문제를 해결하거나 어떤 종류의 개선이라는 결과(될 수 있으면 측정 가능한 결과)를 가져와야 한다. 어떤 일이든, 목 적이 성공을 이끌어낸다. 소셜 미디어의 세계도 다르지 않다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "과학자들은 도덕적 혹은 윤리적 결정에 대한 특별한 강점이 없으며, 기후 과학자가 의료 개혁에 대해 견해를 밝힐 자격이 없는 것은 물리학자가 꿀벌 집단의 붕괴 원인 을 판단할 자격이 없는 것과 같다. 전문화된 영역에서의 전문 지식을 만들어내는 바 로 그 특징이 많은 다른 영역에서의 무지로 이어진다. 어떤 경우에는, 전문가가 아닌 사람들, 즉 농부, 어부, 환자, 토착민이, 과학자들이 그것으로부터 배울 수 있는 관련 경험을 가지고 있을 수 있다. 실제로, 최근 들어 과학자들은 이 점을 인식하기 시작 했는데, 북극 기후 영향 평가는 지역 토착 집단에게서 수집된 관찰을 포함한다. 그러 므로 우리의 신뢰는 한정되고 초점이 맞춰질 필요가 있다. 그것은 매우 ‘특정할’ 필요14 가 있다. 맹목적 신뢰는 최소한 신뢰가 전혀 없는 것만큼이나 우리를 문제에 봉착하 게 할 것이다. 하지만 우리의 지정된 전문가들, 즉 평생을 우리가 사는 자연 세계에 관한 어려운 질문들을 처리하는 데 생애를 바친 남녀들에 대한 어느 정도의 신뢰가 없으면, 우리는 마비되고, 사실상 아침 통근을 위해 준비해야 할지 말아야 할지를 알 지 못할 것이다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "환경 위험 요인에는 생물학적, 물리적, 화학적 위험 요인과 함께 노출을 조장하거나 허용하는 인간의 행동이 포함된다. (오염된 공기의 호흡, 화학적으로 오염된 공공 식 수의 음용, 개방된 공공장소에서의 소음처럼) 일부 환경 오염 물질은 피하기가 어렵 고, 이러한 상황에서 노출은 대개 자기도 모르게 이루어진다. 이러한 요인의 감소 또 는 제거에는 대중의 인식 및 공중 보건 조치와 같은 사회적 조치가 필요할 수도 있 다. 많은 국가에서, 일부 환경적 위험 요인이 개인 수준에서 피하기 어렵다는 사실은 피할 수 있는 그 위험 요인보다 도덕적으로 더 매우 나쁜 것으로 느껴진다. 어쩔 수 없이 매우 높은 수준의 비소로 오염된 물을 마실 수밖에 없는 것이나, 식당에서 담배 연기를 수동적으로 들이마시도록 강요당하는 것은 개인이 담배를 피울지 말지에 대한 개인적인 선택보다 더 사람들을 화나게 한다. 이러한 요인들은 변화(위험 감소)가 어 떻게 일어나는지를 고려할 때 중요하다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "과학자들은 패러다임을 믿기보다는 그것을 ‘사용한다’. 연구에서 패러다임의 사용은 일반적으로 공유된 개념, 상징적 표현, 실험 및 수학적 도구와 절차, 그리고 심지어 동일한 이론적 진술의 일부를 사용함으로써 관련된 문제들을 다룬다. 과학자들은 다 른 사람들이 받아들일 방식으로 이러한 다양한 요소들을 사용하는 ‘방법’을 이해하기 만 하면 된다. 따라서 이러한 공유된 실행의 요소들은 과학자들이 그것들을 사용할 때 그들이 하고 있는 것에 관한 그들의 믿음에서 그 어떤 비슷한 통일성을 전제로 할 필요는 없다. 실제로, 패러다임의 한 가지 역할은 과학자들이 그들이 무엇을 하고 있 는지 또는 그들이 그것에 관해 무엇을 믿고 있는지에 대한 상세한 설명을 제공할 필 요 없이 성공적으로 일할 수 있게 하는 것이다. Thomas Kuhn이 언급하기를, 과학 자들은 “패러다임에 대한 완전한 ‘해석’이나 ‘이론적 설명’에 동의하거나, 심지어 그런 것을 만들어 내려고 시도조차 하지 않고도, 그것(패러다임)을 ‘식별’하는 데 있어서 일 치를 보일 수 있다. 표준적인 해석이나 규칙으로 축약되어 합의된 것이 없다 해도 패 러다임이 연구를 안내하는 것을 막지는 못할 것이다.”"
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "물건을 고치고 복원하는 것에는 흔히 최초 제작보다 훨씬 더 많은 창의력이 필요하 다. 산업화 이전의 대장장이는 가까이에 사는 마을 사람들을 위해 주문에 따라 물건 을 만들었고, 제품을 주문 제작하는 것, 즉 사용자에게 맞게 그것을 수정하거나 변형 하는 일이 일상적이었다. 고객들은 뭔가 잘못되면 물건을 다시 가져다주곤 했고, 따라 서 수리는 제작의 연장이었다. 산업화와 결국 대량 생산이 이루어지면서, 물건을 만드 는 것은 제한된 지식을 지닌 기계 관리자의 영역이 되었다. 그러나 수리에는 설계와 재료에 대한 더 큰 이해, 즉 전체에 대한 이해와 설계자의 의도에 대한 이해가 계속 요구되었다. 1896년의 Manual of Mending and Repairing의 설명에 따르면, “제조 업자들은 모두 기계나 방대한 분업으로 일하고, 말하자면 수작업으로 일하지는 않는 다.” “그러나 모든 수리는 손으로 ‘해야 한다’. 우리는 기계로 손목시계나 총의 모든 세부적인 것을 만들 수 있지만, 고장 났을 때 기계는 그것을 고칠 수 없으며, 시계나 권총은 말할 것도 없다!”"
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "개체 전체와 마찬가지로, 세포도 수명을 가지고 있다. 그것의 생명 주기(세포 주기) 동안에, 세포의 크기, 모양, 물질대사 활동이 극적으로 변할 수 있다. 세포는 모세포 가 분열할 때 쌍둥이로 ‘탄생’하여, 두 개의 딸세포를 생성한다. 각각의 딸세포는 모 세포보다 더 작으며, 특이한 경우를 제외하고는 각각 모세포의 크기만큼 커질 때까지 자란다. 이 기간 동안, 세포는 물, 당, 아미노산, 그리고 다른 영양소들을 흡수하고 그 것들을 새로운 살아있는 원형질로 조합한다. 세포가 적절한 크기로 성장한 후, 그것은 분열할 준비를 하거나 혹은 성숙하여 특화된 세포로 분화하면서 그것의 물질대사가 변화한다. 성장과 발달 둘 다 모든 세포 부분을 포함하는 일련의 복잡하고 역동적인 상호 작용을 필요로 한다. 세포의 물질대사와 구조가 복잡할 것임은 놀라운 것이 아 니겠지만, 실제로 그것들은 꽤 간단하고 논리적이다. 가장 복잡한 세포조차도 그저 몇 몇 부분만을 가지고 있는데, 각각은 세포 생명의 뚜렷하고, 명확한 측면을 맡고 있다."
    ],
    "tags": [
      "#철학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "천연 제품들만 투입물로 사용되는 방식으로 정의되는 ‘유기농’ 방식은 생물권에 해를 덜 끼친다고 시사되어 왔다. 그러나 ‘유기농’ 경작 방식의 대규모 채택은 많은 주요 작물의 산출량을 감소시키고 생산비를 증가시키게 된다. 무기질 질소 공급은 많은 비20 (非)콩과 작물 종의 생산성을 중상 수준으로 유지하는 데 필수적인데, 그것은 질소성 물질의 유기적 공급이 무기 질소 비료보다 자주 제한적이거나 더 비싸기 때문이다. 게다가, ‘친환경적인 거름’ 작물로 거름이나 콩과 식물의 광범위한 사용에는 이점(→ 제약)이 있다. 많은 경우, 화학 물질이 사용될 수 없으면 잡초 방제가 매우 어렵거나 많은 손일이 필요할 수 있는데, 사회가 부유해짐에 따라 이 작업을 기꺼이 하려 는 사람이 더 적을 것이다. 그러나 돌려짓기의 합리적인 사용과 경작과 가축 경영의 특 정한 조합과 같은 ‘유기농’ 경작에서 사용되는 몇몇 방식들은 농촌 생태계의 지속 가 능성에 중요한 이바지를 할 수 있다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "유머는 실제적인 이탈뿐만 아니라 인식의 이탈을 포함한다. 어떤 것이 재미있다면, 우 리는 잠깐 그것이 진짜인지 허구인지, 진실인지 거짓인지에 관해 관심을 두지 않는다. 이것이 우리가 재미있는 이야기를 하는 사람들에게 상당한 여지를 주는 이유이다. 만 약 그들이 상황의 어리석음을 과장하거나 심지어 몇 가지 세부 사항을 꾸며서라도 추 가 웃음을 얻고 있다면, 우리는 그들에게 기꺼이 희극적 파격, 일종의 시적 파격을 허락한다. 실제로, 재미있는 이야기를 듣고 있는 누군가가 ‘아니야, 그는 스파게티를 키보드와 모니터에 쏟은 것이 아니라 키보드에만 쏟았어.’라며 말하는 사람을 바로잡 으려고 하면 그는 아마 듣고 있는 다른 사람들에게서 방해하지 말라는 말을 들을 것 이다. 유머를 만드는 사람은 사람들의 머릿속에 생각을 집어넣고 있는데, 그 생각이 가져올 재미를 위해서이지 정확한 정보를 제공하기 위해서가 아니다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "뉴스, 특히 텔레비전으로 방송되는 형태는 그것이 선택하는 주제와 이야기뿐만 아니 라 그것의 언어적, 시각적 표현 양식이나 전달 방식에 의해서도 구성된다. 표현 방식 은 정보 제공 및 교육적 목적과 재미있게 우리의 주의를 끌 필요성 사이의 긴장 상태 에 영향을 받아 왔다. 시사 프로그램들이 흔히 균형이라는 ‘규칙’을 고수하면서 어조 가 ‘진지하’지만, 더 대중적인 프로그램들은 친근하고 더 가벼운 표현 양식을 채택하 는데 그 표현 양식에서 우리는 ‘거리에서 만나는 보통 사람’의 관점에서 특정 뉴스 기사의 영향을 고려해보게 된다. 사실, 현대의 뉴스 구성은 로고, 짤막한 방송용 어 구, 빠른 시각적 편집 화면, 그리고 뉴스 독자의 ‘스타성’을 이용하는 것을 포함한 더 빠른 편집 속도와 ‘더 현란한’ 표현 방식을 더 많이 이용하는 것에 의존하게 되었다. 대중적인 구성은 장황한 언어를 지향하는 낡은 뉴스 구성 방식을 견딜 의사가 없는 시청자의 주의를 끌어서 이해를 높였다고 할 수 있다. 하지만 그것은 뉴스 사건에 관 한 구조적 맥락을 제공하지 못함으로써 아마 틀림없이 이해를 감소시키는 효과가 있 다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "Elinor Ostrom은 공유지의 문제에 대한 안정적인 제도적 해결책을 가져오는 데 중요 한 몇 가지 요인이 있음을 알게 되었다. 예를 들어, 그녀는 자원의 이용 및 관리 규 칙의 영향을 받는 행위자에게 규칙을 변경하는 결정에 참여할 권리가 있어야 한다고 지적했다. 그러한 이유로 이용자의 행동을 감시하고 통제하는 사람 또한 이용자이고/ 이용자이거나 모든 이용자에 의한 위임을 받았어야 한다. 이것은 중요한 통찰인데, 이 용자가 개인적 책임을 지는 지역적인 해결책에 비해 국가 권력에서 나오는 공유지 문 제에 대한 중앙 (정부) 지향적 해결책의 전망이 열악하다는 것을 그것이 보여주기 때 문이다. Ostrom은 또한 민주적 의사결정 과정의 중요성과 모든 이용자에게 그들 사 이의 문제와 갈등을 해결하기 위한 지역 포럼에 참여할 권한이 주어져야 한다고 강조 한다. 중앙, 지방 및 지역 차원의 정치 기관들은 이용자가 자체 규정을 고안하고 독 립적으로 준수할 수 있도록 해야 한다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "정확성과 확정성은 모든 의미 있는 과학 토론을 위한 필요 조건이며, 과학에서의 발전은 상당 부분, 훨씬 더 높은 정확성을 달성하는 계속 진행 중인 과정이다. 그러나 역사적 진 술은 진술의 증식을 중요시하는데, 이는 한 가지 진술의 정제가 아닌, 훨씬 더 다양한 진23 술 집합의 생성에 중요성을 두는 것이다. 역사적 통찰은 이전에 선택한 것들을 지속해서 ‘좁혀 가는’ 것의 문제, 즉 진리에 근접함의 문제가 아니라, 반대로 가능한 관점들의 ‘폭 발적 증가’이다. 그러므로 그것은 이전의 진술에서 무엇이 옳고 틀렸는지에 대한 신중한 분석에 의해 진리를 획득하는 것이 아니라, 새롭고 대안적인 진술의 생성에 의해 확정성 과 정확성에 대해 이전에 가진 환상의 정체를 드러내는 것을 목표로 한다. 그리고 이러 한 관점에서 보면, 역사적 통찰의 발전은 과학에서처럼 진리에 훨씬 더 많이 근접함보다 는, 훨씬 더 큰 혼란을 만들어내는 과정, 즉 이미 획득한 것처럼 보이는 확실성과 정확성 에 대한 지속적인 의문 제기로 외부인에게 진정 여겨질 수도 있다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "정보 시스템은 도입 이래로 사업 수행 방식을 상당히 변화시켜왔다. 이는 특히 다수 의 부문에 걸쳐 가치 체인의 통합을 수반하는 기업 간의 협력 형태와 유형의 사업에 특히 해당된다. 그 결과로 나타내는 네트워크는 단일 기업의 사업 부문을 포함할 뿐 만 아니라, 서로 다른 기업의 여러 부문을 포함하기도 한다. 결과적으로, 기업은 지속 가능한 사업 성과를 보장하기 위해 그들 내부 조직에 주의를 기울일 필요가 있을 뿐 만 아니라, 자신들을 둘러싸고 있는 부문들의 전체 생태계를 고려할 필요도 있다. (많 은 주요 기업들은 수익성이 있는 부문에는 집중하고 수익성이 낮은 부문은 잘라냄으 로써 자신들의 사업 모델을 근본적으로 변화시키고 있다.) 이 서로 다른 부문들이 성 공적으로 협력할 수 있도록 하기 위해서는 공동 플랫폼의 존재가 매우 중요하다.24"
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "공장에 로봇을 도입하는 것은, 인간 노동자의 고용이 줄어들면서 걱정과 두려움을 불 러일으킨다. 이러한 두려움을 예방하거나 최소한 완화하는 것은 경영진의 책임이다. 예를 들어 로봇은 기존 조립 라인에서 인간을 대체하는 대신 새로운 공장에만 도입될 수 있다. 노동자는 새로운 공장을 계획하거나 기존의 공장에 로봇을 도입하는 데 포26 함되어야 하는데, 그렇게 함으로써 그들은 그 과정에 참여할 수 있다. 회사가 경쟁력 을 유지하도록 제조원가를 낮추기 위해 로봇이 필요할 수도 있지만, 그러한 원가절감 을 위한 계획은 노사가 함께해야 한다. 회사 내 새로운 직책을 위해 현재 직원을 재 교육하면 해고에 대한 두려움도 또한 크게 줄어들 것이다. 로봇은 특히 매우 반복적 인 단순 동작을 잘하기 때문에 교체된 인간 노동자는 로봇의 능력을 넘어선 판단과 결정이 필요한 위치로 옮겨져야 한다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "영화는 우리 현실의 숨겨진 윤곽을 보이게 만드는 능력 때문이 아니라 현실 자체가 가리고 있는 것, 즉 환상의 차원을 드러내는 능력 때문에 가치가 있다. 이것이 최초 의 위대한 영화 이론가들이 영화를 사실주의 쪽으로 밀어붙였던 소리와 (색채와 같은) 다른 기술 혁신의 도입을 이구동성으로 비난한 이유이다. 영화는 전적으로 환상적인 예술이었기 때문에 이러한 혁신은 완전히 불필요했다. 그리고 설상가상으로 그것들은 잠재적으로 영화를 현실의 묘사를 위한 단순한 전달 장치로 변형시키면서, 영화 제작 자와 관객을 영화의 환상적인 차원에서 멀어지게 할 수 있을 뿐이었다. 무성 흑백 영 화의 비현실주의가 지배하는 동안은 영화적 환상을 현실에 대한 묘사로 착각할 수 없 었다. 그러나 소리와 색채는 바로 그러한 착각을 만들겠다고 위협하여 영화 예술의 바로 그 본질을 파괴했다. Rudolf Arnheim이 표현한 것처럼 “예술가의 창의적 힘은 현실과 묘사의 매체가 일치하지 않는 곳에서만 발휘될 수 있다.”"
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "사물들을 묶어서 그룹으로 분류하는 것은 우리가 항상 하는 일이며, 그 이유를 이해 하는 것은 어렵지 않다. 음식이 진열대에 마구잡이로 배열된 슈퍼마켓에서 쇼핑하려 고 한다고 상상해 보라. 한 통로에서는 흰빵 옆에 토마토 수프가 있고, 치킨 수프는 뒤쪽에 있는 60와트 백열 전구 옆에 있고, 한 크림치즈 브랜드는 앞쪽에, 또 다른 하 나는 쿠키 근처의 8번 통로에 있다. 여러분이 원하는 것을 찾는 일은, 불가능하지는 않더라도, 시간이 많이 걸리고 매우 어려울 것이다. 슈퍼마켓의 경우, 누군가는 분류 체계를 설계해야 했다. 하지만 또한 우리 언어에 포 함되어 있는 기성의 분류 체계도 있다. 예를 들어, ‘개’라는 단어는 특정 부류의 동물 들을 함께 분류하여 다른 동물들과 구별한다. 분류라고 하기에는 그러한 분류가 너무 추상적으로(→ 분명해) 보일 수 있지만, 이것은 단지 여러분이 이미 그 단어를 숙달했 기 때문이다. 말하기를 배우는 아이로서, 여러분은 부모님이 가르쳐주려 애썼던 분류 체계를 익히기 위해 열심히 노력해야 했다. 여러분이 그것을 이해하기 전에, 아마 고 양이를 개라고 부르는 것과 같은 실수를 했을 것이다. 만약 여러분이 말하기를 배우 지 않았다면, 온 세상이 정돈되지 않은 슈퍼마켓처럼 보일 것이다. 여러분은 모든 물 건이 새롭고 낯선 유아의 처지에 있을 것이다. 그러므로 분류의 원리를 배울 때, 우 리는 언어의 핵심에 있는 구조에 대해 배우고 있는 것이다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "‘결합 인지 시스템’ 접근법은 로봇을 지력이 서로 도움을 주고, 각 행위자의 기여로 생겨나는 인간-기계 팀의 일부로 다룬다. 그 팀은 적어도 로봇 하나와 인간 한 명으 로 구성되고 그 팀이 인간 행위자와 로봇 행위자가 혼합된 것이기 때문에 흔히 ‘혼합16 팀’이라고 불린다. 사람이 주행(엔진)을 켜고 끄는 자율주행차는 결합 인지 시스템의 한 예이다. 오락용 로봇은 재택근무를 위한 로봇처럼 혼합팀의 예다. 설계 과정은 그 행위자들이 팀의 목표를 달성하기 위해 어떻게 서로 협력하고 조정하는지에 집중한 다. 결합 인지 시스템 접근법은 로봇을 그들 자체의 완전히 독립된 과제를 가진 동료 행위자로 다루기보다는 로봇을 도우미 동물이나 양몰이 개처럼 도움을 주는 존재로 다룬다. 결합 인지 시스템 설계에서, 훌륭한 팀 구성원이 될 만큼 똑똑해질 수 있는 로봇을 만들기 위해 인공 지능이 인간-로봇 상호작용 원리와 함께 사용된다."
    ],
    "tags": [
      "#심리학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "최근 몇 년 동안 전 세계적으로 도시 교통 전문가들은 도시의 자동차 수요에 부응하 기보다는 관리해야 한다는 견해를 대체로 따랐다. 소득 증가는 필연적으로 자동차 보 급의 증가로 이어진다. 기후 변화로 인한 불가피성이 없다 하더라도, 인구 밀도가 높 은 도시의 물리적 제약과 그에 상응하는 접근성, 이동성, 안전, 대기 오염, 그리고 도 시 거주 적합성에 대한 요구 모두가 단지 이러한 증가하는 수요에 부응하기 위해 도 로망을 확장하는 선택권을 제한한다. 결과적으로, 도시가 발전하고 도시의 거주자들이 더 부유해짐에 따라, 사람들이 자동차를 사용하지 ‘않기로’ 결정하도록 설득하는 것이 도시 관리자와 계획 설계자들의 핵심 중점 사항이 된다. 걷기, 자전거 타기, 대중교통 과 같은 대안적인 선택 사항의 질을 향상하는 것이 이 전략의 핵심 요소이다. 하지만 자동차 수요에 부응하는(→ (를) 관리하는) 가장 직접적인 접근 방법은 자동차 여행을 더 비싸게 만들거나 행정 규정으로 그것을 제한하는 것이다. 자동차 여행이 기후 변 화의 원인을 제공하는 것이 이런 불가피성을 강화한다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "21 자기 일에 디지털 기술을 이용하는 젊은 현대 미술가들은 컴퓨터를 거의 언급하지 않 는다. 예를 들어, 워드 프로세싱 프로그램과 잉크젯식 프린터를 사용하는 추상파 화가 인 Wade Guyton은 자신을 컴퓨터 아티스트라고 부르지 않는다. 게다가, 그의 작품 을 높이 평가하는 몇몇 비평가들은 예술 창작 과정에서 그의 광범위한 컴퓨터 사용에 관해 거의 신경 쓰지 않는다. 이것은 컴퓨터를 활용하는 미술가들이 비평가들에 의해, 자주 탐탁지 않게, 컴퓨터 아티스트라고 명명되었던 30년 전과 뚜렷이 대조된다. 현 세대의 미술가들에게 컴퓨터, 혹은 더욱 적절히는 휴대용 컴퓨터는, 그들의 사회 생활 과 직업 생활을 연결하는 일련의 통합된, 휴대 가능한 디지털 기술 중 하나이다. 인 터넷 사용에서 태블릿 컴퓨터와 휴대 전화가 개인용 컴퓨터를 능가하는 상황에서, 그 리고 얇은 디지털 기기들이 수십 년 전의 방 크기의 중앙 컴퓨터와 부피가 큰 탁상용 컴퓨터와 전혀 닮지 않았으므로, 오늘날에는 컴퓨터 아티스트가 결국 소멸한 것으로 보인다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "형식주의의 관점에서 문학에 관하여 쓰고자 하는 비평가는 먼저 글의 모든 요소를 개 별적으로 검토하고 그것들이 모여 예술 작품을 만드는 방식에 대해 질문하는 면밀하 고도 주의 깊은 독자가 되어야 한다. 작품의 자율성을 존중하는 그러한 독자는 그것 의 외부나 그것을 넘어서가 아니라 그것의 내부를 들여다봄으로써 그것에 대한 이해 를 달성한다. 예를 들어, 역사상의 시대, 작가의 전기, 또는 문학적 양식을 검토하는 대신, 그 사람은 글이 자족적인 실체이며, 자신은 그 글이 스스로를 드러내도록 해22 주는 지배적인 원칙을 찾고 있다는 추정으로 글에 접근할 것이다. 예를 들어, James Joyce의 단편 소설인 ‘Araby’ 속의 등장인물들과 그가 개인적으로 알았던 사람들과 의 관련성은 흥미로울 수도 있겠지만, 그 형식주의자에게 그것들은 그 이야기가 그 안에 포함하고 있는 다른 종류의 정보보다 이야기가 의미를 만들어내는 방식을 이해 하는 데 덜 관련되어 있다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "제조업자들은 자신들이 생각하기에 그 과정이 작동되는 방식에 맞춰 자신들의 혁신 과정을 설계한다. 제조업자의 대다수는 제품 개발과 서비스 개발은 항상 제조업자들 에 의해 이루어지며, 자신들의 일은 가끔 리드유저(시장 경향을 선도하는 사용자)가 이미 개발한 혁신을 발견하고 상업화하기보다는 항상 필요를 발견하고 그것을 채우는 것이라고 여전히 생각한다. 그래서, 제조업자들은 핵심 대상 시장 사용자들의 필요를 탐구하기 위한 시장 연구 부서, 그러한 필요에 대처하기에 적절한 제품을 고안하기 위한 제품 개발 집단 및 기타 등등을 설치해 왔다. 리드유저의 필요와 시제품 해결책 은, 만일 정말 마주치기라도 한다면, 대체로 전혀 흥미롭지 않은 아웃라이어(해당 범 위에서 많이 벗어나는 것)로 거부된다. 정말로, 리드유저의 혁신이 그 회사의 제품 라 인에 정말로 들어가게 될 때―그리고 그것은 많은 회사의 여러 주요 혁신의 실질적인 원천이 되는 것으로 알려졌는데―그것은 대체로 지연 후에 이례적이고 비체계적인 경 로를 통해 도착한다."
    ],
    "tags": [
      "#경제",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "전개부는 매우 복잡하고 별날 수가 있다. Johann Sebastian Bach의 푸가는 하나의 멜로디 라인, 때로는 단지 소수의 음이 그 작곡가가 일관된 구조 내에서 많은 복잡한 전개부를 포함하는 훌륭한 작품을 만들기 위해 필요한 전부였을 때, 이 과정이 얼마 나 효과를 보일 수 있을지를 보여준다. Ludwig van Beethoven의 유명한 5번 교향 곡은 클래식 작곡가가 몇 개의 음과 단순하며 리듬감 있는 두드림으로 얼마나 많은 이익을 얻어낼 수 있는지에 대한 이례적일 정도로 우수한 예를 제공한다. 모든 사람 들이 어디선가 들어본 시작 부분의 다-다-다-덤은 일종의 반복 악구나 연결 끈처럼, 시작 악장뿐만 아니라 나머지 3악장 내내 엄청나게 다양한 방식으로 나타난다. 우리 가 그림 작품 하나를 완성하는 데 들인 복잡한 붓놀림을 항상 볼 수 있는 것이 아니 듯이, Beethoven이 자신의 반복 악구를 어떻게 계속 새롭게 사용하는 것을 찾는지 또는 그의 제재를 거대하고 응집력 있는 진술로 어떻게 전개하는지를 항상 알아보지 는 못할 수도 있다. 그러나 그 강력한 교향곡에서 우리가 얻는 즐거움의 많은 부분은 그 이면의 독창성, 즉 음악적 아이디어의 인상적인 전개에서 비롯된다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "상대를 공격하는 것과 도피하는 것 사이에서 갈등하는 동물은 처음에는 즉시 결정을 내릴 수 있게 해줄 만큼 충분한 정보를 갖지 못할 수도 있다. 상대가 싸움에서 이길 것 같다면, 최적의 결정은 즉시 포기하고 부상당할 위험을 무릅쓰지 않는 것일 것이 다. 하지만 상대가 약해서 쉽게 이길만하다면, 싸워서 영역, 암컷, 먹이 또는 성패가 달린 것은 무엇이든 얻는 것에 상당한 이익이 있을 수 있을 것이다. (보통의 상황에 서 동물은 매우 일정한 체중을 유지하며, 그들은 규칙적인 간격으로 자신들에게 필요 한 만큼 충분히 먹고 마신다.) 상대에 대한 정보를 수집하는 데 약간의 추가 시간을 들임으로써, 그 동물은 그러한 정보 없이 결정을 내리는 경우보다 이길 가능성을 최 대화하는 결정에 도달할 가능성이 더 크다. 오늘날 많은 신호들이 이러한 정보 수집 또는 ‘평가’ 기능을 갖는 것으로 간주되어, 다양한 선택의 가능한 결과에 관한 매우 중요한 정보를 제공함으로써 의사 결정 과정의 메커니즘에 직접적으로 기여한다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "content": [
      "In economics, there is a principle known as the sunk cost\nfallacy. The idea is that when you are invested and have\nownership in something, you overvalue that thing. Sometimes, the smartest thing a person can do is quit.\nAlthough this is true, it has also become a tired and\nplayed-out argument. Sunk cost doesn’t always have to be\na bad thing. This leads people to continue on paths or pursuits that\nshould clearly be abandoned. For example, people often\nremain in terrible relationships simply because they’ve\ninvested a great deal of themselves into them. Or someone\nmay continue pouring money into a business that is\nclearly a bad idea in the market. Actually, you can leverage this human tendency to your\nbenefit. Like someone invests a great deal of money in a\npersonal trainer to ensure they follow through on their\ncommitment, you, too, can invest a great deal up front to\nensure you stay on the path you want to be on."
    ],
    "translation": [
      "경제학에서 ‘ 매몰 비용 오류’라고 알려진 원리가 있다. 여러분이 어떤 것에 투자하고 소유권을 가지면, 그것을 지나치게 중시한다는 생각이다. 이것은 사람들이 분명히 그만두어야 하는 경로를 계속 따르거나 추구를 계속하게 한다. 예를 들어, 사람들은 그저 자신의 많은 것을 그 관계에 투여했기 때문에 자주 끔찍한 관계에 남아 있다. 또는, 누군가는 시장에서 분명히 나쁜 아이디어인 사업에 계속 돈을 쏟아부을지도 모 른다. 때로는 한 사람이 할 수 있는 가장 현명한 일은 중지하는 것이다. 이것이 진실이더라도, 그것은 또한 식상하고 효력이 떨어진 주장이 될 수 있다. 매몰 비용이 언제나 나쁜 것이 틀림없는 것은 아니다. 실제로, 여러분은 이 인간적인 경향을 여러분에게 득이 되도록 이용할 수 있다. 확실히 자신이 자신의 약속을 끝까지 완수 하기 위해 많은 돈을 개인 트레이너에게 투자하는 사람처럼, 여러분 또한 여러분이26 있고 싶은 경로에 확실히 있기 위해 선지급으로 많은 것[돈]을 투자할 수 있다."
    ],
    "tags": [
      "#경제",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "다면적인 창의적 활동에 대한 어떤 방해 요인은 너무 이른 전문화, 즉 인생의 너무 이른 시기에 교육 방향을 선택하거나 한 가지 능력 개발에 집중해야 하는 것에 있을 수 있다. 그러나 한 영역에서의 창의적 능력 개발은 비슷한 기술을 필요로 하는 다른 영역에서 효과를 높일 수 있으며, 일반성과 특수성 사이의 유연한 전환은 많은 영역 에서 생산성에 도움이 된다. 지나친 특수성은 해당 영역 외부로부터 오는 정보가 과 소평가 되고 활용할 수 없게 되는 결과를 낳을 수 있어 사고의 고정성으로 이어지는 반면, 지나친 일반성은 혼돈, 모호함, 얕음을 초래한다. 두 가지 경향 모두 영역 간 지식과 기술 이전에 대한 위협이 된다. 그러므로 영역 간 창의성 개발을 위해 응당 최선인 것은 특정한 영역에서 창의적인 도전을 하기 시작할 때 젊은이들을 지원하고 그것을 다른 영역, 분야, 과업으로부터 나온 지식과 기술을 적용할 뿐만 아니라, 다른 영역, 분야, 과업에 지식과 기술을 적용하도록 장려하는 것과 결합하는 것이다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "변호사들은 때로는 소유권을 ‘막대 다발’로 묘사한다. 이 비유는 약 1세기 전에 도입 되었고, 법학 교육과 실무를 극적으로 변화시켰다. 그 비유는 그것이 우리가 소유권을 분리될 수 있고 다시 합쳐질 수 있는 대인 관계적인 권리의 모음으로 보는 것을 도와 주기 때문에 유용하다. 어떤 자원에 관해 ‘그것은 내 것이다.’라고 말할 때, 흔히 그것 은 여러분이 전체 다발을 구성하는 많은 막대, 즉 판매 막대, 임대 막대, 저당잡히고, 허가하고, 증여하며, 심지어 그것을 파괴할 권리를 소유한다는 것을 의미한다. 그러나 우리는 흔히 토지 한 면에 대해서처럼 그 막대들을 분할한다. 즉 땅 주인, 저당권을 가진 은행, 임대차 계약을 맺은 세입자, 토지 진입 면허를 가진 배관공, 광물에 대한 권리를 가진 석유 회사가 있을 수 있다. 이러한 각 당사자는 그 다발의 막대 하나를 소유한다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "인터넷에 관한 한, (많이는 아니고) 약간 편집적이게 되는 것이 이득이 될 따름이다. 인터넷에 있는 모든 것의 익명성 수준을 고려할 때, 여러분이 받을지도 모르는 어떤 자료든 그것의 타당성에 대해 의문을 제기하는 것이 합리적이다. 일반적으로 우리가 인도를 따라 내려오는 누군가를 만날 때, 특히 너무 놀랍게도 그들이 여러분을 알고 있었다고 자신을 소개할 때, 여러분이 스스로 어떤 방식의 방어적인 자세를 취하는 것은 우리의 자연스러운 본능이다. 일부러 우리는 시나리오나, 이름이나 지인, 혹은 그것으로 입증할 증거 (말하자면, 사진)를 제시함으로써 그 사람이 우리를 어떻게 아14 는지를 입증해야만 하는 과제를 설정한다. 일단 우리가 그 정보를 받고 그것이 인지 적 검증을 통과하면, 우리는 그 사람을 더 신뢰할 수 있다고 받아들인다. 이 모든 것 이 몇 분 안에 일어나지만, 우리가 현실 세계에서 수행하는 자연스러운 방어 기제이 다. 하지만, 가상 세계에서는 우리의 행복에 물리적인 위협이 없는 것처럼 보이기 때 문에 우리는 덜 방어적인 경향이 있다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "박물관의 보이지 않는 구역에서 일어나는 활동보다 갤러리에서 발생하는 것을 강조하 게 만드는 박물관 ‘내부의’ 압력이 있다. 박물관의 수입을 늘리도록 박물관이 강요당 하는 시대에, 박물관은 점점 더 많은 관객을 문으로 데려오기 위해 자기 갤러리를 현 대화하거나 일시적인 전시회를 시작하는 데 흔히 자기 에너지를 집중시킨다. 다시 말 해서, 박물관이 경쟁 경제에서 살아남기 위해 고군분투할 때, 그것의 예산은 흔히 갤 러리의 인포테인먼트, 카페와 상점의 상품과 서비스와 같은 소비할 수 있는 박물관 자체의 부분을 우선시한다. 불이 켜져 있지 않은 매력 없는 저장실은, 그것들이 논의 가 된다고 해도, 기껏해야 전시 홀에 둘 물건을 처리하는 서비스 공간으로 제시된다. 그리고 최악의 경우 박물관이 공개적으로 보이는 겉면에 점점 더 많은 자원을 쏟아붓 기 때문에, 저장 공간의 현대화가 보류되거나 확장되는 소장품을 보관하고 그것의 복 잡한 보존상의 요구를 충족시킬 공간이 점점 줄어들게 되어 저장 공간은 더 나빠질지 도 모른다."
    ],
    "tags": [
      "#경제",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "더 먼 거리를 더 빠른 속도로 더 많이 이동하는 것이 더 큰 경제적 성공을 만든다는 개념인 하이퍼 모빌리티는 현재 세계 인구의 절반보다 더 많은 사람이 거주하는 도시 지역의 두드러진 특징인 것으로 보인다. 2005년까지 전 세계 도시에서 매일 약 75억 건의 이동이 이루어졌다. 2050년에는 사회 기반 시설 및 에너지 가격이 허락하는 한, 2000년보다 서너 배 더 많은 인킬로미터를 이동할지도 모른다. 화물 이동도 같은 기 간 세 배보다 더 많이 증가할 수 있다. 이동성 흐름은 관련 사회 기반 시설이 변함없 이 도시 형태의 중추를 구성하면서 도시화의 핵심 동력이 되었다. 그러나 전 세계적 으로 증가하는 도시 이동성 수준에도 불구하고, 장소, 활동 및 서비스에 대한 접근은 점점 더 어려워졌다. 시간, 비용 및 편안함 측면에서 보면, 도시에서 장소에 접근하는 것이 덜 편리할 뿐만 아니라, 도시에서 돌아다니는 바로 그 과정이 많은 부정적인 외 부 효과를 발생시킨다. 그에 따라 세계의 많은 도시는 전례 없는 접근성 위기를 직면 하고 지속 불가능한 이동성 시스템을 특징으로 한다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "‘오즈의 마법사’를 동기 부여에 관한 심리학적 연구로 생각해 보라. Dorothy와 그녀 의 세 친구는 에메랄드 시로 가기 위해 열심히 노력하면서, 장벽을 극복하고, 모든 적에게 끈질기게 맞선다. 그들은 마법사가 그들에게 없는 것을 줄 거라고 기대하기 때문에 그렇게 한다. 대신에, 그 멋진 (그리고 현명한) 마법사는 자신이 아니라 그들 이 항상 자신들의 소원을 실현할 힘을 가지고 있었음을 그들이 깨닫게 한다. Dorothy에게, ‘집’은 장소가 아니라 그녀가 사랑하는 사람들과 함께하는 편안한 느 낌, 안전하다는 느낌이며, 그녀의 마음이 있는 곳이면 어디든 집이다. 사자가 원하는 용기, 허수아비가 바라는 지성, 양철 인간이 꿈꾸는 감정은 그들이 이미 가지고 있는 속성이다. 그들은 이러한 속성을 내적인 조건이 아니라 이미 자신들이 다른 이들과 관계를 맺는 긍정적인 방식으로 생각할 필요가 있다. 결국, 그들은 자신들이 원하는 뭔가를 얻을 수 있을 거라는 미래의 가능성에 관한 생각, 즉 어떤 ‘기대’에 지나지 않 는 것에 의해 동기가 부여된 여행인, 오즈로 가는 여정에서 그러한 자질들을 보여주 지 않았는가?"
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "사람들은 항상 먹을 것이 필요했으며, 또 항상 그럴 것이다. 자기표현 가치에 관한 늘어나는 강조가 물질적 욕구를 끝내지는 않는다. 하지만 우세한 경제적 방향성이 서 서히 재형성되고 있다. 지식 부문에서 일하는 사람들은 계속 높은 급료를 추구하지만, 그들은 (아주 흥미로워) 자극이 되는 일을 하는 것과 그들 자신의 시간 계획을 따르 는 것에 동등한 또는 더 큰 중점을 둔다. 소비는 점진적으로 생존에 대한 필요와 소 비되는 재화의 실용적 사용에 의해 덜 결정된다. 사람들은 여전히 먹지만, 음식 가치 의 증가하는 구성 요소가 그것의 비물질적인 측면에 의해 결정된다. 사람들은 흥미로 운 경험을 제공하거나 독특한 생활 방식을 상징하는 이국적인 요리를 먹고자 할증금 을 낸다. 탈공업화 사회의 대중은 생산이 생태적 또는 윤리적 기준을 위반하는 상품 의 구매를 거부하는 것과 같은 ‘정치적 소비주의’에 점점 더 많은 중점을 둔다. 소비 는 점점 덜 생존의 문제이며 점점 더 생활 방식, 그리고 선택의 문제이다."
    ],
    "tags": [
      "#철학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "노동력 공유 집단에서 사람들은 정기적으로(수확과 같은 계절적인 농사일을 위해) 혹 은 비정기적으로(화재로 손상된 헛간을 다시 지어야 하는 것과 같은 위기 상황 발생 시) 다른 사람들에게 노동력을 제공한다. 아무도 어떤 가족이 얼마나 많이 투입하고 얼마나 많이 가져갔는지에 대해 공식적인 기록을 남기지 않으므로, 노동력 공유 집단 은 ‘도덕적 경제’라고 불려 온 것의 일부다. 대신에, 정산은 사회적으로 규제된다. 그 집단은 다년간의 신뢰와 나눔을 바탕으로 하는 도덕적 공동체 의식을 가지고 있다. 북미의 특정 지역 사회에서는 노동력 공유가 사회적 응집성의 주요 경제적 요소이다. 한 가족이 새 헛간이 필요하거나 단체 노동력을 요하는 수리 작업에 직면할 때, 헛간 조성 모임이 소집된다. 여러 가족이 도우러 온다. 성인 남성은 육체노동을 제공하고, 성인 여성은 행사를 위한 음식을 제공한다. 나중에, 다른 가족이 도움이 필요할 때,21 그들은 같은 사람들을 부른다."
    ],
    "tags": [
      "#철학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "흥미롭게도, 전문가들은 복잡한 과제를 수행하거나 많은 과제를 결합할 때 초보자만 큼 어려움을 겪지 않는다. 전문가는 제한된 영역 내에서 광범위한 연습을 하기 때문 에, 그들의 영역에서의 핵심 구성 기술은 고도로 숙련되고 더 자동화되어 있는 경향 이 있다. 그래서 고도로 숙련된 이러한 각각의 기술은 비교적 적은 인지 자원을 필요 로 하여, 전문가가 경험하는 총 인지 부하를 효과적으로 낮춘다. 따라서 전문가는 비 교적 쉽게 복잡한 과제를 수행하고 많은 과제를 결합할 수 있다. (게다가, 초보자는 과제가 분할되고 분리될 때 그것을 처리하는 데 탁월하다.) 이것은 그들이 반드시 초 보자보다 더 많은 인지적 자원을 가지고 있기 때문인 것은 아니며, 오히려 핵심 기술 을 수행하면서 달성한 높은 수준의 능숙함 때문에 그들은 자신들이 가지고 있는 것으 로 더 많은 것을 할 수 있다. 반면에, 초보자는 각각의 구성 기술에서 동일한 수준의 능숙함과 자동성을 달성하지 못했으며, 따라서 그들은 전문가가 비교적 쉽고 효율적 으로 결합하는 기술을 결합하려고 애쓴다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "content": [
      "The growing complexity of computer software has direct\nimplications for our global safety and security, particularly\nas the physical objects upon which we depend ― things like\ncars, airplanes, bridges, tunnels, and implantable medical\ndevices ― transform themselves into computer code. As all this code grows in size and complexity, so too do\nthe number of errors and software bugs. According to a\nstudy by Carnegie Mellon University, commercial software\ntypically has twenty to thirty bugs for every thousand\nlines of code ― 50 million lines of code means 1 million\nto 1.5 million potential errors to be exploited. This is the basis for all malware attacks that take advantage\nof these computer bugs to get the code to do something it\nwas not originally intended to do. As computer code grows\nmore elaborate, software bugs flourish and security suffers,\nwith increasing consequences for society at large. Physical things are increasingly becoming information\ntechnologies. Cars are “computers we ride in,” and\nairplanes are nothing more than “flying Solaris boxes\nattached to bucketfuls of industrial control systems.”"
    ],
    "translation": [
      "컴퓨터 소프트웨어 복잡성의 증가는 전 세계의 안전과 보안에 직접적인 영향을 주는 데, 우리가 의존하는 물리적 대상, 즉 자동차, 비행기, 교량, 터널, 이식형 의료 기기 와 같은 것들이 컴퓨터 코드로 변해감에 따라 특히 그렇다. 물리적 사물은 점점 더 정보 기술이 되어가고 있다. 자동차는 ‘우리가 타는 컴퓨터’이고, 비행기는 ‘수많은 산업 제어 시스템에 부착된 비행 솔라리스 박스’에 불과하다. 이 모든 코드가 크 기와 복잡성이 증가함에 따라, 오류와 소프트웨어 버그 수 또한 증가한다. Carnegie Mellon 대학교의 연구에 따르면, 상용 소프트웨어에는 보통 코드 1,000줄당 20~30개 의 버그가 있어서, 5천만 줄의 코드는 1백만~150만 개의 잠재적 오류가 악의적으로 이용될 수 있다는 것을 의미한다. 이것이 코드가 원래 하도록 의도되지 않았던 것 을 하도록 이 컴퓨터 버그를 이용하는 모든 악성 소프트웨어 공격의 근간이다. 컴퓨24 터 코드가 더 정교해짐에 따라, 소프트웨어 버그는 창궐하고 보안은 악화되어, 사회 전반에 미치는 영향이 커진다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "특정 관행이 오랜 기간 반복되고 더 널리 공유됨에 따라, 그 관행이 구현하는 가치는 강화되고 재생산되며 우리는 그것들이 ‘제도화’된다고 말한다. 어떤 경우에는 이러한 제도화는 공식적인 면모를 갖추기도 하는데, 규칙과 프로토콜이 문서화되고 절차가 올바르게 지켜지도록 확실히 하고자 전문화된 역할이 만들어진다. 의회, 법원, 경찰 등 국가의 주요 기관이 일부 전문직과 더불어 이러한 공식적인 성격을 보여준다. 다 른 사회 기관들, 아마도 대다수는 이와 같지 않을 것인데 과학이 그 예이다. 과학자 들은 자기 학문의 실질적인 내용에 대해서는 훈련받겠지만, ‘좋은 과학자가 되는 방 법’에 대해서는 공식적으로 교육받지 않는다. 대신, 마치 ‘착하게’ 노는 법을 배우는 어린아이처럼 도제 과학자는 동료들로부터의 흡수, 즉 사회화를 통해 그 역할에 내재 한 도덕적 가치에 대한 이해를 얻는다. 우리는 이러한 가치가 그 전문직에 관한 많은 것을 알려주는 가치와 더불어, 그 전문직 자체의 가치가 위협받고 있는 것과 꼭 마찬 가지로 위협받고 있다고 생각한다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "많은 협상가는 모든 협상이 고정된 파이를 수반한다고 가정한다. 협상가들은 자주 통 합 협상 기회를 제로섬 상황이나 승패 교환으로 접근한다. 허구의 고정된 파이를 믿 는 사람들은 당사자들의 이해관계가 통합적인 합의와 상호 이익이 되는 절충안의 가 능성이 없는 반대 입장에 있다고 가정하기 때문에 이를 찾으려는 노력을 억누른다. 고용 협상에서 급여가 유일한 문제라고 생각하는 구직자는 고용주가 7만 달러를 제시 할 때 7만 5천 달러를 요구할 수 있다. 두 당사자가 가능성에 대해 더 자세히 논의할 때만 이사 비용과 시작 날짜 또한 협상할 수 있다는 사실을 발견하게 되는데, 이는 급여 문제의 해결을 방해할(→ 촉진할) 수 있을 것이다. 협상을 고정된 파이 관점에서 보는 경향은 사람들이 주어진 갈등 상황의 본질을 어떻 게 보느냐에 따라 달라진다. 이는 Harinck, de Dreu와 Van Vianen의, 징역형에 대 한 검사와 피고측 변호인 간의 모의 협상을 포함하는 기발한 실험에서 밝혀졌다. 어 떤 참가자들은 개인적 이득의 관점에서 그들의 목표를 보라는 말을 들었고(예를 들어, 특정 징역형을 정하는 것이 당신의 경력에 도움이 될 것이다), 다른 참가자들은 그들 의 목표를 효과성의 관점에서 보라는 말을 들었으며(특정 형은 상습적 범행을 방지할 가능성이 가장 크다), 그리고 또 다른 참가자들은 가치에 초점을 맞추라는 말을 들었 다(특정 징역형은 공정하고 정당하다). 개인적 이득에 초점을 맞춘 협상가들은 고정된 파이에 대한 믿음의 영향을 받아 상황에 경쟁적으로 접근할 가능성이 가장 컸다. 가 치에 초점을 맞춘 협상가들은 문제를 고정된 파이 관점에서 볼 가능성이 가장 낮았고 상황에 협력적으로 접근하려는 경향이 더 컸다. 시간 제약과 같은 스트레스가 많은 조건은 이러한 흔한 오해의 원인이 되며, 이는 결국 덜 통합적인 합의로 이어질 수28 있다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "자신감이 있다는 것은 맘이 편하다는 것과 같지 않다. 자신감을 갖게 되는 것에 관한 가장 큰 오해 중 하나는 그것이 두려움 없이 사는 것을 의미한다는 것이다. 자신감 구축의 핵심은 오히려 그 반대이다. 이는 우리가 우리에게 중요한 일을 할 때 두려움 이 존재하도록 기꺼이 두는 것을 의미한다. 무언가에 대한 어느 정도의 자신감이 생 기면 기분이 좋다. 우리는 거기에 머물러서 고수하고 싶어 한다. 하지만 우리가 자신 감을 느끼는 곳으로만 간다면, 그런 경우 자신감은 그 이상으로 절대 확장되지 않는 다. 우리가 잘할 수 있다고 알고 있는 일만 한다면, 새롭고 미지의 것에 대한 두려움 은 커지는 경향이 있다. 자신감을 키우려면 필연적으로 취약성과 친구가 되어야 하는 데 그것이 한동안 자신감 없이 지낼 수 있는 유일한 방법이기 때문이다. 하지만 자신 감이 커질 수 있는 유일한 방법은 기꺼이 자신감 없이 지낼 때이다. 우리가 두려움 속으로 들어가 미지의 것과 어울릴 수 있을 때, 바닥에서부터 자신감을 쌓는 것은 바 로 그렇게 하는 용기이다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "프로젝트에서 금도금은 예상되는 결과를 불필요하게 향상하는 것, 즉 비용이 많이 들 고 필요하지 않으며 목표와 관련하여 부가 가치가 낮은 특성을 추가하는 것으로, 다 시 말해 자신의 재능을 입증하는 것 외에는 실질적인 명분이 없는 더 많은 것을 제공 하는 것을 의미한다. 금도금은 특히 프로젝트팀원들에 대해서 흥미로운데, 이는 전문 적인 요소가 뚜렷한 프로젝트, 다시 말해 검증된 경험과 폭넓은 전문적 자율성을 갖 춘 전문가가 참여하는 프로젝트에서 일반적이기 때문이다. 이러한 환경에서 전문가들 은 종종 프로젝트를 자신의 다양한 능력을 테스트하고 강화할 기회로 여긴다. 따라서 선의로 금도금에 참여하려는 유혹, 즉 전문가를 만족시키지만, 고객의 요청에 가치를 더하지 않는 동시에 프로젝트에서 귀중한 자원을 없애는 더 많은 또는 더 높은 품질 의 성과를 달성하려는 유혹이 있다. 속담에 있듯이, ‘최고는 좋음의 적’이다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "14 주류 문화의 가치와 생활방식에 동화되어야 하는 필요성 때문에 갈등이 커지고 있다. 다문화주의자들은 이민자들이 자신의 관습, 신념, 언어 중 일부를 유지하는 부분 동화 모델이 있어야 한다고 제안한다. 그러나 그들의 문화적 정체성을 유지하기보다는 순 응해야 한다는 압력이 있는데, 이러한 갈등은 대개 이민자가 이주하는 커뮤니티에 따 라 결정된다. 이러한 경험은 새로운 것이 아니며, 많은 유럽인이 19세기와 20세기의 첫 두 차례의 이민 물결 동안 배제와 빈곤을 경험했다. 결국 이 이민자들은 계몽과 다양성 수용을 포함한 중대한 변화로 이 나라를 탈바꿈시켰다. 그러나 유색인종들은 계속 받아들여지기 위해 안간힘을 쓰고 있다. 거듭 말하자면, 어려운 과제는 다른 문 화는 다르게 생각하고 행동하며 그들이 그렇게 할 권리가 있다는 것을 인정하는 것이 다. 아마도, 그리 머지않아 이민자들이 우리 사이에서 더는 이방인이 아닐 것이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "상업적 음악 라디오 방송의 주된 목적은 청취자를 광고주와 후원자 집단에 인도하는 것이다. 상업적 성공을 달성하기 위해서는, 그 청취자는 가능한 한 대규모여야 한다. (인구 통계학적 또는 심리 통계학적 개요, 구매력, 관심 수준, 만족도, 주목의 질, 또 는 정서 상태 같은) 다른 어떤 특성보다도, 집단으로 모인 청취자의 크기는 음악 라 디오가 수익 목적에 이바지하게 하고자 하는 방송 진행자에게 가장 중요한 측정 기준 이다. 결과적으로 방송 진행자는 인기 있는 음악, 또는 — 적어도 — 청취자가 라디오를 끄거나 방송국을 바꾸게 하지 않을 것으로 믿기는 음악을 틀어 청취자의 규모를 극대 화하려고 애쓴다. 청취자 보유는 많은 음악 프로그램 제작자에게, 그리고 라디오 방송 국 경영진에 (유일한 핵심 가치는 아니더라도) 하나의 핵심 가치이다. 그 결과 높은 수준의 모험 회피는 흔히 ‘성공한’ 라디오 음악 프로그램 제작자를 구분 짓는다. 방송 목록은 한정되고 흔히 매우 적다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "웹 이전에 신문 기록 보관소는 주로 전문적 연구원과 언론학과 학생의 곰팡내 나는 영역이었다. 저널리즘은 당연히 최신에 관한 것이었다. 자료 보관소의 일반적 접근 가 능성은 더 오래된 기사가 이제는 자주 더 최신 기사에 맥락을 제공하기 위해 인용되 면서, 저널리즘의 유통 기한을 크게 늘리게 되었다. 뉴스에서 마주치는 복잡한 이슈에 관해 의미가 어떻게 형성되는가와 관련하여, 이 새로운 출발은 온라인 뉴스 소비자가 인쇄물 소비자에게는 명백하지 않았던, 또는 심지어 가능하지 않았던, 뉴스의 기저 이 슈와 맥락에 관여할 준비로 이해될 수 있다. 온라인 뉴스의 떠오르는 특성 중 하나 는, 부분적으로는 쉽게 접근할 수 있는 온라인 기록 보관소의 깊이로 결정되는데, 뉴 스 기사가 수명이 짧고 연결성이 없는 미디어 구경거리가 아니라 더 큰 경제적, 사회 적, 문화적 이슈의 분명한 결과로 이해될 가능성인 듯 보인다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "스트레스 반응을 자원으로 보는 것은 두려움이라는 생리 기능을 용기라는 생명 작용 으로 바꿀 수 있다. 그것은 위협을 도전으로 바꿀 수 있고 여러분이 압박감 속에서도 최선을 다하도록 도울 수 있다. 불안감의 경우에서처럼 스트레스가 도움이 되지 않는 다고 느껴질 때조차도 그것을 기꺼이 받아들이는 것은 그것을 도움이 되는 것, 즉, 더 많은 에너지, 더 많은 자신감, 그리고 더 기꺼이 행동을 취하려는 마음으로 바꿀 수 있다. 스트레스의 징후를 알아차릴 때마다 이 전략을 여러분의 삶에 적용할 수 있 다. 여러분의 심장 박동이나 호흡이 빨라지는 것을 느낄 때 그것은 여러분에게 더 많 은 에너지를 주려고 노력하는 여러분의 몸의 방식이라는 것을 깨달으라. 여러분의 몸 에서 긴장을 감지한다면 스트레스 반응이 여러분에게 자신의 힘을 이용할 기회를 준 다는 점을 상기하라. 손바닥에 땀이 나는가? 첫 데이트에 나갔을 때 어떤 기분이었는 지를 기억하라. 즉, 여러분이 원하는 것에 가까이 있을 때 손바닥에 땀이 난다."
    ],
    "tags": [
      "#과학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "‘장소’의 가치는 왜 그렇게 중요한가? 역사적 관점에서 볼 때, 1700년대까지 직물 생 산은 지리적으로 특정한 지역 내에서 이용 가능한 섬유, 예를 들면, 면, 양모, 실크, 아마 섬유를 사용하는 수작업 공정이었다. 지역 간 무역은 이러한 섬유들과 그 섬유 들로 만들어진 관련 직물의 가용성을 증가시켰다. 1차 산업혁명과 그 뒤에 이어진 제 조 섬유에서의 기술 발달은 섬유와 직물이 더 이상 ‘장소에 구애받지’ 않게 되었다는 사실을 증가시켰다. 제품이 어디서, 어떻게, 또는 누구에 의해 만들어졌는지에 대해 거의 또는 전혀 관련 없이 직물들과 직물들로 만들어진 제품들을 패션 회사들은 만들 었고 소비자들은 얻을 수 있었다. 이것이 소비자와 그들이 매일 사용하는 제품 간의 단절, 이러한 제품을 만드는 데 필요한 기술과 자원에 대한 이해와 평가의 상실, 그 리고 제품 창조에 필요한 인간과 천연 자원에 대한 연관된 경시에 반박했다(→를 초 래했다). 따라서 ‘장소’의 가치를 새롭게 하는 것은 회사와 소비자를 특정 장소의 사 람과 지리, 문화와 다시 연결한다."
    ],
    "tags": [
      "#철학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "1945년 이후 제2차 세계대전 이후 시절에 유례없는 경제 성장은 건축 붐과 중심 도20 시에서 새로운 교외 지역으로의 대규모 이주를 부추겼다. 교외 지역은 자동차에 훨씬 더 많이 의존했고, 대중교통에 대한 주된 의존에서 자가용으로의 전환을 알렸다. 이것 은 곧 더 나은 고속도로와 초고속도로의 건설과 대중교통의 감소, 심지어 쇠퇴까지로 이어졌다. 이러한 모든 변화와 함께 여가의 사유화가 이루어졌다. 더 많은 사람이 내 부 공간은 더 넓어지고 외부 정원은 더 아름다운 자신의 집을 소유함에 따라 그들의 휴양과 여가 시간은 점점 더 집이나 기껏해야 이웃에 집중되었다. 이러한 가정에 기 반한 여가의 한 가지 주요 활동은 TV를 시청하는 것이었다. 더 이상 영화를 보기 위 해 전차를 타고 극장까지 갈 필요가 없었고, 유사한 오락(물)이 텔레비전을 통해 무료 로 그리고 더 편리하게 이용 가능하게 되었다."
    ],
    "tags": [
      "#경제"
    ],
  ...
  },
  {
    ...
    "translation": [
      "많은 사람이 인터넷에서 사진과 비디오를 만들고 공유한다. 어려운 점은 여러분이 원 하는 것을 찾는 것이다. 일반적으로 사람들은 (가령, 예시 스케치 대신) 단어를 사용 하여 검색하기를 원한다. 대부분의 사진에는 단어가 첨부되어 있지 않기 때문에 이미 지에 관련 단어를 태그하는 태그 시스템을 시도하고 만들려는 것은 자연스러운 일이 다. 기본적인 시스템은 간단한데, 이미지 분류와 개체 감지 방법을 적용하고 출력된 단어로 이미지를 태그한다. 하지만 태그는 이미지에서 일어나고 있는 일에 대한 포괄 적인 설명이 아니다. 누가 무엇을 하고 있는지가 중요한데, 태그는 이것을 포착하지 못한다. 예를 들어, 거리에 있는 고양이의 사진을 ‘고양이’, ‘거리’, ‘쓰레기통’, ‘물고 기 뼈’의 개체 범주로 태그하는 것은 그 고양이가 거리에 있는 열린 쓰레기통에서 물 고기 뼈를 빼내고 있다는 정보를 빠뜨리게 된다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "시대를 너무 앞서간 발명이나 발견은 가치가 없는데, 누구도 따라갈 수 없기 때문이 다. 이상적으로, 혁신은 알려진 것으로부터 단지 다음 단계만을 가능하게 하고, 그 문 화가 한 걸음 앞으로 나아가도록 요청한다. 지나치게 미래지향적이거나 관행을 벗어 나는 혹은 비현실적인 발명은 처음에는 실패할 수도 있지만(아직 발명되지 않은 필수 적인 재료나 중요한 시장 또는 적절한 이해가 부족할 수 있다) 아이디어를 뒷받침하 는 생태 환경이 따라잡을 때 나중에 성공할 수도 있다. Gregor Mendel의 1865년 유 전 이론은 옳았지만 35년 동안 무시되었다. 그의 날카로운 통찰력은 생물학자들이 그 당시에 가졌던 문제들을 설명하지 않았기 때문에 받아들여지지 않았고, 그의 설명 역 시 알려진 메커니즘에 의해 작동하지 않았기 때문에 그의 발견은 얼리 어답터들에게 도 이해하기 어려웠다. 수십 년 후 과학은 Mendel의 발견이 답할 수 있는 긴급한 질 문에 직면했다. 이제 그의 통찰력은 단 한 걸음만 떨어져 있었다. 서로 몇 년 간격으 로, 세 명의 다른 과학자들이 각각 독립적으로 Mendel의 잊힌 연구를 재발견했는데, 물론 그 연구는 줄곧 그곳에 있었다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "사진이 나오기 전에는 장소들이 잘 이동하지 않았다. 화가들이 항상 특정한 장소를 그것의 ‘거주지’에서 벗어나게 해 다른 곳으로 이동시켜 왔지만, 그림은 제작에 시간 이 많이 걸렸고, 상대적으로 운반이 어려웠고, 단품 수주 생산이었다. 사진의 증가는 특히, 신문, 정기간행물, 책 그리고 광고에서 사진의 기계적인 복제를 가능하게 한 1880년대 하프톤 판의 도입으로 이루어졌다. 사진은 소비자 자본주의와 결합하게 되 었고 이제 세계는 ‘이전에는 전혀 사용되지 않았거나 단 한 명의 고객을 위한 그림으 로만 사용되었던 인물, 풍경, 사건들을 무제한의 양으로 제공받았다’. 자본주의가 세 계를 ‘백화점’으로 정리함에 따라, ‘표현물의 확산과 유통은... 극적이고 사실상 피할 수 없는 세계적 규모를 달성했다’. 점차 사진은 세계를 가시적이고, 미적이며, 탐나게 만드는 값싼 대량생산품이 되었다. 경험들은 그것을 저렴한 이미지로 바꿈으로써 ‘대 중화’되었다. 가볍고 작고 대량으로 제작된 사진은 장소의 시공간적 순환을 위한 역동 적인 수단이 되었다."
    ],
    "tags": [
      "#경제",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "조직들이 과거 어느 때보다 더 많은 수의 재택근무 프로그램을 제공하고 있지만, 이 러한 프로그램의 수용과 이용은 여전히 많은 요인에 의해 제한된다. 이들 요인에는 대면 관리 관행에 대한 관리자의 의존, 조직 내 재택근무 교육 부족, 유연한 직장 프 로그램에 대한 오해와 불편함, 그리고 재택근무가 조직의 최종 결산 결과에 미치는 영향에 대한 정보 부족 등이 있다. 이러한 한계에도 불구하고, 21세기 초에는, ‘언제 어디서나’ 일할 수 있는 새로운 업무 문화가 등장하고 있다. (개인적 그리고 업무적 특성이 재택근무에 가장 적합한 직원을 선발하기 위해 주의를 기울여야 한다.) 정보 기술의 지속적인 발전, 글로벌 노동력의 확대, 일과 가정 사이에서 균형을 이루려는 욕구의 증가는 지배적인 노동력 개발로서 재택근무에 대한 현재의 장벽을 점진적으로 낮출 많은 요인 중 세 가지에 불과하다. 특히 더 낮은 시설 비용, 증가된 직원의 유 연성, 그리고 생산성과 관련하여 조직 비용 절감에 대한 영향과 함께, 재택근무는 점 점 더 많은 조직의 관심사가 되고 있다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "content": [
      "The intuitive ability to classify and generalize is\nundoubtedly a useful feature of life and research, but it\ncarries a high cost, such as in our tendency to stereotype\ngeneralizations about people and situations. Intuitively and quickly, we mentally sort things into groups\nbased on what we perceive the differences between them\nto be, and that is the basis for stereotyping. Only afterwards\ndo we examine (or not examine) more evidence of how\nthings are differentiated, and the degree and significance\nof the variations. Our brain performs these tasks efficiently and automatically,\nusually without our awareness. The real danger of\nstereotypes is not their inaccuracy, but their lack of\nflexibility and their tendency to be preserved, even when\nwe have enough time to stop and consider. For most people, the word stereotype arouses negative\nconnotations: it implies a negative bias. But, in fact,\nstereotypes do not differ in principle from all other\ngeneralizations; generalizations about groups of people\nare not necessarily always negative."
    ],
    "translation": [
      "분류하고 일반화하는 직관적인 능력은 의심할 여지 없이 삶과 연구에 유용한 특징이 지만, 그것은 사람과 상황에 대한 일반화를 고정 관념화하는 경향에 있어서와 같이 많은 대가를 수반한다. 대부분 사람에게, 고정 관념이라는 단어는 부정적인 함축 을 불러일으키는데, 즉 그것은 부정적인 편견을 암시한다. 그러나 사실 고정 관념은 원칙적으로 모든 다른 일반화와 다르지 않으며, 사람들의 집단에 대한 일반화가 반드 시 항상 부정적인 것은 아니다. 직관적이고 빠르게, 우리는 사물 간에 차이가 있 다고 인식하는 것에 기초해 정신적으로 그들을 그룹으로 분류하며, 그것이 고정 관념 의 기초이다. 그 후에야 우리는 사물이 어떻게 차별화되는지, 그리고 그 차이의 정도24 와 중요성에 대한 더 많은 증거를 조사한다(또는 조사하지 않는다). 우리의 뇌는, 대개 우리가 인식하지 못하는 사이에, 이러한 일을 효율적이고 자동으로 수행한다. 고 정 관념이 진정 위험한 것은 그것들의 부정확성이 아니라, 우리가 멈추어 생각할 시 간이 충분할 때조차도, 그것들의 유연성 부족과 유지되려는 경향이다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "content": [
      "Plants show finely tuned adaptive responses when\nnutrients are limiting. Gardeners may recognize yellow\nleaves as a sign of poor nutrition and the need for fertilizer. In contrast, plants with a history of nutrient abundance are\nrisk averse and save energy. At all developmental stages,\nplants respond to environmental changes or unevenness so\nas to be able to use their energy for growth, survival, and\nreproduction, while limiting damage and nonproductive\nuses of their valuable energy. Research in this area has shown that plants are constantly\naware of their position in the environment, in terms of\nboth space and time. Plants that have experienced variable\nnutrient availability in the past tend to exhibit risk-taking\nbehaviors, such as spending energy on root lengthening\ninstead of leaf production. But if a plant does not have a caretaker to provide\nsupplemental minerals, it can proliferate or lengthen its\nroots and develop root hairs to allow foraging in more\ndistant soil patches. Plants can also use their memory to\nrespond to histories of temporal or spatial variation in\nnutrient or resource availability."
    ],
    "translation": [
      "식물은 영양분이 제한적일 때 미세하게 조정된 적응 반응을 보인다. 정원사는 노란 잎을 영양 부족과 비료가 필요하다는 신호로 인식할 수도 있다. 그러나 식물에 보충하는 미네랄을 공급해 줄 관리자가 없다면, 그것은 더 먼 토양에서 구하러 다닐 수 있도록 뿌리를 증식하거나 길게 늘리고 뿌리털을 발달시킬 수 있다. 식물은 또한 영양 혹은 자원 가용성의 시간적 또는 공간적 변화의 역사에 대응하기 위해 자신의 기억을 사용할 수 있다. 이 분야의 연구는 식물은 공간과 시간 모두의 측면에서 환경에서 자신의 위치를 지속적으로 인식한다는 것을 보여주었다. 과거에 다양한 영 양소 가용성을 경험한 식물은 잎 생산 대신 뿌리 길이를 연장하는 데 에너지를 소비 하는 것과 같은 위험을 감수하는 행동을 보이는 경향이 있다. 반대로, 영양분이 풍부했던 이력을 가진 식물은 위험을 회피하고 에너지를 절약한다. 모든 발달 단계에 서 식물은 성장, 생존, 번식에 에너지를 사용할 수 있도록 환경 변화나 불균형에 반 응하는 동시에, 귀중한 에너지의 손상과 비생산적인 사용을 제한한다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "가치만으로는 문화가 창조되고 구축되지 않는다. 일부 시간에만 가치에 따라 생활하 는 것은 문화의 창조와 유지에 기여하지 않는다. 가치를 행동으로 바꾸는 것은 전투 의 절반에 불과하다. 물론, 이것은 올바른 방향으로 나아가는 단계이지만, 그다음에 그러한 행동은 기대되는 것에 대한 명확하고 간결한 설명과 함께 조직 전체에 널리 공유되고 배포되어야 한다. 단순히 그것에 관해 이야기하는 것만으로는 충분하지 않 다. 리더와 모든 인력 관리자가 자신의 팀을 지도하는 데 사용할 수 있는 특정 행동 을 시각적으로 표현해 놓는 것이 중요하다. 스포츠 팀이 좋은 성과를 내고 승리하는 데 도움이 되도록 고안된 특정 플레이를 담고 있는 플레이 북을 갖고 있는 것과 마찬 가지로, 여러분의 회사는 여러분의 문화를 행동으로 바꾸고 여러분의 가치를 승리하 는 행동으로 바꾸는 데 필요한 핵심적인 변화를 담은 플레이 북을 갖고 있어야 한다."
    ],
    "tags": [
      "#심리학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "여러분이 여러분의 주의를 집중하는 방식은 여러분이 스트레스에 대처하는 방식에 중 요한 역할을 한다. 주의가 분산되면 스트레스를 해소하는 능력이 손상되는데, 왜냐하 면 여러분의 주의가 분산되더라도, 여러분은 여러분의 경험 중 스트레스가 많은 부분 에만 집착할 수 있으므로, 그것이 좁게 집중되기 때문이다. 여러분의 주의의 초점이 넓어지면, 여러분은 스트레스를 더 쉽게 해소할 수 있다. 여러분은 어떤 상황이라도 그 상황의 더 많은 측면을 균형 있는 시각으로 볼 수 있으며, 피상적이고 불안을 유 발하는 주의 수준으로 여러분을 옭아매는 한 부분에 갇히지 않을 수 있다. 초점이 좁 으면 각 경험의 스트레스 수준이 높아지지만, 초점이 넓으면 여러분은 각 상황을 더 넓은 시각으로 더 잘 볼 수 있기 때문에 스트레스 수준이 낮아진다. 불안감을 유발하 는 하나의 세부 사항은 더 큰 전체적인 상황보다 덜 중요하다. 그것은 여러분 자신을 들러붙지 않는 프라이팬으로 변형시키는 것과 같다. 여러분은 여전히 달걀을 부칠 수 있지만, 그 달걀이 팬에 들러붙지 않을 것이다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "여러분의 응답에 우선순위를 매길 수 있는 것은, 그것이 특별히 즐겁거나 화가 나는 경험에 대한 일회성 상호 작용이든, 여러분의 고객 기반 내에서 상당히 영향력 있는 개인과의 장기적 관계의 발전이든 간에, 여러분이 개별 고객들과 더 깊은 관계를 맺 을 수 있게 해 준다. 만약 여러분이 어떤 브랜드, 제품 또는 서비스에 관해 호의적인 의견이나 혹은 그 문제에 대해서 어떠한 의견이라도 올려 본 적이 있다면, 그 결과,14 예를 들어, 그 브랜드 관리자로부터 개인적으로 인정의 반응을 얻는다면 기분이 어떨 지 생각해 보라. 일반적으로, 사람들은 할 말이 있기 때문에, 그리고 그것을 말한 것 에 대해 인정받기를 원하기 때문에 글을 올린다. 특히, 사람들이 긍정적인 의견을 게 시할 때 그것은 그 게시물을 작성하게 만든 경험에 대한 감사의 표현이다. 여러분 옆 에 서 있는 사람에 대한 칭찬은 보통 ‘감사합니다’와 같은 응답을 받지만, 슬픈 사실 은 대부분의 브랜드 칭찬은 답을 받지 못한다는 것이다. 이것은 무엇이 칭찬을 이끌 어 냈는지 이해하고 그 칭찬을 바탕으로 하여 확고한 팬을 만들어 낼 수 있는 기회를 잃은 것이다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "천연자원의 관리자는 일반적으로 이용에 대한 재정적 보상을 제공하는 시장 인센티브 에 직면한다. 예를 들어, 삼림 지대의 소유자는 탄소 포집, 야생 동물 서식지, 홍수 방어 및 다른 생태계 도움을 위해 숲을 관리하기보다는 나무를 베어 내는 시장 인센 티브를 가지고 있다. 이러한 (생태계) 도움은 소유자에게 어떠한 재정적 이익도 제공 하지 않으므로, 관리 결정에 영향을 미칠 것 같지 않다. 그러나 이러한 도움이 제공 하는 경제적 이익은, 그것의 비시장적 가치에 근거하여, 목재의 경제적 가치를 초과할 수도 있다. 예를 들어, 유엔의 한 계획은 기후 조절, 수질 정화 및 침식 방지를 포함 하여 열대 우림이 제공하는 생태계 도움의 경제적 이익이 시장 이익보다 헥타르당 3 배보다 더 크다고 추정했다. 따라서 나무를 베는 것은 경제적으로 비효율적인데, 시장 은 채취하는 사용보다 생태계 도움을 선호하게 하는 올바른 ‘신호’를 보내지 않고 있 다."
    ],
    "tags": [
      "#과학",
      "#경제"
  ...
  },
  {
    ...
    "translation": [
      "과잉 관광의 개념은 관광학과 사회 과학 전반에서 흔히 볼 수 있는 사람과 장소에 관 한 특정한 가정에 기초한다. 둘(사람과 장소)은 모두 명확하게 정의되고 경계가 정해 진 것으로 간주된다. 사람들은 주인이나 손님의 역할을 하는 경계가 확실한 사회적 행위자로 구성된다. 장소는 비슷한 방식으로, 명확한 경계가 있는 안정적인 용기로 취 급된다. 그러므로 장소는 관광객으로 가득 찰 수 있고, 따라서 과잉 관광으로 고통받 을 수 있다. 하지만 어떤 장소가 사람으로 가득 차 있다는 것은 무엇을 의미하는가? 사실, 제한된 수용력을 가지고 있고 더 많은 방문객을 수용할 공간이 실제로 없는 특 정 명소의 예가 있다. 이것은 특히 에펠탑과 같은 일부 인공 건축물의 경우이다. 그 러나 장소가 목적지로 홍보되고 과잉 관광의 피해지로 묘사되는 도시, 지역 또는 심 지어 국가 전체와 같은 장소에서는 상황이 더 복잡해진다. 과도하거나 균형이 안 맞 는 것은 매우 상대적이며 자연적 (질적) 저하와 경제적 유출(정치 및 지방 권력 역학 은 말할 것도 없이)과 같은, 물리적 수용력 이외의 다른 측면과 더 관련이 있을 수도 있다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "많은 연구가 사회적 자극에 차별적으로 반응하는 타고난 인간 성향에 대한 상당한 증 거를 제시한다. 태어날 때부터, 아기들은 사람의 얼굴과 목소리 쪽으로 우선하여 향하 게 되는데, 이러한 자극이 특히 자신들에게 의미가 있다는 것을 알고 있는 것 같다. 게다가, 아기들은 혀 내밀기, 입술 다물기, 입 벌리기와 같이 자신들에게 보여지는 다 양한 얼굴 제스처를 모방하면서 이러한 연결을 적극적으로 마음속에 새긴다. 심지어 그들은 자신들이 다소 어려워하는 제스처에 맞추려고 노력하고, 성공할 때까지 자기 자신의 얼굴로 실험한다. 그들은 정말 성공하면 눈을 반짝이면서 기쁨을 보여주고, 실 패하면 괴로움을 나타낸다. 다시 말해, 그들은 운동감각적으로 경험한 그들 자신의 신 체적 움직임과 시각적으로 지각되는 다른 사람의 신체적 움직임을 일치시키는 타고난 능력을 가지고 있을 뿐만 아니라, 그렇게 하려는 타고난 욕구도 가지고 있다. 즉, 그 들은 자신들이 ‘나와 비슷하다’라고 판단하는 타인을 모방하려는 타고난 욕구가 있는 것으로 보인다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "상점가 경제는 공유되는 문화라는 더 지속적인 유대 위에 자리 잡은, 겉으로 보기에 유연한 가격 설정 메커니즘을 특징으로 한다. 구매자와 판매자 둘 다 서로의 제약을 알고 있다. 델리의 상점가에서, 구매자와 판매자는 대체로 다른 행위자들이 그들의 일 상생활에서 가지는 재정적인 제약을 평가할 수 있다. 특정 경제 계층에 속하는 각 행 위자는 상대방이 무엇을 필수품으로 여기고 무엇을 사치품으로 여기는지를 이해한다. 비디오 게임과 같은 전자 제품의 경우, 그것들은 식품과 같은 다른 가정 구매품과 동 일한 수준의 필수품이 아니다. 따라서 델리의 상점가에서 판매자는 비디오 게임에 대 해 직접적으로 매우 낮은(→높은) 가격을 요구하지 않으려 주의하는데, 구매자가 비디 오 게임의 소유를 절대적인 필수 사항으로 볼 이유가 전혀 없기 때문이다. 이러한 유 형의 지식에 대한 접근은 비슷한 문화적이고 경제적인 세상에의 소속에서 비롯한 서 로의 선호와 한계를 관련지어 가격 일치를 형성한다."
    ],
    "tags": [
      "#경제",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "지난 10년 동안 어린이가 읽는 법을 배우는 방법에 관한 관심은 ‘텍스트성’의 본질과20 모든 나이의 독자가 텍스트를 의미하게 하는 다양하고 상호 연관된 방식의 본질을 전 면으로 불러왔다. 이제 '읽기'는 과거 어느 시대보다 훨씬 더 많은 표현 형식에 적용 되는데, 그림, 지도, 화면, 디자인 그래픽, 사진이 모두 텍스트로 여겨진다. 새로운 인 쇄 공정에 의해 그림책에서 가능해진 혁신에 더해, 시집이나 정보 텍스트와 같은 다 른 종류에서도 디자인적 특징이 두드러진다. 이처럼, 읽기는 어린이들의 주의가 인쇄 된 텍스트에 집중되고 스케치나 그림이 부속물일 때보다 더 복잡한 종류의 해석이 된 다. 이제 어린이들은 그림책을 통해 글과 삽화가 서로를 보완하여 향상한다는 것을 배운다. 읽기는 단순히 단어 인식이 아니다. 아무리 쉬운 텍스트에서도 흔히 문장이 ‘말하는 것’이 그 문장이 의미하는 것이 아니다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "어떤 영화 속에서든 악보는 영화 텍스트에 추가적인 층을 추가할 수 있는데, 그것은 보이는 연기를 단순히 흉내 내는 것을 넘어선다. 미래 세계에 관해 말하는 영화에서, 작곡가는 사운드 디자이너와 꼭 마찬가지로, 관객에게 알려지지 않은 새로운 세계를 창조할 수 있는 자유를 추가해 왔다. 그러나 사운드 디자이너와 달리, 작곡가는 흔히 이러한 새로운 세계를 반영하는 독특한 곡을 만들어 내는 것을 피하고, 친숙한 구조 와 박자를 가진 악보를 흔히 제시한다. 이는 창의성과 시공간 감각을 저해할 가능성 이 있지만, 사실 그것은 관객이 영화에 접근하는 데 도움이 된다. 알아볼 수 있는 악 보를 통해 미래나 멀고 먼 은하계에 대한 비전은 알아볼 수 있는 맥락 안에 놓일 수 있다. 그러한 친숙함을 통해 관객은 편안한 공간에 놓이게 되고, 그러면 영화는 관객 을 그들 자신의 것과 다른 세계에 관한 낯설지만 받아들일 수 있는 비전으로 인도할 수 있을 것이다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "피실험자에게 사람들의 얼굴 사진을 보여주고 분명히 나타나는 표정이나 마음 상태를 파악하도록 요청하는 심리학 연구가 있었다. 그 결과는 언제나 매우 엇갈린다. 17세 기에 프랑스의 화가이자 이론가인 Charles Le Brun은 화가가 표현해 달라고 요청받 을 수 있는 다양한 감정을 분명히 보여주는 일련의 얼굴 그림을 그렸다. 그 그림들에 서 놀라운 점은 어떤 수의 얼굴 그림이든 손실 없이 서로 대체될 수 있었다는 것이 다. 이 모든 것에서 빠진 것은 감정을 확정적인 것으로 만드는 어떤 환경이나 맥락이 다. 우리는 이 사람이 누구인지, 다른 이 사람들이 누구인지, 그들은 어떤 관계인지, 그 장면에서 관건이 무엇인지 등을 알아야 한다. 그림에서뿐만 아니라 실생활에서도 우리는 단지 얼굴만 우연히 마주치는 것이 아니며, 우리는 특정한 상황에서 사람들을 마주치고, 사람들에 대한 우리의 이해는 그들과 우리가 살아 숨 쉬고 존재하는 사회 적, 인간적 상황으로부터 괴리된 채 그럭저럭 촉발되어 보유될 수는 없다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "도시에서 운전하거나 걷거나 교통 카드를 판독기에 통과시키는 모든 사람은 현관문을 나서는 순간부터 자신을 교통 전문가로 여긴다. 그리고 그 사람이 도로를 바라보는 방식은 그 사람이 돌아다니는 방식과 매우 밀접하게 일치한다. 그런 이유로 우리는 선의와 시민 의식을 가진 매우 많은 사람이 서로 엇갈리며 논쟁하는 것을 보게 된다. 학교 강당에서 열리는 주민 회의에서, 도서관과 교회의 뒷방에서, 전국의 지역 주민들 이 모여 도시의 거리를 바꿀 교통 제안에 대해 흔히 논쟁적인 토론을 벌인다. 그리고 모든 정치와 마찬가지로, 모든 교통은 지역적이고 지극히 개인적이다. 수만 명의 이동 속도를 높일 수 있는 교통 프로젝트는 몇 개의 주차 공간 상실에 대한 반대나 프로젝 트가 효과가 없을 것이라는 단순한 두려움 때문에 중단될 수 있다. 그것은 데이터나 교통 공학 또는 계획의 과제가 아니다. 도로에 대한 대중 토론은 보통 변화가 개인의 통근, 주차 능력, 안전한 것과 안전하지 않은 것에 대한 믿음, 또는 지역 사업체의 순 익에 어떤 영향을 미칠지에 대한 감정적인 추정에 뿌리를 두고 있다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "빨리 말하는 것은 위험 부담이 큰 일이다. 입이 속도 제한을 훨씬 초과하여 움직일 때 설득력 있고, 말을 잘하며, 효과적인 이상적 조건을 유지하는 것은 거의 불가능하 다. 우리는 우리의 정신이 항상 최고의 효율로 좋은 결정을 내릴 수 있을 정도로 예 리하다고 생각하고 싶겠지만, 그것은 정말 그렇지 않다. 실제로 뇌는 말할 가능성이 있는 것들 4~5가지가 교차하는 지점에 도달하면 몇 초 동안 빈둥거리며 선택지를 고 려한다. (좋은 결정을 내리면 응답을 생각해 낼 시간이 더 많아지기 때문에, 여러분은 더 빨리 말할 수 있다.) 뇌가 입에 항해 지시를 다시 보내는 것을 멈추었는데 입은 너무 빨리 움직여 멈출 수 없을 때, 이때가 바로 여러분이 가벼운 언어적 장애, 또는 필러라고도 하는 것을 겪게 되는 시간이다. ‘음, 아, 알다시피, 그러니까’는 입이 갈 곳이 없을 때 하는 행동이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "content": [
      "Norms emerge in groups as a result of people conforming\nto the behavior of others. Thus, the start of a norm occurs\nwhen one person acts in a particular manner in a particular\nsituation because she thinks she ought to. Thus, she may prescribe the behavior to them by uttering\nthe norm statement in a prescriptive manner. Alternately,\nshe may communicate that conformity is desired in other\nways, such as by gesturing. In addition, she may threaten\nto sanction them for not behaving as she wishes. This will\ncause some to conform to her wishes and act as she acts. But some others will not need to have the behavior prescribed\nto them. They will observe the regularity of behavior and\ndecide on their own that they ought to conform. They may do\nso for either rational or moral reasons. Others may then conform to this behavior for a number of\nreasons. The person who performed the initial action may\nthink that others ought to behave as she behaves in\nsituations of this sort."
    ],
    "translation": [
      "규범은 사람들이 다른 사람들의 행동에 순응하는 결과로 집단에서 생겨난다. 따라서 규범의 시작은 한 사람이 특정 상황에서 자신이 그래야 한다고 생각하여 특정 방식으 로 행동할 때 발생한다. 그런 다음 다른 사람들은 여러 가지 이유로 이 행동에 순응할 수도 있다. 최초의 행동을 한 사람은 다른 사람들이 이런 종류의 상황에서 자 신이 행동하는 것처럼 행동해야 한다고 생각할 수도 있다. 따라서 그 사람은 지 시하는 방식으로 규범 진술을 말함으로써 그들에게 행동을 지시할 수도 있다. 다른 방식으로는 몸짓과 같은 것으로 순응이 요망된다는 것을 전달할 수도 있다. 게다가 자신이 원하는 대로 행동하지 않으면 그들에게 제재를 가하겠다고 위협할 수도 있다. 이렇게 하면 일부 사람들은 그 사람의 바람에 순응하고 그 사람이 행동하는 대로 행 동할 것이다. 그러나 다른 일부 사람들에게는 그 행동이 자신에게 지시되게 할 필 요가 없을 것이다. 그들은 행동의 규칙성을 관찰하고 자신이 순응해야 할 것을 스스 로 결정할 것이다. 그들은 이성적 또는 도덕적 이유로 그렇게 할 수도 있다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "이야기를 과대광고하는 것에 대한 기여를 피하는 한 가지 방법은 아무 말도 하지 않 는 것이다. 그러나 그것은 대중과 정책 입안자에게 정보를 전하고/전하거나 제안을 제공해야 한다는 강한 책임감을 느끼는 과학자들에게는 현실적인 선택안이 아니다. 언론 구성원들과의 대화는 메시지를 알려지게 하고 아마 호의적인 인정을 받을 수 있 다는 장점이 있지만, 오해를 일으키고 반복적인 해명이 필요하며 끝없는 논란에 얽힐 위험을 감수한다. 따라서 언론과 대화할지 여부는 아주 개인적으로 결정되는 경향이 있다. 수십 년 전에 지구과학자들이 언론의 흥미를 끄는 연구 결과를 발표하는 것은 드문 일이었고, 따라서 언론과의 접촉을 기대하거나 권장하는 것은 거의 없었다. 1970년대에는, 언론과 자주 대화하는 소수의 과학자들은 흔히 그렇게 한 것에 대해 동료 과학자들로부터 비난을 받았다. 지금은 상황이 아주 다른데, 많은 과학자가 지구 온난화와 관련 문제의 중요성 때문에 공개적으로 말해야 한다는 책임감을 느끼고 있 으며 많은 기자도 이런 감정들을 공유하고 있기 때문이다. 게다가, 많은 과학자는 자 신이 언론의 주목과 그에 따른 대중의 인정을 즐기고 있다는 사실을 알아 가고 있다. 동시에, 다른 과학자들은 기자들과의 대화를 계속 물리치며, 그렇게 함으로써 자신의 과학을 위해 더 많은 시간을 지켜 내고, 잘못 인용되는 위험과 언론 보도와 관련된 다른 불쾌한 상황을 감수한다(→ 피한다)."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "전 세계가 전반적으로 기계의 영향력, 구체적으로 말하면 인공지능(AI)의 계속 확대되 는 영향력에 점점 더 영향을 받는 듯 보이면서, 많은 사람은 두려움 속에 또는 기대 를 품고 인간의 의사 결정 역할이 줄어드는 미래를 상상하기 시작한다. 커지는 AI 비 서의 존재감 때문이든, 자율 주행 자동차의 등장 때문이든, 의사 결정권자로서의 인간 역할의 필요성은 감소하는 듯 보일 것이다. 결국, 실수를 저지르는 우리의 능력은 충 분히 입증되었다. 하지만, 아마도 인간 결단력의 장점 또한 여기에서 발견될 것이다. 현재 AI의 무오류성을 시사하거나 미래에 그것을 예측하는 증거는 거의 존재하지 않 는다. 인류가 스스로 오류성을 인정한다는 점으로 미루어 볼 때, 우리가 이러한 실패 를 극복할 수 있는 능력을 활용하여 가까운 미래에 AI 자체의 성장과 적용의 감독관 으로서 자리 잡는 것이 매우 중요하다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "폭(모두가 약간 지쳤다고 느낀다)과 깊이(일부는 너무 지쳐서 더는 일을 할 수 없다) 에 대한 필요의 균형을 맞추기 위해, 우리는 번아웃을 ‘상태’가 아니라 ‘범위’로 간주 해야 한다. 번아웃에 대한 대부분의 대중적 논의에서, 우리는 ‘번아웃 된’ 노동자에 대해, 마치 그 상태가 흑백 상태인 것처럼 이야기한다. 그러나, 흑백 논리의 관점은 번아웃 경험의 다양성을 설명할 수 없다. 전구의 경우 그런 것처럼, 번아웃 상태와 그렇지 않은 상태 사이에 명확한 경계가 있다면, 자신이 번아웃 되었다고 말하지만 여전히 용케도 자기 일을 유능하게 해내는 사람들을 분류할 수 있는 좋은 방법이 없 다. 번아웃을 범위로 간주하면 이러한 문제를 해결할 수 있는데, 번아웃을 주장하지만 그것에 의해 쇠약해지지 않는 사람은 그것의 부분적이거나 덜 심각한 형태를 다루고 있을 뿐이다. 그들은 번아웃 ‘되고 있지’ 않으면서 번아웃을 경험하고 있다. 번아웃은 마지막 진술을 하지 않았다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "고대의 수렵·채집인 무리와 오늘날 우리의 친밀한 언어 공동체 둘 다에서, 언어의 확 산은 가치를 형성했다. 모든 사람이 말하고 들을 수 있을 것이라는 사실은 윤리적으14 로 수용되어야 했는데, 그것은 개략적인 인류 평등주의를 통해서였다. 의사소통의 측 면에서 사람들은 평등했으므로, 그들은 평등‘해야’ 하거나 적어도 비교적 그렇다고 여 겨졌다. 이러한 관례에 따라, 고대의 ‘거물’은 통제적으로 행동하도록 허용되지 않았 고, 현대의 사무실 관리자는 마음대로 누구도 침묵시키도록 허용되지 않는다. 게다가, 말하기와 듣기에 대한 평등한 접근은 재산은 공동으로 소유되어야 하고, 특히 물자와 식량은 공유되어야 하며, 모든 사람은 다른 사람을 돌볼 의무가 있다는 생각을 촉진 했다. 이것은 아마도 현대의 가족, 친구 사이, 또는 직장에서보다 수렵·채집인 사이에 서 더 사실이었을 것이다. 하지만 이 경우에도, 우리는 공유와 상호 협력이 옳고 적 절하다고 믿는다. 여러분이 무언가를 가져온다면, 모두를 위해 충분히 가져와야 한다 는 것을 기억하라."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "도시의 구매자 대부분이 자연과 관련이 있는 식품을 사고 먹는다는 개념에 확실히 끌 렸지만, 광고가 주장하는 그 자연은 더는 그 식품을 만들어 낸 자연이 아니었다. 실 제로 많은 광고가 주장하는 자연은 ‘오직’ 광고의 부속물로만 식품 제품과 관련이 있 었다. 이것이 프랑스의 사회학자 Henri Lefebvre가 ‘지시성의 감소’라고 일컬었던 것, 즉 자본주의의 영향을 받은 단어가 의미 있는 연관으로부터 분리되는 경향을 분 명하게 보이는 사례다. 점차, 식품 광고는 구매자가 ‘신선한’, ‘자연스러운’ 같은 단어 의 새로운 개념에 익숙해지도록 도왔는데, 어쩌면 기존 의미와 정반대로 여겨질 수 있을 정의였다. 그 새로운 정의는 신흥 식품 산업 시스템의 요구에 더 잘 부합했는 데, 그 시스템은 관례적인 의미와 기대에 부응하는 식품을 공급할 수 없었다. 그래서 비록 겉치레이긴 하더라도 그 정의는 소비자들의 열망을 더 잘 충족했다."
    ],
    "tags": [
      "#경제",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "무려 3만 2천 년으로 거슬러 올라가, 선사시대 동굴 예술가들은 자신의 말과 들소 그 림에 입체감을 주기 위해 모형화한 그림자를 능숙하게 사용했다. 수천 년 전 고대 이 집트와 그 이후 고대 그리스 예술은 그림자 스타일의 실루엣으로 인간 형태를 나타냈 다. 그러나 서양 예술에서 그림자 드리우기는 기원전 400년경이 되어서야 아테네에서 등장한다. 고전 저술가들이 예술 자체가 인간 그림자의 모사와 더불어 시작되었다고 주장한 것은 그림자가, 논란의 여지는 있으나, 표현의 확고한 한 부분으로 자리 잡게 되고 난 이후였다. 그리스인과 로마인은 최초로 그림자를 모형화하는 방식에서 그림 자를 드리우는 방식으로 전환했는데, 이는 일관된 광원, 고정된 시점, 기하학적 투영 에 대한 이해를 함축하는 관행이었다. 사실 현재 우리가 ‘그림자 연구’라고 부를 수도 있을 것, 즉 다양한 예술적 표현에서 그림자에 관해 탐구하는 것은 고대 아테네에 그 뿌리를 두고 있다. 그 이후로 예술가와 이론가가 그림자 표현의 중요성에 대한 지속 적인 논쟁을 벌임에 따라 그림자를 묘사하는 방식은 그림자에 대한 비판적 분석과 더 불어 발전해 왔다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "불러오기를 연습하는 것이 복습보다 훨씬 더 좋은 이유는 무엇인가? 한 가지 대답은 심리학자 R. A. Bjork의 바람직한 난도 개념에서 나온다. 더 어려운 불러오기는 불러 오기 행위 자체가 성공적이라면 더 나은 학습으로 이어진다. 학생에게 힌트를 주지 않고 그들이 기억할 수 있는 만큼 회상해야 하는 자유 회상형 테스트가 기억해야 할 내용에 대한 힌트를 주는 단서 회상형 테스트보다 결과적으로 더 나은 보유력을 가져 오는 경향이 있다. 그다음으로는 단서 회상형 테스트가 정답을 인식할 필요는 있지만 생성할 필요는 없는 다지선다형 정답과 같은 인식형 테스트보다 더 낫다. 누군가가 무언가를 학습한 직후에 시험을 치르게 하는 것이, 필요할 때 답을 떠올리지 못할 만 큼 충분히 긴 약간의 시간 지연을 주는 것보다 보유력 향상에 덜 효과적이다. 난도는 불러오기가 효과를 발하게 하는 데 장애물이라기보다는 그것이 그렇게 하는[효과를 발하게 하는] 이유의 일부일 수도 있다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "내면화는 자율성에 대한 지지에 의존한다. 두드러진 보상과 처벌 또는 평가하는, 자존 감을 건드리는 압박과 같은 통제 전략을 사용하는 상황에서는 사람들이 활동을 자신 의 것으로 가치 있게 여기게 될 가능성이 거의 없다. 이것은 통제가 행동을 유발하는 데 효과가 없다는 말은 아닌데 수십 년에 걸친 조작적 심리학은 통제가 행동을 유발 할 수 있다는 것을 증명한다. 그 말은 오히려 사람의 행동에 대한 외부 통제가 더 두 드러질수록, 그 사람은 자신의 행동에서 외부적으로만 규제되거나 투입될 가능성이 더 높다는 것이다. 결과적으로 그 사람은 행동에 대한 가치나 투자를 발전시키지 않 고, 대신에 외부 통제에 의존하는 상태로 남는다. 따라서 자녀에게 숙제를 하도록 보 상을 주거나, 강요하거나, 회유하는 부모는 보상받거나, 회유당하거나, 강요받을 때만 그렇게 하는 자녀를 가질 가능성이 높다. 외적 통제가 두드러지면 자기 책임감의 습 득이 촉진된다(→ 약화된다). 그 대신에 이유를 제시하고, 문제를 극복하는 어려움에 대해 정서적 이해를 보여주고, 최소한의 외적 인센티브를 사용하는 부모는 자녀에게 과업에 대한 자발적 의지와 가치에 대한 식별력을 길러줄 가능성이 더 높다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "디지털 보존이 의미하는 바를 정립하려고 할 때 가장 먼저 다루어야 할 질문은 ‘실제 로 무엇을 보존하려고 하는가?’이다. 이는 정보 콘텐츠가 물리적 매체에 풀 수 없게20 고정된 아날로그 환경에서는 분명하다. 디지털 환경에서는 매체가 메시지의 일부가 아니다. 비트 스트림은 그것이 읽히는 매체와 관계없이 컴퓨터에서 동일하게 보인다. 물리적 이동 장치가 필요하지만, 원본 매체를 읽을 수 있는 한, 다른 기기에서도 비 트 단위의 완벽한 복사본을 저렴하고 쉽게 만들 수 있어서 원본 이동 장치의 보존은 그 중요성이 줄어들고 있다. 디지털 정보를 전달하는 물리적 매체는 대부분의 아날로 그 매체에 비해 상당히 취약하기 때문에, 지속적인 보존 과정의 일환으로 디지털 정 보를 한 물리적 이동 장치에서 다른 이동 장치로 옮겨야 할 필요가 있을 것으로 예상 된다. 보존해야 하는 것은 매체 자체가 아니라 매체에 담긴 정보이다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "창의성은 참신하고(독창적이고, 새로운) 유용한(적절하고. 실현 가능한) 아이디어를 생 산하는 것으로 흔히 정의된다. 독창적이지만 유용하지 않은 아이디어는 무의미하고, 유용하지만 독창적이지 않은 아이디어는 특별한 것이 없다. 이러한 정의가 연구에서 널리 사용되지만, 창의성의 중요한 측면이 흔히 간과되는데, 창의적인 아이디어를 생 성하는 것이 최종 목표인 경우는 거의 없다는 것이다. 오히려, 문제를 성공적으로 해 결하거나 혁신하기 위해서는, 실제로 작동하고 이전 접근 방식보다 더 잘 작동하는 하나 또는 몇 개의 좋은 아이디어가 필요하다. 이를 위해 사람들은 자기 자신 또는 서로의 상상력 산물을 평가하고, 더 발전시킬 수 있을 정도로 유망해 보이는 아이디 어를 선택하며, 성공 가능성이 작은 것들은 포기해야 한다. 따라서 창의적인 것은 아 이디어 생성에서 멈추지 않는다. 사실, 창의적인 아이디어를 생성하는 능력은 이러한 아이디어가 이후 조용히 죽어 없어진다면 본질적으로 쓸모가 없다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "일반적인 방식으로 음악적 행동이나 인식의 모형을 만들려는 시도는 어떤 것이든 어 려움으로 가득 차 있다. 인식의 모형과 관련하여, 우리가 특정 문화와 역사적 환경에 국한하더라도, 우리가 누구의 인식을 모형으로 만들려고 하고 있는지에 관한 의문이 생긴다. 분명, 음악에 대한 인식은 다양한 수준의 훈련을 받은 청취자마다 크게 다르 며, 사실, 음악 교육의 큰 부분은 이러한 청취 과정을 개발하고 풍부하게 하는(따라서 변화시킬 가능성이 있는) 데 할애되고 있다. 이것이 사실일 수도 있지만, 나는 여기서 는 인식의 아주 기본적인 측면, 특히 박자 및 조성과 같이 청취자 간에 비교적 일관 성이 있다고 내가 믿고 있는 측면에 관심을 두고 있다. 예를 들어, 대부분 사람은 전 형적인 민요나 클래식 곡에서 ‘박자를 찾을’ 수 있다는 일화적 증거가 있다. 이것이 이 점에 있어 완전한 일치가 있다는 것을 의미하는 것은 아니고, 전문가들 사이에서 도 곡의 음조나 박자를 듣는 방법에 대해 이따금 의견 차이가 있을 수도 있다. 하지 만 나는 우리 사이의 공통점이 차이점보다 훨씬 더 크다고 믿는다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "조류의 노래 학습은 두 단계로 이루어지는데, 첫째로는, 노래를 암기해야 하고 둘째로 는, 노래를 연습해야 한다. 일부 종에서는 이 두 가지 일이 겹치기도 하지만, 다른 종 에서는 연습 전 몇 달 동안 암기가 이루어질 수 있는데, 이는 장기 기억 저장의 인상 적인 예를 제공한다. 어린 새가 암기한 노래를 재현하려는 초기의 노력은 대체로 성 공적이지 못하다. 이러한 초기의 노래에는 고르지 않은 음정과 불규칙한 박자, 그리고23 순서가 맞지 않거나 제대로 재현되지 않은 음이 있을 수도 있다. 하지만 몇 주 또는 몇 달에 걸쳐 녹음된 노래의 음향 그래프를 보면, 이 연습 기간 동안 새가 암기된 본 보기를 정확하게 모방할 때까지 미세 조정의 노력을 기울인다는 것을 알 수 있다. (새소리 연구를 통해 드러날 수 있는 중요한 아이디어는 노래 학습은 선호하는 것과 한계점에 의해 형성된다는 것이다.) 이 과정에서는 자신이 노래하는 것을 들어야 하는 데, 만약 새들이 암기한 후이지만 연습 기간 전에 귀가 먹으면 암기된 노래를 재현할 수 없다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "content": [
      "Wildfire is a natural phenomenon in many Australian\nenvironments. The intentional setting of fire to manage the\nlandscape was practised by Aboriginal people for millennia. However, the pattern of burning that stockmen introduced\nwas unlike previous regimes. When conditions allowed,\nthey would set fire to the landscape as they moved their\nanimals out for the winter. This functioned to clear woody\nvegetation and also stimulated new plant growth in the\nfollowing spring. Although grasses were the first kinds of plants to\nrecolonize the burnt areas they were soon succeeded by\nfurther woody plants and shrubs. About the only strategy\nto prevent such regrowth was further burning ― essentially\nusing fire to control the consequences of using fire. The young shoots were a ready food source for their\nanimals when they returned. However, the practice also\ntended to reinforce the scrubby growth it was intended to\ncontrol."
    ],
    "translation": [
      "산불은 호주의 많은 환경에서 자연스러운 현상이다. 경관을 관리하기 위해 의도적으 로 불을 지르는 일은 수천 년 동안 호주 원주민들에 의해 행해졌다. 하지만 목축 업자들이 도입한 불 지르기 방식은 이전 양식과는 달랐다. 여건이 허락되면, 그들은 겨울에 자신들의 가축을 외부로 이동시켜, 경관에 불을 지르곤 했다. 이는 숲이 우거 진 초목을 없애는 역할을 했고, 또한 이듬해 봄에 새로운 식물의 성장을 촉진했다. 어린 새싹은 그들의 동물들이 돌아왔을 때 준비된 먹을 수 있는 식량원이었다. 하지만, 그 관행은 또한 통제하고자 했던 우거진 관목의 성장을 강화하는 경향도 있 었다. 불에 탄 지역에 다시 대량 서식한 첫 번째 식물류는 풀이었지만, 목본성 식 물과 관목이 곧 그것들의 뒤를 이었다. 그러한 재성장을 막기 위한 거의 유일한 전략 은 불을 더 지르는 것이었는데, 본질적으로는 불을 사용하여 불을 사용한 결과를 통 제하는 것이었다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "우리가 비판적 사고를 ‘의사결정을 안내하기 위한 증거의 검증 및 평가’로 이해한다 면, 윤리적 사고는 윤리적 사안을 식별하고 이러한 사안을 다양한 관점에서 평가하여 어떻게 대응할지를 안내하는 것이다. 이러한 형태의 윤리는 더 높은 수준의 개념적 윤리나 이론과는 구별된다. 이러한 관점에서 윤리적 사안이나 문제의 본질은 명백하 게 옳거나 그른 대응이 없다는 것이다. 따라서 학생들은 규정된 일련의 윤리 규범이 나 규칙을 따르는 것보다는 윤리적 문제를 충분히 생각하는 법을 배우는 것이 필수적 이다. 비록 윤리적인 행동이 ‘옳다고 여겨지는 행동 원칙에 따라’ 행동하는 것으로 정 의된다고 하더라도, 이러한 원칙은 개인 간 그리고 개인 내에서도 다를 수 있다는 인 식을 장려할 필요가 있다. 개인이 가치 있게 여기는 것은 그들의 공식적이고 또 비공 식적인 학습 경험에 의해 영향받은 사회적, 종교적, 혹은 시민으로서의 신념과 관련이 있다. 개인의 관점은 또한 상황에 따라 달라질 수도 있는데, 이는 다른 환경에서, 다 른 시간에, 그들이 다른 감정을 느끼고 있을 때, 동일한 개인이 다른 선택을 할 수도 있음을 의미한다. 따라서 윤리적 사안을 분석하고 윤리적으로 사고하기 위해서는 자 신의 ‘행동 규범’에 영향을 미치는 개인적 요인들과, 이것들이 어떻게 일치할(→ 달라 질) 수 있는지 이해하며, 그와 동시에 다른 사람들의 행동 규범과 의사결정에 영향을 미치는 요소들이 다를 수 있다는 점을 인식하고 받아들이는 것이 필요하다."
    ],
    "tags": [
      "#경제",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "진실은 진보와 지식의 발전에 필수적인데, 그것이 신뢰할 수 있고 정확한 이해가 이 루어지는 토대의 역할을 하기 때문이다. 그러나 지식 축적에 가장 큰 위협 중 하나가 이제 소셜 미디어 플랫폼에서 발견될 수 있다. 소셜 미디어가 수백만 명에게 주 정보 원이 되면서, 그것의 규제받지 않는 특성으로 인해 오정보가 빠르게 퍼지게 된다. 소 셜 미디어 사용자는 자신도 모르게 오정보를 만들고 유포하는 데 참여할 수 있는데, 이는 다양한 전 세계적 사건에서 보이듯이 선거에 영향을 미치고, 폭력을 유발하며, 광범위한 공황 상태를 조성할 수 있다. (정보) 제작자이자 소비자로서, 정확성을 확보 하기 위해 사실 확인 프로토콜 강화에 더 큰 역할을 맡는 것이 우리의 책무이다. 참 여자들이 더 사실 이해에 입각하고 합리적인 대중 커뮤니티를 지원하면서 정보의 신 뢰성을 보호하는 것이 매우 중요하다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "20세기에 접어들면서, 자연 과학에서 훈련받은 인류학자들은 인류학이 어떻게 보여야 하는지와 사회 과학자들이 문화 집단 연구를 어떻게 시작해야 하는지를 다시 생각하 기 시작했다. 그러한 인류학자들 중 일부는 다른 건 몰라도 연구 대상인 사람들을 실 제로 관찰하고 그들과 대화하는 데 상당한 시간을 할애해야 한다고 주장했다. Franz Boas와 Alfred Cort Haddon과 같은 초기 민족지학자들은 일반적으로 연구되고 있 는 사람이 살고 있는 외딴 지역으로 가서 그곳에서 몇 주에서 몇 달을 보냈다. 그들 은 (식민지 관료, 선교사 혹은 사업가와 같이) 주민들과 그 지역을 잘 알고 있는 그 지역 서양인 호스트를 찾아내어 그들을 통해 숙박 시설을 구했다. 가끔은 그들은 정 말이지 가이드 없이 그 지역 사회를 탐험하기도 했지만, 대개 그들은 현지인들과 상 당한 시간을 보내지는 않았다. 그리하여 그들의 관찰은 주로 그들의 ‘베란다’에서 행 해졌다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "개를 선택과 계획을 할 수 있는 지각력이 있는 존재로 간주하여, 이를테면 우리가 ‘그14 것(개)이 다른 방식으로 행동하는 것을 상상했을 수도 있다’라고 추정할 수도 있는 타 당한 이유가 있더라도, 아이를 공격한다 해서 그것이 사악하고 부도덕하다고 생각할 것 같지는 않다. 도덕적 책임은 엔트로피나 온도 같은 어떤 보편적인 개념, 즉 똑같이 적용되어 우주 어디에서나 비슷하게 측정될 수 있는 것이 아니다. 그것은 인간이 사용 하기 위해 특별히 개발된 개념인데, 언어와 별반 다르지 않다. 지각력과 의지가 마음 및 주체성의 측면인 반면, 도덕성은 사회적 행동에 영향을 미치기 위해, 즉 바람직한 것을 함양하고 해로운 것을 막기 위해 개발된 문화적 도구이다. 그것은 태어날 때 주 어지는 것이 아니라 학습된다. 우리는 다른 사람과 협력하려는 성향을 가지고 태어날 수 있고 실제로 그럴 가능성이 크지만, 오로지 인간 사회 내에서만 우리는 이것을 ‘도 덕적’ 행동으로 이해하게 된다."
    ],
    "tags": [
      "#철학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "낙하하는 물체나 밤이 낮으로, 낮이 밤으로 이어지는 것과 같은 평범한 현상보다 일 식과 같은 특이한 현상에 놀라는 것이 훨씬 더 자연스럽다. 그들에게 충격, 공포, 또 는 놀라움을 주었던 이러한 일식을 설명하기 위해 많은 문화에서 신을 만들어 냈지 만, 너무 익숙해서 심지어 알아차리지도 못했던, 낙하하는 물체의 신을 상상했던 문화 는 거의 없었다. 그러나 일식이 일어나는 이유는 밤과 낮이 연속되는 이유와 궁극적 으로 동일한데, 즉 그 자체로 뉴턴의 만유인력의 법칙에 기반하는 천체의 움직임과 그것이 우리가 물체를 놓으면 왜 떨어지는지 설명하는 방식이다. 그러므로 물리학자 로 말할 것 같으면, 평범한 것, 습관적인 것, 빈번한 것을 이해하여 우리가 무서운 것 과 기묘한 것을 설명할 수 있게 해 준다. 따라서 그와 같이, 우주의 모든 수준에서 일어나고 있는 다양하고 폭넓은 훨씬 더 기괴한 현상들을 이해하기 위해서, “물체는 왜 떨어지는가?”라고 질문하는 것과 뉴턴식의 답을 하는 것이 필요했다."
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "translation": [
      "개방형 사무실 계획이 유행하는 데는 그럴 만한 이유가 있지만, 개방형 사무실이 ‘언 제라도’ 선택할 수 있는 계획은 아닐 수도 있다. 대신에, 올바른 계획은 변화의 문화 를 구축하는 것인 듯하다. 지나치게 굳은 관례와 관습은, 아무리 깊이 고려되거나 의 도가 좋다 하더라도 혁신을 위협한다. 시간이 지남에 따른 사무실 계획을 분석할 때 매우 중요한 핵심은 답이 계속 바뀐다는 것이다. 일직선으로 발전하는 것처럼 보일 수도 있지만, 이는 근거 없는 믿음이다. 지난 80년의 사무실 공간을 조사해 보면, 반 복되는 주기를 확인할 수 있다. 1940년대의 사무실과 현대의 사무실 공간을 비교해 보면 칸막이벽과 작은 개인 방이 더 일반적이었던 1980년대를 거쳐, 다시 본질적으로 동일한 스타일로 크게 한 바퀴 돌아왔음을 알 수 있다. 기술과 색상은 다를 수도 있 지만, 1940년대와 2000년대의 계획은 비슷한데, 중앙을 따라 내려오는 기둥까지도 그 렇다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "빅토리아 시대 영국의 특징은 산업혁명의 완전한 전개이다. 영국은 세계 최초의 산업 국가가 되었고, 1850년 무렵에는 농업보다 공업에 종사하는 인구가 더 많은 최초의 국가가 되었다. 무역의 확대는 대영제국의 성장과 맞물려 영국에 막대한 부를 가져다 주었지만, 이 부는 고르게 분배되지 않았다. 많은 진취적인 개인(‘자수성가한 사람들’) 은 비천한 출신에서 부와 영향력을 가진 지위로 올랐지만, 노동 계급의 다수는 열악 한 환경에서 저임금으로 장시간 노동하는 대도시의 빈민가로 내몰렸다. 영국 북부의 제조업 도시들은 몇몇 최악의 사례를 제공하며 Kingsley의 Alton Locke, Gaskell의 Mary Barton, Dickens의 Hard Times와 같은 사회의식이 강한 소설에 영감을 주었 다. 남부에는 이미 세계에서 가장 큰 도시인 런던이 있었는데, 이곳은 과잉 인구와 무계획적인 성장의 결과인 모든 범죄, 악, 비참함을 보여 주었다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "우리는 모두 자신을 신중하고 사려 깊이 생각하며 타당하고 신뢰할 수 있는 판단을 내릴 수 있는 합리적인 행위자라고 여기고 싶어 한다. 우리는 우리가 일반적으로 다 양한 관점을 고려하고 정보에 입각한 결정을 내린다고 믿을지도 모른다. 사실, 우리는 심리학자 Dan Ariely가 이 주제에 관한 자신의 책에 붙인 제목처럼 ‘예측할 수 있게 비합리적’이다. 우리는 모두 자동적이고 반사적인 사고를 하며, 일반적으로 더 쉬운 길을 택하고 정신적 노력을 절약한다. 우리는 각자 자신이 신중하게 생각한다는 주관 적인 인상을 가질 수도 있지만, 우리가 성급한 판단을 내리거나 실제 판단을 전혀 하 지 않는 경우는 흔하다. 게다가, 수많은 편향이 성찰적이고 신중한 사고를 억제하거나 무시하는데, 직관적인 이론도 정확한 과학적 설명의 수용을 방해할 수 있을 것이다. 우리의 마음이 어떻게 작용하고 편향이 어떻게 작동할 수 있는지 더 많이 이해하는 것은 우리 각자가 잘못된 추론에 덜 빠지고, 더 합리적이며, 다른 사람의 사고의 문 제점을 더 잘 인식하게 할 수 있다. 우리의 정신 과정에 내재한 합리성(→ 한계)를 이 해하는 것을 배우는 것은 우리가 다른 사람들에게 더 효과적으로 정보를 전달하는 능 력을 향상하는 데도 도움이 될 수 있다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "나방이 왜 빛에 끌리는지에 관한 많은 논의가 있어 왔다. 나방이 빛에 끌리는 것이20 아니라 빛에 의해 갇힌다는 것이 합의인 것처럼 보인다. 빛은 감각 과부하를 일으켜 곤충이 방향을 잃게 하고 그것이 제자리를 맴돌게 한다. 마하 밴드 이론이라는 가설 에 따르면, 나방은 광원 주변의 어두운 영역을 보고 빛을 피하고자 그쪽으로 향한다. 또 다른 이론은 나방이 광원에서 나오는 빛을 중앙에 어두운 점이 있는, 널리 퍼진 광륜(光輪)으로 인식한다는 것을 보여 준다. 나방은 빛을 피하려고 애쓰면서, 상상 속 의 ‘입구’를 향해 날아가 광원에 더 가까이 다가가게 된다. 빛에 가까워지면서 나방의 기준점이 바뀌고 나방은 입구에 도달하기 위해 어쩔 도리 없이 빛 주위를 맴돈다. 누 구나 현관 불빛을 맴도는 나방에 익숙하다. 나방의 비행은 아무런 목적이 없는 것처 럼 보이지만, 그들은 빛의 끌어당김에서 벗어나려고 애쓰고 있는 것으로 여겨진다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "통신 기술의 사용을 결정하는 요인 중 하나는 장비와 인력에 들어가는 투자의 종류, 즉, 누가 투자를 하고, 그들이 수익으로 무엇을 기대하는지이다. 투자가 반드시 다수 의 사람에게 가장 적합한 통신 형태일 것이라는 보장은 없다. 투자 기금의 소유권은 상업적 조직의 수중에 있는 경향이 있으므로, 통신 기간 시설의 현대화는 오로지 잠 재적 수익성을 바탕으로 이루어진다. 아프리카 대륙 전역에 걸친 광섬유 통신 케이블 설치를 예로 들어보자. 여러 아프리카 국가가 그 개발에 관여하고 있지만, 그것의 운 영 구조는 이용에 대한 대가를 지급할 수 있는 국가들을 우선할 것이다. 교육과 정보 를 위해 그것을 이용하고 싶어 할 수도 있는 많은 국가는 그것이 자국에 너무 비쌀 뿐만 아니라 단순히 이용할 수 없다는 것을 알게 될지도 모른다. 그 개발이 지역 사 회의 수요보다는 투자 기회에 의해 주도되었다는 것은 의심의 여지가 있을 수 없다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "도시의 질은 선택적 활동에 매우 중요해서, 머물기 활동의 정도가 흔히 도시의 공간 뿐만 아니라 도시의 질을 측정하는 잣대로 사용될 수 있다. 도시의 많은 보행자가 반 드시 도시의 질이 좋다는 지표인 것은 아니며, 걸어서 돌아다니는 많은 사람은 흔히 부족한 운송 선택권 또는 도시 내 다양한 기능 간의 먼 거리의 징표일 수 있다. 반대 로, 많은 사람이 걷지 않는 도시는 흔히 좋은 도시의 질을 나타낸다고 주장될 수 있 다. 로마와 같은 도시에서 눈에 띄는 것은 걷기보다는 광장에 서 있거나 앉아 있는 많은 사람이다. 그런데 이것은 필요성 때문이 아니라, 그 도시의 질이 매우 매력적이 기 때문이다. 도시 공간에는 머무르게 하는 유혹이 너무 많아서 계속 움직이기 어렵 다. 반대로 많은 사람이 걸어서 지나가지만 거의 멈추거나 머무르지 않는 많은 새로 운 구역과 단지가 있다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "최고의 판매업자는 단지 상품을 전시하고 ‘재고로 있는 것을 판매하는 것’보다 훨씬 더 폭넓은 서비스를 제공한다. 특정 수집가의 필요를 알게 되면, 그들은 소장품의 빈 틈을 채우려 특정 물품을 적극적으로 찾을 수 있다. 그것이 그들이 전업으로 하는 사23 업이기 때문에, 그들은 여태껏 어느 비전문 수집가가 구축할 수 있는 것보다도 훨씬 더 넓은 조직망을 필연적으로 갖출 것이다. 당연히 그들은 다른 도시의 판매업자들에 게, 그리고 가장 중요하게 일부 범주에서는 해외의 판매업자들에게도 작품의 구매 가 능 여부를 문의할 수 있다. 그들은 모든 경매와 중요한 개인 판매 소식에 대해 정례 적으로 정보를 받을 것이며, 아직 판매되지 않았지만 특정 가격에 구매할 수 있을 물 품에 대해 가끔 소식을 들을 수 있도록 충분히 연결망을 갖추고 있을 것이다. (판매 업자로부터 구매하는 것의 주요 이점은 구매품에 대해 개인화된 서비스를 받는 것이 다.) 결과적으로, 그들은 원하는 물품이나 대상의 ‘필요 품목표’를 자신들이 연락하는 이들에게 배포하여, 자신들의 고객 수집가의 소장품 확장 기회를 배가할 수 있다."
    ],
    "tags": [
      "#경제",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "If learning were simply a matter of accumulating lists of\nfacts, then it shouldn’t make any difference if we are\npresented with information that is just a little bit beyond\nwhat we already know or totally new information. If we are trying to understand something totally new,\nhowever, we need to make larger adjustments to the units\nof the patterns we already have, which requires changing\nthe strengths of large numbers of connections in our\nbrain, and this is a difficult, tiring process. The adjustments are clearly smallest when the new\ninformation is only slightly new ― when it is compatible\nwith what we already know, so that the old patterns need\nonly a little bit of adjustment to accommodate the new\nknowledge. Each fact would simply be stored separately. According to\nconnectionist theory, however, our knowledge is organized\ninto patterns of activity, and each time we learn something\nnew we have to modify the old patterns so as to keep the\nold material while adding the new information."
    ],
    "translation": [
      "학습이 단순히 사실의 목록을 축적하는 문제라면, 우리가 이미 알고 있는 것을 조금 넘어서는 정보가 제공되거나 완전히 새로운 정보가 제공되더라도 아무런 차이가 없을 것이다. 각 사실은 단순히 개별적으로 저장될 것이다. 그러나 연결주의 이론에 따 르면, 우리의 지식은 활동 패턴으로 조직되며, 우리가 새로운 것을 배울 때마다 새로 운 정보를 추가하면서 이전 자료를 유지하기 위해 기존 패턴을 수정해야 한다. 새 로운 정보가 약간만 새로운 것일 때, 즉 그것이 우리가 이미 알고 있는 것과 양립할 수 있어서, 새로운 지식을 수용하기 위해 기존 패턴을 약간만 조정하면 될 때 조정은 분명 가장 적다. 그러나 완전히 새로운 것을 이해하려고 한다면, 우리는 이미 가 지고 있는 패턴의 단위를 더 크게 조정해야 하는데, 이를 위해서는 우리 뇌의 수많은 연결 강도를 변경해야 하며, 이것은 어렵고 피곤한 과정이다."
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "content": [
      "The generally close connection between health and what\nanimals want exists because wanting to obtain the right\nthings and wanting to avoid the wrong ones are major\nways in which animals keep themselves healthy. They can take pre-emptive action so that the worst never\nhappens. They start to want things that will be necessary\nfor their health and survival not for now but for some time\nin the future. Animals have evolved many different ways of maintaining\ntheir health and then regaining it again once it has been\ndamaged, such as an ability to heal wounds when they are\ninjured and an amazingly complex immune system for\nwarding off infection. Animals are equally good, however, at dealing with injury\nand disease before they even happen. They have evolved\na complex set of mechanisms for anticipating and avoiding\ndanger altogether."
    ],
    "translation": [
      "올바른 것을 얻고자 하는 것과 잘못된 것을 피하고자 하는 것은 동물이 자신의 건강 을 유지하는 주요한 방법이기 때문에 건강과 동물이 원하는 것 사이에는 일반적으로 밀접한 관계가 존재한다. 동물은 다쳤을 때 상처를 치유하는 능력과 감염을 막기 위한 놀랍도록 복잡한 면역 체계와 같은, 건강을 유지하고 그러고는 건강이 손상되었 을 때 이를 되찾는 많은 다양한 방법을 발달시켜 왔다. 그러나 동물은 부상과 질 병이 발생하기 전에 대처하는 능력도 똑같이 뛰어나다. 동물은 위험을 예측하고 완전 히 피하기 위한 복잡한 메커니즘을 발달시켜 왔다. 그들은 최악의 상황이 발생하 지 않도록 선제 조치를 취할 수 있다. 그들은 지금이 아니라 미래 언젠가의 건강과 생존에 필요할 것들을 원하기 시작한다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "생태계에 개입할지 여부와 방법을 결정하기 위해 보호 지역 관리자는 자신이 개입하 지 않을 경우 미래의 생태계가 어떨지 일반적으로 상당히 명확하게 알고 있을 필요가 있다. 관리 관행에는 대체로 더 바람직한 미래 상태를 규정하고 생태계를 그 상태 쪽 으로 밀고 가거나 이끌도록 설계된 관리 조치를 실행하는 것이 포함된다. 관리자는 개입의 가능한 결과에 대한 확신이 필요하다. 이러한 전통적이고 본질적으로 논리적 인 접근 방식은 높은 수준의 예측 능력을 필요로 하며, 예측은 적절한 공간적, 시간 적 규모에서, 종종 국지적이고 단기적인 규모로 이루어져야 한다. 안타깝게도 보호 지 역 관리에 가장 유용한 규모, 정확성, 정밀도를 고려할 때 미래는 전례가 없을 뿐만 아니라 예측할 수 없는 것이 될 것이다. 이를 설명하기 위해 기후 변화 예측과 관련 된 불확실성, 생태계가 기후 변화에 어떻게 반응할 것인지, 그리고 기후 변화의 해로 운 영향에 대응하기 위해 취할 수도 있을 조치의 가능한 효율을 고려해 보라. 다른 생태계 스트레스 요인의 미래 변화의 성격과 규모에서도 비슷한 불확실성이 존재한26 다."
    ],
    "tags": [
      "#철학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "우리는 거의 보편적으로 비디오 게임을 하는 것이 기껏해야 학생이 학습에서 잠시 벗 어나는 즐거운 휴식이고, 더 흔히는 학생이 목표를 이루는 것을 방해하는 것이라 받 아들인다. 게임은 다른 어떤 것도 거의 할 수 없는 방식으로 주의를 사로잡고 계속해 서 유지한다. 하지만 일단 그것(게임)이 우리의 집중을 얻고 나면, 그것(게임)은 게임 이외의 삶에서 학생들이 성장하는 데 도움이 되는 의미 있는 어떤 것도 제공하는 경 우는 거의 없는 것 같다. 많은 게임에 대해 이것이 사실일 수도 있지만, 우리는 생산 성을 저해하는 대신 생산성을 향상하는 데 사용될 수도 있는 가치 있는 도구를 너무 쉽게 무시하고 있다. 오히려, 우리가 학생들에게 원하는 학습 성과와 연결되는 게임을 개발하는 것이 바람직하다. 이를 통해 교육자들은 게임의 주의력 지배 능력을 활용할 수 있게 되고, 우리 학생들은 학습하면서 게임을 즐길 수 있게 될 것이다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "건축가의 지위는 로마 제국 시대에 상승했는데, 이는 건축이 상징적으로 특히 중요한 정치적 성명이 되었기 때문이다. Cicero는 건축가를 의사와 교사와 같은 부류에 넣었 으며, Vitruvius는 ‘이토록 위대한 직업’에 대해 말했다. Augustus Caesar 통치 시 기에 활동하던 건축가인 Marcus Vitruvius Pollio는 건축이 실용적 지식과 이론적 지식을 모두 필요로 한다는 점을 인정했으며, 그는 장차 건축가가 되려는 자가 숙달 해야 한다고 생각한 학문 분야를 나열했는데, 이는 문학과 작문, 제도, 수학, 역사, 철 학, 음악, 의학, 법, 그리고 천문학이었고, 이것은 여전히 많은 추천을 받는 교육과정 이다. 그는 이 모든 학문이 필요하다고 주장했는데, 그 이유는 학문 없이 손기술을 습득하려 한 건축가는 결코 자신의 계획에 상응하는 권위 있는 지위에 도달할 수 없 었던 반면, 오로지 이론과 학문에만 의존한 건축가는 분명히 ‘실체가 아닌 그림자를 쫓고 있었기’ 때문이다."
    ],
    "tags": [
      "#철학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "감정을 이해하는 능력, 즉 다양한 감정 어휘를 가지고 있고 감정의 원인과 결과를 이 해하는 능력은 집단 환경에서 특히 중요하다. 이 분야에 능숙한 사람들은 감정, 느낌, 그리고 기분을 정확하게 표현할 수 있으므로, 동료들 간의 명확한 의사소통을 촉진할14 수 있다. 더욱이, 그들은 자신의 필요뿐만 아니라 타인의 필요도 수용하는 방식으로 행동(즉, 협력)할 가능성이 더 높을 수도 있다. 예를 들어, 집단 갈등 상황에서 감정을 이해하는 강력한 능력을 지닌 구성원은 문제에 대해 자신이 어떻게 느끼는지 그리고 왜 그렇게 느끼는지를 표현할 수 있을 것이다. 또한 그는 다른 집단 구성원들의 관점 을 취하여 그들이 왜 특정한 방식으로 반응하는지 이해할 수 있을 것이다. 다름에 대 한 이해는 열린 의사소통을 위한 장을 만들고 건설적인 갈등 해결과 집단 기능 향상 을 촉진한다."
    ],
    "tags": [
      "#심리학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "산업 시대의 도래는 시간, 노동, 자본 사이의 관계를 변화시켰다. 공장은 24시간 내내 생산할 수 있었고, 이전 어느 때보다 더 빠른 속도와 더 많은 양으로 그렇게 할 수 있었다. 하루 12시간 가동되는 기계는 하루 8시간만 가동되는 기계보다 더 많은 제품 을 생산할 것이고, 하루 24시간 가동되는 기계는 모든 기계 중 가장 많은 제품을 생 산할 것이다. 따라서 많은 공장에서 작업일은 8시간 근무 교대로 나누어져서, 제품 (생산) 기계가 쉬지 않고 돌아가도록 언제나 인력이 배치되어 있을 것이다. 산업화는 모든 개별 근무 시간의 잠재적 가치를 높였는데, 더 많은 시간을 일했을수록, 더 많 은 제품을 생산했고, 더 많은 돈을 벌었으며, 이로써 임금은 노력과 생산량에 연계되 었다. 이전에는 수확 주기를 따르던 노동이 시계 중심이 되었고, 사회는 새로운 생산 성의 원칙을 중심으로 재조직되기 시작했다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "셀피가 공명하는 이유는 그것이 새롭기 때문이 아니라, 자화상의 오랜 역사를 표현하 고 발전시키며 확장하고 강화하기 때문이다. 자화상은 그려진 사람의 지위를 다른 사 람들에게 보여 주었다. 이런 의미에서, 우리가 자신의 ‘이미지’라고 부르게 된 것, 즉 우리가 생각하는 우리의 모습과 다른 사람들이 우리를 보는 방식의 접점은 세계적 시 각 문화의 첫 번째이자 근본적인 대상이다. 셀피는 우리가 바라는 대로 표현될 수도 있고 그렇지 않을 수도 있는 우리의 내면적 감정과 긴장 관계에 있는, 우리 자신의 일상적 수행의 드라마를 그린다. 자화상 확장의 각 단계에서. 점점 더 많은 사람이 자신을 그릴 수 있게 되었다. 오늘날의 젊고, 도시에 살며, 네트워크로 연결된 대다수 는 셀피를 새로운 시대의 첫 번째 시각적 특징으로 만들기 위해 자화상의 역사를 다 시 만들었다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "자신을 생각해 보라. 예를 들어, 여러분은 일어서서 물을 마시기로 결정할 때, 그와 관련된 많은 단계를 의식적으로 조직하거나 고려하지 않는다. 우리가 단지 일어서서 걷기 위해서도 수축되거나 이완되어야 하는 각각의 모든 근육을 고려해야 하는 경우 를 상상해 보라. 그것은 성가시고 아주 느릴 것인데, 운동계에 영향을 미치는 뇌 손 상에서 회복 중인 환자들이 알고 있는 것처럼 말이다. 우리 뇌의 자동 조종 부위가 우리를 위해 자동으로 그것을 해서, 우리의 의식적 마음을 더 중요한 일에 사용할 수 있게 해 준다. 우리가 움직이고, 듣고, 보고, 우리의 많은 사회적 기술을 사용할 수 있게 해 주는 이러한 자동적 과정을 지원하는 것은 우리 뇌의 오래된 부위들이다. 말 하기, 읽기, 쓰기와 같은 더 최근에 진화된 능력들은 훨씬 덜 자동화되어 있다. 그래 서 대개는, 여러분이 지각하거나, 느끼거나, 생각하는 것은 완전히 여러분의 의식 없 이 일어나는 매우 투박하고 빠른 분석에 기반한다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "심리학 연구에서는 경쟁적 유인책이 과업 노력을 저하하는 사례를 보고했으며, 그 초 점은 동기 저하의 심리적 기반에 맞춰져 있었다. 예를 들어, 경쟁은 개인적 목표를 달성하려는 동기와 다른 사람들과 좋은 관계를 유지하려는 욕구 사이에 피할 수 없는 갈등을 제기한다. 특히 자신의 상대와, 아니면 일반적으로는 타인과의 대인 관계 유지 가 중요할 때, 경쟁자들은 자신의 목표를 달성하려는 욕구에 손상을 주고 승리로 인 해 생기는 좋은 감정을 더럽힐 수 있는 내적 갈등을 경험한다. Exline과 Lobel은 상 향적 사회 비교의 대상으로 자신을 인식하는 것이 흔히 사람들을 불편하게 만든다는 것을 발견했다. 사람들은 다른 사람들이 시기하며 자신과 비교하고 있다고 생각하면, 불안, 괴로움, 혹은 슬픔을 느낀다. 일반적으로 목표 달성에 대한 높은 동기와 연관된 감정인 죄책감은 경쟁적 목표를 추구할 때의 동기와 성과를 더 강하게(→ 더 약하게) 만든다. 이러한 감정 상태의 결과에는 경쟁 상황에서의 업무 동기 저하, 그리고 결과 의 중요성을 줄이거나 승자의 보상을 나누는 것과 같은 더 협력적이고 이타주의의 결 과에 대한 선호가 포함된다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "20 문학은 그것이 독자에게 길러 주는 개인적 몰입 때문에 언어 학습 과정에 도움이 될 수 있다. 핵심 언어 교육 자료는 언어가 규칙 기반 체계이자 사회의미론적인 체계로 서 어떻게 작동하는지에 중점을 두어야 한다. 매우 흔히, 학습 과정은 본질적으로 분 석적이고 단편적이며, 개인의 수준에서는 상당히 피상적이다. 상상력을 발휘하여 문학 에 몰입함으로써 학습자는 주의의 초점을 외국어 체계의 더 기계적인 측면 너머로 전 환할 수 있게 된다. 소설, 희곡, 혹은 단편 소설을 일정 기간 탐구하면, 그 결과로 독 자는 텍스트에 ‘깃들기’ 시작한다. 독자는 책 속으로 빨려 들어간다. 개별 단어나 어 구가 의미할 수도 있는 것을 정확히 집어내는 것은 이야기 전개를 따라가는 것보다 덜 중요해진다. 독자는 사건이 전개되면서 무슨 일이 일어나는지 간절히 알아내고 싶 어 하고, 독자는 특정 등장인물들과 친밀감을 느끼며 그들의 감정적 반응을 공유한다. 언어는 ‘투명’해지고, 소설은 그 사람 전체를 소설 자체의 세계로 끌어들인다."
    ],
    "tags": [
      "#심리학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "교육은 최고의 모습에서는 단순한 지식 이상을 가르친다. 그것은 비판적 사고, 즉 행 동하기 전에 멈추어 생각할 수 있는, 감정적 압박에 굴복하는 것을 피할 수 있는 능 력을 가르친다. 이것은 사고 통제가 아니다. 그것은 바로 정반대인 정신적 해방이다. 심지어 가장 지적으로 발달한 사람조차도 이 기능은 불완전할 것이다. 하지만 불완전 하게라도 그것을 소유하는 것은 인접한 주변 환경, 가장 밝은색이나 가장 큰 소리에 끊임없이 반응하면서 ‘자극에 의해 추동’되는 것에 대한 부담에서 사람을 벗어나게 해 준다. 휴리스틱 반응에 의해 추동되는 것, 즉 항상 본능과 감정에 따라 사는 것은 여 러 면에서 매우 쉬운 삶의 방식인데, 사고는 특히 경험이 없는 사람들에게는 노력을 필요로 한다. 그러나 감정도 또한 지치게 하고, 단기적인 반응은 장기적으로 볼 때21 건강과 생존에 가장 유익한 것이 아닐 수도 있다. 우리가 편리함을 얻으려고 햄버거 에 손을 뻗어 언젠가 우리의 목숨을 앗아갈지도 모르는 동맥 지방을 축적하는 것처 럼, 우리가 감정에 의존하는 것은 우리에게 큰 해를 끼칠 수 있다."
    ],
    "tags": [
      "#심리학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "20세기의 스포츠 관광의 확대는 교통수단이 더욱 발전되는 것에 영향을 받았다. 철도23 가 19세기에 여행에 혁신을 일으켰던 것과 꼭 마찬가지로, 자동차는 20세기에 훨씬 더 극적인 변화를 일으켰다. 스포츠와 관광의 발전에서 자동차의 중요성은 일반적으 로 상당한 관심을 끌었으며, 구체적으로는 스포츠 관광에 그에 못지않은 영향을 미쳤 다. 자동차는 원래 19세기 말에 접어들면서 발명되었지만, 1920년대에 미국에서, 그 리고 상당히 더 늦게 영국에서 대중적인 교통수단이 되기 시작했다. 자동차는 편리함 과 유연성 외에도 짐과 장비를 쉽게 운송해 준다는 것과 더불어 대중교통이 제공되지 않는 많은 지역에 접근하게 해 준다는 추가적인 장점이 있다. (관광업 성장과 연관된 가격이 합리적이고 질이 좋은 숙박 시설의 확대는 또한 현지에 기반을 둔 식당의 성 장을 촉진했다.) 그 결과, 그것은 여러 형태의 스포츠 관광, 특히 사람과 장비를 비교 적 먼 곳으로 운송해야 하는 스포츠 관광 형태가 발전하는 데 매우 유용했다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "content": [
      "The potential for market enforcement is greater when\ncontracting parties have developed reputational capital that\ncan be devalued when contracts are violated. Similarly, a landowner can undermaintain fences, ditches,\nand irrigation systems. Accurate assessments of farmer\nand landowner behavior will be made over time, and\nthose farmers and landowners who attempt to gain at each\nother’s expense will find that others may refuse to deal\nwith them in the future. Over time landowners indirectly monitor farmers by\nobserving the reported output, the general quality of the soil,\nand any unusual or extreme behavior. Farmer and landowner\nreputations act as a bond. In any growing season a farmer can\nreduce effort, overuse soil, or underreport the crop. Farmers and landowners develop reputations for honesty,\nfairness, producing high yields, and consistently demonstrating\nthat they are good at what they do. In small, close-knit\nfarming communities, reputations are well known."
    ],
    "translation": [
      "시장 규제 집행 가능성은 계약 당사자들이 계약 위반 시 가치가 떨어질 수 있는 평판 자본을 구축한 경우에 더 크다. 농부와 지주는 정직함, 공정함, 높은 수확량을 생 산하는 것, 그리고 자신이 하는 일에 능숙하다는 것을 일관되게 입증하는 것에 대한 평판을 쌓아 나간다. 소규모의 긴밀히 맺어진 농업 공동체에서는 평판이 잘 알려져 있다. 시간이 지나면서 지주들은 보고된 생산량, 토양의 전반적인 질, 어떤 보기 드물거나 극단적인 행동을 관찰함으로써 농부들을 간접적으로 감시한다. 농부와 지주 의 평판은 계약의 역할을 한다. 어떤 한 재배 철에 농부는 노력을 줄이거나 토양을 과도하게 사용하거나 작물을 축소 보고할 수 있다. 마찬가지로, 지주는 울타리, 도랑, 관개 시스템을 제대로 관리하지 않을 수 있다. 농부와 지주의 행동에 대한 정 확한 평가는 시간이 지남에 따라 이루어질 것이고, 상대방의 비용으로 이익을 취하려 고 시도하는 농부와 지주는 다른 사람들이 향후 그들과의 거래를 거부할 수도 있다는 것을 알게 될 것이다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "그야말로 본질적으로, 정비와 수리의 개념은 과정 지향적인 관점에서 주로 검토된다. 관련된 학문적 담론의 초점은 흔히 물건과 기술의 수명 또는 생애 주기를 중심으로 이루어진다. 이러한 맥락에서 정비와 수리는 물건의 존속을 연장하여 장기간에 걸쳐 지속적 활용을 보장할 잠재력을 가진 행위로 여겨진다. Krebs와 Weber는 물건의 일 대기를 암시하는 의인화된 은유를 비판적으로 사용하여, 기술의 생애 주기에 대한 관 례적인 이해가, 기술의 획득부터 가정에서 그것의 폐기에 이르기까지, 불완전한 정의 를 제공한다는 점을 적절히 강조한다. 실제로 물건은 선형적인 수명 주기 모형을 따 르지 않고, 대신에 고장을 겪거나, 수리를 기다리거나, 사용되지 않고 보관되거나, 지 하실로 추방되거나 했다가, 결국 나중에 다시 발견되어 용도가 변경되기도 한다. 게다 가, 물건은 재활용 또는 중고품 순환 과정으로 들어갈 수도 있어서 다양한 용도로 활 용되는 역동적인 사후 생애를 맞이하기도 한다. 따라서 물건의 생애는 단순한 선형적26 진행보다는 훨씬 더 복잡하고 적응적인 경로를 보인다."
    ],
    "tags": [
      "#철학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "여러분의 엄지손가락과 집게손가락 사이에 한 장의 종이를 쥐는 것을 상상해 보라. 어쩌면 여러분은 이 페이지를 넘기면서 이미 하고 있을지도 모른다. 우리는 이러한 유형의 힘을 써서 손가락 끝 살이 맞닿는 정밀하게 쥐는 법을 그것에 대하여 아무 생 각 없이, 말 그대로 순식간에 사용한다. 그러나 그것은 인류 진화의 획기적 발전이었 다. 다른 영장류도 물체를 다루고 사용할 때 일종의 정밀한 쥐기를 보이지만, 우리 손의 해부학적 구조가 허용하는 종류의 효율적인 (엄지와 다른 손가락의) 마주함은 아 니다. 한 손에서, 인간은 작고 깨지기 쉬운 물체조차도 쉽게 잡고 조작할 수 있으며, 한편 모양에 맞게 우리의 손가락을 조정하고 우리의 손가락 끝 살 부분을 이동시켜 그 물체의 방향을 바꿀 수 있다. 우리의 비교적 길고 강력한 엄지손가락과 (거의 모 든 영장류가 소유한) 평평한 손톱을 포함하여 다른 해부학적 속성들이 이것을 가능하 게 한다. 끝이 뾰족하고 굽은 발톱으로 이 페이지의 모서리를 접으려다가 실패하는 모습을 한번 상상해 보라. 고유한 특성의 조합으로, 인간의 손은 인류의 역사를 이루었다. 의심할 여지 없이, 필 요한 신호를 조절하고 조정할 수 있는 신경계와 함께 그 일을 할 수 있는 손이 없었 다면 석기는 인간 기술과 생계의 핵심이 될 수 없었을 것이다. 돌로 창 촉이나 화살 촉을 만들어 보려 한 사람이라면 누구라도 그것이 강하게 쥐는, 지속적인 회전과 재 배치, 그리고 또 다른 단단한 물체로 강하고 주의 깊게 두드리는 것을 배제한다는(→ 요구한다는) 것을 안다. 그리고 상당한 정도의 요령을 가지고서도, 이것은 피투성이가 되는 작업일 수 있다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "위험에 대한 우리의 대응 능력은 생존에 중요했기 때문에, 불확실한 상황에서 걱정을 느끼는 것은 정상이다. 걱정이라는 감정은, 미래 사건을 예상하면서 활성화되며, 일상 적인 상황에서 자주 경험된다. 예를 들어, 우리는 중요한 발표 도중 컴퓨터가 갑자기 작동을 멈추는 것과 같은, 일어날 것 같지 않은 일을 상상하며 걱정할 수 있다. 어느 정도까지는, 잠재적 시나리오를 충분히 생각하는 것은 도움이 될 수 있다. 하지만 우 리의 걱정이 통제 범위를 넘어서면, 그것은 우리에게 불필요한 고통을 일으킨다. 여러 분은 결국 실제로는 일어나지 않은 끔찍한 상황을 생각하느라 잠을 설친 적이 얼마나 많았었는지 생각해 보라. 만약 그 상황이 실제로 일어났다고 해도, 그것은 그것에 대 해 걱정하는 것이 그것이 일어나는 것을 막는 데 아무런 도움이 되지 않았다는 것을 보여줄 뿐이다. 그러므로 겪지 않을 수도 있는 일에 대해 끝없이 걱정하는 것을 멈추 기 위해 의식적인 노력을 기울이는 것은 가치가 있다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "여러분의 자존감을 등반 성과에 근거하는 것은 외부 요인의 변덕에 자신을 맡기는 것 이다. 이러한 요인은 무작위적이고 오도할 수도 있다. 비교는 착각의 한 원천이다. 어 쩌면 여러분의 파트너가 컨디션이 별로 좋지 않은 날이어서 등반이 매우 어렵다고 생 각했기 때문에, 여러분이 그 등반을 잘했다고 느꼈을지도 모른다. 실제로는 평소보다 나을 게 없이 등반하고 있었을 때도, 여러분은 그것이 조금 어렵다고만 생각했고, 자 신이 꽤 잘 등반하고 있었다고 결론짓는다. 아니면, 여러분의 파트너는 기량이 최고였 다. 실제로는 여러분이 객관적으로 매우 강렬한 성과를 냈을 때도, (그와) 비교하여 자신이 약하다고 느꼈다. 환경적 요인이 연관될 수도 있다. 어쩌면 실제로는 정말로 그다지 잘 등반하지 못했을 때도, 여러분은, 가령 습도가 낮은 것처럼, 특히 유리한 조건 덕분에 여러분의 하루 목표를 달성했을지도 모른다. 이 모든 경우에서, 여러분이 느끼는 좋거나 나쁜 감정은 여러분이 자신의 공으로 돌릴 수 있는 것에 근거한 것이 아니다. 만약 그 성과가 여러분의 자존감을 높여준다면, 그 상승은 허구에 근거한 것 이다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "정보와 의미는 분명히 동일한 것이 아니다. 전자는 특정 상황에서 그 확률이 쉽게 측 정될 수 있는, 해석되지 않은 데이터나 감각 상태를 가리키고, 후자는 그 데이터나 감각 상태에 대한 해석을 가리키며, 여기에는 특정 상황에서 그 정보가 수반하거나 갖도록 의도된 특별한 종류의 뉘앙스와 가치가 포함된다. 이는 경보 신호에서 정교한14 진술문에 이르기까지 어떤 종류의 정보에도 적용된다. 예를 들어, 연속으로 앞면을 세 번 던지는 것이 이기게 되는 것으로 결정된 동전 던지기 게임을 생각해 보자. 어떤 게임 참가자가 결국 지속적으로 원하는 결과를 얻어 그 참가자에게 도전하는 모든 이 들을 이긴다면, 우리는 그 결과를 ‘행운’의 작용으로 해석하거나, 아니면 그 이긴 게 임 참가자에 의한 교묘하고 감지할 수 없는 부정행위로 해석하는 경향이 있다. 해석 은 우리가 행하고, 생각하며, 느끼는 모든 것의 중심에 있다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "수업 토론의 목적은 여러분이 수동적인 기록자가 아닌 능동적인 참여자가 되도록 장 려하는 것이다. 토론에서는 학생들이 생각하고, 반응하고, 응답하도록 하는 데 많은 강조점이 주어진다. 이러한 활동은 학습 과정에서 중요한 지적 활동인데, 이는 그것을 통해 자신의 의견을 발견하고 표현해야 하기 때문이다. 글쓰기는 이러한 과업을 완수 하는 데 매우 유용한 도구이다. 안타깝게도 수업 토론이 시작되면 펜과 연필을 내려 놓는 경우가 너무 많다. 강의와 달리 토론은 정리가 안 되어 있고 따라가기 어려운 경향이 있기 때문에, 강의에서 보다 토론에서 메모를 하는 것이 훨씬 더 어렵다는 것 은 인정한다. 또한 학생들은 보통 다른 학생이 하는 말 중 얼마나 많은 부분이 중요 한지 모른다. 그리고 여러분이 적극적인 참여자라면 메모를 하면서 자신이 하고 싶은 말을 표현하는 것이 쉽지 않다. 하지만 토론에서 메모를 하는 것은 관리하기 쉬울 뿐 만 아니라 중요하다. 메모를 하는 것은 여러분이 능동적이고 정신이 초롱초롱하게 유 지하는 데 도움이 되며, 토론에 일정한 체계를 부여할 수 있게 해주고, 말할 준비를 하게 해 줄 수 있다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "우리 모두가 아는 것처럼 음식은 인간의 삶에 필수적이다. 그것은 또한 농업, 식품 가공, 식품 소매업, 식품 서비스업과 같은 전 세계 여러 나라에서 볼 수 있는 몇몇 주요 산업의 기반이기도 하다. 수천 년 동안 인간과 경제 현상으로서 음식과 관련된 사람들의 관심은 그것의 생산, 보존, 유통, 가격 책정 및 기타 실용적인 문제에 집중 되어 있었다. 하지만 18세기 후반에 이것이 바뀌기 시작했다. 음식은 단순한 생활필 수품 그 이상이 되었다. 레스토랑은 처음에는 프랑스에서, 하지만 결국에는 다른 나라 에서도 사람들에게 식사 선택권과 테이블 서비스, 사교의 기회, 그리고 시간이 지남에 따라 점점 더 고급스러운 분위기를 제공하는 별개의 시설로 발전되기 시작했다. 레스 토랑의 부상은 결국 맛, 음식, 그리고 요리의 비평가임을 자랑하는 한 부류의 식사하 는 사람들을 탄생시켰다. Brillat-Savarin은 아마도 ‘요리 철학자’ 또는 오늘날의 용 어로 ‘미식가’로 가장 잘 알려져 있다. Brillat-Savarin이 말한 더 잘 알려진 격언 중 하나는 ‘당신이 무엇을 먹는지 말해주세요, 그러면 당신이 누구인지 알려 드리겠습니 다’이다."
    ],
    "tags": [
      "#철학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "친밀도의 변화는 감정 강도 조절에 매우 중요하다. 예를 들어, 텔레비전에 의해 유발 된 감정을 생각해 보라. 친밀함과 익숙함은 허구의 환경을 더 실제인 것으로 만드는 데 중요하다. 따라서 대부분의 TV 프로그램은 현재나 시청자의 기억에 있는 어떤 시 간을 배경으로 설정한다. 대부분의 등장인물은 우리에게 익숙한 유형이 되도록 상정 된다. 이러한 친밀함과 익숙함은 우리가 상상의 이야기를 실제인 것으로 인식하기 더 쉽게 해 준다. TV에서 폭력이 방송될 때와 같은 다른 상황에서는, 친밀함의 변수가 감정 강도를 줄이기 위해 사용된다. 텔레비전의 오락물은 폭력과 관련한 사회 문제를 또 다른 시간대와 장소에 배치하여, 우리가 우리 자신의 환경으로부터 안전하게 거리 를 둔 배경에서 그러한 허구화된 인물들이 우리의 문제에 대한 해결책을 찾는 모습을 보게 하는 경향이 있다. 폭력이 동시대적 배경에서 일어날 때는, 그것은 일반적으로 경찰과 범죄자 사이 상호 작용의 산물이다. 다시 말해, 그것은 선량한 시민의 삶으로 부터 제거된다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "여러분이 쓴 글에 대한 청중을 확보하는 데에는 단지 목소리를 찾는 것뿐만 아니라, 그 목소리가 여러분이 의도한 독자들과 공명하도록 보장하는 것이 수반된다. 기업가 는 고객을 자신의 제품이나 서비스로 끌어들이며, 자신을 기억에 남을 수 있도록, 그 리고 경쟁자와 구별되도록 만드는 하나의 브랜드를 구축하는 것의 중요성을 이해하고 있다. 그들은 자신들의 목표 청중을 정확히 찾아내고, 고유한 가치 제안을 만들고, 인 식할 수 있는 정체성을 형성함으로써 이를 달성한다. 학자들이 처음에는 이러한 기업 가적 개념을 낯설게 여길 수도 있지만, 사실 그들 또한 학술적인 글에서 자신을 차별 화할 때, 유사한 관행을 수행한다. 학술 논문의 전형적인 문헌 검토와 동기 부분을 생각해 보면, 그 목적은 기존 연구의 공백을 강조하고, (학자) 자신을 그러한 간과된 영역을 다룰 사람으로 자리매김하는 것이다. Labaree가 제안하듯, 도전 과제는 단지 혁신적인 아이디어를 개발하는 것뿐만 아니라, 독자들이 ‘아, 이건 [그 저자]의 글인 것 같아’라고 생각하게 만드는 구별되는 하나의 목소리를 기르는 데에도 있다. 중요한 것은 여러분의 아이디어를 표현하는 것과, 여러분의 청중에게 어떤 일시적인(→ 영구 적인) 인상을 남기는 고유한 목소리를 개발하는 것 사이에서 균형을 맞추는 것이다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "인간 심리학과 교육계(일부 동물 연구자들까지도!)는 동물의 사회적 학습을 설명할 때 ‘가르치기’라고 언급하는 것에 반대해 왔는데, 주된 이유는 가르치기는 모델(본보기 역할을 하는 개체)에게 어느 정도 수준의 의도성이 필연적으로 수반되는데, 이는 동물 에서는 측정이 어렵기 때문이다. 그럼에도 불구하고, 동물 인지 관련 분야 내에서는 동물도 실제로 서로를 가르칠 수 있다고 발언하려는 움직임이 있어 왔다. 예를 들어, 숙련된 개미는 ‘ 탠덤 러닝’으로 불리는 행동을 하는데, 이 행동에서 숙련된 개미는 화 학적 흔적을 남기면서 초보 개미의 신체에 자기 신체를 접촉하는데, 이는 신입 개미 의 경로 학습을 돕기 위한 것으로 추정된다. 범고래 또한 자신의 새끼 앞에서, 때로 는 물개를 죽이지도 않는 상태에서, 같은 물개 사냥 기술을 반복하는데, 이로 인해 연구자들은 먹을 생각이 없다면 범고래가 도대체 왜 물개를 반복적으로 잡고 놓아주 는지 의문을 품게 되었다. 그들(범고래)이 소모해야 하는 에너지를 고려한다면, 타당 한 이유가 있어야 하는데, 그 이유가 아마 가르치기일 수도 있을 것이다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "21 작가는 흔히 자신이 등장인물의 얼굴을 묘사했다는 인상을 우리에게 주지만, 사실, 그 들은 여러분에게 채워 넣어야 할 윤곽만 제시했을 뿐이다. Hermann Broch의 대표 작 The Sleepwalkers에서 가장 중요한 등장인물인 Esch에 대해서, 우리는 그가 큰 치아를 가졌다는 것만 알게 된다. 그렇기는 하지만, 우리는 그의 얼굴이 치아만 있는 공허한 공간인 것처럼 느끼지는 않는다. 대부분 우리는 누군가의 외모가 갖고 있는 인상을 들은 것을, 실제 그 외모를 기술한 것으로 착각한다. “대상 그 자체를 그리지 말고 대상이 주는 인상을 그려라.”라는 시인 Mallarmé의 충고는 자기 부정적인 법령 처럼 들린다. 실제로 그것은 다루기 힘든 문제에서 벗어나는 꽤 영리한 방법이다. Evelyn Waugh가 자기 소설 중 하나에서 새로운 인물에 대해 “그는 그런 유형의 젊 은이라면 가지고 있을 것이라 누구나 예상할 만한, 딱 그런 외모를 가지고 있었다.”라 고만 말하고, 다른 설명을 하지 않았을 때도, 여러분은 여전히 그가 정확히 어떻게 생겼는지 들은 것처럼 느낀다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "우리가 한 곳에 집중할 때, 우리는 모든 연산력을 중요한 몇 가지 과정으로 다시 향 하게 하고 있다. 그것은 마치 느린 와이파이를 돕기 위해, 휴대폰과 태블릿의 접속을 끊어서 화상 회의가 지체되지 않게 하는 것과 같다. 한 곳에 집중하는 것은 목표 달 성에도 도움이 된다. 그것은 집중을 방해하는 다른 모든 것을 삭제하고 가장 중요한 목표를 전면 중앙에 놓는다. 전념할 때, 우리는 동기의 강도를 높이고, 우리 눈앞에 있는 것이 우리가 추구해야 하는 것임을 강화한다. 잠깐은 이러한 절충안이 가치가 있을 수 있지만, 우리가 너무 오랫동안 집중한 상태로 있으면, 우리는 단서와 신호를 놓치기 시작한다. 우리는 한발 물러서 더 나은 길을 보지 못한 채로 하나의 길에 갇 히게 된다. 우리가 너무 오랫동안 한 곳에 집중한 채 꼼짝도 하지 않으면, 사고는 늘 어나고 성과는 떨어진다. 우리는 다른 곳에 문제가 있다는 것을 알리는 경고음을 듣 지 못하게 된다.22"
    ],
    "tags": [
      "#경제",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "지리학과 풀 수 없게 연관된 단어가 하나 있는데, 바로 ‘어디에서’이다. 이는 지리학 이 어떤 일이 지구 표면의 어디에서 일어나는지가 중요하다는 전제에서 출발하기 때 문이다. 하지만 핵심 질문은 단순히 ‘어디에서’라는 질문이 아니라, ‘왜 거기인가’ 그 리고 ‘그래서 무슨 의미가 있는가’라는 질문들이다. 그러한 질문에 도달한다는 것은 공간의 배열, 차이, 상호 연결성을 진지하게 받아들인다는 의미이다. 심지어 가장 단 순한 일상 활동에 참여하는 것조차도 공간적 상황에 대한 어느 정도의 올바른 인식, 즉 음식과 서비스를 어디서 찾을지, 일터에 어떻게 갈지 등에 대한 올바른 인식을 필 요로 한다. 범위를 좀 더 확장해 보면, 현상들이 지구 표면에 어떻게 배열되어 있는 지에 대한 어느 정도의 인식 없이는, 합리적인 사업 및 정책 판단을 하거나, 사건을 이해하거나, 지구상의 삶을 형성하는 몇 가지 기본적인 힘들을 파악하기 어렵다. 새로 운 가게나 공공 서비스의 위치를 정하려면 인구 분포, 도로 및 공공시설의 위치, 사 회경제적 패턴 등을 고려해야 한다. 이주가 왜, 그리고 어디에서 일어나는지를 이해하 려면 지역의 정치 구조, 차별의 공간적 영향, 사회경제적 패턴, 그리고 물리적 환경의 배치를 고려해야 한다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "진정한 빙하는 영구적이어야 한다. 일반적으로, 이는 연간 기준으로는 빙하가 지역적 및 지구적 기후 조건에 따라 팽창하거나 수축할 수도 있지만, 추운 몇 달 동안 여름 철에 녹는 것을 상쇄할 만큼 충분한 새 눈이 쌓여야 한다는 것을 의미한다. 오늘날, 전 세계 대부분의 빙하는 온난해지는 기후로 인해 녹고 있으며, 녹는 속도가 더 빨라 지고 있는 것으로 보인다. 이것은 알프스산맥과 같은 곳에서 인상적으로 기록되었는 데, 그런 곳에서는 역사상 기록이 보존되었고 날짜가 표기된 스케치와 사진을 이용해 현재의 얼음 범위와 비교할 수 있다. 심지어 수십 년이라는 짧은 기간에도, 위성 사 진은 산악 빙하의 급격한 감소가 안데스산맥, 히말라야산맥, 그리고 그 외 산맥에서 발생해 왔음을 보여준다. (빙하에 함유된 다양한 암석과 광물은 학교 내 과학 프로젝 트의 인기 있는 주제가 되었다.) 현재의 온난화 추세에 갑작스럽고 예상치 못한 변화 가 없다면, 많은 소규모 산악 빙하는 10년에서 20년 내 완전히 사라질 것으로 추정된 다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "content": [
      "If we take an evolutionary look at our beginnings, we see\na life in which high levels of physical activity were required\nfor survival. There are fewer manual jobs, we do not need to travel on\nfoot, we do not need to hunt and harvest for our food, and\nmany domestic chores have been mechanized. While these\nchanges have created many benefits for our longevity and\nquality of life, they have also created many problems. Lack of sufficient physical activity has now been linked to\nat least 17 unhealthy conditions, almost all of which are\nchronic diseases or considered risk factors for chronic\ndiseases. Adrianne Hardman has summarized this serious\nsituation for public health: “Physical inactivity is a waste\nof human potential for health and well-being.” Even one century ago, most people needed to be physically\nactive to work, to travel, and to take care of homes and\nfamilies. Our modern world has engineered such activity\nout of our lives."
    ],
    "translation": [
      "24 우리가 우리의 시초를 진화론적으로 살펴보면, 우리는 생존을 위해 높은 수준의 신체 활동이 필요했던 삶을 보게 된다. 1세기 전만 해도, 사람들 대부분은 일하고 이동 하고 가정과 가족을 돌보기 위해 신체적으로 활동적이어야 했다. 우리 현대 사회는 이러한 활동을 우리 삶에서 사라지도록 설계해 왔다. 몸을 쓰는 직업은 줄어들었 고, 우리는 걸어서 이동할 필요가 없으며, 식량을 위해 사냥과 수확을 할 필요가 없 고, 많은 집안일은 기계화되었다. 이러한 변화는 우리의 장수와 삶의 질에 많은 이로 움을 낳았지만, 또한 많은 문제를 유발했다. 충분한 신체 활동의 부족은 이제 최 소 17가지의 건강에 해로운 질병과 연관되었는데, 그 중의 거의 모든 질병이 만성 질 환이거나 만성 질환의 위험 요인으로 여겨진다. Adrianne Hardman은 공중 보건에 서의 이 심각한 상황을, “신체 활동을 하지 않는 것은 건강과 행복을 위한 인간 잠재 력을 낭비하는 것이다.”라고 요약했다."
    ],
    "tags": [
      "#과학",
      "#역사"
  ...
  },
  {
    ...
    "content": [
      "A good example of chaos is the magnetic pendulum sold\nas an executive toy. It has four magnets arranged in a\nsquare at the base and a pendulum that swings back and\nforth between them. In order to produce chaos, the iteration has to be within\nwhat is called a nonlinear system. Nor are all nonlinear\nsystems chaotic: to become so they need to be pushed\nbeyond a certain point, called a bifurcation. Before that\npoint is reached they may behave in a quite orderly fashion. Release the pendulum and note the magnets that it visits,\nand in what order. If the pendulum is released from the same\nposition a second time, the pattern of movement may at\nfirst be the same but soon it will become completely\ndifferent. In fact, the pattern of its movement is chaotic. No matter how much care is taken to start the pendulum\nin the same position, it will visit an entirely different set of\npoints on the two occasions. Chaotic systems are generated\nby iteration, though not all iteration leads to chaos."
    ],
    "translation": [
      "혼돈의 좋은 예는 사무용 장난감으로 판매되는 자기 진자이다. 그것에는 바닥에 사각 형으로 배열된 네 개의 자석이 있고 그것들 사이에서 앞뒤로 흔들리는 추가 있다. 추를 놓아주고 그것이 향하는 자석과 어떤 순서인지에 주목하라. 두 번째 때 추를 똑 같은 위치에서 놓으면, 움직임의 양상이 처음에는 같을 수도 있지만, 곧 그것은 완전 히 다르게 될 것이다. 실제로, 그것의 움직임의 양상은 무질서하다. 추를 똑같은 위치에서 시작하기 위해 아무리 신경을 많이 써도, 그 두 번의 경우에서 그것은 일단 의 완전히 다른 지점을 향할 것이다. 무질서한 체계는 반복을 통해 생겨나지만, 모든 반복이 혼돈을 초래하는 것은 아니다. 혼돈을 만들어 내려면, 반복이 비선형 체계 라고 불리는 것 안에 있어야 한다. 모든 비선형 체계가 무질서한 것 또한 아닌데, 그 렇게 되기 위해서 그것들은 ‘분기’라고 불리는 특정 지점을 넘어 밀려나야 한다. 그 지점에 도달되기 전까지 그것들은 꽤 질서정연한 방식으로 움직일 수도 있다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "기술적 설계에서, ‘이음매 없음’을 향한 열망은 인간의 기술적 경험이 우리의 일상생 활에 매끄럽게 녹아들게 하는 것을 목표로 한다. 본질적으로, 이러한 열망은 사람들 이 기술, 인터페이스, 또는 인간과 기술 간 상호작용과 인간과 인간 간 상호작용 사 이의 차이를 더는 인식하지 않는 경험을 지향한다. 옷에 있는 솔기의 은유를 생각하 면, 우리는 촘촘히 솔기를 꿰매고, 그것을 다림질해서 펴고, 그것이 안쪽에 감춰지도 록 확실히 함으로써 우리가 천 조각들이 아니라 옷을 입도록 하는 이음매 없는 미학 을 열망한다고 말할 수 있다. 디자이너들과 엔지니어들이 기술적 이음매 없음에 관 해 이야기할 때, 그들은 보통 사용의 용이성과 편리함을 말하는 것이다. 예를 들어, 인터페이스 설계에서, 이음매 없음에 대한 열망은 사용자의 경험이 흐르듯 움직이고 스트레스나 거슬림이 없도록 보장한다. 우리 대부분은 직장에서 일을 더 복잡하고 거슬리게 만드는 형편없는 인터페이스 디자인이나 앱을 경험해 봤을 것이고, 더 매 끄러운 인터페이스를 바라왔을 것이다. 기술적 이음매 없음은 또한 새로운 기술에서 덜 눈에 띄는 화면, 혹은 매끄러운 기술적 디자인을 가진 가상현실 기술을 포함할 수 있다. 그 목적은 사용자 경험을 담가서 시각적 상호작용이 신체가 별개의 독립체 로서의 디지털 제어장치나 물체와 상호작용을 하는 것이 아니라, 화면 안에서 이루 어지는 것처럼 묘사될 수 있도록 하는 것이다. 마찬가지로, 휴머노이드 로봇 설계에28 서의 이음매 없음은 휴머노이드를 인간의 몸과 구별되게(→ 구별되지 않게) 만드는 것을 목표로 한다."
    ],
    "tags": [
      "#철학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "직장에 늦게 나타나거나 욕설을 사용하는 것은 모든 기업이 없애고 싶은 유형의 문제 이다. 이를 달성하기를 바라는 기업 지도자들은 흔히 규칙을 어기는 ‘나쁜 사과들(문 제 직원들)’을 찾아내어 그들을 처벌하는 데 중점을 둔다. 이렇게 하는 것은 문제 직 원들이 고의로 나쁘게 행동한다고 가정한다. 사실, 직원들이 규칙을 어긴 것에 대해 제시하는 한 가지 흔한 이유는 그들의 행동이 바람직하지 않다는 것을 몰랐다는 것이 다. 방침을 알면서도 위반하는 몇몇 행위자들도 있지만, 많은 문제들은 의도하지 않은 실수이다. 기업들이 더 나은 직원들을 원한다면, 그 기업들은 명확한 기준을 만들고 그것을 준수하는 방법을 직원들에게 직접 교육해야 한다. 이러한 기준이 없다면 문제 직원들과 단지 정보가 부족한 직원들을 구별할 방법이 없을 것이다."
    ],
    "tags": [
      "#심리학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "다음은 음악의 근본적 특성이다. 음 이름들이 반복되는 것은 주파수의 두 배와 절반 에 상응하는 지각 현상 때문이다. 주파수를 두 배로 하거나 절반으로 줄이면, 우리는 결국 시작했던 음과 놀라울 정도로 유사하게 들리는 음을 얻게 된다. 이 관계, 즉 2:1 또는 1:2의 주파수 비율을 옥타브라고 부른다. 그것은 매우 중요해서, 음악 문화 간에 큰 차이가 존재함에도, 우리가 아는 모든 문화가 다른 음악 전통과 공통점이 거의 없 을지라도 음악의 기초로 옥타브를 사용한다. 이 현상은 음높이 지각에서의 순환성 개 념으로 이어지며, 색채의 순환성과 유사하다. 적색과 보라색은 전자기 에너지의 가시 주파수 연속체에서 정반대 끝에 위치하지만, 우리는 그것들을 지각적으로 유사하게 인식한다. 음악에서도 마찬가지로, 음악은 종종 두 가지 차원을 가진 것으로 묘사되는 데, 하나는 음의 주파수가 상승하는 것을 설명하는 것이고, 다른 하나는 음의 주파수 를 두 배로 할 때마다 우리가 다시 집으로 돌아왔다는 지각적 감각을 설명하는 것이 다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "사람들이 소셜 미디어에 참여하는 한 가지 이유는 그것이 사회적 관계를 형성하기 때 문이다. 우리가 소셜 미디어에 성공적으로 참여할 때, 우리는 사회적 자본을 증가시킨 다. 사회적 자본은 상호성과 정체성, 이해, 규범 및 가치 공유를 바탕으로 구축된 관 계망을 설명한다. 우리는 일자리 정보나 추천서와 같은 보상이 따를 수 있는 유대를14 형성한다. 우리는 개인 블로그나 프로필에서의 온라인 표현을 통해 우리의 정체성을 강화한다. “사회적 자본 개념 뒤에 있는 전제는 상당히 단순하고 직접적인데, 그것은 기대 수익이 있는 사회적 관계에 대한 투자”라고 사회학자 Nan Lin은 언급했다. Lin 의 연구는 사회에서 우리의 경험을 형성하는 것은 우리가 무엇을 아는가만큼이나 우 리가 누구를 아는가라는 점을 강조한다. 새로운 미디어와 함께 우리의 연결 범위는 훨씬 더 커지고, 우리의 ‘누구를 아는가’를 점점 더 넓게 확장한다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "한 사람의 생애를 기록하는 데 있어서, 생애 서술자와 전기 작가는 서로 다른 종류의 증거를 사용한다. 대부분의 전기 작가들은 역사적 문서, 인터뷰, 그리고 가족 기록물 을 포함한 여러 형태의 증거를 통합하는데, 그들은 그것들의 타당성을 평가한다. 전기 작가가 대상에 대한 자신 개인적인 기억을 증거로 쓰는 일은 상대적으로 드문데, 그 들이 (친척, 자녀, 친구, 또는 동료로서) 전기의 대상과 개인적 관계가 있지 않으면 그 렇다. 반면, 생애 서술자들에게는 개인적 기억이 주요한 기록물의 출처이다. 그들은 편지, 일기, 사진, 대화와 같은 여러 종류의 자료들, 그리고 역사적 순간에 대한 자신 의 지식에 의지할 수도 있다. 그러나 그러한 증거가 그들의 이야기에 갖는 유용성은 그들이 그 증거를 이용하여 자신의 개인화된 기억 행위를 뒷받침하거나 보완하거나 해설을 제공하는 방식에 달려 있다. 자서전적인 서술에서, 기억을 떠올리는 상상적 행 위는 항상 단언, 정당화, 판단, 확신, 그리고 의문 제기와 같은 수사적 행위와 중첩된 다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "수도원은 중세 시대의 원동력이었다. 수도원은 활동과 영향력이 정점에 있을 때, 교회 와 시민 정부 기관들에 지적 지도력, 종교적 사상과 관행의 혁신, 의료 공급, 교육, 시각 문화, 그리고 농업 발전을 제공했다. 그들은 더 넓은 공동체로부터 스스로 부과 한 고립을 명백히 지키면서 이 모든 것을 해냈다. 왜냐하면 수도원은 세상으로부터 동떨어진 장소로서 기능하도록 의도되었기 때문인데, 그곳에서 수도사들은 종교적 의 식, 기도와 공부의 영속적인 리듬에 자신의 삶을 바쳤다. 종교적 기도와 찬양은 수도 원 생활의 중심에 자리했다. 이러한 삶을 따르는 사람들과 외부 사람들 둘 다 수도원 생활이 더 넓은 사회의 이익을 위해 영위되는 것이라 믿었고, ‘정상적인’ 인간 접촉으 로부터 스스로를 분리함으로써 수도사들이 행한 희생이 자신들의 구원뿐만 아니라 공 동체를 대신한 참회 행위로 작용한다고 믿었다. 수도사들은 그들 자신과 다른 사람들 을 구원할 힘을 지닌, 속세와 나란한 삶을 영위하는 것으로 여겨졌다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "꿀은 그 자체로 먹거나 다른 재료와 섞을 수 있다. 천연 또는 순수 꿀은 첨가물, 방 부제, 또는 합성 성분이 전혀 더해져 있지 않다. 또한 그것은 ‘묽게 되지 않은’이라고 불리며, 보통 묽어진 꿀보다 더 비싸다. 천연 꿀은 또한 ‘혼합 꿀’이라고도 불리는데, 그것에서는 여러 출처의 꿀들이 벌에 의해서가 아니라, 꿀이 채취된 후 단계적으로 인간 가공업자와 유통업자에 의해 한데 섞인다. 혼합은 마케팅 상의 이유들 뿐 아니 라 맛을 위해서도 자주 행해지는데, 특히 일부 소비자가 더 진한 색의 꿀이 너무 강 하다고 여기기 때문이다. 여러 종류의 꿀을 함께 섞는 것은 그것을 더 입에 맞게 만 들 수 있고 또한 더 균일한 맛을 제공하는데, 이것은 생산자와 소매상에게 중요한 고 수상 인원 상금(1인당) 1등 1명 $1,000 2등 1명 $700 3등 2명 $500 비율 창의성 50% 주제와의 관련성 30% 매력도 20%19 려 사항으로, 그들은 자신의 고객에게 신뢰할 수 있고, 놀랍지 않은(보통은 순한) 맛 을 보장할 필요가 있다고 느낀다. 클로버 꿀은 미국에서 가장 인기 있는 꿀 중 하나 이고, 그 부드러운 맛과 풍미는 많은 미국인들에게 익숙해졌다."
    ],
    "tags": [
      "#경제",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "소프트 패스 하천 공학이란 무엇인가? 그것의 정신을 시각화하는 한 가지 방법은 그 것을 숲속의 오솔길에 비유하는 것이다. 나무가 오솔길을 가로질러 쓰러져 있다고 해 보자. 소프트 패스의 대응은 그저 쓰러진 나무를 돌아서 그 오솔길을 우회하는 것이 다. 보다 개입적인 대응은 나무를 제거하여 원래 길을 복구하는 것일 거다. 더욱더 개입적인 대응은 길을 곧게 펴고 포장하여 그것을 경관 속에 더 영구적으로 삽입하는 것일 수 있다. 물론, 진정한 하이 모더니스트 단계는 경관을 제거하고 지형 속 모든 장애물을 불도저로 밀고 나가는 초고속도로를 만드는 것일 거다. 소프트 패스 공학은 하천의 움직임과 그 환경적 효과에 관해 우리가 실제로 알고 있는 것에 관한 지적 겸 손이라는 독특한 장점이 있다. 하드 패스 공학과는 대조적으로, 소프트 패스 공학은 그렇지 않다는 것이 입증될 때까지는 하천 움직임의 변동성을 하찮은(→ 중요한) 것으 로 받아들인다. 지류, 단명하는 습지, 갈래와 수로, 늪지 등, 하드 패스 공학에서는 바 람직하지 않다고 여겨지는 모든 것들이 소프트 패스 엔지니어들에게는 생태학적으로 중요하다고 간주된다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "우리는 동물이 자신에게 약간의 안전을 부여하기 위해 포식자의 지각을 조작하는 다 양한 방식을 진화시켜 왔음을 알고 있다. 큰바우어새는 짝짓기 영역에서 지각적 편향 을 활용한다. 수컷은 바우어를 짓는데, 그 기능은 수컷이 바우어로 이어지는 길에 서 있는 암컷에게 구애 동작을 하는 무대를 제공하는 것이다. 수컷은 돌이나 조개껍데기 같은 다양한 물체로 그 길을 장식한다. 그러나 그들은 무질서하게 그렇게 하지는 않 는다. 더 큰 물체는 바우어에 더 가까이에, 더 작은 물체는 더 멀리 배치된다. 이것은 ‘신데렐라 성’과는 반대의 강제 원근감을 만들어 내는데, 바우어는 실제보다 더 작아 보인다. Endler와 그의 동료들은 바우어에서 구애하는 수컷이 이제 더 커 보이고, 따 라서 암컷에게 더 매력적으로 보인다는 것을 보여 주었다. 야생에서 수집된 수컷의 짝짓기 성공에 관한 자료는 그들의 가설을 뒷받침한다."
    ],
    "tags": [
      "#심리학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "비록 공감이 학자들과 공인들에 의해 널리 칭송받지만, 모든 사람이 공감을 북돋는 것은 아니다. 공감의 비판자들은 공감이 우리를 개인 간 및 집단 간 갈등으로부터 구 해주지 않을 것이라고 주장한다. 사실, 그들은 공감이 그러한 갈등을 더 악화시킨다고 주장한다. 이 비판자들은 공감이 소모적일 수 있고, 쇠진, 고통에 대한 무감각, 혹은 더 나쁘게 이끌 수 있다고 주장한다. 그들은 우리가 내집단에 대해서는 강하게 공감 하고 외집단에 대해서는 공감하기를 거부하며, 경쟁적이거나 위협적인 상황에서는 심 지어 외집단의 고통을 즐기는 경향이 있다고 주장한다. 따라서, 더 많은 공감을 위한 처방은 갈등 상황에서 흔히 역효과를 낸다. 그들이 주장하기를, 공감은 갈등을 한층 더 확립하고 우리를 우리 대 그들이라는 사고방식에 몰아넣을 수 있다. 마지막으로, 우리가 우리와 다르거나 낯선 맥락 속에 있는 다른 사람들에게 공감하려고 할 때조 차, 때때로 우리는 그들의 경험에 정확히 공감하지 못해, 더 깊은 오해와 좌절을 일 으킨다. 공감의 비판자들은 우리가 공감을 포기하고 사회적 조화를 추구하면서 예를 들어 이성적 동정심이나 두려움, 분노, 수치심 같은 도덕적 감정과 같은 다른 수단을 써야 한다고 주장한다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "22 다른 생태계들과 비교했을 때, 숲은 상대적으로 다양하지만, 이것이 반드시 숲이 아닌 곳을 숲으로 전환하기 위한 타당한 이유가 될 수는 없을 것이다. 비록 보통은 숲의 생물상만큼 풍부하지는 않더라도 습지, 목초지, 초원 역시 고유한 생물상을 가지고 있 다. 이 과정의 생태학적 문제는 아이슬란드, 남아프리카, 오스트레일리아와 같은 여러 지역에서 기술되어 왔지만, 이것의 전형적 사례는 스코틀랜드와 잉글랜드 북부에서 나온다. 여기서 삼림위원회는 광대한 습지 구역을 배수하고, 기름지게 하며, 울타리를 설치해 그것들을 숲으로 바꾸는 것을 촉진했다. 영국에서 숲의 범위를 늘리는 것은 분명히 바람직한 목표이며, 삼림위원회의 노력 대부분은 양과 양치기들이 섬에 오기 전에는 숲이었던 곳을 대상으로 한다. 그러나 생태학자들은 그 위원회의 작업에 대해 자주 불평하는데, 그 이유는 그것이 이전에 숲이었던 곳에만 국한되지 않고, 조성된 숲이 대개 외래종 나무로 구성되어 있으며, 이 활동으로 위협받는 야생동물들에는 흔 하지 않은 종들이 많이 포함되기 때문이다."
    ],
    "tags": [
      "#철학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "여러 행위자의 선호를 하나의 집단적 선택으로 모을 때, 특정 경우들은 무작위 추출 이나 동점을 가르는 다른 방법들이 필요하다는 것을 쉽게 알 수 있다. 예를 들어, 두 개의 대안 a와 b가 있고, 두 명의 행위자가 있는데 한 사람은 a를 선호하고 나머지 사람은 b를 선호한다면, ‘익명성’과 ‘중립성’으로 알려진 두 가지 기본적인 공정성 조 건 중 하나를 위반하지 않고 단일 대안을 선택할 결정적 방법은 없다. 익명성은 집단 적 선택이 행위자들의 정체성과는 무관해야 한다고 요구하고, 반면 중립성은 대안에 대한 공정성을 요구한다. 따라서 사회적 결과로 추첨을 허용하는 것은 공정한 집단적 선택을 위해 필수적인 것처럼 보인다. 사실, 복수 규칙(다수결)과 같은 가장 일반적인 ‘결정적’ 사회적 선택 함수조차도, 동점이 없는 한에서만 결정적인데, 보통 그런 경우23 에는 제비뽑기로 해결된다. 관리 선발을 위한 추첨의 사용은 흥미롭게도 아테네의 세 계 최초의 민주주의로 거슬러 올라가는데, 거기서는 그것이 민주주의의 주요 특징으 로 널리 여겨졌으며, 최근에는 정치학에서 점점 더 많은 관심을 끌어 왔다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "모든 근로자들은 그들의 직무, 직장, 그리고 조직 내에서 이용 가능한 자원에 대해 가치 있는 정보를 제공해 줄 수 있는 멘토에게로의 접근이 필요하다. 멘토 또한 꼭 필요한 심리사회적인 지원을 제공한다. 다양한 멘토 네트워크를 갖추는 것은 지배 집 단과 소수 집단에게 똑같이 중요하다. 소수 집단 구성원들은 특정한 조직이나 특정한 분야 혹은 직종에 고용된다는 것이 무엇을 의미하는지에 대한 통찰을 얻기 위해 다양 한 멘토가 필요하다. 다수 집단의 근로자들은 다양한 멘토들로 구성된 네트워크를 가 짐으로써 혜택을 보는데, 그 이유는 그것이 다양한 근로자들의 고유한 현실과 그들 자신의 정체성, 그리고 어쩌면 그들 자신이 지닌 특권의 형태들에 대해서까지도 이해 와 민감성을 높여주기 때문이다. (멘토링은 전형적으로 고용주의 개인적 성장의 필수 요소로 요구되고 칭송받아 왔다.) 이러한 멘토링 기회의 궁극적인 목표는 개인들이 자 신의 일과 조직에 대해 더 많은 정보를 갖고, 더 많이 동일시되며, 더 많이 관여되게 하는 것이다."
    ],
    "tags": [
      "#사회",
      "#예술"
  ...
  },
  {
    ...
    "content": [
      "Traditionally, when teachers teach writing, they assign\ntopics for students to write on; perhaps they do a bit of\nbrainstorming about the topic during a pre-writing phase,\nand then have students write about the topic without\ninterruption. In process writing, on the other hand, students may\ninitially brainstorm ideas about a topic and begin writing,\nbut then they have repeated conferences with the teacher\nand the other students, during which they receive feedback\non their writing up to that point, make revisions, based on\nthe feedback they receive, and carry on writing. In this way, students learn to view their writing as someone\nelse’s reading and to improve both the expression of\nmeaning and the form of their writing as they draft and\nredraft. Process writing shifts the emphasis in teaching\nwriting from evaluation to revision. Subsequently, teachers collect and evaluate what students\nhave written. Such instruction is very ‘product-oriented;’\nthere is no involvement of the teacher in the act or\n‘process’ of writing.\n－\n－\n－\n－\n－\n－\n－\n－\n－\n－"
    ],
    "translation": [
      "전통적으로, 글쓰기를 가르칠 때, 교사들은 학생들이 글을 쓸 주제를 배정해 주고, 아 마도 사전 글쓰기 단계에서 그 주제에 대해 약간의 브레인스토밍을 하고, 그런 다음 학생들이 방해받지 않고 그 주제에 대해 글을 쓰게 한다. 이어서, 교사들은 학생 들이 쓴 것을 수거하여 평가한다. 이러한 수업 방식은 매우 ‘결과물 지향적’이어서, 교사는 글을 쓰는 행위나 ‘과정’에 어떤 관여도 하지 않는다. 반면에, 과정 중심 글쓰기에서는, 학생들이 처음에 어떤 주제에 대해 아이디어를 브레인스토밍하고 글쓰 기를 시작할 수도 있지만, 그 후에 그들은 교사 및 다른 학생들과 반복으로 협의하 며, 그 과정에서 그들은 그 시점까지 쓴 글에 대한 피드백을 받고, 받은 피드백을 바 탕으로 수정하며, 계속해서 글쓰기를 이어간다. 이러한 방식으로, 학생들은 자신 의 글쓰기를 어떤 다른 사람의 읽을거리로 여기고, 초안을 쓰고 다시 쓰는 중에 글의 의미 표현과 형식 둘 다를 개선하는 법을 배운다. 과정 중심 글쓰기는 글쓰기 교육의 주안점을 평가에서 수정으로 전환한다."
    ],
    "tags": [
      "#심리학",
      "#역사"
  ...
  },
  {
    ...
    "content": [
      "Perhaps at some point you have seen some mathematical\nwriting and not understood it. The complicated notations that might spring to mind ― all\nthose strange dashes, squiggles and letters ― are obvious\nsigns, but a lot of those are really quite modern. Mathematics\nhad been going on for a long time before the dashes and\nsquiggles were invented. You would not be the first; rest assured, even professional\nmathematicians sometimes have to rely on discussions\nwith colleagues to properly understand problems they are\nlooking at. But how do you recognise some writing is\nmathematical in the first place? Put simply, there has to be something mathematical going\non for us to say that it is mathematics. And if we are\ndealing with writing from a very distant past, in a\nlanguage that is not familiar to us, from a time even\nbefore recorded language, that can be sometimes difficult\nto recognise."
    ],
    "translation": [
      "아마도 어느 순간 여러분은 수학적 글을 본 적이 있지만, 그것을 이해하지 못했을 수 도 있다. 여러분이 처음은 아니므로, 안심해도 되는 것이, 심지어 전문 수학자들25 조차도 자신들이 바라보고 있는 문제를 제대로 이해하기 위해 때때로 동료들과의 토 론에 의존해야 하기 때문이다. 그러나 애초에 어떤 글이 수학적이라는 것을 어떻게 알아볼 수 있을까? 그 모든 낯선 대시, 꼬부라져 읽기 어려운 글자, 그리고 문자 와 같은 머릿속에 떠오를지도 모르는 복잡한 기호들은 명백한 부호들이지만, 그중 많 은 것이 사실 꽤 현대적인 것이다. 수학은 그 대시들과 꼬부라져 읽기 어려운 글자들 이 발명되기 훨씬 전부터 계속되어 오고 있었다. 간단히 말해서, 우리가 그것이 수학이라고 말하기 위해서는 ‘수학적인’ 무언가가 진행되고 있어야만 한다. 그리고 만 약 우리가 우리에게 익숙하지 않은 언어로 쓰인, 심지어 기록된 언어가 존재하기 이 전의 시대에서 온, 매우 먼 과거의 글을 다루고 있다면, 그것을 알아보기란 때로 어 려울 수 있다."
    ],
    "tags": [
      "#일반"
    ],
  ...
  },
  {
    ...
    "translation": [
      "문학 연구는 현대 음악 작사가들의 영향과 그들이 언어의 발전에 기여한 바를 반복적 으로 인식하지 못해 왔다. 특히 어휘와 문법 구조에서 영어의 발전을 이끌었다고 연 구되고 기려져 온 셰익스피어와 달리, 현대 작사가들은 그들의 기여가 인정되는 데 제약을 겪어 왔고 대체로 무시당해 왔다. 지난 한 세기 동안 우리는 이 예술가들에 의한 엄청난 문학 작품들의 폭발적 증가를 목격해 왔는데, 그들은 음악을 통해 언어 적 조작과 스토리텔링을 사용하여 우리의 언어와 문학을 풍요롭게 했다. 독특하고 복 잡한 심상을 담은 가사를 만들어 내며, 작사가들은 우리의 언어에 엄청난 문학적 영 향을 미쳐 왔다. 현대 언어 발전에 미친 영향을 포함하여 그들의 훌륭한 작품은 현대 문학 분야에서 인정받아야 한다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "디지털 플랫폼은 많은 일을 덜 끈끈하게 만들었다. 일이 점점 더 모듈화되고, 상품화 되고, 표준화되면서, 그리고 디지털 노동을 위한 시장이 만들어지면서, 서비스 노동과 특정 장소 사이의 연결은 끊어질 수 있다. 1990년대에 등장한 아웃소싱이라는 비즈니 스 과정이 대기업이 콜센터를 값싸고 먼 노동 시장으로 옮김으로써 ‘글로벌 산업예비 군’을 활용하도록 해준 한편, 클라우드 워크는 지리적으로 가까이 있지 않은 곳에서 일이 이루어질 수 있는 규모와 과립상(顆粒狀)을 변화시킨다. 뉴욕의 작은 기업이 어 느 날은 나이로비의 프리랜서 필사생을, 다음 날에는 뉴델리의 필사생을 고용할 수 있다. 사무실이나 공장을 지을 필요가 없고, 현지 규정을 준수하지 않으며, 대부분의 경우 현지 세금도 내지 않는다. 노동 생산 네트워크의 전환은 단순히 몇 통의 이메일 을 보내거나 디지털 노동 플랫폼에서 버튼을 몇 개 클릭하는 것으로 이루어진다. 그 리고 이런 방식으로, 고용주는 한때 고용주였던 장소들에 어떠한 물질적 흔적도 남기 지 않는다."
    ],
    "tags": [
      "#경제",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "스포츠 생태계는 존재하는 협조적 경쟁의 유형과 정도에 기반하여 존재한다. 협조적 경쟁은 “우월한 가치 창출을 목적으로 전략적으로 중요한 자원을 활용하기 위해 기업 들이 협력과 경쟁을 동시에 추구하는 것”으로 정의된다. 그것은 자원 효율성 목적을 위해 협력해야 하지만, 잠재적으로 서로 경쟁해야 하는 스포츠 사업체의 역동적 특성 을 이해하는 데 유용한 방식이다. 이 특별한 관계는 신뢰와 신용 문제가 최고이기 때 문에 적절히 관리되어야 한다. 스포츠에서 협력적이면서 경쟁적인 것은 서로 다른 형 태의 행동을 수반하기 때문에 어려울 수 있다. 이는 각 활동에 두는 강조의 정도 면 에서 주의 깊은 균형 잡기가 필요할 수도 있음을 의미한다. 흔히 스포츠 관리자들은 성과의 이유로 더 경쟁적이려 하고, 덜 협력적이려 한다. 필요 때문에 그들은 정보를 공유해야 할 수도 있지만, 신중한 방식으로 그렇게 한다. 이는 둘을 동시에 추구하는 방법에 대한 계획을 마련해 두는 것이 더 나을 수도 있다는 뜻이다. 이렇게 함으로써 어느 하나가 다른 하나를 대가로 소홀히 다루어지지 않도록 확실히 할 것이다."
    ],
    "tags": [
      "#역사"
    ],
  ...
  },
  {
    ...
    "translation": [
      "‘빈도보다 속도’를 강조하는 것은, 출퇴근 시간대에만 운행하는 통근 서비스와 수요가 적은 아주 긴 거리의 운행을 포함하여, 모든 사람이 시간표에 맞춰 계획을 짜야 하는 상황에서는 타당할 수 있다. 그러나 그 외의 모든 다른 상황에서, 그것은 운전자들의 흔한 오류인 것으로 보인다. 도로는 항상 거기에 존재하기에, 그것(도로)의 속도가 그15 것을 구분 짓는 가장 중요한 사실이다. 하지만 대중교통은 그것(대중교통)이 곧 도착 하는 경우에만 거기에 존재한다. 만약에 여러분이 차가 있다면 여러분은 원하는 어느 때든지 도로를 이용해 그것의 속도를 경험할 수 있다. 그러나 대중교통은 여러분이 그것을 필요로 할 때 존재해야 하고(운행 시간대의 범위), 그것은 곧 도착해야 한다 (운행 빈도). 그렇지 않으면, 기다림으로 인해 빠른 서비스로 절약된 시간이 모두 없 어져 버릴 것이다. 여러분이 특정한 운행 일정에 맞춰 삶을 계획하는 것이 편안하지 않다면, 속도는 빈도 없이는 가치가 없으므로, 속도에 대해선 소리치고(강조하고) 빈 도에 대해선 속삭이는(드러내지 않는) 교통 지도는 단지 혼란을 심어줄 수도 있다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "컬처테인먼트의 경제적 이점은 정치인과 정책 입안자에게 동등하게 매력적이다. 관련 상품과 서비스(여행, 숙박, 소매 등)에 대한 수요와 더불어 국내 유입 방문객 수의 증 가 가능성은 정부 및 관련 기관 사람들이 축제와 기념 행사를 더 크고 더 주목을 끄 는 행사로 발전시키기 위해 문화 단체와 협력하게 하는 장려책이 된다. 하지만 그와 같은 상업화는 컬처테인먼트가 동종화가 되고 그것의 원래의 ‘메시지’를 잃어버려 관 객의 희석화를 초래할 수도 있는 위험이 있다. 이것은 또한 더 소규모의 비상업적 독 립 행사가 생겨나게 해 관객을 더욱 분산시키는 역할만 할 수도 있다. 이것은 계획자 와 이해관계자가 잠재적인 재정적 이익에 맞서 균형을 맞춰야 할 필요가 있는 일이 다. 정치적, 사회적, 종교적 경관을 바꾸는 것은 새로운 문화의 출현 및 그와 더불어 새로운 컬처테인먼트 경험의 출현을 이끌 것이다. 전반적으로 이것은 엔터테인먼트16 산업의 건전한 성장 영역이지만, 본질적으로 착취와 마주하는 경우엔 취약한 영역이 기도 하다."
    ],
    "tags": [
      "#과학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "우리는 대단히 똑똑하며, 이것은 우리가 다양한 환경에 적응하는 데 도움을 준다. 하 지만 현대 인류가 지구 전역으로 퍼져나가면서 현대 인류가 직면한 적응 문제를 개별 적으로 해결할 만큼은 전혀 똑똑하지 않다. 어떤 수렵‧채집 집단이 사용하는 도구, 채 집 기술, 생태 지식, 사회적 설비의 모음은 어느 한 개인이 만들어 내기에는 너무나 복잡하다. 우리는 오직 타인으로부터 정보를 습득하므로 우리가 살아가는 많은 서로 다른 각각의 환경에서 알아야 할 필요가 있는 모든 것을 배울 수 있다. 우리는 다른 종들보다 타인으로부터 배우는 데 훨씬 더 능숙하며, 우리의 모델이 왜 그런 행동을 하는지 이해하지 못할 때조차도 타인으로부터 배우려는 동기를 지닌다. 이러한 심리 는 인간 집단이 개인의 발명 능력을 훨씬 능가하는 방대한 적응적 정보 축적을 가능 하게 한다."
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "‘상황 윤리’는 어떤 상황이나 행위가 윤리적인지를 판단할 때 그것의 맥락을 고려하는 윤리 이론이다. 이 이론의 지지자들은 기꺼이 절대적 도덕 기준을 버리는 것을 허용 한다. 보편적인 기준이나 법이 부재할 때 중요한 것은 결과나 결과의 영향이며, 따라 서 목적이 수단을 정당화한다. 아마 다음과 같은 대조적인 현실 상황이 상황 윤리의 적용을 설명하는 데 도움이 될 수 있다. 친구들끼리 하는 즉석 농구 경기에서는 모두 가 자신의 파울을 스스로 선언하거나 공을 경기장 밖으로 쳐낸(아웃시킨) 것을 인정할 것으로 기대된다. 친구들을 배려하고 아마도 그 그룹과 계속 함께 경기할 수 있다는 점이 이러한 행동으로 이어진다. 그러나 정식 경기가 심판이 있는 상태에서 진행되면, 선수 대부분은 상대방에 대한 배려를 표현하는 것보다 승리라는 최종 목표가 더 중요20 하기 때문에 같은 파울이나 바이얼레이션을 인정하지 않는다. 상황 윤리는 많은 선수 와 코치에 의해, 경쟁적 이점을 버리려고(→ 얻으려고) 경기장이나 코트에서 가능한 한 많은 행동을 들키지 않고 넘어가려고 애쓰는 것을 의미하는 것으로 확대되어 왔 다."
    ],
    "tags": [
      "#철학",
      "#사회"
  ...
  },
  {
    ...
    "translation": [
      "초기 곡물 무역 회사들은 잉여 생산 지역과 식량 부족 지역 모두에서 활발히 활동했 으며, 이들 회사는 두 지역의 공급과 수요 상태를 아는 것을 그들의 업무로 삼았다. 이러한 정보가 수익성의 열쇠였기에, 이들 회사는 상대적으로 비밀리에 운영되었으며, 종종 가족 관계, 신뢰, 충성심에 기반을 두었다. 또한 이들 기업은 1800년대 중반 생 긴 상품 거래소와 상품 선물 시장의 부흥으로 이익을 얻을 수 있었다. 농업 시장은 변동하는 기상 패턴 및 기타 요인으로 인한 수확량 변화로 인해 당연히 불안정하다. 미래 인도용 곡물을 구매하고 판매하여 가격을 고정하는 방식은 이 회사들이 그러한 위험을 최소화하는 데 도움이 되었다. 곡물 무역 회사들이 서로 거래하는 독립적인 국가별 회사로 운영하기보다는 여러 국가에서 운영되는 단일 기업 내에서 위험을 관 리하는 것이 합리적이었다. 여러 시장에 대한 정보 접근성은 그들이 농업 상품 거래 와 관련된 위험을 쉽게 상쇄할 수 있게 해주었다."
    ],
    "tags": [
      "#경제",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "진행 중인 여러분의 설계 작업에 대해 고객들이 반응할 충분한 기회를 주는 것은 전 문적 성공의 핵심이다. 마찬가지로, 고객뿐 아니라 예상되는 건물 사용자들을 참여시 키는 것은 장기적으로 훨씬 더 가치가 있다. 이를테면, 여러분의 고객이 의료 서비스 제공 기관과 같은 대규모 기업이라고 하자. 병원 행정 부서가 여러분의 고객 역할을 할 수는 있더라도, 행정 부서 직원들의 관점은 그 건물을 정기적으로 사용하는 의사, 인턴, 레지던트, 간호사, 그리고 다른 의료 직원들의 관점과 분명 크게 다를 것이다. 게다가 그 건물을 비정기적으로 사용하는 환자와 방문객들의 경험은, 종종 생명을 위 협하는 응급 상황의 결과로 찾아오게 되는 만큼, 또한 완전히 다르다. 각 사용자 유 형이 여러분의 예상되는 설계안에 어떻게 반응하는지는 물론 현재의 의료 환경을 어 떻게 경험하는지를 이해하는 것은 필연적으로 더 나은 건물을 만들어낸다. 새로운 건 물이나 증축에 대해 사람들은 자신들이 설계 과정에서 의견을 들려줄 경우 더 만족할 가능성이 높다. 대규모 기관의 경우, 이것은 업무 생산성 향상, 장기 결근 감소, 이직 률 감소, 비용 절감으로 이어질 수 있다."
    ],
    "tags": [
      "#사회"
    ],
  ...
  },
  {
    ...
    "translation": [
      "칸트는 안전과 평화뿐 아니라 자유에 대한 궁극적인 보장 수단으로서의 법의 지배에 대한 강력한 옹호자였다. 그는 인간 사회가 효과적이고 법적 구속력이 있는 법적인 틀에 의해 규제되는 더 합리적인 형태로 나아가고 있다고 믿었는데, 오직 그러한 틀 이야말로 사람들이 조화를 이루며 살아가고, 번영하고, 협력할 수 있게 해주기 때문이 었다. 그러나 그의 불가피한 진보에 대한 믿음은 인간 본성에 대한 낙관적이거나 고23 결한 관점에 근거한 것이 아니었다. 그와는 반대로, 그의 견해는 홉스의 관점에 가까 워지는데, 인간의 폭력적이고 갈등을 일으키기 쉬운 본성이 평화를 확보하기 위해 효 과적인 법적 틀을 세우고 유지하는 것을 필수적으로 만든다는 것이다. 우리는 사람들 의 자비심이나 선의를 의존할 수 없지만, 심지어 ‘악마의 나라’조차 모든 시민을 똑같 이 구속하는 법체계 속에서는 조화롭게 살아갈 수 있다. 이상적으로, 법은 모든 이성 적 존재가 기꺼이 선택할 정치적 원칙들의 구현이다. 만약 그러한 법이 그들이 어차 피 이성적으로는 선택하지 않을 어떤 것을 하지 못하게 금지한다면, 그 법은 그들의 자유에 대한 제약으로 여겨질 수 없다."
    ],
    "tags": [
      "#사회",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "우리 중에 운동, 취미, 혹은 휴식과 같은 자기관리 활동을 위한 시간을 적어도 만들 고자 하지 않는 사람은 거의 없다. 우리는 가장 좋은 의도를 가지고 날마다 시작하지 만, 그러고는 이메일 메시지의 홍수에 갇히거나 예상치 못한 회의로 끌려간다. 마감 전에 모든 일을 끝낼 수 있도록 우선순위를 다시 정하려고 애쓸 때, 흔히 우리의 자 기관리 활동은 가장 먼저 포기되는 것이다. 우리가 아무리 계획을 세워도, 우리는 모 두 그런 일이 일어나는 날을 때때로 겪는다. 단기적으로는, 그 보조금 신청 마감일을 놓치는 영향은 목공 수업을 놓치는 영향보다 더 클 수 있다. (말할 필요도 없이, 우리 가 디자인 수업에 앞서 목공 수업에 등록하려고 노력해야 하는데, 그 이유는 그것이 들어가는 데 더 경쟁이 치열하고 우리에게 더 유익하기 때문이다.) 그러나 자기관리에 우선순위를 두지 않는 것의 누적된 영향을 인식하고, 장기적으로는 이것이 일반적인 것이 아니라 예외가 되도록 하는 것이 중요하다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "content": [
      "We usually think of a clock as a physical thing, like an\nalarm clock or a wristwatch. But a clock is really a process\nembodied in a machine, and the nature of that process is\nrepetitive. Indeed, it is almost impossible to think of a clock that\ndoes not depend on a repetitive cycle of events. The only\nexample that comes to mind readily is a candle marked in\nhours. But here too there is iteration ― the repeated\nburning of molecules of wax ― so this too is an iterative\nprocess, although at first masked. The use of radiocarbon dating is another, much longer\nscale clock that also appears to be like this. It seems to\nyield a smooth time scale but in fact does not: the decay\nof atoms of carbon-14 is repetitive, although on a large\nscale it gives the appearance of being continuous. A clock can be almost any process that repeats itself over\nand over again for an indefinite period. Water clocks drip\nat a steady pace; quartz crystals vibrate regularly."
    ],
    "translation": [
      "우리는 보통 시계를 알람 시계나 손목시계 같은 물리적인 것으로 생각한다. 그러나 시계는 실제로는 어떤 기계 속에 구현된 하나의 과정이며, 그 과정의 본질은 반복적 이다. 시계는 무기한으로 계속 자신을 반복하는 거의 모든 과정일 수 있다. 물시 계는 일정한 속도로 물방울이 떨어지고, 석영 결정은 규칙적으로 진동한다. 실제 로, 반복적인 사건의 주기에 의존하지 않는 시계를 생각하는 것은 거의 불가능하다. 선뜻 떠오르는 유일한 사례는 시간 단위로 표시된 양초이다. 그러나 여기에서도 밀랍 분자들의 반복적인 연소처럼 반복이 있어서, 비록 처음에는 가려져 있었지만, 이것 또 한 반복적 과정이다. 방사성탄소 연대측정의 사용은 또 다른, 훨씬 더 장기적 규 모의 시계로, 이것 또한 이와 같은 것처럼 보인다. 그것은 매끈한 시간 척도를 내는 것처럼 보이지만, 실제로는 그렇지 않다. 비록 큰 규모에서는 탄소-14 원자의 붕괴가 연속적인 것처럼 보이지만, 그것은 반복적이다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "이야기가 기억할 만함과 설득력의 관점 모두에서 통계보다 분명 우세하지만, 사실과 일화, 심지어 사실과 다른 사실 간의 싸움으로 보는 경우는 드물다. 진정한 충돌은 사실 ‘이야기들 사이’, 즉 우세한 점유자와 새로운 도전자 사이의 충돌이다. 이야기하 는 존재로서 우리는 우리를 둘러싼 세계를 이해하는 데 도움을 주기 위해 일상적으로 내러티브를 형성한다. 우리가 여러 가지 사건을 경험하거나 다양한 사실을 마주할 때, 우리의 마음은 그것을 둘러싼 이야기를 형성함으로써 그것을 이해하려고 한다. 예를 들어, 여러분이 특정 대학 졸업생들과 어떤 좋지 않은 경험을 했다면, 여러분은 그26 학교 출신 사람들에 대한 부정적인 내러티브를 마음속에 만들어 낼 수도 있다. 갑자 기, 여러분은 자신이 겪은 고작 몇 번의 유감스러운 일로 그 대학 출신 모두를 판단 한다. 때때로 우리가 형성하는 이러한 내적 내러티브는 우리의 신념과 의견을 형성할 뿐만 아니라 우리의 정체성에 깊이 뿌리내리기도 한다. 예를 들어, 총기 규제나 기후 변화를 둘러싸고 여러분이 형성한 내러티브는 여러분의 정치적 이념, 즉 개인으로서 여러분이 어떤 사람인지와 관련이 있을 가능성이 매우 높다."
    ],
    "tags": [
      "#과학",
      "#예술"
  ...
  },
  {
    ...
    "translation": [
      "복식사에는 그것의 모든 전시에서 분명한 문제가 있는데, 그것은, 비록 직물이 기록된 역사 초기의 시대와 문화로부터 남아 있기는 하지만, 실제 의복은 동일한 오랜 기간 동안 끊김이 없는 증거의 흐름을 제공하지 못한다는 점이다. 따라서 복식 연구에 건 축, 회화, 판화, 소묘, 조각과 같은 다른 분야와 동등한 중요성을 부여하기 위해, 이들 다른 분야가 원자료의 많은 부분을 제공하는 것이 불가피했다. 남아 있는 복식의 역 사는 실제로 겨우 17세기에 시작하며, 미술 혹은 장식 미술이라 기술되는 모든 인공 물과 마찬가지로, 매우 시각적인 주제이다. 그러나 그러한 분야를 구성하는 대부분의 수집 및 연구의 범주와는 달리, 그것은 정적이라기보다는 유동적이다. 의복은 전시용 동상 위에 고정된 것이 아니라, 인간의 신체 위의 움직임으로 보여져야 한다. 이것은 의상 수집품을 큐레이팅할 때의 많은 어려움 중 하나이며, 또한 일부 현대 작가들이 의상 수집품을 물리적으로나 지적으로 생명력 없는 것으로 여기는 이유이기도 하다. 다행히도, 더 많은 옷이 남아 그 주제의 역사에 대한 우리의 이해를 풍부하게 해주는 1660년 이후 시기에는, 움직임이 포착된, 옷을 입은 사람들에 대한 다수의 회화, 판 화, 사진, 영화의 많은 증거 자료가 또한 존재한다. 자주 서로 다른 유형의 다양한 설 명적인 사례들이 의복이 만들어진 시기에 그것이 어떻게 착용되었는지에 대한 증거를 제공한다. 소묘에서 조각까지, 모든 형태의 예술에 포함된 자료가 없으면, 역사적 복 식 전시는 그것의 원래 제작자와 소유자의 의도를 어색하게 모방한 것일 가능성이 낮 다(→ 가능성이 있다)."
    ],
    "tags": [
      "#심리학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "신체 활동 지도자들은 흔히 활동을 수행하는 참여자들보다 활동 자체에 더 집중한다. 사람들은 신체 훈련이 마음 훈련과 무관하고 생각할지도 모른다. 그러나 참여자들의13 마음은 신체 발달을 향한 그들의 태도와 노력 수준을 결정한다. 평소 연습에서 지도 자들은 참여자들에게 규칙적으로 운동하거나, 운동 전에 몸을 풀거나, 특정 전략을 사 용하라고만 말할지도 모른다. 하지만 지도자들은 참여자들이 신체 활동에서 자신의 지도를 맹목적으로 따르기를 기대하는 것만으로는 충분하지 않다. 지도자들은 이러한 활동이 그들의 신체적 수행을 어떻게 향상시키는지에 관한 참여자들의 인식을 높여야 만 한다. 예를 들어, 지도자는 운동 전 몸풀기가 어떻게 그들의 수행을 향상시키는지 를 명시적으로 설명할 수도 있다. 참여자들이 이러한 활동의 원리를 이해한다면 그것 은 그들이 자신의 발달에 관한 더 완전한 소유권을 점진적으로 가질 수 있게 한다."
    ],
    "tags": [
      "#예술"
    ],
  ...
  },
  {
    ...
    "translation": [
      "사실 과학자들이 어떤 동물이든 의식이 있다고 생각한 일이 너무 최근이어서 인터넷 이 더 오래되었다. 1976년에 Donald Griffin이라는 한 동물학자는 'The Question of Animal Awareness'라는 책을 출간했는데, 그 책은 동물의 인지를 진지하게 여겨 야 한다고 주장했다. 그와 한 동료는 1944년에 박쥐가 반향 위치 측정으로 길을 찾는 다는 사실을 발견한 주역이었다. 이제 평생 그 생물들을 지켜본 끝에 그는 박쥐들이 내면 세계를 가지고 있다고 확신하게 되었다. 박쥐들이 유연한 행동, 즉 외부 환경의 변화에 따라 행동을 바꿀 수 있는 능력을 가지고 있으며, 이는 진정한 지능의 특징이 라고 그는 말했다. 그는 박쥐들이 먹이를 찾기 위해 영리한 기술을 개발하는 것을 관 찰했는데, 박쥐들은 분명히 즉석에서 결정을 내릴 수 있었고, 인간이 보여주는 것과 동일한 문제 해결 능력을 다수 보여주었다. 동물의 사고력과 판단력을 진지하게 연구 해야 한다고 그는 주장했다. 결국, 신경과학의 번영에도 불구하고, 이 신성한 ‘의식’을 담당할지도 모르는 인간에게만 유일무이한 뇌의 어떤 부위를 아직 아무도 발견하지 못했다. 그 환상을 포기할 때가 되지 않았는가?"
    ],
    "tags": [
      "#심리학",
      "#철학",
  ...
  },
  {
    ...
    "translation": [
      "자동차 제조사들은 사람들이 자동차의 ‘얼굴’에 정서적 애착을 형성한다는 것을 알고 있으며, 그 사실을 디자인과 마케팅 노력을 이끄는 데 사용한다. ‘Wall Street Journal’은 2006년 ‘왜 자동차는 화가 났는가’라는 제목의 기사에서 ‘오늘날의 과도하 게 경쟁적인 자동차 시장에서 디자이너들은 구매자의 마음을 사로잡는 자동차를 디자 인하기 위한 더 광범위한 노력의 일환으로 차량의 얼굴에 집중하고 있는데, 심리학자, 인류학자 및 기타 인간 행동 전문가들을 활용하고, 심지어 포커스 그룹 참가자들의 뇌파까지 모니터링하고 있다’고 보도했다. 이 기사는 자동차 연구에서 ‘운전자의 70% 가 헤드라이트와 그릴로 차량을 식별하고 평가한다’고 전했다. 21세기 초반의 추세는 자동차 얼굴이 더 화나고 더 무섭게 보이는 방향으로 변화하는 것이었다. 그 기사는 이러한 얼굴이 더 많은 대형 SUV들 사이의 더 혼잡한 교통 체증 속에서 운전자가 더 안전함을 느끼도록 돕는다고 가정했다. 우리의 떠들썩한 시대를 반영하듯, ‘무서운 외 관’은 새 천년에도 늦출 기미를 보이지 않고 있다. 2017년에 한 국제 자동차 사이트 는 ‘힘이나 거친 기질을 연상시키는 스타일의 자동차에 관한 부력이 있는 판매는 소 비자들이 이러한 외관에 만족한다는 사실을 확인해 주는 것처럼 보인다’고 보도했다."
    ],
    "tags": [
      "#심리학",
      "#경제",
  ...
  },
  {
    ...
    "translation": [
      "시간의 압축은 크기와 상관관계가 있다. 몸집이 작은 동물의 반사 작용은 훨씬 더 작 은 수족을 조절하고 빠른 운동 기관의 피드백에 반응하기 위해 더 빨라야 한다. 또한 몸집이 작은 종에서는 의사 결정이 간소화되어야 하는데, 이들의 높은 신진대사율과 매우 적은 에너지 비축량은 먹이를 찾는 활동, 포식자로부터 자신을 방어하는 일, 또 는 짝짓기 행동에서 선택의 여지를 거의 주지 않기 때문이다. 그리고 아마도 가장 중 요한 것은, 짧은 수명이 경험을 통해 배우는 데 쓸 시간을 거의 주지 않는다는 점이 다. 그 결과, 수명이 짧다는 것은 환경에 맞춘 세밀한 조정을 거의 필요로 하지 않는 미리 프로그램화된 행동 패턴의 효과성을 특히 중요하게 만든다. 이에 비해, 몸집이 큰 동물은 다소 더 느린 반사 작용으로도 그럭저럭 살아갈 수 있고, 자신의 행동을 더 잘 최적화하기 위한 노력의 일환으로 짝짓기와 먹이 찾기 행동을 변화시킬 여유가 있으며, 관찰과 시행착오를 통해 배울 상당한 기회를 가질 수도 있다. 수명이 더 길 다는 것은 학습과 기억을 더 중요하게 만들고, 자동적인 미리 프로그램화된 행동을 덜 중요하게 만든다. 또한 오래 살거나 장거리를 이동할 능력을 지니는 것은 동물이 환경의 중대한 변화에 노출될 가능성을 더 크게 만든다."
    ],
    "tags": [
      "#심리학",
      "#과학",
  ...
  },
  {
    ...
    "translation": [
      "1950년대 이전에 관광업은 파편화된 산업이었고, 호텔, 운송업체, 여행사, 여행 상품 운영업체 모두 서로 독립적으로 일하는 경향이 있었다. 호텔은 대체로 숙박을 판매하 는 사업을 하고 있었다. 항공사와 철도 회사는 좌석을 판매하는 사업을 하고 있었다. 물론 여행사는 여행과 휴가 상품을 판매하고 있었지만, 각각의 경우에 이들은 매우 별개의 사업체로 운영되는 경향이 있었다. 1950년대 중반 이후부터, 특히 영국에서, 여행 상품 운영업체의 성장은 산업의 성격을 본질적으로 개별적인 사업 활동에서 보 다 통합적인 활동으로 바꾸기 시작했다. 예를 들어, 호텔은 고객을 단순히 숙박만 구 매하는 사람이라기보다 다양한 서비스를 원하는 사람으로 보기 시작했다. 그래서 호 텔은 호텔 단지 안에서 투숙객의 지출액을 늘리기 위해 쇼핑 아케이드를 조성하고, 나중에는 사무 지원 센터를 제공하기 시작했다. 운송업체, 특히 항공업계의 운송업체 는 운송 서비스의 판매를 훨씬 더 폭넓은 필요와 불가분의 관계가 있는 것으로 보았 다. 항공사는 여행자에게 보험과 숙박 예약 서비스를 제공했다."
    ],
    "tags": [
      "#예술",
      "#역사"
  ...
  },
  {
    ...
    "translation": [
      "패션은 언제나 문화와 깊이 관련되어 있으며, 이것의 훌륭한 예는 유럽 의복의 발전 에서 볼 수 있다. 중세 초기에는 의복이 단순한 경향이 있었고, 거친 양모나 동물의 모피로 만들어지는 경우가 많았다. 그러나 직물 제작의 발전과 함께, 패션은 더 정교 하고 몸에 꼭 맞는 스타일로 나아가기 시작했다. 르네상스와 엘리자베스 시대에는 스 타일이 훨씬 더 세련되었다. 부유한 사람들이 입던 옷은 점점 더 화려해졌으며, 특히 더 잘록한 허리가 강조되었다. 의복과 사회적 지위 사이의 연관성은 매우 뚜렷해서, 특정 사치품의 착용을 제한하기 위해 법이 제정되었다. 더 높은 사회 계층에게만 허 용된 깃털, 비단, 벨벳과 같은 사치스러운 스타일과 장식은 사회에서 자신의 지위를 보여 주는 수단으로 사용되었다. 이것은 상류 계층의 스타일이 문화적 의식에 명시적 으로 포함되면서 더욱 강화되었는데, 이는 그것을 착용한 사람들의 역할이 명확하게 식별될 수 있도록 하기 위한 것이었다."
    ],
    "tags": [
      "#과학",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "Shakespeare나 Euripides와 같은 극작가들의 고전 작품이나 심지어 미국 뮤지컬 노 래 가사에는 등장인물의 생각과 감정을 전달하는 관습적이지 않고 비현실적인 방식이 포함되어 있으며, 그것들을 이해하기 위해서는 조금 더 많은 기술과 인내가 필요하다. 독자는 시적 형식이나 고어체 어휘 사용이 이야기에 관한 의미 있는 정보를 얻는 데 방해가 되지 않도록 주의해야 하며, 대신 그 형식 자체를 내용을 드러내는 문체적 기 법으로 보아야 한다. 복잡한 언어나 낯선 문체를 가진 대본은 그 뉘앙스가 분명해지 기 위해 몇 차례 더 읽을 필요가 있을 수도 있다. 뮤지컬 작품은 대화에 대한 강조가 줄어들고 노래와 춤에 대한 강조가 크기 때문에, 읽을 때 마음속에 그려 보기가 특히 어렵다. 예를 들어, 음악과 가사가 뮤지컬 대본에서 제거되면, 남는 것은 극본 또는 대본으로 알려진 대화이고, 그것은 매우 두꺼울(→ 얇을) 수 있다. 뮤지컬에서는 실제 로 무대에서 공연될 때 시간이 많이 걸릴 수 있는 춤, 움직임, 또는 동작이 강조되지 만, 희곡 대본에 인쇄되면 매우 적은 공간을 차지할 수 있다."
    ],
    "tags": [
      "#사회",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "화자가 항상 자신에게 중요한 모든 것을 말로 표현하는 것은 아니다. 매우 흔하게, 목소리 어조나 크기의 변화, 시선 교환, 얼굴 표정, 몸짓과 같은 비언어적 행동을 관 찰함으로써 화자가 전달하려는 의미를 이해할 수 있다. 비언어적 행동은 오해하기 쉽 기 때문에, 효과적인 청자는 누군가의 비언어적 소통에 대한 자신의 해석을 말로 확 인한다. “고개를 끄덕이신 것이 찬성을 의미하나요?”와 같은 간단한 질문으로 모두가 같은 이해를 공유하고 있다는 것을 분명히 할 수 있다. 비언어적 (소통에 대한) 연구 가 가리키듯이, 화자가 의미하고자 하는 것의 절반 이상이 비언어적으로 전달된다면, 우리가 비언어적 행동을 ‘귀담아 듣지’ 않을 때, 많은 중요한 정보를 놓치게 되는 것 이다. 심지어 Freud는 “볼 눈과 들을 귀가 있는 사람은 어떤 인간도 비밀을 지킬 수 없다는 것을 스스로 확신하게 될 수 있다. 만약 입술이 침묵하더라도 그는 손가락 끝 으로 재잘거리며, 누설(속마음)이 그의 모든 모공에서 스며 나온다.”라고 시사했다. 대 면 집단 토론에서 대부분의 사람들이 자신이 의미하고 느끼는 것을 숨기는 것이 어려 운 것은 당연하다.22"
    ],
    "tags": [
      "#심리학"
    ],
  ...
  },
  {
    ...
    "translation": [
      "미술 작품의 가치가 단지 시장에서뿐만 아니라 본질적으로 의존적이며 가변적이라는 속성은, 오늘날의 미술 수집가가 자신을 위해 구매하든 한 기관의 대표자로서 구매하 든 스스로의 마음 속에 가장 우선적으로 자리하고 있다. 작품을 소장하는 것은 미술 사의 한 부분을 소장하는 것이거나, (다시 말해, 고양이나 기념품과 같은 부류의 개인 적 즐거움의 대상을 제외하면) 아무것도 소장하지 않는 것이다. 수표에 서명함으로써, 수집가는 미술 전체에 의해 달성된 하나의 중요한 지점으로서 그 작품이 미래에도 존 재할 것이라는 자신의 믿음을 단언한다. 하지만 역사는 어느 것에나 열려 있고, 선택 된 그림이나 조각의 가치는 기껏해야 현재의 합의에 의한 확인에 불과하다. 이러한 합의는, 과거에 다른 합의들이 그래왔듯이, 대체될 것이 거의 확실하다. 결국, 그림 한 작품에 헌신하는 것은 수집가 자신의 행위이다. 이러한 행위를 통해 그는, 그것(자 신의 미학적 판단)이 어떤 근원으로부터 유래되었든, 자신의 미학적 판단뿐만 아니라 스스로 미술이 나아갈 방향을 예측할 수 있다는 확신 또한 용기 있게 확언한다."
    ],
    "tags": [
      "#경제",
      "#사회",
  ...
  },
  {
    ...
    "translation": [
      "누군가의 몸집이 더 클수록, 심지어 비교적 무해한 사고를 통해서도 스스로에게 더 많은 해를 가할 수 있다. 아장아장 걷는 아기들이 자주 넘어지고 부딪힘에도 불구하 고, 그들이 입는 부상이 심각한 경우는 드물다. 몸집에 비해 상대적으로 두꺼운 그들 의 뼈는, 최고 속도로 움직일 때조차도 스스로에게 큰 해를 가할 만큼 충분한 에너지 를 거의 축적하지 못한다는 것을 의미한다. 성인의 늘어난 몸집 때문에 (더 높은 곳 에서 떨어지며 반응이 더 느릴 수 있다는 사실이 가중되어), 넘어질 경우 바닥에 훨 씬 더 큰 힘으로 충돌하게 된다. 몸집과 뼈 강도 사이의 비선형적인 관계는 비록 성 인의 뼈가 아기의 뼈보다 절대적인 수치로는 더 두꺼울지라도, 커진 몸집으로 인해 야기된 더 큰 충격을 상쇄할 만큼 상대적으로 충분히 두껍지는 않을 수 있다는 것을 의미한다. (체질량 지수(BMI)는 비전문가들이 일상생활에서 자신들의 건강 상태를 점 검하는 편리한 방법으로 쓰일 수 있다.) 같은 이유로, 키가 더 큰 사람들이 키가 더 작은 사람들보다 고관절 골절과 같은 낙상 관련 부상을 더 많이 겪는 것으로 나타났 다."
    ],
    "tags": [
      "#과학"
    ],
  ...
  },
  {
    ...
    "content": [
      "Plants have evolved defenses almost as diverse as the\nnumber of genera. Some load their tissues with harsh\ncompounds that either are unpleasant to insects or intoxicate\nthem, encouraging the insects to go bother another plant or\nat least slowing down their eating. The back-and-forth is not a matter of natural balance, but\nmore like a drawn-out evolutionary conversation. New\nplant defenses unintentionally select for insects with ways\nto get around them, which in turn help bring about more\nresilient and resistant plant species. New variations,\nshading into entire new forms and adaptations, maintain\nthe stalemate. Plants can release chemical compounds that let their\nsame-species neighbors know that an attack is likely\ncoming, pushing those nearby plants to start building up\ndefensive compounds in their tissues. Some of these cues\neven attract insect predators, a call for an assist that\nbenefits both the plant and its bug-eating collaborators. Structural defenses like thick coats of wax on leaves may\nprevent some insect species from damaging the plant\ntissues altogether. Nor are individual plants entirely on\ntheir own while under attack."
    ],
    "translation": [
      "식물들은 거의 그 속의 수만큼이나 다양한 방어 기제를 진화시켜 왔다. 어떤 식물은 자신의 조직을 곤충에게 불쾌감을 주거나 곤충을 취하게 만드는 독한 화합물로 채워 서, 곤충이 다른 식물을 괴롭히러 가도록 유도하거나 적어도 곤충이 먹이를 먹는 속 도를 늦춘다. 잎의 두꺼운 왁스층과 같은 구조적 방어 기제는 일부 곤충 종이 식 물 조직을 아예 손상시키지 못하게 막을 수도 있다. 또한 개별 식물은 공격을 받는 동안 완전히 혼자인 것도 아니다. 식물은 동종의 이웃 식물에게 공격이 임박한 것 같다고 알려주는 화학 화합물을 방출하여, 그 주변의 식물들이 자신의 조직에 방어용 화합물을 축적하기 시작하도록 유도할 수 있다. 이러한 신호 중 일부는 심지어 곤충 의 포식자를 유인하기도 하는데, 이는 식물과 곤충을 잡아먹는 협력자 모두에게 이익 이 되는 지원 요청이다. 이러한 공방전은 자연적 균형의 문제가 아니라 오히려25 길게 이어지는 진화적 대화에 가깝다. 식물의 새로운 방어 기제는 의도치 않게 그것 을 우회할 방법을 지닌 곤충들을 선택하게 되고, 이는 결국 더 회복력과 저항력이 강 한 식물 종이 나타나도록 돕는다. 새로운 변이들은 완전히 새로운 형태와 적응으로 점차 변해가며 그 교착 상태를 유지한다."
    ],
    "tags": [
      "#과학",
      "#예술",
  ...
  },
  {
    ...
    "translation": [
      "유리의 구조는, 솔직히 말해서, 다소 엉망진창이다. 우리 눈에는 투명하고 완벽해 보 일지 몰라도, 분자 수준으로 내려가 보면, 유리는 원자들이 마구잡이로 있는 볼풀에29 더 가까워 보인다. 이러한 엉망진창인 상태를 뜻하는 전문 용어는 여러분이 누구에 게 묻고 있느냐에 따라 달라지는데, 어떤 과학자들에게는 그것이 ‘무정형의 고체’이 고, 다른 이들에게는 ‘과냉각 액체’이다. 이론적으로 그것은 액체이면서 동시에 고체 이지만, 그것이 작용하는 방식을 고려하면 실제로는 후자(고체)이다. 사실, 상온에서 유리는, 심지어 (알아차릴 수 없을 정도로) 미세하게 점성이 있는 것이라 해도, 심지 어 오랜 시간이 지나더라도, 결코 액체처럼 행동하지 않는다(비록 혼합물에 석회를 충분히 넣지 않으면 유리가 ‘땀을 흘릴’ 수는 있지만). 여러분이 오래된 스테인드글 라스 창문에서 가끔 보는, 윗부분보다 아랫부분이 더 두꺼운 보기 흉한 유리판들은 대개 시간이 지나면서 유리가 천천히 아래로 가라앉고 있기 때문에 그렇게 된 것이 아니다. 교회가 400°C가 넘는 온도를 견뎌낸 것이 아니라면, 아마 그것들이 애초에 그런 방식으로 불어서 만들어지고 응고되었기 때문에 고르지 않은 것이다. 판유리는 19세기가 되어서야 겨우 개발되었고, 정말로 평평하고 얇은 유리판을 얻기 위해서는 20세기 중반까지 기다려야 했다. 역설은 유리가 인간이 만든 가장 오래된 물질 중 하나임에도 불구하고, 과학자들은 유리가 왜 그런 방식으로 작용하는지 이해하는 데 여전히 애를 먹고 있다는 점이다. 유리는 대부분의 분자 법칙을 따르는(→ 거부하는) 것처럼 보인다. 한 유리 제조업자가 말했듯이, 유리는 재료가 아니라 상태이다."
    ],
    "tags": [
      "#역사"
    ],
